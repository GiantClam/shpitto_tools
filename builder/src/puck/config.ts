  ...
  components: {
    ...
    LeadCaptureCTA: {
      ...
      fields: {
        title: textField("Title"),
        subtitle: textareaField("Subtitle"),
        titleColor: textField("Title Color"),
        titleClassName: textField("Title ClassName"),
        ctaBackgroundColor: textField("CTA Background Color"),
        ctaTextColor: textField("CTA Text Color"),
        ctaClassName: textField("CTA ClassName"),
    ...
    CardsGrid: {
      ...
      fields: {
        ...
        featureFirst: booleanField("Feature First"),
        paddingY: selectField("Padding", ["sm", "md", "lg"]),
        background: selectField("Background", ["none", "muted", "gradient", "image"]),
        maxWidth: selectField("Max Width", ["lg", "xl", "2xl"]),
        items: listField("Items", {
