...
const DEFAULT_PROPS = {
  "id": "feckw",
  "emptitletext": "我们的员工",
  "empbodytext": "我们的员工占力我们实现一切，是他们对于创新、对持续发展、优化业务和工程应用的热情帮助我们走在行业前沿。很重要的是，正是得益于我们的员工们，我们提供的合作伙伴、我们才得益于他们的个性连接与交互现实。我们的足迹遍布150多个国家，拥有员工140,000名。加入我们，机会无限。",
  "emplinktext": "职业机会  ›",
  "empimageimagesrc": "https://images.unsplash.com/photo-1758470584241-b50ea5cf7b79?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMzE3NDN8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSandvikAboutStoryEmployeesecpenAlt11({ id, emptitletext, empbodytext, emplinktext, empimageimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, emptitletext, empbodytext, emplinktext, empimageimagesrc });
