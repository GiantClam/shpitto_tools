...
export default function TemplateExclusivePenSiteHomeContactHomecontactpenAlt7({ id, xvezktext, mtgetext, ieae8text, p5aeatext, avgedtext, c6xgtext, ewg1ctext, osgwitext, ryrpwtext, stymmtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, xvezktext, mtgetext, ieae8text, p5aeatext, avgedtext, c6xgtext, ewg1ctext, osgwitext, ryrpwtext, stymmtext });
