...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerFollowtext",
      "hrefProp": "footerFollowhref"
    },
    {
      "type": "text",
      "id": "footer-vat",
      ...
      "children": [],
      "textProp": "footerVattext",
      "hrefProp": "footerVathref"
    },
    {
      "type": "rectangle",
      "id": "footer-link-Customer Service",
      "name": "footer-link-Customer Service",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "footer-link-t-Customer Service",
      "name": "footer-link-t-Customer Service",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerLinkTCustomerServicetext",
      "hrefProp": "footerLinkTCustomerServicehref"
    },
    {
      "type": "text",
      "id": "footer-link-a-Customer Service",
      "name": "footer-link-a-Customer Service",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerLinkACustomerServicetext",
      "hrefProp": "footerLinkACustomerServicehref"
    },
    {
      "type": "rectangle",
    ...
    {
      "type": "text",
      "id": "footer-link-t-Contacts",
      "name": "footer-link-t-Contacts",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerLinkTContactstext",
      "hrefProp": "footerLinkTContactshref"
    },
    {
      "type": "text",
      "id": "footer-link-a-Contacts",
      "name": "footer-link-a-Contacts",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerLinkAContactstext",
      "hrefProp": "footerLinkAContactshref"
    },
    {
      "type": "rectangle",
    ...
    {
      "type": "text",
      "id": "footer-link-t-Terms",
      "name": "footer-link-t-Terms",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerLinkTTermstext",
      "hrefProp": "footerLinkTTermshref"
    },
    {
      "type": "text",
      "id": "footer-link-a-Terms",
      "name": "footer-link-a-Terms",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerLinkATermstext",
      "hrefProp": "footerLinkATermshref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "footer",
  "footerFollowtext": "Follow Breton on: Facebook • LinkedIn • YouTube",
  "footerFollowhref": "/",
  "footerVattext": "VAT: 01880270267 • © 2026 Breton S.p.A. All rights reserved.",
  "footerVathref": "/",
  "footerLinkTCustomerServicetext": "Customer Service",
  "footerLinkTCustomerServicehref": "/contacts",
  "footerLinkACustomerServicetext": "↗",
  "footerLinkACustomerServicehref": "/",
  "footerLinkTContactstext": "Contacts",
  "footerLinkTContactshref": "/contacts",
  "footerLinkAContactstext": "↗",
  "footerLinkAContactshref": "/",
  "footerLinkTTermstext": "Terms",
  "footerLinkTTermshref": "/",
  "footerLinkATermstext": "↗",
  "footerLinkATermshref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #D4D8DE)";
...
export default function TemplateExclusivePenSiteRevolutionizingManufacturingFooterFooterpenAlt1({ id, footerFollowtext, footerFollowhref, footerVattext, footerVathref, footerLinkTCustomerServicetext, footerLinkTCustomerServicehref, footerLinkACustomerServicetext, footerLinkACustomerServicehref, footerLinkTContactstext, footerLinkTContactshref, footerLinkAContactstext, footerLinkAContactshref, footerLinkTTermstext, footerLinkTTermshref, footerLinkATermstext, footerLinkATermshref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerFollowtext, footerFollowhref, footerVattext, footerVathref, footerLinkTCustomerServicetext, footerLinkTCustomerServicehref, footerLinkACustomerServicetext, footerLinkACustomerServicehref, footerLinkTContactstext, footerLinkTContactshref, footerLinkAContactstext, footerLinkAContactshref, footerLinkTTermstext, footerLinkTTermshref, footerLinkATermstext, footerLinkATermshref });
