...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageCompanyNavbarLogoimagesrc, pageCompanyNavbarLangtext, pageCompanyNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageCompanyNavbarLogoimagesrc, pageCompanyNavbarLangtext, pageCompanyNavbarLanghref });
