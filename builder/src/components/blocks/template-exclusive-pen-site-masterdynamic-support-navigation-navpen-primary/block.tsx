...
export default function TemplateExclusivePenSiteMasterdynamicSupportNavigationNavpenPrimary({ id, logotext, logohref, l1text, l1href, l2text, l2href, l3text, l3href, l4text, l4href, shopbtnhref, shoptxttext, ...rest }) {
