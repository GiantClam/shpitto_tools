...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #ef6f2e)";
...
export default function TemplateExclusivePenSiteHomeNavigationDarktoppenAlt3({ id, d1text, d1href, d2text, d2href, arrtext, arrhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, d1text, d1href, d2text, d2href, arrtext, arrhref });
