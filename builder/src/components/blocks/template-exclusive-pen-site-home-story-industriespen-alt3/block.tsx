...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "indCard1Imgimagesrc"
    },
    {
      "type": "text",
      "id": "ind-card-1-title",
      "name": "ind-card-1-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "indCard1Titletext"
    },
    {
      "type": "text",
      "id": "ind-card-1-body",
      "name": "ind-card-1-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "indCard1Bodytext"
    },
    {
      "type": "rectangle",
      "id": "ind-card-1-btn-box",
      "name": "ind-card-1-btn-box",
      "style": {
        "boxSizing": "border-box",
        "width": 120,
        "height": 30,
      ...
      "children": [],
      "hrefProp": "indCard1BtnBoxhref"
    },
    {
      "type": "text",
      "id": "ind-card-1-btn-text",
      "name": "ind-card-1-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "indCard1BtnTexttext",
      "hrefProp": "indCard1BtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "ind-card-2-box",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "indCard2Imgimagesrc"
    },
    {
      "type": "text",
      "id": "ind-card-2-title",
      "name": "ind-card-2-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "indCard2Titletext"
    },
    {
      "type": "text",
      "id": "ind-card-2-body",
      "name": "ind-card-2-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "indCard2Bodytext"
    },
    {
      "type": "rectangle",
      "id": "ind-card-2-btn-box",
      "name": "ind-card-2-btn-box",
      "style": {
        "boxSizing": "border-box",
        "width": 120,
        "height": 30,
      ...
      "children": [],
      "hrefProp": "indCard2BtnBoxhref"
    },
    {
      "type": "text",
      "id": "ind-card-2-btn-text",
      "name": "ind-card-2-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "indCard2BtnTexttext",
      "hrefProp": "indCard2BtnTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "industries",
  "indTitletext": "应用行业",
  "indCopytext": "FPT 可在多个工业领域开展业务，每台机器都根据行业需求与客户生产特性制造。",
  "indCard1Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-rail.jpg",
  "indCard1Titletext": "铁路",
  "indCard1Bodytext": "高稳定性和大尺寸零件加工。",
  "indCard1BtnBoxhref": "/",
  "indCard1BtnTexttext": "了解更多",
  "indCard1BtnTexthref": "/",
  "indCard2Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-defense.jpg",
  "indCard2Titletext": "防务",
  "indCard2Bodytext": "复杂、高精度加工场景。",
  "indCard2BtnBoxhref": "/",
  "indCard2BtnTexttext": "了解更多",
  "indCard2BtnTexthref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryIndustriespenAlt3({ id, indTitletext, indCopytext, indCard1Imgimagesrc, indCard1Titletext, indCard1Bodytext, indCard1BtnBoxhref, indCard1BtnTexttext, indCard1BtnTexthref, indCard2Imgimagesrc, indCard2Titletext, indCard2Bodytext, indCard2BtnBoxhref, indCard2BtnTexttext, indCard2BtnTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, indTitletext, indCopytext, indCard1Imgimagesrc, indCard1Titletext, indCard1Bodytext, indCard1BtnBoxhref, indCard1BtnTexttext, indCard1BtnTexthref, indCard2Imgimagesrc, indCard2Titletext, indCard2Bodytext, indCard2BtnBoxhref, indCard2BtnTexttext, indCard2BtnTexthref });
