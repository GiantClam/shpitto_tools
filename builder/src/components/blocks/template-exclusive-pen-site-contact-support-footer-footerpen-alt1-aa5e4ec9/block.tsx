...
const DEFAULT_PROPS = {
  ...
  "footerBrandhref": "/",
  "footerCol1text": "Products Support Announcements",
  "footerCol1href": "/products",
  "footerCol2text": "Developer Editions 3D Pocket",
  "footerCol2href": "/developer",
  "footerCopytext": "Analogue structured clone pen. Editable text, cards, buttons and image containers.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteContactSupportFooterFooterpenAlt1({ id, footerBrandtext, footerBrandhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCopytext, footerCopyhref, ...rest }) {
