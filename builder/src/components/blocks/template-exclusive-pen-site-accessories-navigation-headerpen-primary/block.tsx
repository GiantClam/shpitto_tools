...
export default function TemplateExclusivePenSiteAccessoriesNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOurRidestext, navPageOurRideshref, navPageAccessoriestext, navPageAccessorieshref, navPageOurStorytext, navPageOurStoryhref, navPagePeakDesigntext, navPagePeakDesignhref, navPageShippingDeliverytext, navPageShippingDeliveryhref, ...rest }) {
