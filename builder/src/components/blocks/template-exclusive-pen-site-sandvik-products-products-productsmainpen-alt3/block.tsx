...
const DEFAULT_PROPS = {
  "id": "pzjqo",
  "titletext": "金属切削刀具",
  "desctext": "在牢固可靠的基础上，我们提供的设备涵盖广泛材料、进给和应用工艺，数字化工具为精准刀具管理提供智能优势，从而释放出干净高效的可扩展价值。",
  "alllinktext": "探索金属切削刀具和解决方案  ›",
  "g1text": "刀片 (17507)",
  "g2text": "刀具 (24805)",
  "g3text": "自适应部件 (5445)",
  "g4text": "其它 (4533)",
  ...
  "kgejmtext": "刀杆 (4470)  ›",
  "rgfxktext": "锯齿刀 (4311)  ›",
  "sdttstext": "防振切削部件 (1240)  ›",
  "ot6wjtext": "Adaptive items灵活自适应切削部件 (2529)  ›",
  "ayobqtext": "夹头 (1693)  ›",
  "lnpyvtext": "用于平衡刀具的部件 (974)  ›",
  "cmttvtext": "Non-classified products (4533)  ›",
  "cat1imagesrc": "https://images.unsplash.com/photo-1616410011236-7a42121dd981?auto=format&fit=crop&w=1200&q=80",
  "cat2imagesrc": "https://images.unsplash.com/photo-1616401784845-180882ba9ba8?auto=format&fit=crop&w=1200&q=80",
  "cat3imagesrc": "https://images.unsplash.com/photo-1660183846659-1133f4637364?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMzIzMDh8&ixlib=rb-4.1.0&q=80&w=1080",
  "cat4imagesrc": "https://images.unsplash.com/photo-1536064479547-7ee40b74b807?auto=format&fit=crop&w=1200&q=80",
  "cat5imagesrc": "https://images.unsplash.com/photo-1572981779307-38b8cabb2407?auto=format&fit=crop&w=1200&q=80",
  "uwtwqtext": "刀片和材质  ›",
  "rlhiktext": "车削  ›",
  "k8x22text": "切断和切槽刀片  ›",
  "aq6y3text": "切断和切槽  ›",
...
export default function TemplateExclusivePenSiteSandvikProductsProductsProductsmainpenAlt3({ id, titletext, desctext, alllinktext, g1text, g2text, g3text, g4text, gqtfctext, fcyb2text, vg0ctext, p8bfftext, kgejmtext, rgfxktext, sdttstext, ot6wjtext, ayobqtext, lnpyvtext, cmttvtext, cat1imagesrc, cat2imagesrc, cat3imagesrc, cat4imagesrc, cat5imagesrc, uwtwqtext, rlhiktext, k8x22text, aq6y3text, kbqwtext, qnibtext, o1z3dtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, titletext, desctext, alllinktext, g1text, g2text, g3text, g4text, gqtfctext, fcyb2text, vg0ctext, p8bfftext, kgejmtext, rgfxktext, sdttstext, ot6wjtext, ayobqtext, lnpyvtext, cmttvtext, cat1imagesrc, cat2imagesrc, cat3imagesrc, cat4imagesrc, cat5imagesrc, uwtwqtext, rlhiktext, k8x22text, aq6y3text, kbqwtext, qnibtext, o1z3dtext });
