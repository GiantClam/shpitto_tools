...
export default function TemplateExclusivePenSiteOerlikonIndustriesStoryPresscopybpenAlt3({ id, pressttext, pressltext, evttext, evltext, ablr1text, evloctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pressttext, pressltext, evttext, evltext, ablr1text, evloctext });
