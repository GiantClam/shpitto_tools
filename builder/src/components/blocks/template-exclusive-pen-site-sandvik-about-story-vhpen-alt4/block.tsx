...
const DEFAULT_PROPS = {
  "id": "uxAki",
  "yl7lotext": "\n探讨  ›",
  "m9od3text": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "m1text": "从整体角度",
  "v1text": "1.",
  "eioktext": "\n探讨  ›",
  "wjhtwtext": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "m1text2": "拥抱新技术",
  "v1text2": "2.",
  "m7b3mtext": "\n探讨  ›",
  "djjntext": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "v1text3": "3.",
  "uosystext": "\n探讨  ›",
  "ftp0utext": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "v1text4": "4.",
  "romumtext": "\n探讨  ›",
  "owwl3text": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "v1text5": "5.",
  "vggytext": "\n探讨  ›",
  "bc8bxtext": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "v1text6": "6.",
  "jif7vtext": "\n探讨  ›",
  "rhkrrtext": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "v1text7": "7.",
  "mg80xtext": "\n探讨  ›",
  "mbjmtext": "专注于整体计划中最具影响力的步骤，并消除持久成功的障碍。\n",
  "v1text8": "8.",
  "dondotext": "了解更多  ›"
};
const DEFAULT_THEME = {
...
export default function TemplateExclusivePenSiteSandvikAboutStoryVhpenAlt4({ id, yl7lotext, m9od3text, m1text, v1text, eioktext, wjhtwtext, m1text2, v1text2, m7b3mtext, djjntext, v1text3, uosystext, ftp0utext, v1text4, romumtext, owwl3text, v1text5, vggytext, bc8bxtext, v1text6, jif7vtext, rhkrrtext, v1text7, mg80xtext, mbjmtext, v1text8, dondotext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, yl7lotext, m9od3text, m1text, v1text, eioktext, wjhtwtext, m1text2, v1text2, m7b3mtext, djjntext, v1text3, uosystext, ftp0utext, v1text4, romumtext, owwl3text, v1text5, vggytext, bc8bxtext, v1text6, jif7vtext, rhkrrtext, v1text7, mg80xtext, mbjmtext, v1text8, dondotext });
