...
export default function TemplateExclusivePenSiteOerlikonRDStoryInnovatewithuspenAlt9({ id, prhbwtext, i73tjtext, invbtnhref, nglgntext, invimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, prhbwtext, i73tjtext, invbtnhref, nglgntext, invimgimagesrc });
