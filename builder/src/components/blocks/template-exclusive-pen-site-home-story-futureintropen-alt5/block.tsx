  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "futureIntroBgimagesrc"
    },
    {
      "type": "rectangle",
      "id": "future-intro-shade",
      "name": "future-intro-shade",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 820,
    ...
    {
      "type": "rectangle",
      "id": "future-intro-shell",
      "name": "future-intro-shell",
      "style": {
        "boxSizing": "border-box",
        "width": 760,
        "height": 300,
    ...
    {
      "type": "text",
      "id": "future-intro-chapter",
      "name": "future-intro-chapter",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroChaptertext"
    },
    {
      "type": "text",
      "id": "future-intro-count",
      "name": "future-intro-count",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroCounttext"
    },
    {
      "type": "text",
      "id": "future-intro-title",
      "name": "future-intro-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroTitletext"
    },
    {
      "type": "text",
      "id": "future-intro-body",
      "name": "future-intro-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroBodytext"
    },
    {
      "type": "rectangle",
      "id": "future-intro-nav-chip-0",
      "name": "future-intro-nav-chip-0",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-intro-nav-chip-text-0",
      "name": "future-intro-nav-chip-text-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroNavChipText0text"
    },
    {
      "type": "rectangle",
      "id": "future-intro-nav-chip-1",
      "name": "future-intro-nav-chip-1",
      "style": {
        "boxSizing": "border-box",
    ...
    {
      "type": "text",
      "id": "future-intro-nav-chip-text-1",
      "name": "future-intro-nav-chip-text-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroNavChipText1text"
    },
    {
      "type": "rectangle",
      "id": "future-intro-nav-chip-2",
      "name": "future-intro-nav-chip-2",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-intro-nav-chip-text-2",
      "name": "future-intro-nav-chip-text-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroNavChipText2text"
    },
    {
      "type": "rectangle",
      "id": "future-intro-nav-chip-3",
      "name": "future-intro-nav-chip-3",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-intro-nav-chip-text-3",
      "name": "future-intro-nav-chip-text-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroNavChipText3text"
    },
    {
      "type": "rectangle",
      "id": "future-intro-nav-chip-4",
      "name": "future-intro-nav-chip-4",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-intro-nav-chip-text-4",
      "name": "future-intro-nav-chip-text-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureIntroNavChipText4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "future-intro",
  "futureIntroBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/future-intro.jpg",
  "futureIntroChaptertext": "Future",
  "futureIntroCounttext": "1 / 5",
  "futureIntroTitletext": "The future is written in the wind.",
  "futureIntroBodytext": "What is in the making only exists as a spark that has not yet found its form. The future is the breeze that only intuition and genius can catch and turn into a project.",
  "futureIntroNavChipText0text": "Intro",
  "futureIntroNavChipText1text": "The Research",
  "futureIntroNavChipText2text": "Beauty",
  "futureIntroNavChipText3text": "The Dream",
  "futureIntroNavChipText4text": "Certainty"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryFutureintropenAlt5({ id, futureIntroBgimagesrc, futureIntroChaptertext, futureIntroCounttext, futureIntroTitletext, futureIntroBodytext, futureIntroNavChipText0text, futureIntroNavChipText1text, futureIntroNavChipText2text, futureIntroNavChipText3text, futureIntroNavChipText4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, futureIntroBgimagesrc, futureIntroChaptertext, futureIntroCounttext, futureIntroTitletext, futureIntroBodytext, futureIntroNavChipText0text, futureIntroNavChipText1text, futureIntroNavChipText2text, futureIntroNavChipText3text, futureIntroNavChipText4text });
