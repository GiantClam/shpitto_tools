...
export default function TemplateExclusivePenSiteSectorNavigationNavbarpenPrimary({ id, pageSectorNavbarLogoimagesrc, pageSectorNavbarContactTexttext, pageSectorNavbarContactTexthref, pageSectorNavbarContactArrowtext, pageSectorNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageSectorNavbarLogoimagesrc, pageSectorNavbarContactTexttext, pageSectorNavbarContactTexthref, pageSectorNavbarContactArrowtext, pageSectorNavbarContactArrowhref });
