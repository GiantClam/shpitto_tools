...
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #111111)";
...
export default function TemplateExclusivePenSitePrivacyNavigationHeaderpenPrimary({ id, dl1uytext, dl1uyhref, cl6fmtext, cl6fmhref, e1rfgtext, e1rfghref, rva14text, rva14href, fds0text, fds0href, de06ztext, de06zhref, o96phtext, o96phhref, j7zkbtext, j7zkbhref, ludtutext, ludtuhref, nwndqtext, nwndqhref, lvwh9text, lvwh9href, zjsxrtext, zjsxrhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, dl1uytext, dl1uyhref, cl6fmtext, cl6fmhref, e1rfgtext, e1rfghref, rva14text, rva14href, fds0text, fds0href, de06ztext, de06zhref, o96phtext, o96phhref, j7zkbtext, j7zkbhref, ludtutext, ludtuhref, nwndqtext, nwndqhref, lvwh9text, lvwh9href, zjsxrtext, zjsxrhref });
