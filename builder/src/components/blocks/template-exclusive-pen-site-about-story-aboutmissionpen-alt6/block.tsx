...
const DEFAULT_PROPS = {
  "id": "3UM69",
  "soltitletext": "一个由共同愿景驱动的全球性组织\n",
  "soltagtxttext": "我们是Plexus",
  "soldesctext": "我们秉承追求卓越的创新文化，以设计、制造和服务全球最具变革性的产品而自豪。从挽救生命的医疗技术、任务关键型国防解决方案到复杂的工业自动化，我们很荣幸能与客户合作，将他们复杂的想法推向市场。"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryAboutmissionpenAlt6({ id, soltitletext, soltagtxttext, soldesctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, soltitletext, soltagtxttext, soldesctext });
