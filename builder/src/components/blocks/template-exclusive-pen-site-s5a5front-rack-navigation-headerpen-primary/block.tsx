...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-s5-a5-front-rack",
  "name": "Header",
  "style": {
...
export default function TemplateExclusivePenSiteS5A5FrontRackNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOurRidestext, navPageOurRideshref, navPageAccessoriestext, navPageAccessorieshref, navPageOurStorytext, navPageOurStoryhref, navPagePeakDesigntext, navPagePeakDesignhref, navPageShippingDeliverytext, navPageShippingDeliveryhref, ...rest }) {
