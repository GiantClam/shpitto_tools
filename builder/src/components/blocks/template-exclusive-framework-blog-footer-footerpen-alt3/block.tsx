...
export default function TemplateExclusiveFrameworkBlogFooterFooterpenAlt3({ id, y1pjgtext, boahrtext, boahrhref, hqbpktext, uj2cktext, uj2ckhref, iiv5dtext, tfjhstext, tfjhshref, iaikqtext, gzytext, gzyhref, hftivtext, brd7etext, brd7ehref, dmhketext, xjtjihref, vt300text, xsatptext, b7gutext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, y1pjgtext, boahrtext, boahrhref, hqbpktext, uj2cktext, uj2ckhref, iiv5dtext, tfjhstext, tfjhshref, iaikqtext, gzytext, gzyhref, hftivtext, brd7etext, brd7ehref, dmhketext, xjtjihref, vt300text, xsatptext, b7gutext });
  ...
  return renderFrameworkStructuredFooter({
    ...
    columns: [
      buildColumn(y1pjgtext, boahrtext, boahrhref),
      buildColumn(hqbpktext, uj2cktext, uj2ckhref),
      buildColumn(iiv5dtext, tfjhstext, tfjhshref),
      buildColumn(iaikqtext, gzytext, gzyhref),
    ],
    subscribeTitle: hftivtext,
    subscribeBody: brd7etext,
    subscribeBodyHref: brd7ehref,
    subscribeInputPlaceholder: dmhketext,
    subscribeInputHref: xjtjihref,
    subscribeButtonLabel: vt300text,
    legal: xsatptext,
    currency: b7gutext,
    theme: merged?.theme,
  });
