...
export default function TemplateExclusivePenSitePscsSolutionContactContactcopypenAlt7({ id, jec4ctext, hponptext, jlz47text, bmsnqtext, qzbmwtext, o5kqtext, r3wyftext, ym7eotext, ii7oktext, q5kb5text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, jec4ctext, hponptext, jlz47text, bmsnqtext, qzbmwtext, o5kqtext, r3wyftext, ym7eotext, ii7oktext, q5kb5text });
