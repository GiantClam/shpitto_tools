...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-partners-navbar-bg",
      "name": "page-partners-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-partners-navbar-logo",
      "name": "page-partners-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 34,
      ...
      "children": [],
      "imageProp": "pagePartnersNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-search",
      "name": "page-partners-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarSearchtext",
      "hrefProp": "pagePartnersNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-intl",
      "name": "page-partners-navbar-intl",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarIntltext",
      "hrefProp": "pagePartnersNavbarIntlhref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-design",
      "name": "page-partners-navbar-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarDesigntext",
      "hrefProp": "pagePartnersNavbarDesignhref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-support",
      "name": "page-partners-navbar-support",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarSupporttext",
      "hrefProp": "pagePartnersNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-iso",
      "name": "page-partners-navbar-iso",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarIsotext",
      "hrefProp": "pagePartnersNavbarIsohref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-PLATFORM",
      "name": "page-partners-navbar-PLATFORM",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarPlatformtext",
      "hrefProp": "pagePartnersNavbarPlatformhref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-INDUSTRIES",
      "name": "page-partners-navbar-INDUSTRIES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarIndustriestext",
      "hrefProp": "pagePartnersNavbarIndustrieshref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-PARTNERS",
      "name": "page-partners-navbar-PARTNERS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarPartnerstext",
      "hrefProp": "pagePartnersNavbarPartnershref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-RESOURCES",
      "name": "page-partners-navbar-RESOURCES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarResourcestext",
      "hrefProp": "pagePartnersNavbarResourceshref"
    },
    {
      "type": "text",
      "id": "page-partners-navbar-ABOUT",
      "name": "page-partners-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarAbouttext",
      "hrefProp": "pagePartnersNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-partners-navbar-contact-box",
      "name": "page-partners-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 40,
    ...
    {
      "type": "text",
      "id": "page-partners-navbar-contact-text",
      "name": "page-partners-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarContactTexttext",
      "hrefProp": "pagePartnersNavbarContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-partners-navbar",
  "pagePartnersNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "pagePartnersNavbarSearchtext": "Search...",
  "pagePartnersNavbarSearchhref": "/",
  "pagePartnersNavbarIntltext": "International",
  "pagePartnersNavbarIntlhref": "/",
  "pagePartnersNavbarDesigntext": "Design Engine",
  "pagePartnersNavbarDesignhref": "/",
  "pagePartnersNavbarSupporttext": "Customer Support",
  "pagePartnersNavbarSupporthref": "/contact",
  "pagePartnersNavbarIsotext": "ISO 9001:2015",
  "pagePartnersNavbarIsohref": "/",
  "pagePartnersNavbarPlatformtext": "PLATFORM",
  "pagePartnersNavbarPlatformhref": "/platform",
  "pagePartnersNavbarIndustriestext": "INDUSTRIES",
  "pagePartnersNavbarIndustrieshref": "/industries",
  "pagePartnersNavbarPartnerstext": "PARTNERS",
  "pagePartnersNavbarPartnershref": "/partners",
  "pagePartnersNavbarResourcestext": "RESOURCES",
  "pagePartnersNavbarResourceshref": "/resources",
  "pagePartnersNavbarAbouttext": "ABOUT",
  "pagePartnersNavbarAbouthref": "/about",
  "pagePartnersNavbarContactTexttext": "CONTACT",
  "pagePartnersNavbarContactTexthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSitePartnersNavigationNavbarpenPrimary({ id, pagePartnersNavbarLogoimagesrc, pagePartnersNavbarSearchtext, pagePartnersNavbarSearchhref, pagePartnersNavbarIntltext, pagePartnersNavbarIntlhref, pagePartnersNavbarDesigntext, pagePartnersNavbarDesignhref, pagePartnersNavbarSupporttext, pagePartnersNavbarSupporthref, pagePartnersNavbarIsotext, pagePartnersNavbarIsohref, pagePartnersNavbarPlatformtext, pagePartnersNavbarPlatformhref, pagePartnersNavbarIndustriestext, pagePartnersNavbarIndustrieshref, pagePartnersNavbarPartnerstext, pagePartnersNavbarPartnershref, pagePartnersNavbarResourcestext, pagePartnersNavbarResourceshref, pagePartnersNavbarAbouttext, pagePartnersNavbarAbouthref, pagePartnersNavbarContactTexttext, pagePartnersNavbarContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagePartnersNavbarLogoimagesrc, pagePartnersNavbarSearchtext, pagePartnersNavbarSearchhref, pagePartnersNavbarIntltext, pagePartnersNavbarIntlhref, pagePartnersNavbarDesigntext, pagePartnersNavbarDesignhref, pagePartnersNavbarSupporttext, pagePartnersNavbarSupporthref, pagePartnersNavbarIsotext, pagePartnersNavbarIsohref, pagePartnersNavbarPlatformtext, pagePartnersNavbarPlatformhref, pagePartnersNavbarIndustriestext, pagePartnersNavbarIndustrieshref, pagePartnersNavbarPartnerstext, pagePartnersNavbarPartnershref, pagePartnersNavbarResourcestext, pagePartnersNavbarResourceshref, pagePartnersNavbarAbouttext, pagePartnersNavbarAbouthref, pagePartnersNavbarContactTexttext, pagePartnersNavbarContactTexthref });
