...
export default function TemplateExclusivePenSiteAboutStoryAboutheaderpenPrimary({ id, logotexttext, navtext, langtxttext, ctahtxttext, toplinkstext, flagtxttext, langarrowtext, ...rest }) {
