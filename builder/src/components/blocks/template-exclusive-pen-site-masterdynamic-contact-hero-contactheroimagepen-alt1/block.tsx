...
const SECTION_TREE = {
  ...
  "children": [],
  "imageProp": "contactheroimageimagesrc"
};
const DEFAULT_PROPS = {
  "id": "iEfJL",
  "contactheroimageimagesrc": "https://images.unsplash.com/photo-1764557207167-66d80fa7e5ee?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzIyMDgxMzR8&ixlib=rb-4.1.0&q=80&w=1080"
};
...
export default function TemplateExclusivePenSiteMasterdynamicContactHeroContactheroimagepenAlt1({ id, contactheroimageimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, contactheroimageimagesrc });
