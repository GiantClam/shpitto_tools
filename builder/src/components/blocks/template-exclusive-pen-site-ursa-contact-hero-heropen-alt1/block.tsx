...
export default function TemplateExclusivePenSiteUrsaContactHeroHeropenAlt1({ id, h1text, h2text, hdesctext, herodesctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, h1text, h2text, hdesctext, herodesctext });
