...
const DEFAULT_PROPS = {
  "id": "bMKSx",
  "newstitletext": "新闻和见解",
  "newscard1ttext": "新闻: 2026-02-16",
  "newscard1stext": "展望2026年，以人为本、技术和可持续投资驱动行业发展",
  "newscard2ttext": "12 三月",
  "newscard2stext": "高级车削技术与应用培训",
  "newscard3ttext": "新闻洞察和出版",
  "newscard3stext": "了解 CoroDrill DE10i 等重大上市和加工创新",
  "newscard4imagesrc": "https://images.unsplash.com/photo-1720036237182-5e0adada1873?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjUxMzV8&ixlib=rb-4.1.0&q=80&w=1080",
  "news4ttext": "新闻 2026-2-16",
  "news4stext": "展望2026年，以人为本、技术和可持续投资驱动行业发展"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeCtaNewssectionpenAlt3({ id, newstitletext, newscard1ttext, newscard1stext, newscard2ttext, newscard2stext, newscard3ttext, newscard3stext, newscard4imagesrc, news4ttext, news4stext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newstitletext, newscard1ttext, newscard1stext, newscard2ttext, newscard2stext, newscard3ttext, newscard3stext, newscard4imagesrc, news4ttext, news4stext });
