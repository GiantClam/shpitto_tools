          ...
          "children": [
            {
              ...
              "children": [],
              "textProp": "craftbtntxttext"
            }
          ],
          "hrefProp": "craftbtnhref"
        }
      ]
    }
  ]
...
const DEFAULT_PROPS = {
  "id": "L0WtF",
  "craftimageimagesrc": "https://images.unsplash.com/photo-1642051679957-440ec6492c77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzIyMDgwNzd8&ixlib=rb-4.1.0&q=80&w=1080",
  "craftktext": "THE FINEST SOUND AND CRAFTSMANSHIP",
  "craftttext": "Built from Precision Materials, Tuned by Hand",
  "craftdtext": "From anodized aluminum to lambskin leather, every detail is selected for long-term comfort and iconic acoustic performance.",
  "craftbtnhref": "/masterdynamic-blog",
  "craftbtntxttext": "Explore Craft"
};
...
export default function TemplateExclusivePenSiteHomeStoryFinestcraftpenAlt4({ id, craftimageimagesrc, craftktext, craftttext, craftdtext, craftbtnhref, craftbtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, craftimageimagesrc, craftktext, craftttext, craftdtext, craftbtnhref, craftbtntxttext });
