...
export default function TemplateExclusiveFrameworkHomeHeroHero3penAlt3({ id, hero3limagesrc, h3t1text, h3bttext, cn9citext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hero3limagesrc, h3t1text, h3bttext, cn9citext });
