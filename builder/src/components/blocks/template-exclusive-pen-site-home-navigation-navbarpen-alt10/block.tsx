...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "brandLogoHomeimagesrc"
    },
    {
      "type": "text",
      "id": "nav-home-0",
      ...
      "children": [],
      "textProp": "navHome0text",
      "hrefProp": "navHome0href"
    },
    {
      "type": "text",
      "id": "nav-home-1",
      ...
      "children": [],
      "textProp": "navHome1text",
      "hrefProp": "navHome1href"
    },
    {
      "type": "text",
      "id": "nav-home-2",
      ...
      "children": [],
      "textProp": "navHome2text",
      "hrefProp": "navHome2href"
    },
    {
      "type": "text",
      "id": "nav-home-3",
      ...
      "children": [],
      "textProp": "navHome3text",
      "hrefProp": "navHome3href"
    },
    {
      "type": "text",
      "id": "nav-home-4",
      ...
      "children": [],
      "textProp": "navHome4text",
      "hrefProp": "navHome4href"
    },
    {
      "type": "text",
      "id": "nav-home-5",
      ...
      "children": [],
      "textProp": "navHome5text",
      "hrefProp": "navHome5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-home",
...
const DEFAULT_PROPS = {
  "id": "navbar-home",
  "brandLogoHomeimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navHome0text": "Home",
  "navHome0href": "/",
  "navHome1text": "History",
  "navHome1href": "/history",
  "navHome2text": "Dealers",
  "navHome2href": "/dealers",
  "navHome3text": "Tours",
  "navHome3href": "/guided-tours",
  "navHome4text": "Utopia",
  "navHome4href": "/pagani-utopia",
  "navHome5text": "Contact",
  "navHome5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenAlt10({ id, brandLogoHomeimagesrc, navHome0text, navHome0href, navHome1text, navHome1href, navHome2text, navHome2href, navHome3text, navHome3href, navHome4text, navHome4href, navHome5text, navHome5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoHomeimagesrc, navHome0text, navHome0href, navHome1text, navHome1href, navHome2text, navHome2href, navHome3text, navHome3href, navHome4text, navHome4href, navHome5text, navHome5href });
