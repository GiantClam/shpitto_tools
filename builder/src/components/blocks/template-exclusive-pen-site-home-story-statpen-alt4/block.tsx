...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "aboutmoretext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "RoxvK",
  "statheadtext": "旨在实现卓越的全球足迹",
  "s1ttext": "$4B",
  "s1ltext": "年收入",
  "s2ttext": "~30",
  "s2ltext": "全球分布",
  ...
  "s4ttext": "5k+",
  "s4ltext": "供应商关系",
  "abouttagtxttext": "关于PLEXUS",
  "aboutmoretext": "关于我们的更多信息 →"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeStoryStatpenAlt4({ id, statheadtext, s1ttext, s1ltext, s2ttext, s2ltext, s3ttext, s3ltext, s4ttext, s4ltext, abouttagtxttext, aboutmoretext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, statheadtext, s1ttext, s1ltext, s2ttext, s2ltext, s3ttext, s3ltext, s4ttext, s4ltext, abouttagtxttext, aboutmoretext });
