...
export default function TemplateExclusiveUnistellarHomeTechnologiesNavigationHeadpenPrimary({ id, logotext, logohref, nhtext, nhhref, nstext, nshref, nbtext, nbhref, nttext, nthref, nrtext, nrhref, btnhref, btnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, nhtext, nhhref, nstext, nshref, nbtext, nbhref, nttext, nthref, nrtext, nrhref, btnhref, btnttext });
