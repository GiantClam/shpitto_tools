...
export default function TemplateExclusiveFrameworkProductsFooterFooterpenAlt3({ id, i4katext, dyodktext, dyodkhref, xfwttext, dew7otext, dew7ohref, icru3text, httzhtext, httzhhref, fplrvtext, yrfltext, yrflhref, emze2text, uqretext, uqrehref, juramtext, zvlavhref, vux1ztext, n5q0utext, hl1oztext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, i4katext, dyodktext, dyodkhref, xfwttext, dew7otext, dew7ohref, icru3text, httzhtext, httzhhref, fplrvtext, yrfltext, yrflhref, emze2text, uqretext, uqrehref, juramtext, zvlavhref, vux1ztext, n5q0utext, hl1oztext });
  ...
  return renderFrameworkStructuredFooter({
    ...
    columns: [
      buildColumn(i4katext, dyodktext, dyodkhref),
      buildColumn(xfwttext, dew7otext, dew7ohref),
      buildColumn(icru3text, httzhtext, httzhhref),
      buildColumn(fplrvtext, yrfltext, yrflhref),
    ],
    subscribeTitle: emze2text,
    subscribeBody: uqretext,
    subscribeBodyHref: uqrehref,
    subscribeInputPlaceholder: juramtext,
    subscribeInputHref: zvlavhref,
    subscribeButtonLabel: vux1ztext,
    legal: n5q0utext,
    currency: hl1oztext,
    theme: merged?.theme,
  });
