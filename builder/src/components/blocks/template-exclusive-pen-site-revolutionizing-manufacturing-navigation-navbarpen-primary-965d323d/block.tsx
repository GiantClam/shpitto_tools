...
const DEFAULT_PROPS = {
  ...
  "pageRevolutionizingManufacturingNavbarLangtext": "🌐",
...
export default function TemplateExclusivePenSiteRevolutionizingManufacturingNavigationNavbarpenPrimary({ id, pageRevolutionizingManufacturingNavbarLogoimagesrc, pageRevolutionizingManufacturingNavbarSearchtext, pageRevolutionizingManufacturingNavbarSearchhref, pageRevolutionizingManufacturingNavbarLangtext, pageRevolutionizingManufacturingNavbarLanghref, pageRevolutionizingManufacturingNavbarMenutext, pageRevolutionizingManufacturingNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageRevolutionizingManufacturingNavbarLogoimagesrc, pageRevolutionizingManufacturingNavbarSearchtext, pageRevolutionizingManufacturingNavbarSearchhref, pageRevolutionizingManufacturingNavbarLangtext, pageRevolutionizingManufacturingNavbarLanghref, pageRevolutionizingManufacturingNavbarMenutext, pageRevolutionizingManufacturingNavbarMenuhref });
