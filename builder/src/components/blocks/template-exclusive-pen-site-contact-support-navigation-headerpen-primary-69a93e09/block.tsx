...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "hrefProp": "navPageSupportCentrehref"
    },
    {
      "type": "text",
      ...
      "hrefProp": "navPageContactSupporthref"
    }
  ]
};
const DEFAULT_PROPS = {
  ...
  "navPageOffershref": "/offers",
  "navPagePhonestext": "PHONES",
  "navPagePhoneshref": "/phones",
  "navPageAudiotext": "AUDIO",
  "navPageAudiohref": "/audio",
  "navPageSupportCentretext": "SUPPORT CENTRE",
  "navPageSupportCentrehref": "/support-centre",
  "navPageContactSupporttext": "CONTACT SUPPORT",
  "navPageContactSupporthref": "/contact-support"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteContactSupportNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOfferstext, navPageOffershref, navPagePhonestext, navPagePhoneshref, navPageAudiotext, navPageAudiohref, navPageSupportCentretext, navPageSupportCentrehref, navPageContactSupporttext, navPageContactSupporthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, headerBrandtext, headerBrandhref, navPageOfferstext, navPageOffershref, navPagePhonestext, navPagePhoneshref, navPageAudiotext, navPageAudiohref, navPageSupportCentretext, navPageSupportCentrehref, navPageContactSupporttext, navPageContactSupporthref });
