...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt1({ id, heroimageimagesrc, eyebrowtext, herotitletext, herobodytext, herobtnhref, herobtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroimageimagesrc, eyebrowtext, herotitletext, herobodytext, herobtnhref, herobtntxttext });
