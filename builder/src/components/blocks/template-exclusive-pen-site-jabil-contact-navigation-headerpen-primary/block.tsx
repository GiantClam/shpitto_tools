...
export default function TemplateExclusivePenSiteJabilContactNavigationHeaderpenPrimary({ id, logotext, logohref, navtext, navhref, searchtext, searchhref, ...rest }) {
