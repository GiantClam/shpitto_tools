...
export default function TemplateExclusivePenSiteAboutStoryAboutcontactpenAlt6({ id, contacttitletext, contactbgimagesrc, contactbtnhref, contactbtnttext, contactbtnthref, qtagtext, qdesctext, ...rest }) {
