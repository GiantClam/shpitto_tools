  ...
  "children": [
    ...
    },
    {
      ...
      "style": {
        ...
        "width": 1440,
        "height": 526,
        "background": "linear-gradient(90deg, #05365be6 0%, #0a3150de 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
...
export default function TemplateExclusivePenSiteHomeStoryCuttingedgepenAlt5({ id, edgebgimagesrc, uptext, textatext, linkatext, textbtext, linkbtext, textctext, linkctext, textdtext, linkdtext, feattxttext, zqusmtext, j7fjutext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, edgebgimagesrc, uptext, textatext, linkatext, textbtext, linkbtext, textctext, linkctext, textdtext, linkdtext, feattxttext, zqusmtext, j7fjutext });
