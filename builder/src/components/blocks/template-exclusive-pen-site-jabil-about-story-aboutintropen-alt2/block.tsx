    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "children": [],
          "textProp": "videoplaytext"
        }
      ],
      "imageProp": "videocardimagesrc"
    }
  ]
};
const DEFAULT_PROPS = {
...
export default function TemplateExclusivePenSiteJabilAboutStoryAboutintropenAlt2({ id, introtexttext, videocardimagesrc, videobtnhref, videoplaytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introtexttext, videocardimagesrc, videobtnhref, videoplaytext });
