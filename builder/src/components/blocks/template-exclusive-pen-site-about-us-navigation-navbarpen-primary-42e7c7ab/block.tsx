...
export default function TemplateExclusivePenSiteAboutUsNavigationNavbarpenPrimary({ id, pageAboutNavbarLogoimagesrc, pageAboutNavbarSearchtext, pageAboutNavbarSearchhref, pageAboutNavbarLangtext, pageAboutNavbarLanghref, pageAboutNavbarMenutext, pageAboutNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAboutNavbarLogoimagesrc, pageAboutNavbarSearchtext, pageAboutNavbarSearchhref, pageAboutNavbarLangtext, pageAboutNavbarLanghref, pageAboutNavbarMenutext, pageAboutNavbarMenuhref });
