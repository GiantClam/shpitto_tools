...
export default function TemplateExclusivePenSiteJabilAboutCtaCtabgpenAlt12({ id, ctabgimagesrc, ctabtnhref, ctabtntxttext, ctatitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctabgimagesrc, ctabtnhref, ctabtntxttext, ctatitletext });
