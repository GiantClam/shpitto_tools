...
const DEFAULT_PROPS = {
  "id": "hero",
  "heroImageimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/builder/public/assets/template-factory/pamama-machinetools-reference/mobile-hero-top.png",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroImageimagesrc, homeNavbarLogoimagesrc, homeNavbarContactTexttext, homeNavbarContactArrowtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroImageimagesrc, homeNavbarLogoimagesrc, homeNavbarContactTexttext, homeNavbarContactArrowtext });
