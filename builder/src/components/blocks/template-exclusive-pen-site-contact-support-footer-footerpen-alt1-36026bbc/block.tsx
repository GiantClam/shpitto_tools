...
const DEFAULT_PROPS = {
  ...
  "footerBrandhref": "/",
  "footerCol1text": "Offers Phones Audio",
  "footerCol1href": "/offers",
  "footerCol2text": "Support Centre Contact Support Phone (3a) Pro Ear (3)",
  "footerCol2href": "/support-centre",
  "footerCopytext": "Nothing structured clone pen. Editable text, cards, buttons and image containers.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
