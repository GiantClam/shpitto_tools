...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "insightB1text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "insights",
  "insightImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-home-img-1-1d7086e9.jpg",
  "insightK0text": "Story",
  "insightT0text": "Sound Room",
  "insightB0text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection.",
  "insightImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-home-img-1-1d7086e9.jpg",
  "insightK1text": "Support",
  "insightT1text": "About",
  "insightB1text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection."
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryInsightspenAlt3({ id, insightImg0imagesrc, insightK0text, insightT0text, insightB0text, insightImg1imagesrc, insightK1text, insightT1text, insightB1text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, insightImg0imagesrc, insightK0text, insightT0text, insightB0text, insightImg1imagesrc, insightK1text, insightT1text, insightB1text });
