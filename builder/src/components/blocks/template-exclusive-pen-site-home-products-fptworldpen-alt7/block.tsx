...
const DEFAULT_PROPS = {
  ...
  "worlddesctext": "FPT 的国际销售和售后网络覆盖 40 多个国家。\n每天有 300 多名代理商为集团国际成功做出贡献。",
  "num1text": "56",
  "label1text": "年份",
  "num2text": "76500",
  "label2text": "平方米",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #666E75)";
...
export default function TemplateExclusivePenSiteHomeProductsFptworldpenAlt7({ id, worldtitletext, worlddesctext, num1text, label1text, num2text, label2text, num3text, label3text, num4text, label4text, num5text, label5text, worldbtnhref, worldbtntexttext, worldbtntexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, worldtitletext, worlddesctext, num1text, label1text, num2text, label2text, num3text, label3text, num4text, label4text, num5text, label5text, worldbtnhref, worldbtntexttext, worldbtntexthref });
