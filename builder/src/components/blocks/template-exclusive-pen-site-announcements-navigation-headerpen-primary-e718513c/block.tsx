...
export default function TemplateExclusivePenSiteAnnouncementsNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
