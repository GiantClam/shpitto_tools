...
export default function TemplateExclusivePenSiteJabilAboutContactContactpenAlt13({ id, formtitletext, fnlabeltext, lnlabeltext, colabeltext, joblabeltext, indlabeltext, emaillabeltext, phonelabeltext, reasonlabeltext, commentlabeltext, flagtxttext, cctxttext, captxttext, capicontext, submitbtnhref, submittxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, formtitletext, fnlabeltext, lnlabeltext, colabeltext, joblabeltext, indlabeltext, emaillabeltext, phonelabeltext, reasonlabeltext, commentlabeltext, flagtxttext, cctxttext, captxttext, capicontext, submitbtnhref, submittxttext });
