...
const SECTION_TREE = {
  "type": "frame",
  "id": "page-nikolaus-bagnara-navbar",
  "name": "Navbar",
  "style": {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-nikolaus-bagnara-navbar-bg",
      "name": "page-nikolaus-bagnara-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-nikolaus-bagnara-navbar-logo",
      "name": "page-nikolaus-bagnara-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 140,
        "height": 44,
      ...
      "children": [],
      "imageProp": "pageNikolausBagnaraNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-Engineering",
      "name": "page-nikolaus-bagnara-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarEngineeringtext",
      "hrefProp": "pageNikolausBagnaraNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-Products",
      "name": "page-nikolaus-bagnara-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarProductstext",
      "hrefProp": "pageNikolausBagnaraNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-Services",
      "name": "page-nikolaus-bagnara-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarServicestext",
      "hrefProp": "pageNikolausBagnaraNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-BIT",
      "name": "page-nikolaus-bagnara-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarBittext",
      "hrefProp": "pageNikolausBagnaraNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-nikolaus-bagnara-navbar-lets",
      "name": "page-nikolaus-bagnara-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-lets-t",
      "name": "page-nikolaus-bagnara-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarLetsTtext",
      "hrefProp": "pageNikolausBagnaraNavbarLetsThref"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-search",
      "name": "page-nikolaus-bagnara-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarSearchtext",
      "hrefProp": "pageNikolausBagnaraNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-lang",
      "name": "page-nikolaus-bagnara-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarLangtext",
      "hrefProp": "pageNikolausBagnaraNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-nikolaus-bagnara-navbar-menu",
      "name": "page-nikolaus-bagnara-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNikolausBagnaraNavbarMenutext",
      "hrefProp": "pageNikolausBagnaraNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-nikolaus-bagnara-navbar",
  "pageNikolausBagnaraNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageNikolausBagnaraNavbarEngineeringtext": "Engineering",
  "pageNikolausBagnaraNavbarEngineeringhref": "/engineering",
  "pageNikolausBagnaraNavbarProductstext": "Products",
  "pageNikolausBagnaraNavbarProductshref": "/products",
  "pageNikolausBagnaraNavbarServicestext": "Services",
  "pageNikolausBagnaraNavbarServiceshref": "/services",
  "pageNikolausBagnaraNavbarBittext": "BIT",
  "pageNikolausBagnaraNavbarBithref": "/bit",
  "pageNikolausBagnaraNavbarLetsTtext": "Let's talk",
  "pageNikolausBagnaraNavbarLetsThref": "/",
  "pageNikolausBagnaraNavbarSearchtext": "⌕",
  "pageNikolausBagnaraNavbarSearchhref": "/",
  "pageNikolausBagnaraNavbarLangtext": "Language",
  "pageNikolausBagnaraNavbarLanghref": "/",
  "pageNikolausBagnaraNavbarMenutext": "☰",
  "pageNikolausBagnaraNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteNikolausBagnaraNavigationNavbarpenPrimary({ id, pageNikolausBagnaraNavbarLogoimagesrc, pageNikolausBagnaraNavbarEngineeringtext, pageNikolausBagnaraNavbarEngineeringhref, pageNikolausBagnaraNavbarProductstext, pageNikolausBagnaraNavbarProductshref, pageNikolausBagnaraNavbarServicestext, pageNikolausBagnaraNavbarServiceshref, pageNikolausBagnaraNavbarBittext, pageNikolausBagnaraNavbarBithref, pageNikolausBagnaraNavbarLetsTtext, pageNikolausBagnaraNavbarLetsThref, pageNikolausBagnaraNavbarSearchtext, pageNikolausBagnaraNavbarSearchhref, pageNikolausBagnaraNavbarLangtext, pageNikolausBagnaraNavbarLanghref, pageNikolausBagnaraNavbarMenutext, pageNikolausBagnaraNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageNikolausBagnaraNavbarLogoimagesrc, pageNikolausBagnaraNavbarEngineeringtext, pageNikolausBagnaraNavbarEngineeringhref, pageNikolausBagnaraNavbarProductstext, pageNikolausBagnaraNavbarProductshref, pageNikolausBagnaraNavbarServicestext, pageNikolausBagnaraNavbarServiceshref, pageNikolausBagnaraNavbarBittext, pageNikolausBagnaraNavbarBithref, pageNikolausBagnaraNavbarLetsTtext, pageNikolausBagnaraNavbarLetsThref, pageNikolausBagnaraNavbarSearchtext, pageNikolausBagnaraNavbarSearchhref, pageNikolausBagnaraNavbarLangtext, pageNikolausBagnaraNavbarLanghref, pageNikolausBagnaraNavbarMenutext, pageNikolausBagnaraNavbarMenuhref });
