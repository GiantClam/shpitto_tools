...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-products-navbar-企业",
      "name": "page-products-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarText",
      "hrefProp": "pageProductsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-产品",
      "name": "page-products-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarText2",
      "hrefProp": "pageProductsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-行业",
      "name": "page-products-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarText3",
      "hrefProp": "pageProductsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-技术",
      "name": "page-products-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarText4",
      "hrefProp": "pageProductsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-通信",
      "name": "page-products-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarText5",
      "hrefProp": "pageProductsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-联系方式",
      "name": "page-products-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarText6",
      "hrefProp": "pageProductsNavbarHref"
    },
    {
      "type": "rectangle",
...
const DEFAULT_PROPS = {
  "id": "page-products-navbar",
  "pageProductsNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageProductsNavbarLangtext": "ZH",
  "pageProductsNavbarLanghref": "/",
  "pageProductsNavbarText": "企业",
  "pageProductsNavbarHref": "/",
  "pageProductsNavbarText2": "产品",
  "pageProductsNavbarText3": "行业",
  "pageProductsNavbarText4": "技术",
  "pageProductsNavbarText5": "通信",
  "pageProductsNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarLangtext, pageProductsNavbarLanghref, pageProductsNavbarText, pageProductsNavbarHref, pageProductsNavbarText2, pageProductsNavbarText3, pageProductsNavbarText4, pageProductsNavbarText5, pageProductsNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarLangtext, pageProductsNavbarLanghref, pageProductsNavbarText, pageProductsNavbarHref, pageProductsNavbarText2, pageProductsNavbarText3, pageProductsNavbarText4, pageProductsNavbarText5, pageProductsNavbarText6 });
