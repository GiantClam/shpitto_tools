...
const DEFAULT_PROPS = {
  "id": "xGADt",
  "herotitletext": "The full-stack\nquantum platform",
  "herodesctext": "IonQ, the only full-stack quantum platform, is solving the world’s most complex problems with products and services spanning across quantum compute, quantum networking, quantum sensing, quantum security, and quantum space infrastructure.",
  "heroimgimagesrc": "https://images.unsplash.com/photo-1755053757526-84af4c260204?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxNTgwNTB8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteProductHeroProductheropenAlt2({ id, herotitletext, herodesctext, heroimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herodesctext, heroimgimagesrc });
