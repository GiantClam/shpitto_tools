...
export default function TemplateExclusivePenSiteSolutionContactSolcontactpenAlt5({ id, contactimgimagesrc, contacttagtxttext, contacttitletext, contactbtnhref, contactbtntxttext, ...rest }) {
