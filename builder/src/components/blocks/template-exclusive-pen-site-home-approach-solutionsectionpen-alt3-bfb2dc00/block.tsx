...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "solutionImageimagesrc"
    },
    {
      "type": "rectangle",
      "id": "solution-overlay",
    ...
    {
      "type": "text",
      "id": "solution-inner-title",
      "name": "solution-inner-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "solutionInnerTitletext"
    },
    {
      "type": "text",
      "id": "solution-inner-body",
      "name": "solution-inner-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "solutionInnerBodytext"
    },
    {
      "type": "rectangle",
      "id": "solution-cta-box",
      "name": "solution-cta-box",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 38,
      ...
      "children": [],
      "hrefProp": "solutionCtaBoxhref"
    },
    {
      "type": "text",
      "id": "solution-cta-text",
      "name": "solution-cta-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "solutionCtaTexttext",
      "hrefProp": "solutionCtaTexthref"
    },
    {
      "type": "text",
      "id": "solution-cta-arrow",
      "name": "solution-cta-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "solutionCtaArrowtext",
      "hrefProp": "solutionCtaArrowhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "solution-section",
  "solutionTitletext": "SOLUTION PROVIDER",
  "solutionCopytext": "PAMA is at the service of its customers and provides support to satisfy all their needs even for the most difficult machine tool applications.",
  "solutionImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/solution-f30308ed.png",
  "solutionInnerTitletext": "YOUR SOLUTION PROVIDER",
  "solutionInnerBodytext": "From plant configuration to technology services, a dedicated project manager supports every customer through the full production process.",
  "solutionCtaBoxhref": "/",
  "solutionCtaTexttext": "DISCOVER MORE",
  "solutionCtaTexthref": "/",
  "solutionCtaArrowtext": "›",
  "solutionCtaArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteHomeApproachSolutionsectionpenAlt3({ id, solutionTitletext, solutionCopytext, solutionImageimagesrc, solutionInnerTitletext, solutionInnerBodytext, solutionCtaBoxhref, solutionCtaTexttext, solutionCtaTexthref, solutionCtaArrowtext, solutionCtaArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, solutionTitletext, solutionCopytext, solutionImageimagesrc, solutionInnerTitletext, solutionInnerBodytext, solutionCtaBoxhref, solutionCtaTexttext, solutionCtaTexthref, solutionCtaArrowtext, solutionCtaArrowhref });
