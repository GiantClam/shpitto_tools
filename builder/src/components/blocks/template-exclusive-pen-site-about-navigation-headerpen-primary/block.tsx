...
export default function TemplateExclusivePenSiteAboutNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageAllProductstext, navPageAllProductshref, navPageModularSystemtext, navPageModularSystemhref, navPageSoundRoomtext, navPageSoundRoomhref, navPageSupporttext, navPageSupporthref, navPageAbouttext, navPageAbouthref, ...rest }) {
