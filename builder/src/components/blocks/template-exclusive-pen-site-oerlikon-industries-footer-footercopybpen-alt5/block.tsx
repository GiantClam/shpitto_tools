...
export default function TemplateExclusivePenSiteOerlikonIndustriesFooterFootercopybpenAlt5({ id, ge8rctext, j94ibtext, d9apitext, d9apihref, z0yaetext, z0yaehref, y9ybttext, y9ybthref, ugkkytext, ce57ytext, tqvq8text, tqvq8href, vgvadtext, vgvadhref, f8lgotext, dbbcgtext, ba1pltext, ba1plhref, uusmktext, uusmkhref, ahafstext, ahafshref, zgdwtext, t6bzstext, frpttext, frpthref, rmmytext, rmmyhref, nz6qgtext, ruu6stext, ruu6shref, aylvtext, ejh9vtext, j1swvtext, zd5otext, hv3nctext, contactbtnhref, contacttexttext, l0zbtext, vt2nttext, vt2nthref, bxre4text, bxre4href, yyso8text, ykvtext, ykvhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ge8rctext, j94ibtext, d9apitext, d9apihref, z0yaetext, z0yaehref, y9ybttext, y9ybthref, ugkkytext, ce57ytext, tqvq8text, tqvq8href, vgvadtext, vgvadhref, f8lgotext, dbbcgtext, ba1pltext, ba1plhref, uusmktext, uusmkhref, ahafstext, ahafshref, zgdwtext, t6bzstext, frpttext, frpthref, rmmytext, rmmyhref, nz6qgtext, ruu6stext, ruu6shref, aylvtext, ejh9vtext, j1swvtext, zd5otext, hv3nctext, contactbtnhref, contacttexttext, l0zbtext, vt2nttext, vt2nthref, bxre4text, bxre4href, yyso8text, ykvtext, ykvhref });
