...
const DEFAULT_PROPS = {
  "id": "b4cNA",
  "splitimgimagesrc": "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=1400&q=80",
  "righttagtext": "工程项目",
  "righttitletext": "将生产挑战转化为竞争优势  ›"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeApproachSplitsectionpenAlt4({ id, splitimgimagesrc, righttagtext, righttitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, splitimgimagesrc, righttagtext, righttitletext });
