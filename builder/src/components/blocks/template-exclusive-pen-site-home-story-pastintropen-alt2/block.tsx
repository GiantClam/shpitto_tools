  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "pastIntroBgimagesrc"
    },
    {
      "type": "rectangle",
      "id": "past-intro-shade",
      "name": "past-intro-shade",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 860,
    ...
    },
    {
      ...
      "children": [],
      "textProp": "pastBodytext"
    },
    {
      "type": "rectangle",
      "id": "past-nav-chip-0",
      "name": "past-nav-chip-0",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "past-nav-chip-text-0",
      "name": "past-nav-chip-text-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pastNavChipText0text"
    },
    {
      "type": "rectangle",
      "id": "past-nav-chip-1",
      "name": "past-nav-chip-1",
      "style": {
        "boxSizing": "border-box",
        "width": 130.6,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "past-nav-chip-text-1",
      "name": "past-nav-chip-text-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pastNavChipText1text"
    },
    {
      "type": "rectangle",
      "id": "past-nav-chip-2",
      "name": "past-nav-chip-2",
      "style": {
        "boxSizing": "border-box",
        "width": 89.6,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "past-nav-chip-text-2",
      "name": "past-nav-chip-text-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pastNavChipText2text"
    },
    {
      "type": "rectangle",
      "id": "past-nav-chip-3",
      "name": "past-nav-chip-3",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "past-nav-chip-text-3",
      "name": "past-nav-chip-text-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
        ...
        "width": 82,
        "position": "absolute",
        "left": 402.20000000000005,
        "top": 457
      },
      "children": [],
      "textProp": "pastNavChipText3text"
    },
    {
      "type": "rectangle",
      "id": "past-nav-chip-4",
      "name": "past-nav-chip-4",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "past-nav-chip-text-4",
      "name": "past-nav-chip-text-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pastNavChipText4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "past-intro",
  "pastIntroBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/past-intro.jpg",
  "pastChaptertext": "Past",
  "pastCounttext": "1 / 5",
  "pastTitletext": "Wind blows round.",
  "pastBodytext": "That of Horacio Pagani is the great adventure of an art and engineering crusade. How did the myth of Pagani Automobili come to life, the brand for which cars the richest men in the world are willing to spend a crazy amount of money?",
  "pastNavChipText0text": "Intro",
  "pastNavChipText1text": "The Challenge",
  "pastNavChipText2text": "Leonardo",
  "pastNavChipText3text": "Perfection",
  "pastNavChipText4text": "The Belief"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryPastintropenAlt2({ id, pastIntroBgimagesrc, pastChaptertext, pastCounttext, pastTitletext, pastBodytext, pastNavChipText0text, pastNavChipText1text, pastNavChipText2text, pastNavChipText3text, pastNavChipText4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pastIntroBgimagesrc, pastChaptertext, pastCounttext, pastTitletext, pastBodytext, pastNavChipText0text, pastNavChipText1text, pastNavChipText2text, pastNavChipText3text, pastNavChipText4text });
