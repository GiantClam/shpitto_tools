...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-contacts-navbar-企业",
      "name": "page-contacts-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarText",
      "hrefProp": "pageContactsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-产品",
      "name": "page-contacts-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarText2",
      "hrefProp": "pageContactsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-行业",
      "name": "page-contacts-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarText3",
      "hrefProp": "pageContactsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-技术",
      "name": "page-contacts-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarText4",
      "hrefProp": "pageContactsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-通信",
      "name": "page-contacts-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarText5",
      "hrefProp": "pageContactsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-联系方式",
      "name": "page-contacts-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarText6",
      "hrefProp": "pageContactsNavbarHref"
    },
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-menu-hit",
      "name": "page-contacts-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-menu-line1",
      "name": "page-contacts-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-menu-line2",
      "name": "page-contacts-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-menu-line3",
      "name": "page-contacts-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-contacts-navbar",
  "pageContactsNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageContactsNavbarLangtext": "ZH",
  "pageContactsNavbarLanghref": "/",
  "pageContactsNavbarText": "企业",
  "pageContactsNavbarHref": "/",
  "pageContactsNavbarText2": "产品",
  "pageContactsNavbarText3": "行业",
  "pageContactsNavbarText4": "技术",
  "pageContactsNavbarText5": "通信",
  "pageContactsNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageContactsNavbarLogoimagesrc, pageContactsNavbarLangtext, pageContactsNavbarLanghref, pageContactsNavbarText, pageContactsNavbarHref, pageContactsNavbarText2, pageContactsNavbarText3, pageContactsNavbarText4, pageContactsNavbarText5, pageContactsNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactsNavbarLogoimagesrc, pageContactsNavbarLangtext, pageContactsNavbarLanghref, pageContactsNavbarText, pageContactsNavbarHref, pageContactsNavbarText2, pageContactsNavbarText3, pageContactsNavbarText4, pageContactsNavbarText5, pageContactsNavbarText6 });
