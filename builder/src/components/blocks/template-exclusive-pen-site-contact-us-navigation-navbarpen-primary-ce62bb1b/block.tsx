...
export default function TemplateExclusivePenSiteContactUsNavigationNavbarpenPrimary({ id, pageContactUsNavbarLogoimagesrc, pageContactUsNavbarContactTexttext, pageContactUsNavbarContactTexthref, pageContactUsNavbarContactArrowtext, pageContactUsNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactUsNavbarLogoimagesrc, pageContactUsNavbarContactTexttext, pageContactUsNavbarContactTexthref, pageContactUsNavbarContactArrowtext, pageContactUsNavbarContactArrowhref });
