...
export default function TemplateExclusivePenSiteAboutUsNavigationNavbarpenPrimary({ id, pageAboutUsNavbarLogoimagesrc, pageAboutUsNavbarContactTexttext, pageAboutUsNavbarContactTexthref, pageAboutUsNavbarContactArrowtext, pageAboutUsNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAboutUsNavbarLogoimagesrc, pageAboutUsNavbarContactTexttext, pageAboutUsNavbarContactTexthref, pageAboutUsNavbarContactArrowtext, pageAboutUsNavbarContactArrowhref });
