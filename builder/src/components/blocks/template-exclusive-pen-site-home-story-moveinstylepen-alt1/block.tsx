...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "storyCopytext"
    },
    {
      "type": "rectangle",
      "id": "story-card-1-box",
      "name": "story-card-1-box",
      "style": {
        "boxSizing": "border-box",
        "width": 420,
        "height": 250,
    ...
    {
      "type": "rectangle",
      "id": "story-card-1-image",
      "name": "story-card-1-image",
      "style": {
        "boxSizing": "border-box",
        "width": 396,
        "height": 96,
      ...
      "children": [],
      "imageProp": "storyCard1Imageimagesrc"
    },
    {
      "type": "text",
      "id": "story-card-1-eyebrow",
      "name": "story-card-1-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard1Eyebrowtext"
    },
    {
      "type": "text",
      "id": "story-card-1-title",
      "name": "story-card-1-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard1Titletext"
    },
    {
      "type": "text",
      "id": "story-card-1-body",
      "name": "story-card-1-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard1Bodytext"
    },
    {
      "type": "text",
      "id": "story-card-1-arrow",
      "name": "story-card-1-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard1Arrowtext"
    },
    {
      "type": "rectangle",
      "id": "story-card-2-box",
      "name": "story-card-2-box",
      "style": {
        "boxSizing": "border-box",
        "width": 420,
        "height": 250,
    ...
    {
      "type": "rectangle",
      "id": "story-card-2-image",
      "name": "story-card-2-image",
      "style": {
        "boxSizing": "border-box",
        "width": 396,
        "height": 96,
      ...
      "children": [],
      "imageProp": "storyCard2Imageimagesrc"
    },
    {
      "type": "text",
      "id": "story-card-2-eyebrow",
      "name": "story-card-2-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard2Eyebrowtext"
    },
    {
      "type": "text",
      "id": "story-card-2-title",
      "name": "story-card-2-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard2Titletext"
    },
    {
      "type": "text",
      "id": "story-card-2-body",
      "name": "story-card-2-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard2Bodytext"
    },
    {
      "type": "text",
      "id": "story-card-2-arrow",
      "name": "story-card-2-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard2Arrowtext"
    },
    {
      "type": "rectangle",
      "id": "story-card-3-box",
      "name": "story-card-3-box",
      "style": {
        "boxSizing": "border-box",
        "width": 420,
        "height": 250,
    ...
    {
      "type": "rectangle",
      "id": "story-card-3-image",
      "name": "story-card-3-image",
      "style": {
        "boxSizing": "border-box",
        "width": 396,
        "height": 96,
      ...
      "children": [],
      "imageProp": "storyCard3Imageimagesrc"
    },
    {
      "type": "text",
      "id": "story-card-3-eyebrow",
      "name": "story-card-3-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard3Eyebrowtext"
    },
    {
      "type": "text",
      "id": "story-card-3-title",
      "name": "story-card-3-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard3Titletext"
    },
    {
      "type": "text",
      "id": "story-card-3-body",
      "name": "story-card-3-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard3Bodytext"
    },
    {
      "type": "text",
      "id": "story-card-3-arrow",
      "name": "story-card-3-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard3Arrowtext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "move-in-style",
  "storyTitletext": "I MOVE IN STYLE",
  "storyCopytext": "With almost one century of experience and a research and development department that continuously studies and works on new technologies, PAMA develops and manufactures boring machines, milling machines and machining centres for various sectors for which it guarantees quality and reliability.",
  "storyCard1Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/sector-aerospace-1c409b17.jpg",
  "storyCard1Eyebrowtext": "SECTOR",
  "storyCard1Titletext": "AEROSPACE SECTOR",
  "storyCard1Bodytext": "Processing of hard materials for titanium, Inconel and steel alloys in aerospace applications.",
  "storyCard1Arrowtext": "›",
  "storyCard2Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/sector-energy-40ca7931.jpg",
  "storyCard2Eyebrowtext": "SECTOR",
  "storyCard2Titletext": "ENERGY SECTOR",
  "storyCard2Bodytext": "High precision and repeatability for thermal, nuclear and renewable energy production.",
  "storyCard2Arrowtext": "›",
  "storyCard3Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/sector-transport-18e8f590.jpg",
  "storyCard3Eyebrowtext": "SECTOR",
  "storyCard3Titletext": "TRANSPORT SECTOR",
  "storyCard3Bodytext": "Flexible machining solutions designed for demanding transport components.",
  "storyCard3Arrowtext": "›"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryMoveinstylepenAlt1({ id, storyTitletext, storyCopytext, storyCard1Imageimagesrc, storyCard1Eyebrowtext, storyCard1Titletext, storyCard1Bodytext, storyCard1Arrowtext, storyCard2Imageimagesrc, storyCard2Eyebrowtext, storyCard2Titletext, storyCard2Bodytext, storyCard2Arrowtext, storyCard3Imageimagesrc, storyCard3Eyebrowtext, storyCard3Titletext, storyCard3Bodytext, storyCard3Arrowtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, storyTitletext, storyCopytext, storyCard1Imageimagesrc, storyCard1Eyebrowtext, storyCard1Titletext, storyCard1Bodytext, storyCard1Arrowtext, storyCard2Imageimagesrc, storyCard2Eyebrowtext, storyCard2Titletext, storyCard2Bodytext, storyCard2Arrowtext, storyCard3Imageimagesrc, storyCard3Eyebrowtext, storyCard3Titletext, storyCard3Bodytext, storyCard3Arrowtext });
