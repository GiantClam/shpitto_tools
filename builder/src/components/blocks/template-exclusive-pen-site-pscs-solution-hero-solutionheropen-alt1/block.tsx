...
export default function TemplateExclusivePenSitePscsSolutionHeroSolutionheropenAlt1({ id, herotitletext, heroleadtext, herobtnhref, herobtntexttext, heroimageimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, heroleadtext, herobtnhref, herobtntexttext, heroimageimagesrc });
