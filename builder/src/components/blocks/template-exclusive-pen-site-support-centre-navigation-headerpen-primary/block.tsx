...
export default function TemplateExclusivePenSiteSupportCentreNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOfferstext, navPageOffershref, navPagePhonestext, navPagePhoneshref, navPageAudiotext, navPageAudiohref, navPageSupportCentretext, navPageSupportCentrehref, navPageContactSupporttext, navPageContactSupporthref, ...rest }) {
