...
export default function TemplateExclusivePenSiteOerlikonProductsStoryBrandscopyppenAlt6({ id, brtitletext, kovdytext, ui18wtext, zxktatext, tmml9text, phgbttext, stnhltext, brdesctext, brbtnhref, uenrotext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brtitletext, kovdytext, ui18wtext, zxktatext, tmml9text, phgbttext, stnhltext, brdesctext, brbtnhref, uenrotext });
