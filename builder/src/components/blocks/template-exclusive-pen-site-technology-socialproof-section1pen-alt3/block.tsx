...
const DEFAULT_PROPS = {
  "id": "BWrIE",
  "introtagtext": "[ Introduction ]",
  "newtitletext": "Atoms make better\nquantum computers.",
  "col1ttext": "At its core, a quantum computer is a machine that uses a quantum system, like the spin of an electron, to do a very specific type of math.\n\nThis math takes advantage of the uniquely complex behavior of quantum systems, namely entanglement and superposition, to perform calculations that are fundamentally unlike the calculations ordinary computers based on classical physics can perform.",
  "col2ttext": "Many quantum hardware developers use \"synthetic\" quantum systems for their quantum bits (qubits for short), like loops of superconducting wire, intentional imperfections in crystalline silicon, or other designs carefully coaxed to behave as quantum systems.\n\nAt IonQ, we take a different approach. We use a naturally occurring quantum system: individual atoms.",
  "col3ttext": "These atoms are the heart of our quantum processing units. We trap them in 3D space, and then use lasers to do everything from initial preparation to final readout.\n\nIt requires counterintuitive physics, precision optical and mechanical engineering, and fine-grained firmware control over a variety of components, but the superior results speak for themselves."
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteTechnologySocialproofSection1penAlt3({ id, introtagtext, newtitletext, col1ttext, col2ttext, col3ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introtagtext, newtitletext, col1ttext, col2ttext, col3ttext });
