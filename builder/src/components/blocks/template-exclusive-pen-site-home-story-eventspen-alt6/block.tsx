              ...
              "children": [
                {
                  ...
                  "style": {
                    ...
                    "width": 312,
                    "height": 72,
                    "background": "linear-gradient(90deg, #01284a 0%, #0e4b7c 100%)",
                    "position": "absolute",
                    "left": 0,
                    "top": 0
                  },
              ...
              "children": [
                {
                  ...
                  "style": {
                    ...
                    "width": 313,
                    "height": 72,
                    "background": "linear-gradient(90deg, #042547 0%, #073d67 100%)",
                    "position": "absolute",
                    "left": 0,
                    "top": 0
                  },
              ...
              "children": [
                {
                  ...
                  "style": {
                    ...
                    "width": 313,
                    "height": 72,
                    "background": "linear-gradient(90deg, #001d44 0%, #083866 100%)",
                    "position": "absolute",
                    "left": 0,
                    "top": 0
                  },
              ...
              "children": [
                {
                  ...
                  "style": {
                    ...
                    "width": 312,
                    "height": 72,
                    "background": "linear-gradient(90deg, #062c53 0%, #0c4b7a 100%)",
                    "position": "absolute",
                    "left": 0,
                    "top": 0
                  },
...
export default function TemplateExclusivePenSiteHomeStoryEventspenAlt6({ id, xrk0text, qdmbwtext, fosctext, lkkvitext, oypjktext, g8ldytext, jw9ltext, wglogtext, pdca8text, xcjnbtext, bfsjtext, fqrtatext, itkvtext, vl5text, lnbttext, knqhitext, hav1ptext, ftbgjtext, mc4kjtext, v1noktext, r5rbrtext, ror01text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, xrk0text, qdmbwtext, fosctext, lkkvitext, oypjktext, g8ldytext, jw9ltext, wglogtext, pdca8text, xcjnbtext, bfsjtext, fqrtatext, itkvtext, vl5text, lnbttext, knqhitext, hav1ptext, ftbgjtext, mc4kjtext, v1noktext, r5rbrtext, ror01text });
