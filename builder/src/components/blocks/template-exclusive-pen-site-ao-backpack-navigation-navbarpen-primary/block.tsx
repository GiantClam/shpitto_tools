...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-ao-backpack-navbar-bg",
      "name": "page-ao-backpack-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-ao-backpack-navbar-logo",
      "name": "page-ao-backpack-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 34,
      ...
      "children": [],
      "imageProp": "pageAoBackpackNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-search",
      "name": "page-ao-backpack-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarSearchtext",
      "hrefProp": "pageAoBackpackNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-intl",
      "name": "page-ao-backpack-navbar-intl",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarIntltext",
      "hrefProp": "pageAoBackpackNavbarIntlhref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-design",
      "name": "page-ao-backpack-navbar-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarDesigntext",
      "hrefProp": "pageAoBackpackNavbarDesignhref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-support",
      "name": "page-ao-backpack-navbar-support",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarSupporttext",
      "hrefProp": "pageAoBackpackNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-iso",
      "name": "page-ao-backpack-navbar-iso",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarIsotext",
      "hrefProp": "pageAoBackpackNavbarIsohref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-PLATFORM",
      "name": "page-ao-backpack-navbar-PLATFORM",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarPlatformtext",
      "hrefProp": "pageAoBackpackNavbarPlatformhref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-INDUSTRIES",
      "name": "page-ao-backpack-navbar-INDUSTRIES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarIndustriestext",
      "hrefProp": "pageAoBackpackNavbarIndustrieshref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-PARTNERS",
      "name": "page-ao-backpack-navbar-PARTNERS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarPartnerstext",
      "hrefProp": "pageAoBackpackNavbarPartnershref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-RESOURCES",
      "name": "page-ao-backpack-navbar-RESOURCES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarResourcestext",
      "hrefProp": "pageAoBackpackNavbarResourceshref"
    },
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-ABOUT",
      "name": "page-ao-backpack-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarAbouttext",
      "hrefProp": "pageAoBackpackNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-ao-backpack-navbar-contact-box",
      "name": "page-ao-backpack-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 40,
    ...
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-contact-text",
      "name": "page-ao-backpack-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarContactTexttext",
      "hrefProp": "pageAoBackpackNavbarContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-ao-backpack-navbar",
  "pageAoBackpackNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "pageAoBackpackNavbarSearchtext": "Search...",
  "pageAoBackpackNavbarSearchhref": "/",
  "pageAoBackpackNavbarIntltext": "International",
  "pageAoBackpackNavbarIntlhref": "/",
  "pageAoBackpackNavbarDesigntext": "Design Engine",
  "pageAoBackpackNavbarDesignhref": "/",
  "pageAoBackpackNavbarSupporttext": "Customer Support",
  "pageAoBackpackNavbarSupporthref": "/contact",
  "pageAoBackpackNavbarIsotext": "ISO 9001:2015",
  "pageAoBackpackNavbarIsohref": "/",
  "pageAoBackpackNavbarPlatformtext": "PLATFORM",
  "pageAoBackpackNavbarPlatformhref": "/platform",
  "pageAoBackpackNavbarIndustriestext": "INDUSTRIES",
  "pageAoBackpackNavbarIndustrieshref": "/industries",
  "pageAoBackpackNavbarPartnerstext": "PARTNERS",
  "pageAoBackpackNavbarPartnershref": "/partners",
  "pageAoBackpackNavbarResourcestext": "RESOURCES",
  "pageAoBackpackNavbarResourceshref": "/resources",
  "pageAoBackpackNavbarAbouttext": "ABOUT",
  "pageAoBackpackNavbarAbouthref": "/about",
  "pageAoBackpackNavbarContactTexttext": "CONTACT",
  "pageAoBackpackNavbarContactTexthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteAoBackpackNavigationNavbarpenPrimary({ id, pageAoBackpackNavbarLogoimagesrc, pageAoBackpackNavbarSearchtext, pageAoBackpackNavbarSearchhref, pageAoBackpackNavbarIntltext, pageAoBackpackNavbarIntlhref, pageAoBackpackNavbarDesigntext, pageAoBackpackNavbarDesignhref, pageAoBackpackNavbarSupporttext, pageAoBackpackNavbarSupporthref, pageAoBackpackNavbarIsotext, pageAoBackpackNavbarIsohref, pageAoBackpackNavbarPlatformtext, pageAoBackpackNavbarPlatformhref, pageAoBackpackNavbarIndustriestext, pageAoBackpackNavbarIndustrieshref, pageAoBackpackNavbarPartnerstext, pageAoBackpackNavbarPartnershref, pageAoBackpackNavbarResourcestext, pageAoBackpackNavbarResourceshref, pageAoBackpackNavbarAbouttext, pageAoBackpackNavbarAbouthref, pageAoBackpackNavbarContactTexttext, pageAoBackpackNavbarContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAoBackpackNavbarLogoimagesrc, pageAoBackpackNavbarSearchtext, pageAoBackpackNavbarSearchhref, pageAoBackpackNavbarIntltext, pageAoBackpackNavbarIntlhref, pageAoBackpackNavbarDesigntext, pageAoBackpackNavbarDesignhref, pageAoBackpackNavbarSupporttext, pageAoBackpackNavbarSupporthref, pageAoBackpackNavbarIsotext, pageAoBackpackNavbarIsohref, pageAoBackpackNavbarPlatformtext, pageAoBackpackNavbarPlatformhref, pageAoBackpackNavbarIndustriestext, pageAoBackpackNavbarIndustrieshref, pageAoBackpackNavbarPartnerstext, pageAoBackpackNavbarPartnershref, pageAoBackpackNavbarResourcestext, pageAoBackpackNavbarResourceshref, pageAoBackpackNavbarAbouttext, pageAoBackpackNavbarAbouthref, pageAoBackpackNavbarContactTexttext, pageAoBackpackNavbarContactTexthref });
