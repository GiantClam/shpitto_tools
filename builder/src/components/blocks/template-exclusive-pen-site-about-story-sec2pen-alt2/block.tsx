...
const DEFAULT_PROPS = {
  "id": "obhbm",
  "sec1desctext": "Built upon fundamental metamaterials research at Duke University, Kymeta's disruptive technology is supported by a world-class R&D facility, and a team that includes some of the brightest minds in the industry. Together, we are building and delivering an Intelligent Communications Platform to enable network access and spatial intelligence, anytime and everywhere.",
  "sec1navtext": "↘  Timeline      ↘  Latest News      ↘  Vision & Principles      ↘  Leadership"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStorySec2penAlt2({ id, sec1desctext, sec1navtext, ...rest }) {
