      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "stripbtnttext"
        }
      ],
      "hrefProp": "stripbtnhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "vQcBX",
  "striptitletext": "不要错过任何一个帖子。",
  "stripdesctext": "订阅后，您将收到来自行业专家的最新见解、观点和故事。",
  "stripbtnhref": "/",
  "stripbtnttext": "立即订阅"
};
const DEFAULT_THEME = {
...
export default function TemplateExclusivePenSiteResourcesStoryResourcestrippenAlt7({ id, striptitletext, stripdesctext, stripbtnhref, stripbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, striptitletext, stripdesctext, stripbtnhref, stripbtnttext });
