...
export default function TemplateExclusivePenSiteAboutNavigationNavbarpenPrimary({ id, pageAboutNavbarLogoimagesrc, pageAboutNavbarMenutext, pageAboutNavbarMenuhref, pageAboutNavbarSearchtext, pageAboutNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAboutNavbarLogoimagesrc, pageAboutNavbarMenutext, pageAboutNavbarMenuhref, pageAboutNavbarSearchtext, pageAboutNavbarSearchhref });
