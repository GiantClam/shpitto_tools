...
export default function TemplateExclusivePenSiteBretonHydraNavigationNavbarpenPrimary({ id, pageBretonHydraNavbarLogoimagesrc, pageBretonHydraNavbarSearchtext, pageBretonHydraNavbarSearchhref, pageBretonHydraNavbarLangtext, pageBretonHydraNavbarLanghref, pageBretonHydraNavbarMenutext, pageBretonHydraNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageBretonHydraNavbarLogoimagesrc, pageBretonHydraNavbarSearchtext, pageBretonHydraNavbarSearchhref, pageBretonHydraNavbarLangtext, pageBretonHydraNavbarLanghref, pageBretonHydraNavbarMenutext, pageBretonHydraNavbarMenuhref });
