...
export default function TemplateExclusivePenSiteNewsEventsNavigationNavbarpenPrimary({ id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, pageNewsEventsNavbarLangtext, pageNewsEventsNavbarLanghref, pageNewsEventsNavbarMenutext, pageNewsEventsNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, pageNewsEventsNavbarLangtext, pageNewsEventsNavbarLanghref, pageNewsEventsNavbarMenutext, pageNewsEventsNavbarMenuhref });
