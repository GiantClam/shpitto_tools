...
export default function TemplateExclusivePenSiteJabilAboutStoryWhyjabilpenAlt11({ id, weytext, wsubtext, whybodytext, wbtnhref, wbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, weytext, wsubtext, whybodytext, wbtnhref, wbtnttext });
