...
export default function TemplateExclusivePenSiteOerlikonAboutFooterFootercopybpenAlt8({ id, ayfgwtext, w0hkqtext, b9ljutext, b9ljuhref, qjdictext, qjdichref, j8xsztext, j8xszhref, flye8text, skbajtext, r9zjltext, r9zjlhref, dmacctext, dmacchref, kbuqtext, dekitext, pgfrtext, pgfrhref, rn6vstext, rn6vshref, macq0text, macq0href, mrk0jtext, ibpiutext, lllktext, lllkhref, n8sftext, n8sfhref, zyyi6text, ko9ojtext, ko9ojhref, ya6jftext, vnsutext, pdmr2text, soglrtext, x5jottext, contactbtnhref, contacttexttext, d9y04text, uy7pjtext, uy7pjhref, uyzqtext, uyzqhref, i7wmetext, iseoftext, iseofhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ayfgwtext, w0hkqtext, b9ljutext, b9ljuhref, qjdictext, qjdichref, j8xsztext, j8xszhref, flye8text, skbajtext, r9zjltext, r9zjlhref, dmacctext, dmacchref, kbuqtext, dekitext, pgfrtext, pgfrhref, rn6vstext, rn6vshref, macq0text, macq0href, mrk0jtext, ibpiutext, lllktext, lllkhref, n8sftext, n8sfhref, zyyi6text, ko9ojtext, ko9ojhref, ya6jftext, vnsutext, pdmr2text, soglrtext, x5jottext, contactbtnhref, contacttexttext, d9y04text, uy7pjtext, uy7pjhref, uyzqtext, uyzqhref, i7wmetext, iseoftext, iseofhref });
