...
export default function TemplateExclusivePenSiteHuayraRNavigationNavbarpenPrimary({ id, brandLogoHuayraRimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoHuayraRimagesrc });
