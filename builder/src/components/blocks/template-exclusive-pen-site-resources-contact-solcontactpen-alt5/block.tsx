...
const DEFAULT_PROPS = {
  "id": "gTg0G",
  "contactimgimagesrc": "https://images.unsplash.com/photo-1758518729912-bf3a84c400e0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTcwNzV8&ixlib=rb-4.1.0&q=80&w=1080",
  "contacttagtxttext": "联系我们的团队",
  "contacttitletext": "携手合作，共创非凡，将变革性产品变为现实。",
  "contactbtnhref": "/",
  "contactbtntxttext": "联系我们的团队"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteResourcesContactSolcontactpenAlt5({ id, contactimgimagesrc, contacttagtxttext, contacttitletext, contactbtnhref, contactbtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, contactimgimagesrc, contacttagtxttext, contacttitletext, contactbtnhref, contactbtntxttext });
