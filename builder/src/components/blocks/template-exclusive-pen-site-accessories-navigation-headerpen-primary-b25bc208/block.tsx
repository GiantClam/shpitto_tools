...
export default function TemplateExclusivePenSiteAccessoriesNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
