...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-sector-navbar-bg",
      "name": "page-sector-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-sector-navbar-logo",
      "name": "page-sector-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pageSectorNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-sector-navbar-SECTORS",
      "name": "page-sector-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSectorNavbarSectorstext",
      "hrefProp": "pageSectorNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-sector-navbar-PRODUCTS",
      "name": "page-sector-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSectorNavbarProductstext",
      "hrefProp": "pageSectorNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-sector-navbar-SUPPORT",
      "name": "page-sector-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSectorNavbarSupporttext",
      "hrefProp": "pageSectorNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-sector-navbar-ABOUT",
      "name": "page-sector-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSectorNavbarAbouttext",
      "hrefProp": "pageSectorNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-sector-navbar-contact-box",
      "name": "page-sector-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-sector-navbar-contact-text",
      "name": "page-sector-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSectorNavbarContactTexttext",
      "hrefProp": "pageSectorNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-sector-navbar-contact-arrow",
      "name": "page-sector-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSectorNavbarContactArrowtext",
      "hrefProp": "pageSectorNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-sector-navbar-menu-hit",
      "name": "page-sector-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-sector-navbar-menu-line1",
      "name": "page-sector-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-sector-navbar-menu-line2",
      "name": "page-sector-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-sector-navbar-menu-line3",
      "name": "page-sector-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-sector-navbar",
  "pageSectorNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageSectorNavbarSectorstext": "SECTORS",
  "pageSectorNavbarSectorshref": "/",
  "pageSectorNavbarProductstext": "PRODUCTS",
  "pageSectorNavbarProductshref": "/products",
  "pageSectorNavbarSupporttext": "SUPPORT",
  "pageSectorNavbarSupporthref": "/support",
  "pageSectorNavbarAbouttext": "ABOUT",
  "pageSectorNavbarAbouthref": "/about-us",
  "pageSectorNavbarContactTexttext": "CONTACT",
  "pageSectorNavbarContactTexthref": "/contact-us",
  "pageSectorNavbarContactArrowtext": "›",
  "pageSectorNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteSectorNavigationNavbarpenPrimary({ id, pageSectorNavbarLogoimagesrc, pageSectorNavbarSectorstext, pageSectorNavbarSectorshref, pageSectorNavbarProductstext, pageSectorNavbarProductshref, pageSectorNavbarSupporttext, pageSectorNavbarSupporthref, pageSectorNavbarAbouttext, pageSectorNavbarAbouthref, pageSectorNavbarContactTexttext, pageSectorNavbarContactTexthref, pageSectorNavbarContactArrowtext, pageSectorNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageSectorNavbarLogoimagesrc, pageSectorNavbarSectorstext, pageSectorNavbarSectorshref, pageSectorNavbarProductstext, pageSectorNavbarProductshref, pageSectorNavbarSupporttext, pageSectorNavbarSupporthref, pageSectorNavbarAbouttext, pageSectorNavbarAbouthref, pageSectorNavbarContactTexttext, pageSectorNavbarContactTexthref, pageSectorNavbarContactArrowtext, pageSectorNavbarContactArrowhref });
