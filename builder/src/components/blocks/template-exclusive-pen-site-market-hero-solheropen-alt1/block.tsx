...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "herodesctext2"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "VMRgQ",
  "herotitletext": "我们的市场领域",
  "herodesctext": "与我们合作为您的行业提供领先的解决方案",
  "herobtnhref": "/",
  "herobtntxttext": "解决方案",
  "herodesctext2": "作为全球领先企业，我们专门为产品高度复杂、监管环境苛刻的行业客户提供服务。"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteMarketHeroSolheropenAlt1({ id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herodesctext2, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herodesctext2 });
