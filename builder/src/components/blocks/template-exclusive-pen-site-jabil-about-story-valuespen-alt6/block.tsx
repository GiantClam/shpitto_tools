...
export default function TemplateExclusivePenSiteJabilAboutStoryValuespenAlt6({ id, pb4j6text, v1text, dt1dktext, v1text2, sqsqhtext, v1text3, jhrrtext, v1text4, veytext, vsubtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pb4j6text, v1text, dt1dktext, v1text2, sqsqhtext, v1text3, jhrrtext, v1text4, veytext, vsubtext });
