...
const DEFAULT_PROPS = {
  "id": "cUWeV",
  "row1imgimagesrc": "https://images.unsplash.com/photo-1668076476189-7664ff0e7a91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDMyODB8&ixlib=rb-4.1.0&q=80&w=1080",
  "r1titletext": "航空航天/国防",
  "r1desctext": "与可信赖的合作伙伴一起交付关键任务技术。",
  "r1btnhref": "/",
  "r1btnttext": "了解更多",
  "restagtxttext": "我们的市场领域",
  "r2titletext": "医疗保健/生命科学",
  "r2desctext": "合作创造下一个改变生命的创新成果",
  "r2btnhref": "/",
  "r2btnttext": "了解更多",
  "restagtxttext2": "我们的市场行业",
  "row2imgimagesrc": "https://images.unsplash.com/photo-1739289696456-823ef234a417?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDMzMzZ8&ixlib=rb-4.1.0&q=80&w=1080",
  "row3imgimagesrc": "https://images.unsplash.com/photo-1751150271171-5133ca1b6725?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDMzMzd8&ixlib=rb-4.1.0&q=80&w=1080",
  "r3titletext": "工业",
  "r3desctext": "先进工业技术促进建设更美好的世界",
  "r3btnhref": "/",
  "r3btnttext": "了解更多",
  "r4titletext": "半导体资本设备",
  "r4desctext": "对半导体资本设备的重视与品质的承诺",
  "r4btnhref": "/",
  "r4btnttext": "了解更多",
  "row4imgimagesrc": "https://images.unsplash.com/photo-1562906343-23eff3c3a118?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDMzMzd8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteResourcesStoryDesignsecpenAlt3({ id, row1imgimagesrc, r1titletext, r1desctext, r1btnhref, r1btnttext, restagtxttext, r2titletext, r2desctext, r2btnhref, r2btnttext, restagtxttext2, row2imgimagesrc, row3imgimagesrc, r3titletext, r3desctext, r3btnhref, r3btnttext, r4titletext, r4desctext, r4btnhref, r4btnttext, row4imgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, row1imgimagesrc, r1titletext, r1desctext, r1btnhref, r1btnttext, restagtxttext, r2titletext, r2desctext, r2btnhref, r2btnttext, restagtxttext2, row2imgimagesrc, row3imgimagesrc, r3titletext, r3desctext, r3btnhref, r3btnttext, r4titletext, r4desctext, r4btnhref, r4btnttext, row4imgimagesrc });
