...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "mission2text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "Cd2MA",
  "herotitletext": "To develop the world’s best quantum technology to solve the world’s most complex problems.",
  "mission2text": "Our mission"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutHeroAboutheropenAlt4({ id, herotitletext, mission2text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, mission2text });
