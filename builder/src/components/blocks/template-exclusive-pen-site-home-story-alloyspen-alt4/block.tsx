...
export default function TemplateExclusivePenSiteHomeStoryAlloyspenAlt4({ id, a0text, a1text, a2text, c1ttext, c2ttext, c3ttext, c4ttext, c5ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, a0text, a1text, a2text, c1ttext, c2ttext, c3ttext, c4ttext, c5ttext });
