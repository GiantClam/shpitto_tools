...
export default function TemplateExclusivePenSiteHomeNavigationHeaderpenPrimary({ id, logotext, logohref, navtext, navhref, actionstext, actionshref, searchtxttext, searchtxthref, loginbtnhref, logintxttext, logintxthref, ...rest }) {
