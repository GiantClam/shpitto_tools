...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageContactsNavbarLogoimagesrc, pageContactsNavbarLangtext, pageContactsNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactsNavbarLogoimagesrc, pageContactsNavbarLangtext, pageContactsNavbarLanghref });
