...
export default function TemplateExclusivePenSiteWarcomNewsNavigationNavbarpenPrimary({ id, pageWarcomNewsNavbarLogoimagesrc, pageWarcomNewsNavbarLangtext, pageWarcomNewsNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageWarcomNewsNavbarLogoimagesrc, pageWarcomNewsNavbarLangtext, pageWarcomNewsNavbarLanghref });
