...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "cloudvisualimagesrc"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "sv0WG",
  "y33fktext": "A quantum cloud\nmade for developers",
  "cbtnhref": "/",
  "c20u8text": "Learn more",
  "signupbtnhref": "/",
  "c18text": "Sign up",
  "c19text": "Forget translating your workload into yet another quantum SDK. IonQ works with all of the most popular cloud providers, libraries and tools. Just sign in and get to work.",
  "c20text": "Partner Clouds",
  "c21text": "Whether you run on Google Cloud, Microsoft Azure, AWS or Nvidia, hardware access is just a few clicks away.",
  "c22text": "AWS   ◌   Google Cloud   ◌   Microsoft Azure",
  "cloudvisualimagesrc": "./images/generated-1773151424551.png"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeStoryCloudpenAlt7({ id, y33fktext, cbtnhref, c20u8text, signupbtnhref, c18text, c19text, c20text, c21text, c22text, cloudvisualimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, y33fktext, cbtnhref, c20u8text, signupbtnhref, c18text, c19text, c20text, c21text, c22text, cloudvisualimagesrc });
