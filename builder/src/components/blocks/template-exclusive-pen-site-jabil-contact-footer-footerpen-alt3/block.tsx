...
export default function TemplateExclusivePenSiteJabilContactFooterFooterpenAlt3({ id, xpcqhtext, qif6qtext, qif6qhref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, xpcqhtext, qif6qtext, qif6qhref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref });
