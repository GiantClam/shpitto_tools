      ...
      "children": [
        ...
        },
        {
          ...
          "style": {
            ...
            "fontWeight": "500",
            "position": "absolute",
            "left": 36.05706272320049,
            "top": 87.77171233952595
          },
          "children": [],
          "textProp": "i079ytext"
        },
...
const DEFAULT_PROPS = {
  ...
  "subtext": "We are united by a common vision and key values, informed by shared principles that guide our work today and into the future.",
  "i079ytext": "Our vision",
  "aehogtext": "Securing the future with revolutionary technology.",
  "wk3phtext": "Our mission",
  "ewaeltext": "Leveraging our disruptive technology, we deliver intelligent communication platforms that empower resilient connectivity and spatial intelligence, anytime and anywhere.",
  "aresetext": "Our core principles",
  "vamtext": "Kymeta's core principles define the character and spirit of our employees and focus our experts. We are committed to fostering a workplace rooted in trust by creating a diverse, equitable, and inclusive work environment that is rooted in accountability, employee well-being and corporate social responsibility.",
  "jmjectext": "Drive customers success",
  "yjo04text": "We deliver solutions that delight our customers"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStorySec5penAlt4({ id, titletext, subtext, i079ytext, aehogtext, wk3phtext, ewaeltext, aresetext, vamtext, jmjectext, yjo04text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, titletext, subtext, i079ytext, aehogtext, wk3phtext, ewaeltext, aresetext, vamtext, jmjectext, yjo04text });
