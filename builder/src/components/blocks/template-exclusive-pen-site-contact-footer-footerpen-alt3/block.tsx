...
export default function TemplateExclusivePenSiteContactFooterFooterpenAlt3({ id, a8p3ftext, mqbmrtext, mqbmrhref, dthwxtext, howybtext, howybhref, npx2text, t3cx4text, t3cx4href, fhzltext, puz92text, puz92href, xfcygtext, fnrsltext, fnrslhref, wpl5ptext, uwcuhref, uoytatext, dmqitext, thaqitext, ...rest }) {
