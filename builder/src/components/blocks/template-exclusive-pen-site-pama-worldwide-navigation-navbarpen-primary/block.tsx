...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-bg",
      "name": "page-pama-worldwide-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-logo",
      "name": "page-pama-worldwide-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pagePamaWorldwideNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-pama-worldwide-navbar-SECTORS",
      "name": "page-pama-worldwide-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePamaWorldwideNavbarSectorstext",
      "hrefProp": "pagePamaWorldwideNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-pama-worldwide-navbar-PRODUCTS",
      "name": "page-pama-worldwide-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePamaWorldwideNavbarProductstext",
      "hrefProp": "pagePamaWorldwideNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-pama-worldwide-navbar-SUPPORT",
      "name": "page-pama-worldwide-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePamaWorldwideNavbarSupporttext",
      "hrefProp": "pagePamaWorldwideNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-pama-worldwide-navbar-ABOUT",
      "name": "page-pama-worldwide-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePamaWorldwideNavbarAbouttext",
      "hrefProp": "pagePamaWorldwideNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-contact-box",
      "name": "page-pama-worldwide-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-pama-worldwide-navbar-contact-text",
      "name": "page-pama-worldwide-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePamaWorldwideNavbarContactTexttext",
      "hrefProp": "pagePamaWorldwideNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-pama-worldwide-navbar-contact-arrow",
      "name": "page-pama-worldwide-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePamaWorldwideNavbarContactArrowtext",
      "hrefProp": "pagePamaWorldwideNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-menu-hit",
      "name": "page-pama-worldwide-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-menu-line1",
      "name": "page-pama-worldwide-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-menu-line2",
      "name": "page-pama-worldwide-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-pama-worldwide-navbar-menu-line3",
      "name": "page-pama-worldwide-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-pama-worldwide-navbar",
  "pagePamaWorldwideNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pagePamaWorldwideNavbarSectorstext": "SECTORS",
  "pagePamaWorldwideNavbarSectorshref": "/",
  "pagePamaWorldwideNavbarProductstext": "PRODUCTS",
  "pagePamaWorldwideNavbarProductshref": "/products",
  "pagePamaWorldwideNavbarSupporttext": "SUPPORT",
  "pagePamaWorldwideNavbarSupporthref": "/support",
  "pagePamaWorldwideNavbarAbouttext": "ABOUT",
  "pagePamaWorldwideNavbarAbouthref": "/about-us",
  "pagePamaWorldwideNavbarContactTexttext": "CONTACT",
  "pagePamaWorldwideNavbarContactTexthref": "/contact-us",
  "pagePamaWorldwideNavbarContactArrowtext": "›",
  "pagePamaWorldwideNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSitePamaWorldwideNavigationNavbarpenPrimary({ id, pagePamaWorldwideNavbarLogoimagesrc, pagePamaWorldwideNavbarSectorstext, pagePamaWorldwideNavbarSectorshref, pagePamaWorldwideNavbarProductstext, pagePamaWorldwideNavbarProductshref, pagePamaWorldwideNavbarSupporttext, pagePamaWorldwideNavbarSupporthref, pagePamaWorldwideNavbarAbouttext, pagePamaWorldwideNavbarAbouthref, pagePamaWorldwideNavbarContactTexttext, pagePamaWorldwideNavbarContactTexthref, pagePamaWorldwideNavbarContactArrowtext, pagePamaWorldwideNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagePamaWorldwideNavbarLogoimagesrc, pagePamaWorldwideNavbarSectorstext, pagePamaWorldwideNavbarSectorshref, pagePamaWorldwideNavbarProductstext, pagePamaWorldwideNavbarProductshref, pagePamaWorldwideNavbarSupporttext, pagePamaWorldwideNavbarSupporthref, pagePamaWorldwideNavbarAbouttext, pagePamaWorldwideNavbarAbouthref, pagePamaWorldwideNavbarContactTexttext, pagePamaWorldwideNavbarContactTexthref, pagePamaWorldwideNavbarContactArrowtext, pagePamaWorldwideNavbarContactArrowhref });
