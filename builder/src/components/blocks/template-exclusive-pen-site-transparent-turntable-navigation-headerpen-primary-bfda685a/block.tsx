...
export default function TemplateExclusivePenSiteTransparentTurntableNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
