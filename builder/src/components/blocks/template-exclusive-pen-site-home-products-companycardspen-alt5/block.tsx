...
const DEFAULT_PROPS = {
  "id": "1I8FY",
  "card1imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/card-italian.jpg",
  "card1titletext": "意式风格",
  "card1bodytext": "作为意大利生产商的自豪。",
  "card2imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/card-dna.jpg",
  "card2titletext": "创新是我们的 DNA",
  "card2bodytext": "FPT 已注册了 30 多项国际发明专利。",
  "card3imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/card-engineers.jpg",
  "card3titletext": "超过 50 名工程师",
  "card3bodytext": "不断研发新产品、机头和生产解决方案。"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Heebo",
...
export default function TemplateExclusivePenSiteHomeProductsCompanycardspenAlt5({ id, card1imagesrc, card1titletext, card1bodytext, card2imagesrc, card2titletext, card2bodytext, card3imagesrc, card3titletext, card3bodytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, card1imagesrc, card1titletext, card1bodytext, card2imagesrc, card2titletext, card2bodytext, card3imagesrc, card3titletext, card3bodytext });
