...
export default function TemplateExclusivePenSiteJabilCapabilitiesFooterFooterpenAlt7({ id, zyqzktext, q7otext, q7ohref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, zyqzktext, q7otext, q7ohref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref });
