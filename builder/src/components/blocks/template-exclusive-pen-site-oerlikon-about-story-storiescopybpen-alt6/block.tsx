...
export default function TemplateExclusivePenSiteOerlikonAboutStoryStoriescopybpenAlt6({ id, sttitletext, story1imagesrc, ykbtext, story2imagesrc, zjjq7text, story3imagesrc, yfglntext, stlinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sttitletext, story1imagesrc, ykbtext, story2imagesrc, zjjq7text, story3imagesrc, yfglntext, stlinktext });
