  ...
  "children": [
    {
      ...
      "style": {
        ...
        "height": 252,
        "position": "absolute",
        "left": 54.2458302803527,
        "top": 45.77617880473963
      },
      "children": [
        {
          "type": "text",
...
export default function TemplateExclusivePenSiteHomeStoryPeoplecenteredpenAlt7({ id, pqpivtext, n5u34text, pt03text, peobtnhref, myyrltext, peopleimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pqpivtext, n5u34text, pt03text, peobtnhref, myyrltext, peopleimgimagesrc });
