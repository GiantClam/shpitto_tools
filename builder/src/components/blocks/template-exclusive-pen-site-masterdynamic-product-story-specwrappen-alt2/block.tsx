...
const DEFAULT_PROPS = {
  "id": "fP6oU",
  "specttext": "Technical Details",
  "s1text": "Drivers: 40mm Beryllium\nBluetooth: 5.2 with aptX Adaptive\nBattery: up to 32 hours\nWeight: 338g",
  "inboxttext": "In the Box",
  "inboxdtext": "MW75 headphones\nPremium carrying case\nUSB-C charging cable\n3.5mm audio cable\nFlight adapter"
};
...
export default function TemplateExclusivePenSiteMasterdynamicProductStorySpecwrappenAlt2({ id, specttext, s1text, inboxttext, inboxdtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, specttext, s1text, inboxttext, inboxdtext });
