...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-bg",
      "name": "page-contact-us-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-logo",
      "name": "page-contact-us-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pageContactUsNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-contact-us-navbar-SECTORS",
      "name": "page-contact-us-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactUsNavbarSectorstext",
      "hrefProp": "pageContactUsNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-contact-us-navbar-PRODUCTS",
      "name": "page-contact-us-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactUsNavbarProductstext",
      "hrefProp": "pageContactUsNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-contact-us-navbar-SUPPORT",
      "name": "page-contact-us-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactUsNavbarSupporttext",
      "hrefProp": "pageContactUsNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-contact-us-navbar-ABOUT",
      "name": "page-contact-us-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactUsNavbarAbouttext",
      "hrefProp": "pageContactUsNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-contact-box",
      "name": "page-contact-us-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-contact-us-navbar-contact-text",
      "name": "page-contact-us-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactUsNavbarContactTexttext",
      "hrefProp": "pageContactUsNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-contact-us-navbar-contact-arrow",
      "name": "page-contact-us-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactUsNavbarContactArrowtext",
      "hrefProp": "pageContactUsNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-menu-hit",
      "name": "page-contact-us-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-menu-line1",
      "name": "page-contact-us-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-menu-line2",
      "name": "page-contact-us-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-contact-us-navbar-menu-line3",
      "name": "page-contact-us-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-contact-us-navbar",
  "pageContactUsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageContactUsNavbarSectorstext": "SECTORS",
  "pageContactUsNavbarSectorshref": "/",
  "pageContactUsNavbarProductstext": "PRODUCTS",
  "pageContactUsNavbarProductshref": "/products",
  "pageContactUsNavbarSupporttext": "SUPPORT",
  "pageContactUsNavbarSupporthref": "/support",
  "pageContactUsNavbarAbouttext": "ABOUT",
  "pageContactUsNavbarAbouthref": "/about-us",
  "pageContactUsNavbarContactTexttext": "CONTACT",
  "pageContactUsNavbarContactTexthref": "/contact-us",
  "pageContactUsNavbarContactArrowtext": "›",
  "pageContactUsNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteContactUsNavigationNavbarpenPrimary({ id, pageContactUsNavbarLogoimagesrc, pageContactUsNavbarSectorstext, pageContactUsNavbarSectorshref, pageContactUsNavbarProductstext, pageContactUsNavbarProductshref, pageContactUsNavbarSupporttext, pageContactUsNavbarSupporthref, pageContactUsNavbarAbouttext, pageContactUsNavbarAbouthref, pageContactUsNavbarContactTexttext, pageContactUsNavbarContactTexthref, pageContactUsNavbarContactArrowtext, pageContactUsNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactUsNavbarLogoimagesrc, pageContactUsNavbarSectorstext, pageContactUsNavbarSectorshref, pageContactUsNavbarProductstext, pageContactUsNavbarProductshref, pageContactUsNavbarSupporttext, pageContactUsNavbarSupporthref, pageContactUsNavbarAbouttext, pageContactUsNavbarAbouthref, pageContactUsNavbarContactTexttext, pageContactUsNavbarContactTexthref, pageContactUsNavbarContactArrowtext, pageContactUsNavbarContactArrowhref });
