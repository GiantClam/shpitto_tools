...
export default function TemplateExclusivePenSiteProductsFooterFooterpenAlt3({ id, i4katext, dyodktext, dyodkhref, xfwttext, dew7otext, dew7ohref, icru3text, httzhtext, httzhhref, fplrvtext, yrfltext, yrflhref, emze2text, uqretext, uqrehref, juramtext, zvlavhref, vux1ztext, n5q0utext, hl1oztext, ...rest }) {
