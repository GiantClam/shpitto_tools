...
export default function TemplateExclusivePenSiteSandvikAboutStoryTbarpenAlt1({ id, txt1text, txt1text2, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, txt1text, txt1text2 });
