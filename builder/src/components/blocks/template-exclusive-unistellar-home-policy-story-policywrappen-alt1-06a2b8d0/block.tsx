              ...
              "children": [
                {
                  ...
                  "hrefProp": "sectionDataCollecthref"
                },
                {
                  "type": "frame",
                  "id": "CARgf",
                ...
                },
                {
                  ...
                  "hrefProp": "sectionTermsNoticeshref"
                }
              ]
            },
            {
...
export default function TemplateExclusiveUnistellarHomePolicyStoryPolicywrappenAlt1({ id, herokickertext, herotitletext, herocopytext, effectivelabeltext, effectivebodytext, effectivecardhref, scopelabeltext, scopebodytext, scopecardhref, responselabeltext, responsebodytext, responsecardhref, indextitletext, indexlisttext, applieslabeltext, appliesbodytext, appliescardhref, contactlabeltext, contactbodytext, contactcardhref, privacylabeltext, privacybodytext, privacycardhref, termslabeltext, termsbodytext, termscardhref, rightslabeltext, rightsbodytext, rightscardhref, sectiontitletext, sectionbodytext, sectionDataCollecthref, sectiontitletext2, sectionbodytext2, sectionDataUsehref, sectiontitletext3, sectionbodytext3, sectionSharinghref, sectiontitletext4, sectionbodytext4, sectionSecurityhref, sectiontitletext5, sectionbodytext5, sectionRightshref, sectiontitletext6, sectionbodytext6, sectionTermsNoticeshref, legalnoticetitletext, legalnoticebodytext, noticemetatext, legalnoticehref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herokickertext, herotitletext, herocopytext, effectivelabeltext, effectivebodytext, effectivecardhref, scopelabeltext, scopebodytext, scopecardhref, responselabeltext, responsebodytext, responsecardhref, indextitletext, indexlisttext, applieslabeltext, appliesbodytext, appliescardhref, contactlabeltext, contactbodytext, contactcardhref, privacylabeltext, privacybodytext, privacycardhref, termslabeltext, termsbodytext, termscardhref, rightslabeltext, rightsbodytext, rightscardhref, sectiontitletext, sectionbodytext, sectionDataCollecthref, sectiontitletext2, sectionbodytext2, sectionDataUsehref, sectiontitletext3, sectionbodytext3, sectionSharinghref, sectiontitletext4, sectionbodytext4, sectionSecurityhref, sectiontitletext5, sectionbodytext5, sectionRightshref, sectiontitletext6, sectionbodytext6, sectionTermsNoticeshref, legalnoticetitletext, legalnoticebodytext, noticemetatext, legalnoticehref });
