...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "highlightsTitletext"
    },
    {
      "type": "text",
      "id": "highlights-copy",
      "name": "highlights-copy",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "highCtaTexttext",
      "hrefProp": "highCtaTexthref"
    },
    {
      "type": "text",
      "id": "high-cta-arrow",
      ...
      "children": [],
      "textProp": "highCtaArrowtext",
      "hrefProp": "highCtaArrowhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "highlights-section",
  "highlightsTitletext": "HIGHLIGHTS",
  "highlightsCopytext": "Activities, news, events: the latest updates from the PAMA world.",
  "high1Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/highlight-c-c-m-t-960341b1.png",
  "high1Eyebrowtext": "FAIRS & EVENTS",
  "high1Titletext": "CCMT 2026 (21-25 APRIL 2026)",
  "high1Bodytext": "We are pleased to invite you to the next CCMT 2026.",
  "high1Arrowtext": "›",
  "high2Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/highlight-i-m-t-s-41535b19.jpg",
  "high2Eyebrowtext": "FAIRS & EVENTS",
  "high2Titletext": "IMTS 2026 (14-19 SEPTEMBER 2026)",
  "high2Bodytext": "We are pleased to invite you to the next IMTS 2026.",
  "high2Arrowtext": "›",
  "highCtaBoxhref": "/",
  "highCtaTexttext": "DISCOVER ALL NEWS",
  "highCtaTexthref": "/",
  "highCtaArrowtext": "›",
  "highCtaArrowhref": "/"
};
...
export default function TemplateExclusivePenSiteHomeStoryHighlightssectionpenAlt6({ id, highlightsTitletext, highlightsCopytext, high1Imageimagesrc, high1Eyebrowtext, high1Titletext, high1Bodytext, high1Arrowtext, high2Imageimagesrc, high2Eyebrowtext, high2Titletext, high2Bodytext, high2Arrowtext, highCtaBoxhref, highCtaTexttext, highCtaTexthref, highCtaArrowtext, highCtaArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, highlightsTitletext, highlightsCopytext, high1Imageimagesrc, high1Eyebrowtext, high1Titletext, high1Bodytext, high1Arrowtext, high2Imageimagesrc, high2Eyebrowtext, high2Titletext, high2Bodytext, high2Arrowtext, highCtaBoxhref, highCtaTexttext, highCtaTexthref, highCtaArrowtext, highCtaArrowhref });
