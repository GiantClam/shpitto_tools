...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "sec1navtext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "3hL9x",
  "sec1desctext": "In an increasingly complex world, assured connectivity is not merely a convenience — it’s a vital requirement for mission success. Our intelligent communications platforms provide resilient, always-on connectivity and situational awareness, ensuring that military personnel and emergency responders can execute their critical missions effectively and without compromise.",
  "sec1navtext": "↘  Latest News      ↘  Vision & Principles      ↘  EmergencyResponse"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteApplicationStoryIntropenAlt5({ id, sec1desctext, sec1navtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec1desctext, sec1navtext });
