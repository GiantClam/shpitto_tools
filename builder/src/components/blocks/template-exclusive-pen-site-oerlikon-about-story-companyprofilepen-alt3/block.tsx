              ...
              "children": [
                {
                  ...
                  "children": [],
                  "textProp": "companybtntxtbtext"
                }
              ],
              "hrefProp": "companybtnbhref"
            }
          ]
        },
        {
...
export default function TemplateExclusivePenSiteOerlikonAboutStoryCompanyprofilepenAlt3({ id, companyheadbtext, companydescbtext, companybtnbhref, companybtntxtbtext, right1btext, right2btext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, companyheadbtext, companydescbtext, companybtnbhref, companybtntxtbtext, right1btext, right2btext });
