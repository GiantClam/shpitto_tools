...
const DEFAULT_PROPS = {
  "id": "YWWai",
  "herokickertext": "MASTER & DYNAMIC / FOCUS",
  "heroheadlinetext": "MW09 Earphones For Precision Listening Everywhere",
  "herobodytext": "Compact true wireless earphones engineered for clarity, comfort, and everyday movement.",
