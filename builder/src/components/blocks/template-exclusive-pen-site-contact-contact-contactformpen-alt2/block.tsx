...
const DEFAULT_PROPS = {
  "id": "kgGGh",
  "formtitletext": "请选择最能描述您的询问的类别 *",
  "opt1text": "○ 销售",
  "opt2text": "○ 媒体关系",
  "opt3text": "○ 供应商",
  "opt4text": "○ 人力资源",
  "opt5text": "○ 投资者关系",
  "opt6text": "○ Plexus 社区基金会",
  "namelabtext": "姓名 *",
  "emaillabtext": "电子邮件地址 *",
  "phonelabtext": "电话 *",
  "msglabtext": "请简要说明您的询问 *",
  "checktext": "□ 勾选此框表示我同意接收相关营销与产品更新信息。",
  "legaltext": "提交本表格表示您已阅读并同意我们的《隐私声明》。",
  "submittxttext": "提交"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteContactContactContactformpenAlt2({ id, formtitletext, opt1text, opt2text, opt3text, opt4text, opt5text, opt6text, namelabtext, emaillabtext, phonelabtext, msglabtext, checktext, legaltext, submittxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, formtitletext, opt1text, opt2text, opt3text, opt4text, opt5text, opt6text, namelabtext, emaillabtext, phonelabtext, msglabtext, checktext, legaltext, submittxttext });
