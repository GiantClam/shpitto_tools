...
export default function TemplateExclusiveFrameworkHomeNavigationTopnavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
