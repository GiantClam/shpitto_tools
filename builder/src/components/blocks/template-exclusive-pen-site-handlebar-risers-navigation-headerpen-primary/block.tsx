...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-handlebar-risers",
  "name": "Header",
  "style": {
...
export default function TemplateExclusivePenSiteHandlebarRisersNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOurRidestext, navPageOurRideshref, navPageAccessoriestext, navPageAccessorieshref, navPageOurStorytext, navPageOurStoryhref, navPagePeakDesigntext, navPagePeakDesignhref, navPageShippingDeliverytext, navPageShippingDeliveryhref, ...rest }) {
