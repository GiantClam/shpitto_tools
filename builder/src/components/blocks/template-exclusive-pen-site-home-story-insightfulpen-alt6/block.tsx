      ...
      "children": [
        {
          ...
          "style": {
            ...
            "left": 912,
            "top": 0,
            "boxShadow": "0px 2px 6px #00000010"
          },
          "children": [
            {
              "type": "frame",
...
export default function TemplateExclusivePenSiteHomeStoryInsightfulpenAlt6({ id, wx3vtext, lst0ptext, i3imagesrc, t3text, i1imagesrc, t1text, i2imagesrc, t2text, i4imagesrc, t4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, wx3vtext, lst0ptext, i3imagesrc, t3text, i1imagesrc, t1text, i2imagesrc, t2text, i4imagesrc, t4text });
