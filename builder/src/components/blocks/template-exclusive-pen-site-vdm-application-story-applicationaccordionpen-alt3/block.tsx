...
export default function TemplateExclusivePenSiteVdmApplicationStoryApplicationaccordionpenAlt3({ id, tatext, tbtext, tctext, tdtext, tetext, tftext, tgtext, p1text, p2text, p3text, p4text, p5text, p6text, p7text, infotitletext, infolinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, tatext, tbtext, tctext, tdtext, tetext, tftext, tgtext, p1text, p2text, p3text, p4text, p5text, p6text, p7text, infotitletext, infolinktext });
