...
export default function TemplateExclusiveUnistellarHomeHomeHeroHero2penAlt2({ id, hero2imagesrc, h2tagtext, h2text, h2desctext, hero2attext, hero2ahref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hero2imagesrc, h2tagtext, h2text, h2desctext, hero2attext, hero2ahref });
