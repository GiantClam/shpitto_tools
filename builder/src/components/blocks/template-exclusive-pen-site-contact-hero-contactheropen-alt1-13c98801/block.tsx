...
const DEFAULT_PROPS = {
  "id": "1RcBG",
  "breadcrumbtext": "主页    >    联系我们",
  "herotitletext": "联系我们",
  "herosubtext": "请填写以下详细信息，我们将尽快与您联系",
  "bgnettext": "................................................................................................................"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteContactHeroContactheropenAlt1({ id, breadcrumbtext, herotitletext, herosubtext, bgnettext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, breadcrumbtext, herotitletext, herosubtext, bgnettext });
