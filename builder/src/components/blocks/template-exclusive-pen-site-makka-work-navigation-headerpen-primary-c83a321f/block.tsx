...
export default function TemplateExclusivePenSiteMakkaWorkNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
