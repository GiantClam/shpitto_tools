...
export default function TemplateExclusivePenSiteServiceSupportNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
