...
export default function TemplateExclusivePenSiteMarketFooterSolfooterpenAlt6({ id, flogottext, flogothref, fnavtext, fnavhref, copytext, copyhref, footeraddrtext, footeraddrhref, fbtext, fbhref, intext, inhref, ...rest }) {
