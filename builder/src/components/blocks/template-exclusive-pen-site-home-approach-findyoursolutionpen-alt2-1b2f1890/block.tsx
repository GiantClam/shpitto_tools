...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "findCardImg0imagesrc"
    },
    {
      "type": "text",
      "id": "find-card-label-0",
      "name": "find-card-label-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "findCardLabel0text"
    },
    {
      "type": "rectangle",
      "id": "find-card-corner-0-a",
      "name": "find-card-corner-0-a",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-0-b",
      "name": "find-card-corner-0-b",
      "style": {
        "boxSizing": "border-box",
        "width": 2,
        "height": 10,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-0-hit",
      "name": "find-card-corner-0-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 18,
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "findCardImg1imagesrc"
    },
    {
      "type": "text",
      "id": "find-card-label-1",
      "name": "find-card-label-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "findCardLabel1text"
    },
    {
      "type": "rectangle",
      "id": "find-card-corner-1-a",
      "name": "find-card-corner-1-a",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-1-b",
      "name": "find-card-corner-1-b",
      "style": {
        "boxSizing": "border-box",
        "width": 2,
        "height": 10,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-1-hit",
      "name": "find-card-corner-1-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 18,
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "findCardImg2imagesrc"
    },
    {
      "type": "text",
      "id": "find-card-label-2",
      "name": "find-card-label-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "findCardLabel2text"
    },
    {
      "type": "rectangle",
      "id": "find-card-corner-2-a",
      "name": "find-card-corner-2-a",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-2-b",
      "name": "find-card-corner-2-b",
      "style": {
        "boxSizing": "border-box",
        "width": 2,
        "height": 10,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-2-hit",
      "name": "find-card-corner-2-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 18,
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "findCardImg3imagesrc"
    },
    {
      "type": "text",
      "id": "find-card-label-3",
      "name": "find-card-label-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "findCardLabel3text"
    },
    {
      "type": "rectangle",
      "id": "find-card-corner-3-a",
      "name": "find-card-corner-3-a",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-3-b",
      "name": "find-card-corner-3-b",
      "style": {
        "boxSizing": "border-box",
        "width": 2,
        "height": 10,
    ...
    {
      "type": "rectangle",
      "id": "find-card-corner-3-hit",
      "name": "find-card-corner-3-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 18,
...
const DEFAULT_PROPS = {
  "id": "find-solution",
  "findTitletext": "Find your solution",
  "findCopytext": "Discover Breton's new technological solutions",
  "findCardImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/microwire-0ff9c364.jpg",
  "findCardLabel0text": "Microwire",
  "findCardImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/nexa-8a60fc23.png",
  "findCardLabel1text": "Breton Nexa",
  "findCardImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/hydra-b461b69c.png",
  "findCardLabel2text": "Breton Hydra",
  "findCardImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/kappa-9e8748c4.png",
  "findCardLabel3text": "Breton Kappa G"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeApproachFindyoursolutionpenAlt2({ id, findTitletext, findCopytext, findCardImg0imagesrc, findCardLabel0text, findCardImg1imagesrc, findCardLabel1text, findCardImg2imagesrc, findCardLabel2text, findCardImg3imagesrc, findCardLabel3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, findTitletext, findCopytext, findCardImg0imagesrc, findCardLabel0text, findCardImg1imagesrc, findCardLabel1text, findCardImg2imagesrc, findCardLabel2text, findCardImg3imagesrc, findCardLabel3text });
