  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "futureBeautyBgimagesrc"
    },
    {
      "type": "rectangle",
      "id": "future-beauty-shade",
      "name": "future-beauty-shade",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 820,
    ...
    {
      "type": "rectangle",
      "id": "future-beauty-shell",
      "name": "future-beauty-shell",
      "style": {
        "boxSizing": "border-box",
        "width": 760,
        "height": 300,
    ...
    {
      "type": "text",
      "id": "future-beauty-chapter",
      "name": "future-beauty-chapter",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyChaptertext"
    },
    {
      "type": "text",
      "id": "future-beauty-count",
      "name": "future-beauty-count",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyCounttext"
    },
    {
      "type": "text",
      "id": "future-beauty-title",
      "name": "future-beauty-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyTitletext"
    },
    {
      "type": "text",
      "id": "future-beauty-body",
      "name": "future-beauty-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyBodytext"
    },
    {
      "type": "rectangle",
      "id": "future-beauty-nav-chip-0",
      "name": "future-beauty-nav-chip-0",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-beauty-nav-chip-text-0",
      "name": "future-beauty-nav-chip-text-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyNavChipText0text"
    },
    {
      "type": "rectangle",
      "id": "future-beauty-nav-chip-1",
      "name": "future-beauty-nav-chip-1",
      "style": {
        "boxSizing": "border-box",
    ...
    {
      "type": "text",
      "id": "future-beauty-nav-chip-text-1",
      "name": "future-beauty-nav-chip-text-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyNavChipText1text"
    },
    {
      "type": "rectangle",
      "id": "future-beauty-nav-chip-2",
      "name": "future-beauty-nav-chip-2",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-beauty-nav-chip-text-2",
      "name": "future-beauty-nav-chip-text-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyNavChipText2text"
    },
    {
      "type": "rectangle",
      "id": "future-beauty-nav-chip-3",
      "name": "future-beauty-nav-chip-3",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-beauty-nav-chip-text-3",
      "name": "future-beauty-nav-chip-text-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyNavChipText3text"
    },
    {
      "type": "rectangle",
      "id": "future-beauty-nav-chip-4",
      "name": "future-beauty-nav-chip-4",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-beauty-nav-chip-text-4",
      "name": "future-beauty-nav-chip-text-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureBeautyNavChipText4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "future-beauty",
  "futureBeautyBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/future-beauty.jpg",
  "futureBeautyChaptertext": "Future",
  "futureBeautyCounttext": "3 / 5",
  "futureBeautyTitletext": "Beauty",
  "futureBeautyBodytext": "None of this would make sense if it was not enclosed by the lines of beauty at its highest expression: a design language that captures the heart and thrills the eyes.",
  "futureBeautyNavChipText0text": "Intro",
  "futureBeautyNavChipText1text": "The Research",
  "futureBeautyNavChipText2text": "Beauty",
  "futureBeautyNavChipText3text": "The Dream",
  "futureBeautyNavChipText4text": "Certainty"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryFuturebeautypenAlt7({ id, futureBeautyBgimagesrc, futureBeautyChaptertext, futureBeautyCounttext, futureBeautyTitletext, futureBeautyBodytext, futureBeautyNavChipText0text, futureBeautyNavChipText1text, futureBeautyNavChipText2text, futureBeautyNavChipText3text, futureBeautyNavChipText4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, futureBeautyBgimagesrc, futureBeautyChaptertext, futureBeautyCounttext, futureBeautyTitletext, futureBeautyBodytext, futureBeautyNavChipText0text, futureBeautyNavChipText1text, futureBeautyNavChipText2text, futureBeautyNavChipText3text, futureBeautyNavChipText4text });
