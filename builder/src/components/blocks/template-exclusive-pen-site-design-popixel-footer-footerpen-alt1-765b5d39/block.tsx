...
const DEFAULT_PROPS = {
  ...
  "footerBrandhref": "/",
  "footerCol1text": "Products Guides Downloads",
  "footerCol1href": "/products",
  "footerCol2text": "Designs Contact TX-6 OP-XY",
  "footerCol2href": "/designs",
  "footerCopytext": "teenage engineering structured clone pen. Editable text, cards, buttons and image containers.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteDesignPopixelFooterFooterpenAlt1({ id, footerBrandtext, footerBrandhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCopytext, footerCopyhref, ...rest }) {
