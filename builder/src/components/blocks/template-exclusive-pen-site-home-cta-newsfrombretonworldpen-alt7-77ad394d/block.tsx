...
const DEFAULT_PROPS = {
  "id": "news-world",
  "newsTitletext": "News from Breton's world",
  "newsCardK0text": "NEWS",
  "newsCardT0text": "Breton and Tianjing Equipment set the course...",
  "newsCardK1text": "NEWS",
  "newsCardT1text": "Breton & ZOLLER take stone fabrication productivity to the next level",
  "newsCardK2text": "NEWS",
  "newsCardT2text": "Breton Kappa G, The Evolution Of The Legend"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeCtaNewsfrombretonworldpenAlt7({ id, newsTitletext, newsCardK0text, newsCardT0text, newsCardK1text, newsCardT1text, newsCardK2text, newsCardT2text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newsTitletext, newsCardK0text, newsCardT0text, newsCardK1text, newsCardT1text, newsCardK2text, newsCardT2text });
