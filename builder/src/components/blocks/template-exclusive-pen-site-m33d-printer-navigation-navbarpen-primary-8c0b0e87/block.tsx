...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-m3-printer-navbar-menu",
      "name": "page-m3-printer-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageM3PrinterNavbarMenutext",
      "hrefProp": "pageM3PrinterNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pageM3PrinterNavbarMenutext": "☰",
  "pageM3PrinterNavbarMenuhref": "/",
  "pageM3PrinterNavbarSearchtext": "⌕",
...
export default function TemplateExclusivePenSiteM33dPrinterNavigationNavbarpenPrimary({ id, pageM3PrinterNavbarLogoimagesrc, pageM3PrinterNavbarMenutext, pageM3PrinterNavbarMenuhref, pageM3PrinterNavbarSearchtext, pageM3PrinterNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageM3PrinterNavbarLogoimagesrc, pageM3PrinterNavbarMenutext, pageM3PrinterNavbarMenuhref, pageM3PrinterNavbarSearchtext, pageM3PrinterNavbarSearchhref });
