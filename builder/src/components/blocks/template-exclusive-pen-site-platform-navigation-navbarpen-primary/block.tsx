...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-platform-navbar-bg",
      "name": "page-platform-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-platform-navbar-logo",
      "name": "page-platform-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 34,
      ...
      "children": [],
      "imageProp": "pagePlatformNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-search",
      "name": "page-platform-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarSearchtext",
      "hrefProp": "pagePlatformNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-intl",
      "name": "page-platform-navbar-intl",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarIntltext",
      "hrefProp": "pagePlatformNavbarIntlhref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-design",
      "name": "page-platform-navbar-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarDesigntext",
      "hrefProp": "pagePlatformNavbarDesignhref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-support",
      "name": "page-platform-navbar-support",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarSupporttext",
      "hrefProp": "pagePlatformNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-iso",
      "name": "page-platform-navbar-iso",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarIsotext",
      "hrefProp": "pagePlatformNavbarIsohref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-PLATFORM",
      "name": "page-platform-navbar-PLATFORM",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarPlatformtext",
      "hrefProp": "pagePlatformNavbarPlatformhref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-INDUSTRIES",
      "name": "page-platform-navbar-INDUSTRIES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarIndustriestext",
      "hrefProp": "pagePlatformNavbarIndustrieshref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-PARTNERS",
      "name": "page-platform-navbar-PARTNERS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarPartnerstext",
      "hrefProp": "pagePlatformNavbarPartnershref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-RESOURCES",
      "name": "page-platform-navbar-RESOURCES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarResourcestext",
      "hrefProp": "pagePlatformNavbarResourceshref"
    },
    {
      "type": "text",
      "id": "page-platform-navbar-ABOUT",
      "name": "page-platform-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarAbouttext",
      "hrefProp": "pagePlatformNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-platform-navbar-contact-box",
      "name": "page-platform-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 40,
    ...
    {
      "type": "text",
      "id": "page-platform-navbar-contact-text",
      "name": "page-platform-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarContactTexttext",
      "hrefProp": "pagePlatformNavbarContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-platform-navbar",
  "pagePlatformNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "pagePlatformNavbarSearchtext": "Search...",
  "pagePlatformNavbarSearchhref": "/",
  "pagePlatformNavbarIntltext": "International",
  "pagePlatformNavbarIntlhref": "/",
  "pagePlatformNavbarDesigntext": "Design Engine",
  "pagePlatformNavbarDesignhref": "/",
  "pagePlatformNavbarSupporttext": "Customer Support",
  "pagePlatformNavbarSupporthref": "/contact",
  "pagePlatformNavbarIsotext": "ISO 9001:2015",
  "pagePlatformNavbarIsohref": "/",
  "pagePlatformNavbarPlatformtext": "PLATFORM",
  "pagePlatformNavbarPlatformhref": "/platform",
  "pagePlatformNavbarIndustriestext": "INDUSTRIES",
  "pagePlatformNavbarIndustrieshref": "/industries",
  "pagePlatformNavbarPartnerstext": "PARTNERS",
  "pagePlatformNavbarPartnershref": "/partners",
  "pagePlatformNavbarResourcestext": "RESOURCES",
  "pagePlatformNavbarResourceshref": "/resources",
  "pagePlatformNavbarAbouttext": "ABOUT",
  "pagePlatformNavbarAbouthref": "/about",
  "pagePlatformNavbarContactTexttext": "CONTACT",
  "pagePlatformNavbarContactTexthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSitePlatformNavigationNavbarpenPrimary({ id, pagePlatformNavbarLogoimagesrc, pagePlatformNavbarSearchtext, pagePlatformNavbarSearchhref, pagePlatformNavbarIntltext, pagePlatformNavbarIntlhref, pagePlatformNavbarDesigntext, pagePlatformNavbarDesignhref, pagePlatformNavbarSupporttext, pagePlatformNavbarSupporthref, pagePlatformNavbarIsotext, pagePlatformNavbarIsohref, pagePlatformNavbarPlatformtext, pagePlatformNavbarPlatformhref, pagePlatformNavbarIndustriestext, pagePlatformNavbarIndustrieshref, pagePlatformNavbarPartnerstext, pagePlatformNavbarPartnershref, pagePlatformNavbarResourcestext, pagePlatformNavbarResourceshref, pagePlatformNavbarAbouttext, pagePlatformNavbarAbouthref, pagePlatformNavbarContactTexttext, pagePlatformNavbarContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagePlatformNavbarLogoimagesrc, pagePlatformNavbarSearchtext, pagePlatformNavbarSearchhref, pagePlatformNavbarIntltext, pagePlatformNavbarIntlhref, pagePlatformNavbarDesigntext, pagePlatformNavbarDesignhref, pagePlatformNavbarSupporttext, pagePlatformNavbarSupporthref, pagePlatformNavbarIsotext, pagePlatformNavbarIsohref, pagePlatformNavbarPlatformtext, pagePlatformNavbarPlatformhref, pagePlatformNavbarIndustriestext, pagePlatformNavbarIndustrieshref, pagePlatformNavbarPartnerstext, pagePlatformNavbarPartnershref, pagePlatformNavbarResourcestext, pagePlatformNavbarResourceshref, pagePlatformNavbarAbouttext, pagePlatformNavbarAbouthref, pagePlatformNavbarContactTexttext, pagePlatformNavbarContactTexthref });
