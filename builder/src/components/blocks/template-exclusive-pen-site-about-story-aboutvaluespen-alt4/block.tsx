...
const DEFAULT_PROPS = {
  "id": "wMZsy",
  "valtagtxttext": "发展人才",
  "valtitletext": "人，是我们存在和行动的核心。",
  "aimgimagesrc": "https://images.unsplash.com/photo-1763550662603-78aa2f2033bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTc5NTZ8&ixlib=rb-4.1.0&q=80&w=1080",
  "atxttext": "为我们的客户\n\n“在 Bevi，我们正在用可持续的智能饮水系统为一次性塑料瓶减负。随着 Plexus 团队在产品交付、能力建设与质量控制方面的持续支持，我们实现了快速扩展。”\n\n— Bevi 首席运营官 Matt Gannon",
  "bimgimagesrc": "https://images.unsplash.com/photo-1737573477556-ac3ed2db618c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTc5NTd8&ixlib=rb-4.1.0&q=80&w=1080",
  "btxttext": "团队成员\n\n“在 Plexus 工作期间，我看到了许多绝佳的机会。导师和领导帮助我持续成长，并不断拓展能力边界。”\n\n— Chris Draws，Plexus 员工工程师",
  "cimgimagesrc": "https://images.unsplash.com/photo-1740205645173-d2ff3c09d7ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTgzNDl8&ixlib=rb-4.1.0&q=80&w=1080",
  "ctitletext": "为了我们的世界",
  "ctexttext": "“Plexus 员工的奉献精神始终打动着我们，而这真正延伸到社区建设与长期合作中。Plexus 以客户价值和社会责任驱动成果，让影响深植于每一次行动。”\n\n— 大溪城 Habitat for Humanity 的 John Wyenberg",
  "cbtnhref": "/",
  "cbtntxttext": "了解更多",
  "valdtxttext": "为了更好地服务全球客户，我们在组织、流程和能力上不断进化。",
  "dtitletext": "我们与客户并肩，加速价值实现",
  "dbtnhref": "/",
  "dbtntxttext": "阅读案例",
  "talentsubtext": "我们通过开放、赋能与信任驱动团队成长，共同应对复杂的挑战。"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryAboutvaluespenAlt4({ id, valtagtxttext, valtitletext, aimgimagesrc, atxttext, bimgimagesrc, btxttext, cimgimagesrc, ctitletext, ctexttext, cbtnhref, cbtntxttext, valdtxttext, dtitletext, dbtnhref, dbtntxttext, talentsubtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, valtagtxttext, valtitletext, aimgimagesrc, atxttext, bimgimagesrc, btxttext, cimgimagesrc, ctitletext, ctexttext, cbtnhref, cbtntxttext, valdtxttext, dtitletext, dbtnhref, dbtntxttext, talentsubtext });
