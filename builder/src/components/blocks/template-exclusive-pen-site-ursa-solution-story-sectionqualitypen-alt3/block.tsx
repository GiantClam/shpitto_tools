...
const SECTION_TREE = {
  ...
  "children": [
    {
      ...
      "style": {
        ...
        "width": 1440,
        "height": 371,
        "background": "linear-gradient(90deg, #111722F2 0%, #111722CC 60%, #111722F2 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
  ...
  "imageProp": "sectionQualityimagesrc"
};
const DEFAULT_PROPS = {
  "id": "mwpgl",
...
export default function TemplateExclusivePenSiteUrsaSolutionStorySectionqualitypenAlt3({ id, sectionQualityimagesrc, kcqautext, bkdqztext, z5rmntext, gtrlbtext, y7hcptext, srjootext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sectionQualityimagesrc, kcqautext, bkdqztext, z5rmntext, gtrlbtext, y7hcptext, srjootext });
