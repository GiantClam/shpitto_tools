          ...
          "children": [
            {
              ...
              "style": {
                ...
                "width": 880,
                "height": 400,
                "background": "linear-gradient(0deg, #00000022 0%, #000000D6 100%)",
                "position": "absolute",
                "left": 0,
                "top": 0
              },
...
export default function TemplateExclusivePenSiteHomeApproachCapabilitiespenAlt3({ id, captitletext, capimgimagesrc, capnametext, capdesctext, rail1imagesrc, rail1ttext, rail2imagesrc, rail2ttext, capbtnhref, capbtntexttext, capbtnarrowtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, captitletext, capimgimagesrc, capnametext, capdesctext, rail1imagesrc, rail1ttext, rail2imagesrc, rail2ttext, capbtnhref, capbtntexttext, capbtnarrowtext });
