...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "supportBody2text"
    },
    {
      "type": "rectangle",
      "id": "support-cta-box",
      "name": "support-cta-box",
      "style": {
        "boxSizing": "border-box",
        "width": 156,
        "height": 38,
      ...
      "children": [],
      "hrefProp": "supportCtaBoxhref"
    },
    {
      "type": "text",
      "id": "support-cta-text",
      "name": "support-cta-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "supportCtaTexttext",
      "hrefProp": "supportCtaTexthref"
    },
    {
      "type": "text",
      "id": "support-cta-arrow",
      "name": "support-cta-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "supportCtaArrowtext",
      "hrefProp": "supportCtaArrowhref"
    }
  ]
};
const DEFAULT_PROPS = {
  ...
  "supportBodytext": "PAMA is proud of its many years of experience in the field of machine tools and provides its customers with a wide range of services and contracts to ensure the sustained highest level of performance of its products.",
  "supportBody2text": "From dedicated helpline and remote diagnosis to preventative maintenance and machine geometry optimisation, PAMA keeps machine tools productive over time.",
  "supportCtaBoxhref": "/",
  "supportCtaTexttext": "DISCOVER MORE",
  "supportCtaTexthref": "/",
  "supportCtaArrowtext": "›",
  "supportCtaArrowhref": "/"
};
...
export default function TemplateExclusivePenSiteHomeContactSupportsectionpenAlt5({ id, supportTitletext, supportBodytext, supportBody2text, supportCtaBoxhref, supportCtaTexttext, supportCtaTexthref, supportCtaArrowtext, supportCtaArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, supportTitletext, supportBodytext, supportBody2text, supportCtaBoxhref, supportCtaTexttext, supportCtaTexthref, supportCtaArrowtext, supportCtaArrowhref });
