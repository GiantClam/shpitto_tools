...
const DEFAULT_PROPS = {
  ...
  "featbtnthref": "/read-featured-story"
};
...
export default function TemplateExclusiveUnistellarHomeBlogApproachFeatpenAlt2({ id, featimgimagesrc, featktext, featttext, featdtext, featbtnhref, featbtnttext, featbtnthref, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, featimgimagesrc, featktext, featttext, featdtext, featbtnhref, featbtnttext, featbtnthref });
