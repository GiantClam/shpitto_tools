...
export default function TemplateExclusivePenSiteAboutFooterAboutfooterpenAlt2({ id, flogottext, flogothref, fnavtext, fnavhref, copytext, copyhref, footeraddrtext, footeraddrhref, fbtext, fbhref, intext, inhref, ...rest }) {
