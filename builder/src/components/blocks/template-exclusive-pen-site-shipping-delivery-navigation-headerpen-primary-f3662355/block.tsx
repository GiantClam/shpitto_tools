...
export default function TemplateExclusivePenSiteShippingDeliveryNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
