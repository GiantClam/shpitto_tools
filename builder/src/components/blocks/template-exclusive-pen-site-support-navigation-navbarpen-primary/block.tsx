...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-support-navbar-bg",
      "name": "page-support-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-support-navbar-logo",
      "name": "page-support-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pageSupportNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-support-navbar-SECTORS",
      "name": "page-support-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSupportNavbarSectorstext",
      "hrefProp": "pageSupportNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-support-navbar-PRODUCTS",
      "name": "page-support-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSupportNavbarProductstext",
      "hrefProp": "pageSupportNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-support-navbar-SUPPORT",
      "name": "page-support-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSupportNavbarSupporttext",
      "hrefProp": "pageSupportNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-support-navbar-ABOUT",
      "name": "page-support-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSupportNavbarAbouttext",
      "hrefProp": "pageSupportNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-support-navbar-contact-box",
      "name": "page-support-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-support-navbar-contact-text",
      "name": "page-support-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSupportNavbarContactTexttext",
      "hrefProp": "pageSupportNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-support-navbar-contact-arrow",
      "name": "page-support-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSupportNavbarContactArrowtext",
      "hrefProp": "pageSupportNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-support-navbar-menu-hit",
      "name": "page-support-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-support-navbar-menu-line1",
      "name": "page-support-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-support-navbar-menu-line2",
      "name": "page-support-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-support-navbar-menu-line3",
      "name": "page-support-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-support-navbar",
  "pageSupportNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageSupportNavbarSectorstext": "SECTORS",
  "pageSupportNavbarSectorshref": "/",
  "pageSupportNavbarProductstext": "PRODUCTS",
  "pageSupportNavbarProductshref": "/products",
  "pageSupportNavbarSupporttext": "SUPPORT",
  "pageSupportNavbarSupporthref": "/support",
  "pageSupportNavbarAbouttext": "ABOUT",
  "pageSupportNavbarAbouthref": "/about-us",
  "pageSupportNavbarContactTexttext": "CONTACT",
  "pageSupportNavbarContactTexthref": "/contact-us",
  "pageSupportNavbarContactArrowtext": "›",
  "pageSupportNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteSupportNavigationNavbarpenPrimary({ id, pageSupportNavbarLogoimagesrc, pageSupportNavbarSectorstext, pageSupportNavbarSectorshref, pageSupportNavbarProductstext, pageSupportNavbarProductshref, pageSupportNavbarSupporttext, pageSupportNavbarSupporthref, pageSupportNavbarAbouttext, pageSupportNavbarAbouthref, pageSupportNavbarContactTexttext, pageSupportNavbarContactTexthref, pageSupportNavbarContactArrowtext, pageSupportNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageSupportNavbarLogoimagesrc, pageSupportNavbarSectorstext, pageSupportNavbarSectorshref, pageSupportNavbarProductstext, pageSupportNavbarProductshref, pageSupportNavbarSupporttext, pageSupportNavbarSupporthref, pageSupportNavbarAbouttext, pageSupportNavbarAbouthref, pageSupportNavbarContactTexttext, pageSupportNavbarContactTexthref, pageSupportNavbarContactArrowtext, pageSupportNavbarContactArrowhref });
