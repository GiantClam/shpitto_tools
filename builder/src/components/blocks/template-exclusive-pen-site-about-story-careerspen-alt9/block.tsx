...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "hrefProp": "carbtnthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "942NV",
  "carimgimagesrc": "https://images.unsplash.com/photo-1581094376857-a89b560e4e7f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHNlYXJjaHwxfHxlbmdpbmVlciUyMHdvcmtzaG9wfGVufDB8fHx8MTc3MzI3MTI1MHww&ixlib=rb-4.1.0&q=80&w=1600",
  "cartitletext": "Explore careers at Kymeta",
  "cardesctext": "Answering tomorrow's complex problems takes vision and people with the talent and expertise that can identify and creatively solve the solutions. Smart people. Great people. We are always looking for individuals that want to be part of a team that focuses on solving challenges every day, in a way that would produce unprecedented growth. We embrace teamwork, diversity, and provide a place where your ideas are respected.",
  "carbtnhref": "/",
  "carbtnttext": "Learn more",
  "carbtnthref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteAboutStoryCareerspenAlt9({ id, carimgimagesrc, cartitletext, cardesctext, carbtnhref, carbtnttext, carbtnthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, carimgimagesrc, cartitletext, cardesctext, carbtnhref, carbtnttext, carbtnthref });
