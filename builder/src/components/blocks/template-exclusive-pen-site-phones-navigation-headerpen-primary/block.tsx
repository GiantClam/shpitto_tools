...
export default function TemplateExclusivePenSitePhonesNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOfferstext, navPageOffershref, navPagePhonestext, navPagePhoneshref, navPageAudiotext, navPageAudiohref, navPageSupportCentretext, navPageSupportCentrehref, navPageContactSupporttext, navPageContactSupporthref, ...rest }) {
