...
export default function TemplateExclusivePenSiteHomeFooterFooterpenAlt9({ id, jepkjtext, orajgtext, l8jrttext, l8jrthref, bdiktext, bdikhref, vt6hztext, vt6hzhref, lfytdtext, bsdw2text, fqxfltext, fqxflhref, r9yl0text, r9yl0href, qhwrmtext, c0zfltext, rzp7ctext, rzp7chref, d74ectext, d74echref, ajqntext, ajqnhref, av9swtext, ml9hatext, yxnomtext, yxnomhref, gmysetext, gmysehref, lfermtext, nkx6qtext, nkx6qhref, czlbltext, wntntext, vwebftext, orm4stext, gg7cxtext, contactbtnhref, contacttexttext, ugbqftext, p7bcwtext, p7bcwhref, o1swrtext, o1swrhref, yr5tftext, nnknctext, nnknchref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, jepkjtext, orajgtext, l8jrttext, l8jrthref, bdiktext, bdikhref, vt6hztext, vt6hzhref, lfytdtext, bsdw2text, fqxfltext, fqxflhref, r9yl0text, r9yl0href, qhwrmtext, c0zfltext, rzp7ctext, rzp7chref, d74ectext, d74echref, ajqntext, ajqnhref, av9swtext, ml9hatext, yxnomtext, yxnomhref, gmysetext, gmysehref, lfermtext, nkx6qtext, nkx6qhref, czlbltext, wntntext, vwebftext, orm4stext, gg7cxtext, contactbtnhref, contacttexttext, ugbqftext, p7bcwtext, p7bcwhref, o1swrtext, o1swrhref, yr5tftext, nnknctext, nnknchref });
