...
export default function TemplateExclusiveFrameworkSupportNavigationNavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
