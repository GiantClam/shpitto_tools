...
export default function TemplateExclusivePenSitePscsProductsStoryTransformsectionpenAlt3({ id, transformtitletext, transformleadtext, c1ttext, c1btext, c2ttext, c2btext, c3ttext, c3btext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, transformtitletext, transformleadtext, c1ttext, c1btext, c2ttext, c2btext, c3ttext, c3btext });
