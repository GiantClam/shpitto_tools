...
const SECTION_TREE = {
  "type": "frame",
  "id": "page-solution-provider-navbar",
  "name": "Navbar",
  "style": {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-bg",
      "name": "page-solution-provider-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-logo",
      "name": "page-solution-provider-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pageSolutionProviderNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-solution-provider-navbar-SECTORS",
      "name": "page-solution-provider-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSolutionProviderNavbarSectorstext",
      "hrefProp": "pageSolutionProviderNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-solution-provider-navbar-PRODUCTS",
      "name": "page-solution-provider-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSolutionProviderNavbarProductstext",
      "hrefProp": "pageSolutionProviderNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-solution-provider-navbar-SUPPORT",
      "name": "page-solution-provider-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSolutionProviderNavbarSupporttext",
      "hrefProp": "pageSolutionProviderNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-solution-provider-navbar-ABOUT",
      "name": "page-solution-provider-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSolutionProviderNavbarAbouttext",
      "hrefProp": "pageSolutionProviderNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-contact-box",
      "name": "page-solution-provider-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-solution-provider-navbar-contact-text",
      "name": "page-solution-provider-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSolutionProviderNavbarContactTexttext",
      "hrefProp": "pageSolutionProviderNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-solution-provider-navbar-contact-arrow",
      "name": "page-solution-provider-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageSolutionProviderNavbarContactArrowtext",
      "hrefProp": "pageSolutionProviderNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-menu-hit",
      "name": "page-solution-provider-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-menu-line1",
      "name": "page-solution-provider-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-menu-line2",
      "name": "page-solution-provider-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-solution-provider-navbar-menu-line3",
      "name": "page-solution-provider-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-solution-provider-navbar",
  "pageSolutionProviderNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageSolutionProviderNavbarSectorstext": "SECTORS",
  "pageSolutionProviderNavbarSectorshref": "/",
  "pageSolutionProviderNavbarProductstext": "PRODUCTS",
  "pageSolutionProviderNavbarProductshref": "/products",
  "pageSolutionProviderNavbarSupporttext": "SUPPORT",
  "pageSolutionProviderNavbarSupporthref": "/support",
  "pageSolutionProviderNavbarAbouttext": "ABOUT",
  "pageSolutionProviderNavbarAbouthref": "/about-us",
  "pageSolutionProviderNavbarContactTexttext": "CONTACT",
  "pageSolutionProviderNavbarContactTexthref": "/contact-us",
  "pageSolutionProviderNavbarContactArrowtext": "›",
  "pageSolutionProviderNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #1A1F24)";
...
export default function TemplateExclusivePenSiteSolutionProviderNavigationNavbarpenPrimary({ id, pageSolutionProviderNavbarLogoimagesrc, pageSolutionProviderNavbarSectorstext, pageSolutionProviderNavbarSectorshref, pageSolutionProviderNavbarProductstext, pageSolutionProviderNavbarProductshref, pageSolutionProviderNavbarSupporttext, pageSolutionProviderNavbarSupporthref, pageSolutionProviderNavbarAbouttext, pageSolutionProviderNavbarAbouthref, pageSolutionProviderNavbarContactTexttext, pageSolutionProviderNavbarContactTexthref, pageSolutionProviderNavbarContactArrowtext, pageSolutionProviderNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageSolutionProviderNavbarLogoimagesrc, pageSolutionProviderNavbarSectorstext, pageSolutionProviderNavbarSectorshref, pageSolutionProviderNavbarProductstext, pageSolutionProviderNavbarProductshref, pageSolutionProviderNavbarSupporttext, pageSolutionProviderNavbarSupporthref, pageSolutionProviderNavbarAbouttext, pageSolutionProviderNavbarAbouthref, pageSolutionProviderNavbarContactTexttext, pageSolutionProviderNavbarContactTexthref, pageSolutionProviderNavbarContactArrowtext, pageSolutionProviderNavbarContactArrowhref });
