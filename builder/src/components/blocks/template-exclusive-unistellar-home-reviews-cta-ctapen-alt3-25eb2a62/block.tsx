...
const DEFAULT_PROPS = {
  "id": "0OCEc",
  "ctahref": "/ready-for-your-own-first-night-review",
...
export default function TemplateExclusiveUnistellarHomeReviewsCtaCtapenAlt3({ id, ctahref, ctahtext, ctabttext, ...rest }) {
