...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-footwear-navbar-bg",
      "name": "page-footwear-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-footwear-navbar-logo",
      "name": "page-footwear-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 34,
      ...
      "children": [],
      "imageProp": "pageFootwearNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-search",
      "name": "page-footwear-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarSearchtext",
      "hrefProp": "pageFootwearNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-intl",
      "name": "page-footwear-navbar-intl",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarIntltext",
      "hrefProp": "pageFootwearNavbarIntlhref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-design",
      "name": "page-footwear-navbar-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarDesigntext",
      "hrefProp": "pageFootwearNavbarDesignhref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-support",
      "name": "page-footwear-navbar-support",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarSupporttext",
      "hrefProp": "pageFootwearNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-iso",
      "name": "page-footwear-navbar-iso",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarIsotext",
      "hrefProp": "pageFootwearNavbarIsohref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-PLATFORM",
      "name": "page-footwear-navbar-PLATFORM",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarPlatformtext",
      "hrefProp": "pageFootwearNavbarPlatformhref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-INDUSTRIES",
      "name": "page-footwear-navbar-INDUSTRIES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarIndustriestext",
      "hrefProp": "pageFootwearNavbarIndustrieshref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-PARTNERS",
      "name": "page-footwear-navbar-PARTNERS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarPartnerstext",
      "hrefProp": "pageFootwearNavbarPartnershref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-RESOURCES",
      "name": "page-footwear-navbar-RESOURCES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarResourcestext",
      "hrefProp": "pageFootwearNavbarResourceshref"
    },
    {
      "type": "text",
      "id": "page-footwear-navbar-ABOUT",
      "name": "page-footwear-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarAbouttext",
      "hrefProp": "pageFootwearNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-footwear-navbar-contact-box",
      "name": "page-footwear-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 40,
    ...
    {
      "type": "text",
      "id": "page-footwear-navbar-contact-text",
      "name": "page-footwear-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarContactTexttext",
      "hrefProp": "pageFootwearNavbarContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-footwear-navbar",
  "pageFootwearNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "pageFootwearNavbarSearchtext": "Search...",
  "pageFootwearNavbarSearchhref": "/",
  "pageFootwearNavbarIntltext": "International",
  "pageFootwearNavbarIntlhref": "/",
  "pageFootwearNavbarDesigntext": "Design Engine",
  "pageFootwearNavbarDesignhref": "/",
  "pageFootwearNavbarSupporttext": "Customer Support",
  "pageFootwearNavbarSupporthref": "/contact",
  "pageFootwearNavbarIsotext": "ISO 9001:2015",
  "pageFootwearNavbarIsohref": "/",
  "pageFootwearNavbarPlatformtext": "PLATFORM",
  "pageFootwearNavbarPlatformhref": "/platform",
  "pageFootwearNavbarIndustriestext": "INDUSTRIES",
  "pageFootwearNavbarIndustrieshref": "/industries",
  "pageFootwearNavbarPartnerstext": "PARTNERS",
  "pageFootwearNavbarPartnershref": "/partners",
  "pageFootwearNavbarResourcestext": "RESOURCES",
  "pageFootwearNavbarResourceshref": "/resources",
  "pageFootwearNavbarAbouttext": "ABOUT",
  "pageFootwearNavbarAbouthref": "/about",
  "pageFootwearNavbarContactTexttext": "CONTACT",
  "pageFootwearNavbarContactTexthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteConsumerFootwearNavigationNavbarpenPrimary({ id, pageFootwearNavbarLogoimagesrc, pageFootwearNavbarSearchtext, pageFootwearNavbarSearchhref, pageFootwearNavbarIntltext, pageFootwearNavbarIntlhref, pageFootwearNavbarDesigntext, pageFootwearNavbarDesignhref, pageFootwearNavbarSupporttext, pageFootwearNavbarSupporthref, pageFootwearNavbarIsotext, pageFootwearNavbarIsohref, pageFootwearNavbarPlatformtext, pageFootwearNavbarPlatformhref, pageFootwearNavbarIndustriestext, pageFootwearNavbarIndustrieshref, pageFootwearNavbarPartnerstext, pageFootwearNavbarPartnershref, pageFootwearNavbarResourcestext, pageFootwearNavbarResourceshref, pageFootwearNavbarAbouttext, pageFootwearNavbarAbouthref, pageFootwearNavbarContactTexttext, pageFootwearNavbarContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageFootwearNavbarLogoimagesrc, pageFootwearNavbarSearchtext, pageFootwearNavbarSearchhref, pageFootwearNavbarIntltext, pageFootwearNavbarIntlhref, pageFootwearNavbarDesigntext, pageFootwearNavbarDesignhref, pageFootwearNavbarSupporttext, pageFootwearNavbarSupporthref, pageFootwearNavbarIsotext, pageFootwearNavbarIsohref, pageFootwearNavbarPlatformtext, pageFootwearNavbarPlatformhref, pageFootwearNavbarIndustriestext, pageFootwearNavbarIndustrieshref, pageFootwearNavbarPartnerstext, pageFootwearNavbarPartnershref, pageFootwearNavbarResourcestext, pageFootwearNavbarResourceshref, pageFootwearNavbarAbouttext, pageFootwearNavbarAbouthref, pageFootwearNavbarContactTexttext, pageFootwearNavbarContactTexthref });
