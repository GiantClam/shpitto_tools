...
export default function TemplateExclusivePenSiteOerlikonAboutStoryAboutlinkgridpenAlt5({ id, card1ttext, card1dtext, card2ttext, card2dtext, card3ttext, card3dtext, card4ttext, card4dtext, card5ttext, card5dtext, card6ttext, card6dtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, card1ttext, card1dtext, card2ttext, card2dtext, card3ttext, card3dtext, card4ttext, card4dtext, card5ttext, card5dtext, card6ttext, card6dtext });
