...
export default function TemplateExclusivePenSiteContactFooterFooterpenAlt2({ id, tjgbbtext, fafdetext, tjtext, col2ttext, col2thref, lcxuwtext, lcxuwhref, wr3eitext, wr3eihref, u7xzatext, u7xzahref, ctcbptext, ctcbphref, sjsfttext, sjsfthref, tpp1ntext, tpp1nhref, gg6mttext, gg6mthref, qipirtext, qipirhref, bonrutext, bonruhref, shewetext, shewehref, ilnhftext, ilnhfhref, gv3kztext, gv3kzhref, fhjhxtext, fhjhxhref, ek51text, ek51href, paktext, pakhref, nrkhvtext, nrkhvhref, ofeqptext, ofeqphref, aln9ptext, aln9phref, kbnetext, kbnehref, r6rcytext, r6rcyhref, c4vp2text, c4vp2href, lvxftext, lvxfhref, t6ke3text, t6ke3href, e5irmtext, e5irmhref, text, href, iosugtext, iosughref, ngdkbtext, ngdkbhref, moertext, moerhref, socialtext, socialhref, b4947text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, tjgbbtext, fafdetext, tjtext, col2ttext, col2thref, lcxuwtext, lcxuwhref, wr3eitext, wr3eihref, u7xzatext, u7xzahref, ctcbptext, ctcbphref, sjsfttext, sjsfthref, tpp1ntext, tpp1nhref, gg6mttext, gg6mthref, qipirtext, qipirhref, bonrutext, bonruhref, shewetext, shewehref, ilnhftext, ilnhfhref, gv3kztext, gv3kzhref, fhjhxtext, fhjhxhref, ek51text, ek51href, paktext, pakhref, nrkhvtext, nrkhvhref, ofeqptext, ofeqphref, aln9ptext, aln9phref, kbnetext, kbnehref, r6rcytext, r6rcyhref, c4vp2text, c4vp2href, lvxftext, lvxfhref, t6ke3text, t6ke3href, e5irmtext, e5irmhref, text, href, iosugtext, iosughref, ngdkbtext, ngdkbhref, moertext, moerhref, socialtext, socialhref, b4947text });
