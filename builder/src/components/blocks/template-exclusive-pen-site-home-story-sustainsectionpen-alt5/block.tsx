...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "susbtnttext",
      "hrefProp": "susbtnthref"
    },
    {
      "type": "rectangle",
      "id": "SLPqA",
...
const DEFAULT_PROPS = {
  "id": "fbF1K",
  "sustitletext": "获得个性化的体验",
  "susmaintext": "创建山特维克可乐满账户 即刻享受：",
  "susdesctext": "√ 轻松订购我们的热门产品\n√ 查看价格、供货情况和库存信息\n√ 发票打印\n√ 定制自己的刀具条件\n√ 访问学习和指南\n√ 下载电子版目录",
  "susbtnhref": "/",
  "susbtnttext": "创建账户",
  "susbtnthref": "/"
};
...
export default function TemplateExclusivePenSiteHomeStorySustainsectionpenAlt5({ id, sustitletext, susmaintext, susdesctext, susbtnhref, susbtnttext, susbtnthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sustitletext, susmaintext, susdesctext, susbtnhref, susbtnttext, susbtnthref });
