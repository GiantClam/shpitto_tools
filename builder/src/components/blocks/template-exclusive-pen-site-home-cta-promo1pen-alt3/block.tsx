...
export default function TemplateExclusivePenSiteHomeCtaPromo1penAlt3({ id, protexttext, prodesctext, btn1href, btn1txttext, bulletsatext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, protexttext, prodesctext, btn1href, btn1txttext, bulletsatext });
