...
export default function TemplateExclusiveUnistellarHomeTechnologiesApproachBenefitspenAlt3({ id, bhtext, m1ntext, m1dtext, m1href, m2ntext, m2dtext, m2href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, bhtext, m1ntext, m1dtext, m1href, m2ntext, m2dtext, m2href });
