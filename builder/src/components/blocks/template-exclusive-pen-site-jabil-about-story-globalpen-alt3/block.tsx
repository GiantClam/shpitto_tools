...
export default function TemplateExclusivePenSiteJabilAboutStoryGlobalpenAlt3({ id, globaleyebrowtext, globaltitletext, ap3uatext, byqw3text, w5uftext, orxo4text, s42xstext, sl6wtext, fsm7rtext, sbxkutext, umcgetext, d8pthtext, e2ibotext, huv70text, linktxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, globaleyebrowtext, globaltitletext, ap3uatext, byqw3text, w5uftext, orxo4text, s42xstext, sl6wtext, fsm7rtext, sbxkutext, umcgetext, d8pthtext, e2ibotext, huv70text, linktxttext });
