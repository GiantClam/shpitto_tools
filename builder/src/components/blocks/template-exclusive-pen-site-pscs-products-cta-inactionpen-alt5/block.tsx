...
export default function TemplateExclusivePenSitePscsProductsCtaInactionpenAlt5({ id, actiontitletext, actionleadtext, ac1iimagesrc, ac1ttext, ac2iimagesrc, ac2ttext, ac3iimagesrc, ac3ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, actiontitletext, actionleadtext, ac1iimagesrc, ac1ttext, ac2iimagesrc, ac2ttext, ac3iimagesrc, ac3ttext });
