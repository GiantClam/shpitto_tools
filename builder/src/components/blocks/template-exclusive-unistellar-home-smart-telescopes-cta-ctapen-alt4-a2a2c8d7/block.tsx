...
export default function TemplateExclusiveUnistellarHomeSmartTelescopesCtaCtapenAlt4({ id, ctahref, ctahtext, ctabttext, ctabhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctahref, ctahtext, ctabttext, ctabhref });
