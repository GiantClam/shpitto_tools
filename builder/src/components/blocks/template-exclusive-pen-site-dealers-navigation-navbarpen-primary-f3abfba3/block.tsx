...
export default function TemplateExclusivePenSiteDealersNavigationNavbarpenPrimary({ id, brandLogoDealersimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoDealersimagesrc });
