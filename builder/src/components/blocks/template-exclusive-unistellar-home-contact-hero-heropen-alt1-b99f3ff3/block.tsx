...
export default function TemplateExclusiveUnistellarHomeContactHeroHeropenAlt1({ id, herotagtext, herotitletext, herosubtext, primaryCtahref, primaryCtaTexttext, secondaryCtahref, secondaryCtaTexttext, promiseTexttext, promisePillhref, coverageTexttext, coveragePillhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotagtext, herotitletext, herosubtext, primaryCtahref, primaryCtaTexttext, secondaryCtahref, secondaryCtaTexttext, promiseTexttext, promisePillhref, coverageTexttext, coveragePillhref });
