...
const DEFAULT_PROPS = {
  ...
  "footerProductsBodytext": "M3 Printer\nM2 Printer\nL1 Printer",
...
export default function TemplateExclusivePenSiteConsumerFootwearFooterFooterpenAlt1({ id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref });
