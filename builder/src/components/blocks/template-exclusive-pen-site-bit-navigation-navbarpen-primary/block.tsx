...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-bit-navbar-bg",
      "name": "page-bit-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-bit-navbar-logo",
      "name": "page-bit-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 140,
        "height": 44,
      ...
      "children": [],
      "imageProp": "pageBitNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-Engineering",
      "name": "page-bit-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarEngineeringtext",
      "hrefProp": "pageBitNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-Products",
      "name": "page-bit-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarProductstext",
      "hrefProp": "pageBitNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-Services",
      "name": "page-bit-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarServicestext",
      "hrefProp": "pageBitNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-BIT",
      "name": "page-bit-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarBittext",
      "hrefProp": "pageBitNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-bit-navbar-lets",
      "name": "page-bit-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-bit-navbar-lets-t",
      "name": "page-bit-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarLetsTtext",
      "hrefProp": "pageBitNavbarLetsThref"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-search",
      "name": "page-bit-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarSearchtext",
      "hrefProp": "pageBitNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-lang",
      "name": "page-bit-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarLangtext",
      "hrefProp": "pageBitNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-bit-navbar-menu",
      "name": "page-bit-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageBitNavbarMenutext",
      "hrefProp": "pageBitNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-bit-navbar",
  "pageBitNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageBitNavbarEngineeringtext": "Engineering",
  "pageBitNavbarEngineeringhref": "/engineering",
  "pageBitNavbarProductstext": "Products",
  "pageBitNavbarProductshref": "/products",
  "pageBitNavbarServicestext": "Services",
  "pageBitNavbarServiceshref": "/services",
  "pageBitNavbarBittext": "BIT",
  "pageBitNavbarBithref": "/bit",
  "pageBitNavbarLetsTtext": "Let's talk",
  "pageBitNavbarLetsThref": "/",
  "pageBitNavbarSearchtext": "⌕",
  "pageBitNavbarSearchhref": "/",
  "pageBitNavbarLangtext": "Language",
  "pageBitNavbarLanghref": "/",
  "pageBitNavbarMenutext": "☰",
  "pageBitNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteBitNavigationNavbarpenPrimary({ id, pageBitNavbarLogoimagesrc, pageBitNavbarEngineeringtext, pageBitNavbarEngineeringhref, pageBitNavbarProductstext, pageBitNavbarProductshref, pageBitNavbarServicestext, pageBitNavbarServiceshref, pageBitNavbarBittext, pageBitNavbarBithref, pageBitNavbarLetsTtext, pageBitNavbarLetsThref, pageBitNavbarSearchtext, pageBitNavbarSearchhref, pageBitNavbarLangtext, pageBitNavbarLanghref, pageBitNavbarMenutext, pageBitNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageBitNavbarLogoimagesrc, pageBitNavbarEngineeringtext, pageBitNavbarEngineeringhref, pageBitNavbarProductstext, pageBitNavbarProductshref, pageBitNavbarServicestext, pageBitNavbarServiceshref, pageBitNavbarBittext, pageBitNavbarBithref, pageBitNavbarLetsTtext, pageBitNavbarLetsThref, pageBitNavbarSearchtext, pageBitNavbarSearchhref, pageBitNavbarLangtext, pageBitNavbarLanghref, pageBitNavbarMenutext, pageBitNavbarMenuhref });
