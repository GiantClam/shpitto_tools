...
const DEFAULT_PROPS = {
  "id": "8HGP5",
  "joinhtext": "Join us",
  "joindtext": "Whether you are an expert or just ready for a career pivot, if you love collaboration, we’d love to hear from you.",
  "joinltext": "View open positions"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryJoinsecpenAlt9({ id, joinhtext, joindtext, joinltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, joinhtext, joindtext, joinltext });
