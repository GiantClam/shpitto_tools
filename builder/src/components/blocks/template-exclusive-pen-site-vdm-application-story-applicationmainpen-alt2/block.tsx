...
export default function TemplateExclusivePenSiteVdmApplicationStoryApplicationmainpenAlt2({ id, heroimgimagesrc, midimgimagesrc, midtitletext, midbodytext, linkstitletext, li1text, li2text, li3text, li4text, li5text, btnhref, btnttext, biztitletext, bizbodytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroimgimagesrc, midimgimagesrc, midtitletext, midbodytext, linkstitletext, li1text, li2text, li3text, li4text, li5text, btnhref, btnttext, biztitletext, bizbodytext });
