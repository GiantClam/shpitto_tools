...
export default function TemplateExclusivePenSitePscsProductsHeroProductsheropenAlt1({ id, herotitletext, heroleadtext, heroimageimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, heroleadtext, heroimageimagesrc });
