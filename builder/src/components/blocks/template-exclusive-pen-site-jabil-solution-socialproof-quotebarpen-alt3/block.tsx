...
export default function TemplateExclusivePenSiteJabilSolutionSocialproofQuotebarpenAlt3({ id, quotetexttext, quotetexttext2, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, quotetexttext, quotetexttext2 });
