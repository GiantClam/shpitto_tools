...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-platform-navbar-menu",
      "name": "page-platform-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePlatformNavbarMenutext",
      "hrefProp": "pagePlatformNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pagePlatformNavbarMenutext": "☰",
  "pagePlatformNavbarMenuhref": "/",
...
export default function TemplateExclusivePenSitePlatformNavigationNavbarpenPrimary({ id, pagePlatformNavbarLogoimagesrc, pagePlatformNavbarMenutext, pagePlatformNavbarMenuhref, pagePlatformNavbarSearchtext, pagePlatformNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagePlatformNavbarLogoimagesrc, pagePlatformNavbarMenutext, pagePlatformNavbarMenuhref, pagePlatformNavbarSearchtext, pagePlatformNavbarSearchhref });
