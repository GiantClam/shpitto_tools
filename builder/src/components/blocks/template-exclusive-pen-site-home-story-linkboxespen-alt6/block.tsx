...
export default function TemplateExclusivePenSiteHomeStoryLinkboxespenAlt6({ id, l1ttext, l1stext, l2ttext, l2stext, l3ttext, l3stext, l4ttext, l4stext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, l1ttext, l1stext, l2ttext, l2stext, l3ttext, l3stext, l4ttext, l4stext });
