  ...
  "children": [
    {
      ...
      "children": [],
      "textProp": "anntexttext",
      "hrefProp": "anntexthref"
    },
    {
      "type": "frame",
      "id": "D6eNs",
...
const DEFAULT_PROPS = {
  "id": "JIWPg",
  "anntexttext": "Watch IonQ&apos;s Quantum World Congress 2025 Keynote On Demand.",
  "anntexthref": "/",
  "annbtnhref": "/",
  "annbtntxttext": "Watch now"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeNavigationTopannouncementpenPrimary({ id, anntexttext, anntexthref, annbtnhref, annbtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, anntexttext, anntexthref, annbtnhref, annbtntxttext });
