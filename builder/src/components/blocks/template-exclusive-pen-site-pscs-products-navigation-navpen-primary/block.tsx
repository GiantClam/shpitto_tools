...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #8eb2ca)";
...
export default function TemplateExclusivePenSitePscsProductsNavigationNavpenPrimary({ id, ri5tytext, ri5tyhref, fzccvtext, fzccvhref, alluvtext, alluvhref, pndhztext, pndhzhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ri5tytext, ri5tyhref, fzccvtext, fzccvhref, alluvtext, alluvhref, pndhztext, pndhzhref });
