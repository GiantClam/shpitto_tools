...
export default function TemplateExclusivePenSitePscsAboutStoryWhyjabilpenAlt4({ id, a1zintext, mzqlktext, uggkltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, a1zintext, mzqlktext, uggkltext });
