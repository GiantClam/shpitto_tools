...
export default function TemplateExclusivePenSiteZondaC12NavigationNavbarpenPrimary({ id, brandLogoZondaC12imagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoZondaC12imagesrc });
