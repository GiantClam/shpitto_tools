...
const DEFAULT_PROPS = {
  "id": "footer",
  "footerBrandtext": "teenage engineering",
  "footerBrandhref": "/",
  "footerTitle0text": "Sections",
  "footerTitle0href": "/",
  "footerBody0text": "Products Guides",
  "footerBody0href": "/products",
  "footerTitle1text": "Explore",
  "footerTitle1href": "/",
  "footerBody1text": "Downloads Designs",
  "footerBody1href": "/downloads",
  "footerTitle2text": "Products",
  "footerTitle2href": "/products",
  "footerBody2text": "Contact TX-6 OP-XY",
  "footerBody2href": "/contact",
  "footerCopytext": "teenage engineering structured clone pen with desktop and mobile page sets.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F0F0EB)";
