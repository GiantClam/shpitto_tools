...
export default function TemplateExclusivePenSiteContactNavigationNavpenAlt1({ id, cev9xtext, cev9xhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, cev9xtext, cev9xhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref });
