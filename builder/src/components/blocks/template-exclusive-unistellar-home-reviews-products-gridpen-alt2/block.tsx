...
export default function TemplateExclusiveUnistellarHomeReviewsProductsGridpenAlt2({ id, q1text, a1text, card1href, q2text, a2text, card2href, q3text, a3text, card3href, q4text, a4text, card4href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, q1text, a1text, card1href, q2text, a2text, card2href, q3text, a3text, card3href, q4text, a4text, card4href });
