...
export default function TemplateExclusivePenSiteHomeStoryInsightspenAlt3({ id, insightK0text, insightT0text, insightB0text, insightK1text, insightT1text, insightB1text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, insightK0text, insightT0text, insightB0text, insightK1text, insightT1text, insightB1text });
