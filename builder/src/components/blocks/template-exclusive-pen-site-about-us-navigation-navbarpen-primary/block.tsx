...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-about-navbar-Engineering",
      "name": "page-about-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarEngineeringtext",
      "hrefProp": "pageAboutNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-about-navbar-Products",
      "name": "page-about-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarProductstext",
      "hrefProp": "pageAboutNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-about-navbar-Services",
      "name": "page-about-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarServicestext",
      "hrefProp": "pageAboutNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-about-navbar-BIT",
      "name": "page-about-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarBittext",
      "hrefProp": "pageAboutNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-about-navbar-lets",
      "name": "page-about-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-about-navbar-lets-t",
      "name": "page-about-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarLetsTtext",
      "hrefProp": "pageAboutNavbarLetsThref"
    },
    {
      "type": "text",
    ...
    {
      "type": "text",
      "id": "page-about-navbar-lang",
      "name": "page-about-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarLangtext",
      "hrefProp": "pageAboutNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-about-navbar-menu",
      "name": "page-about-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutNavbarMenutext",
      "hrefProp": "pageAboutNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-about-navbar",
  "pageAboutNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageAboutNavbarEngineeringtext": "Engineering",
  "pageAboutNavbarEngineeringhref": "/engineering",
  "pageAboutNavbarProductstext": "Products",
  "pageAboutNavbarProductshref": "/products",
  "pageAboutNavbarServicestext": "Services",
  "pageAboutNavbarServiceshref": "/services",
  "pageAboutNavbarBittext": "BIT",
  "pageAboutNavbarBithref": "/bit",
  "pageAboutNavbarLetsTtext": "Let's talk",
  "pageAboutNavbarLetsThref": "/",
  "pageAboutNavbarSearchtext": "⌕",
  "pageAboutNavbarSearchhref": "/",
  "pageAboutNavbarLangtext": "Language",
  "pageAboutNavbarLanghref": "/",
  "pageAboutNavbarMenutext": "☰",
  "pageAboutNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteAboutUsNavigationNavbarpenPrimary({ id, pageAboutNavbarLogoimagesrc, pageAboutNavbarEngineeringtext, pageAboutNavbarEngineeringhref, pageAboutNavbarProductstext, pageAboutNavbarProductshref, pageAboutNavbarServicestext, pageAboutNavbarServiceshref, pageAboutNavbarBittext, pageAboutNavbarBithref, pageAboutNavbarLetsTtext, pageAboutNavbarLetsThref, pageAboutNavbarSearchtext, pageAboutNavbarSearchhref, pageAboutNavbarLangtext, pageAboutNavbarLanghref, pageAboutNavbarMenutext, pageAboutNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAboutNavbarLogoimagesrc, pageAboutNavbarEngineeringtext, pageAboutNavbarEngineeringhref, pageAboutNavbarProductstext, pageAboutNavbarProductshref, pageAboutNavbarServicestext, pageAboutNavbarServiceshref, pageAboutNavbarBittext, pageAboutNavbarBithref, pageAboutNavbarLetsTtext, pageAboutNavbarLetsThref, pageAboutNavbarSearchtext, pageAboutNavbarSearchhref, pageAboutNavbarLangtext, pageAboutNavbarLanghref, pageAboutNavbarMenutext, pageAboutNavbarMenuhref });
