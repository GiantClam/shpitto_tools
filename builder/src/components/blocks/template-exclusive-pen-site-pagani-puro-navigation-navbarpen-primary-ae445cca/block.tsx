...
export default function TemplateExclusivePenSitePaganiPuroNavigationNavbarpenPrimary({ id, brandLogoPaganiPuroimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoPaganiPuroimagesrc });
