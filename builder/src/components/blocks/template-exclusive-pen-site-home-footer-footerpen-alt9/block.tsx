...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerHeading1text",
      "hrefProp": "footerHeading1href"
    },
    {
      "type": "text",
      "id": "footer-links-1",
      ...
      "children": [],
      "textProp": "footerLinks1text",
      "hrefProp": "footerLinks1href"
    },
    {
      "type": "text",
      "id": "footer-heading-2",
      "name": "footer-heading-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerHeading2text",
      "hrefProp": "footerHeading2href"
    },
    {
      "type": "text",
      "id": "footer-links-2",
      ...
      "children": [],
      "textProp": "footerLinks2text",
      "hrefProp": "footerLinks2href"
    },
    {
      "type": "text",
      "id": "footer-heading-3",
      "name": "footer-heading-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerHeading3text",
      "hrefProp": "footerHeading3href"
    },
    {
      "type": "text",
      "id": "footer-links-3",
      ...
      "children": [],
      "textProp": "footerLinks3text",
      "hrefProp": "footerLinks3href"
    },
    {
      "type": "rectangle",
      "id": "footer-top-box",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerTopTexttext",
      "hrefProp": "footerTopTexthref"
    },
    {
      "type": "rectangle",
      "id": "footer-contact-box",
      "name": "footer-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 170,
        "height": 42,
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerContactTexttext",
      "hrefProp": "footerContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "footer",
  "footerLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "footerCopytext": "Structured Pagani homepage clone. Text, buttons, chips, rails and image containers are editable nodes, not a flattened screenshot.",
  "footerCopyhref": "/",
  "footerHeading1text": "Chapters",
  "footerHeading1href": "/",
  "footerLinks1text": "Home\nHistory\nDealers\nGuided Tours",
  "footerLinks1href": "/",
  "footerHeading2text": "Models",
  "footerHeading2href": "/",
  "footerLinks2text": "Pagani Utopia\nUtopia Roadster\nHuayra R\nZonda C12",
  "footerLinks2href": "/pagani-utopia",
  "footerHeading3text": "Meta",
  "footerHeading3href": "/",
  "footerLinks3text": "Pagani S.P.A.\nP.IVA 02054560368\nStructured pen clone",
  "footerLinks3href": "/",
  "footerTopTexttext": "Back to top",
  "footerTopTexthref": "/",
  "footerContactTexttext": "Contact Pagani",
  "footerContactTexthref": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #B9B3AB)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F3F2ED)";
...
export default function TemplateExclusivePenSiteHomeFooterFooterpenAlt9({ id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerHeading1text, footerHeading1href, footerLinks1text, footerLinks1href, footerHeading2text, footerHeading2href, footerLinks2text, footerLinks2href, footerHeading3text, footerHeading3href, footerLinks3text, footerLinks3href, footerTopTexttext, footerTopTexthref, footerContactTexttext, footerContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerHeading1text, footerHeading1href, footerLinks1text, footerLinks1href, footerHeading2text, footerHeading2href, footerLinks2text, footerLinks2href, footerHeading3text, footerHeading3href, footerLinks3text, footerLinks3href, footerTopTexttext, footerTopTexthref, footerContactTexttext, footerContactTexthref });
