...
const NAV_ACTIVE_COLOR = "#7E8CA8";
const NAV_INACTIVE_COLOR = "#D1DAEB";
...
export default function TemplateExclusiveUnistellarHomeAboutFooterFootaboutpenAlt6({ id, ftlogotext, ftdesctext, ftdeschref, col1text, col2text, col2href, col3text, col3href, col4text, col4href, copytext, jxbxptext, aay6otext, aay6ohref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ftlogotext, ftdesctext, ftdeschref, col1text, col2text, col2href, col3text, col3href, col4text, col4href, copytext, jxbxptext, aay6otext, aay6ohref });
