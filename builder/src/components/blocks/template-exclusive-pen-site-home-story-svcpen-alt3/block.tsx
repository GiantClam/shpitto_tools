...
const DEFAULT_PROPS = {
  ...
  "a4atext": "→",
  "mkttagtxttext": "市场领域",
  "mktdesctext": "为高度领先的市场领域提供的产品与 Plexus 的核心使命。凭借在不同行业的深厚行业专业知识，我们致力于为客户创造成功。",
  "sollinktext": "查看我们的市场领域 →"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeStorySvcpenAlt3({ id, svctitletext, a1ttext, a1atext, a2ttext, a2atext, a3ttext, a3atext, a4ttext, a4atext, mkttagtxttext, mktdesctext, sollinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, svctitletext, a1ttext, a1atext, a2ttext, a2atext, a3ttext, a3atext, a4ttext, a4atext, mkttagtxttext, mktdesctext, sollinktext });
