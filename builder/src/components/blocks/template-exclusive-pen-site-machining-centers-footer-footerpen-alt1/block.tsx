...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "footer-col-1-title",
      "name": "footer-col-1-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerCol1Titletext",
      "hrefProp": "footerCol1Titlehref"
    },
    {
      "type": "text",
      "id": "footer-col-1-links",
      "name": "footer-col-1-links",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerCol1Linkstext",
      "hrefProp": "footerCol1Linkshref"
    },
    {
      "type": "text",
      "id": "footer-col-2-title",
      "name": "footer-col-2-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerCol2Titletext",
      "hrefProp": "footerCol2Titlehref"
    },
    {
      "type": "text",
      "id": "footer-col-2-links",
      "name": "footer-col-2-links",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerCol2Linkstext",
      "hrefProp": "footerCol2Linkshref"
    },
    {
      "type": "text",
      "id": "footer-col-3-title",
      "name": "footer-col-3-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerCol3Titletext",
      "hrefProp": "footerCol3Titlehref"
    },
    {
      "type": "text",
      "id": "footer-col-3-links",
      "name": "footer-col-3-links",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerCol3Linkstext",
      "hrefProp": "footerCol3Linkshref"
    },
    {
      "type": "text",
      ...
      "children": [],
      "textProp": "footerNewslettertext",
      "hrefProp": "footerNewsletterhref"
    },
    {
      "type": "rectangle",
      "id": "footer-input",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerInputPlaceholdertext",
      "hrefProp": "footerInputPlaceholderhref"
    },
    {
      "type": "rectangle",
      "id": "footer-send",
    ...
    {
      "type": "text",
      "id": "footer-send-arrow",
      "name": "footer-send-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerSendArrowtext",
      "hrefProp": "footerSendArrowhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "footer",
  "footerLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo-white.png",
  "footerCopytext": "PAMA structured clone pen. Desktop and mobile files use editable text, buttons, cards and image containers.",
  "footerCopyhref": "/",
  "footerCol1Titletext": "COMPANY",
  "footerCol1Titlehref": "/",
  "footerCol1Linkstext": "About us\nSolution provider\nPAMA Worldwide",
  "footerCol1Linkshref": "/about-us",
  "footerCol2Titletext": "PRODUCTS",
  "footerCol2Titlehref": "/products",
  "footerCol2Linkstext": "Machining centers\nMilling machines\nAutomation",
  "footerCol2Linkshref": "/machining-centers",
  "footerCol3Titletext": "SUPPORT",
  "footerCol3Titlehref": "/support",
  "footerCol3Linkstext": "Maintenance\nContact us\nTechnology services",
  "footerCol3Linkshref": "/maintenance",
  "footerNewslettertext": "NEWSLETTER",
  "footerNewsletterhref": "/",
  "footerInputPlaceholdertext": "Email address",
  "footerInputPlaceholderhref": "/support",
  "footerSendArrowtext": "›",
  "footerSendArrowhref": "/"
};
const DEFAULT_THEME = {
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #05A6B5)";
...
export default function TemplateExclusivePenSiteMachiningCentersFooterFooterpenAlt1({ id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerCol1Titletext, footerCol1Titlehref, footerCol1Linkstext, footerCol1Linkshref, footerCol2Titletext, footerCol2Titlehref, footerCol2Linkstext, footerCol2Linkshref, footerCol3Titletext, footerCol3Titlehref, footerCol3Linkstext, footerCol3Linkshref, footerNewslettertext, footerNewsletterhref, footerInputPlaceholdertext, footerInputPlaceholderhref, footerSendArrowtext, footerSendArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerCol1Titletext, footerCol1Titlehref, footerCol1Linkstext, footerCol1Linkshref, footerCol2Titletext, footerCol2Titlehref, footerCol2Linkstext, footerCol2Linkshref, footerCol3Titletext, footerCol3Titlehref, footerCol3Linkstext, footerCol3Linkshref, footerNewslettertext, footerNewsletterhref, footerInputPlaceholdertext, footerInputPlaceholderhref, footerSendArrowtext, footerSendArrowhref });
