...
const DEFAULT_PROPS = {
  ...
  "heroCatTexttext": "Choose a category"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroBgimagesrc, homeNavbarLogoimagesrc, homeNavbarSearchtext, homeNavbarLangtext, homeNavbarMenutext, heroTitletext, heroCatTexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroBgimagesrc, homeNavbarLogoimagesrc, homeNavbarSearchtext, homeNavbarLangtext, homeNavbarMenutext, heroTitletext, heroCatTexttext });
