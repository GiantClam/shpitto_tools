...
export default function TemplateExclusivePenSiteHomeCtaPromo2penAlt4({ id, promo2imgimagesrc, p2titletext, p2desctext, btn2href, btn2txttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, promo2imgimagesrc, p2titletext, p2desctext, btn2href, btn2txttext });
