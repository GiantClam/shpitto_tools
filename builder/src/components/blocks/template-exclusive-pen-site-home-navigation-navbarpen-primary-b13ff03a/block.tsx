...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-industries-navbar-lang",
      "name": "page-industries-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarLangtext",
      "hrefProp": "pageIndustriesNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-industries-navbar-企业",
      "name": "page-industries-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarText",
      "hrefProp": "pageIndustriesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-industries-navbar-产品",
      "name": "page-industries-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarText2",
      "hrefProp": "pageIndustriesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-industries-navbar-行业",
      "name": "page-industries-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarText3",
      "hrefProp": "pageIndustriesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-industries-navbar-技术",
      "name": "page-industries-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarText4",
      "hrefProp": "pageIndustriesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-industries-navbar-通信",
      "name": "page-industries-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarText5",
      "hrefProp": "pageIndustriesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-industries-navbar-联系方式",
      "name": "page-industries-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarText6",
      "hrefProp": "pageIndustriesNavbarHref"
    },
    {
      "type": "rectangle",
      "id": "page-industries-navbar-menu-hit",
      "name": "page-industries-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-industries-navbar-menu-line1",
      "name": "page-industries-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-industries-navbar-menu-line2",
      "name": "page-industries-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-industries-navbar-menu-line3",
      "name": "page-industries-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-industries-navbar",
  "pageIndustriesNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageIndustriesNavbarLangtext": "ZH",
  "pageIndustriesNavbarLanghref": "/",
  "pageIndustriesNavbarText": "企业",
  "pageIndustriesNavbarHref": "/",
  "pageIndustriesNavbarText2": "产品",
  "pageIndustriesNavbarText3": "行业",
  "pageIndustriesNavbarText4": "技术",
  "pageIndustriesNavbarText5": "通信",
  "pageIndustriesNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #E8C400)";
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageIndustriesNavbarLogoimagesrc, pageIndustriesNavbarLangtext, pageIndustriesNavbarLanghref, pageIndustriesNavbarText, pageIndustriesNavbarHref, pageIndustriesNavbarText2, pageIndustriesNavbarText3, pageIndustriesNavbarText4, pageIndustriesNavbarText5, pageIndustriesNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageIndustriesNavbarLogoimagesrc, pageIndustriesNavbarLangtext, pageIndustriesNavbarLanghref, pageIndustriesNavbarText, pageIndustriesNavbarHref, pageIndustriesNavbarText2, pageIndustriesNavbarText3, pageIndustriesNavbarText4, pageIndustriesNavbarText5, pageIndustriesNavbarText6 });
