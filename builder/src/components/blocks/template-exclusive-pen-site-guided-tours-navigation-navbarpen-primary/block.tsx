...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-guided-tours",
      "name": "header-bg-guided-tours",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-guided-tours",
      "name": "brand-logo-guided-tours",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoGuidedToursimagesrc"
    },
    {
      "type": "text",
      "id": "nav-guided-tours-0",
      "name": "nav-guided-tours-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navGuidedTours0text",
      "hrefProp": "navGuidedTours0href"
    },
    {
      "type": "text",
      "id": "nav-guided-tours-1",
      "name": "nav-guided-tours-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navGuidedTours1text",
      "hrefProp": "navGuidedTours1href"
    },
    {
      "type": "text",
      "id": "nav-guided-tours-2",
      "name": "nav-guided-tours-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navGuidedTours2text",
      "hrefProp": "navGuidedTours2href"
    },
    {
      "type": "text",
      "id": "nav-guided-tours-3",
      "name": "nav-guided-tours-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navGuidedTours3text",
      "hrefProp": "navGuidedTours3href"
    },
    {
      "type": "text",
      "id": "nav-guided-tours-4",
      "name": "nav-guided-tours-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navGuidedTours4text",
      "hrefProp": "navGuidedTours4href"
    },
    {
      "type": "text",
      "id": "nav-guided-tours-5",
      "name": "nav-guided-tours-5",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navGuidedTours5text",
      "hrefProp": "navGuidedTours5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-guided-tours",
      "name": "menu-box-guided-tours",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-guided-tours",
      "name": "menu-line-1-guided-tours",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-guided-tours",
      "name": "menu-line-2-guided-tours",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-guided-tours",
      "name": "menu-line-3-guided-tours",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-guided-tours",
  "brandLogoGuidedToursimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navGuidedTours0text": "Home",
  "navGuidedTours0href": "/",
  "navGuidedTours1text": "History",
  "navGuidedTours1href": "/history",
  "navGuidedTours2text": "Dealers",
  "navGuidedTours2href": "/dealers",
  "navGuidedTours3text": "Tours",
  "navGuidedTours3href": "/guided-tours",
  "navGuidedTours4text": "Utopia",
  "navGuidedTours4href": "/pagani-utopia",
  "navGuidedTours5text": "Contact",
  "navGuidedTours5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteGuidedToursNavigationNavbarpenPrimary({ id, brandLogoGuidedToursimagesrc, navGuidedTours0text, navGuidedTours0href, navGuidedTours1text, navGuidedTours1href, navGuidedTours2text, navGuidedTours2href, navGuidedTours3text, navGuidedTours3href, navGuidedTours4text, navGuidedTours4href, navGuidedTours5text, navGuidedTours5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoGuidedToursimagesrc, navGuidedTours0text, navGuidedTours0href, navGuidedTours1text, navGuidedTours1href, navGuidedTours2text, navGuidedTours2href, navGuidedTours3text, navGuidedTours3href, navGuidedTours4text, navGuidedTours4href, navGuidedTours5text, navGuidedTours5href });
