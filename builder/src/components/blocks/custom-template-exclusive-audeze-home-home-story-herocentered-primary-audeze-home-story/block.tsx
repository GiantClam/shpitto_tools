...
const DEFAULT_PROPS = {
  ...
  "subtitle": "The very finest audio experiences available, our audiophile collection is a showcase for the unbounded inventiveness of our famed engineers and their pursuit of the most natural, l",
  "body": "The very finest audio experiences available, our audiophile collection is a showcase for the unbounded inventiveness of our famed engineers and their pursuit of the most natural, lifelike sound reproduction.",
...
export default function CustomTemplateExclusiveAudezeHomeHomeStoryHerocenteredPrimary_audeze_home_story({
  id,
  anchor,
  variant,
  title,
  ...
  return (
    <section
      ...
      data-block="CustomTemplateExclusiveAudezeHomeHomeStoryHerocenteredPrimary_audeze_home_story"
