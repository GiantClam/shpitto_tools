...
export default function TemplateExclusivePenSiteUtopiaRoadsterNavigationNavbarpenPrimary({ id, brandLogoUtopiaRoadsterimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoUtopiaRoadsterimagesrc });
