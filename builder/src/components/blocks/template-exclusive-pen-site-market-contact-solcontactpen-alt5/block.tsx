...
const DEFAULT_PROPS = {
  ...
  "contacttitletext": "准备好寻找一个致力于您的成功的合作伙伴吗？",
  "contactbtnhref": "/",
...
export default function TemplateExclusivePenSiteMarketContactSolcontactpenAlt5({ id, contactimgimagesrc, contacttagtxttext, contacttitletext, contactbtnhref, contactbtntxttext, ...rest }) {
