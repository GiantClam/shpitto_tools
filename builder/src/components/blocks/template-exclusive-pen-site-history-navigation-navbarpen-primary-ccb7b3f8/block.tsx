...
export default function TemplateExclusivePenSiteHistoryNavigationNavbarpenPrimary({ id, brandLogoHistoryimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoHistoryimagesrc });
