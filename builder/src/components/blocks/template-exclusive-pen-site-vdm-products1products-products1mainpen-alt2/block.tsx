          ...
          "children": [
            {
              ...
              "style": {
                ...
                "width": 160,
                "height": 90,
                "background": "linear-gradient(0deg, #000000ff 0%, #ffffffff 100%)",
                "position": "absolute",
                "left": 230,
                "top": 22
              },
...
export default function TemplateExclusivePenSiteVdmProducts1ProductsProducts1mainpenAlt2({ id, introtitletext, introbodytext, secatext, secabodytext, btnhref, btnttext, secbtext, secbbodytext, li1text, li2text, li3text, li4text, i1imagesrc, t1text, t2text, i3imagesrc, t3text, i4imagesrc, t4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introtitletext, introbodytext, secatext, secabodytext, btnhref, btnttext, secbtext, secbbodytext, li1text, li2text, li3text, li4text, i1imagesrc, t1text, t2text, i3imagesrc, t3text, i4imagesrc, t4text });
