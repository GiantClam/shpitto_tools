...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerCol3text",
      "hrefProp": "footerCol3href"
    }
  ]
};
const DEFAULT_PROPS = {
  ...
  "footerCopyhref": "/",
  "footerCol1text": "SECTORS\nPRODUCTS\nSUPPORT",
  "footerCol1href": "/",
  "footerCol2text": "ABOUT US\nWORLDWIDE\nCONTACT",
  "footerCol2href": "/about-us",
  "footerCol3text": "NEWS\nMEDIA\nCAREERS",
  "footerCol3href": "/"
};
const DEFAULT_THEME = {
...
export default function TemplateExclusivePenSiteSolutionProviderFooterFooterpenAlt1({ id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCol3text, footerCol3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCol3text, footerCol3href });
