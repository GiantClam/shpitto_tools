      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "topmenutext",
          "hrefProp": "topmenuhref"
        },
        {
          "type": "frame",
          "id": "sBTyD",
          ...
          "children": [
            {
              ...
              "children": [],
              "textProp": "navPortfoliotext",
              "hrefProp": "navPortfoliohref"
            },
            {
              "type": "text",
              "id": "aPGHS",
              ...
              "children": [],
              "textProp": "navIndustriestext",
              "hrefProp": "navIndustrieshref"
            },
            {
              "type": "text",
              "id": "J3U9P",
              ...
              "children": [],
              "textProp": "navInnovationtext",
              "hrefProp": "navInnovationhref"
            },
            {
              "type": "text",
              "id": "S9pub",
              ...
              "children": [],
              "textProp": "navSustainabilitytext",
              "hrefProp": "navSustainabilityhref"
            },
            {
              "type": "text",
              "id": "uFemN",
              ...
              "children": [],
              "textProp": "navInvestorstext",
              "hrefProp": "navInvestorshref"
            },
            {
              "type": "text",
              "id": "xTy9o",
              ...
              "children": [],
              "textProp": "navAbouttext",
              "hrefProp": "navAbouthref"
            },
            {
              "type": "text",
              "id": "DYrjQ",
              ...
              "children": [],
              "textProp": "navCareerstext",
              "hrefProp": "navCareershref"
            }
          ]
        }
      ]
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #e3000f)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #000000)";
...
export default function TemplateExclusivePenSiteOerlikonIndustriesNavigationNavcopyapenPrimary({ id, topmenutext, topmenuhref, contactbtnhref, contactdottext, contacttexttext, logotext, logohref, navPortfoliotext, navPortfoliohref, navIndustriestext, navIndustrieshref, navInnovationtext, navInnovationhref, navSustainabilitytext, navSustainabilityhref, navInvestorstext, navInvestorshref, navAbouttext, navAbouthref, navCareerstext, navCareershref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, topmenutext, topmenuhref, contactbtnhref, contactdottext, contacttexttext, logotext, logohref, navPortfoliotext, navPortfoliohref, navIndustriestext, navIndustrieshref, navInnovationtext, navInnovationhref, navSustainabilitytext, navSustainabilityhref, navInvestorstext, navInvestorshref, navAbouttext, navAbouthref, navCareerstext, navCareershref });
