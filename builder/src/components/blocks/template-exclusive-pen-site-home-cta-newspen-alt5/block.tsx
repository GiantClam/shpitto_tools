...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "hrefProp": "news1BtnBoxhref"
    },
    {
      "type": "text",
      "id": "news-1-btn-text",
      "name": "news-1-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "news1BtnTexttext",
      "hrefProp": "news1BtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "news-2-box",
    ...
    },
    {
      ...
      "children": [],
      "hrefProp": "news2BtnBoxhref"
    },
    {
      "type": "text",
      "id": "news-2-btn-text",
      "name": "news-2-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "news2BtnTexttext",
      "hrefProp": "news2BtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "news-3-box",
    ...
    },
    {
      ...
      "children": [],
      "hrefProp": "news3BtnBoxhref"
    },
    {
      "type": "text",
      "id": "news-3-btn-text",
      "name": "news-3-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "news3BtnTexttext",
      "hrefProp": "news3BtnTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "news",
  "newsTitletext": "活动与新闻",
  "news1Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-mecspe.jpg",
  "news1Titletext": "MECSPE 2026",
  "news1Bodytext": "展会与新产品亮点。",
  "news1BtnBoxhref": "/",
  "news1BtnTexttext": "了解更多",
  "news1BtnTexthref": "/",
  "news2Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-warcom.jpg",
  "news2Titletext": "WARCOM AND FPT",
  "news2Bodytext": "共享质量与长期合作。",
  "news2BtnBoxhref": "/",
  "news2BtnTexttext": "了解更多",
  "news2BtnTexthref": "/",
  "news3Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-steelfab.jpg",
  "news3Titletext": "FPT AT STEELFAB",
  "news3Bodytext": "更多展会与活动信息。",
  "news3BtnBoxhref": "/",
  "news3BtnTexttext": "了解更多",
  "news3BtnTexthref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeCtaNewspenAlt5({ id, newsTitletext, news1Imgimagesrc, news1Titletext, news1Bodytext, news1BtnBoxhref, news1BtnTexttext, news1BtnTexthref, news2Imgimagesrc, news2Titletext, news2Bodytext, news2BtnBoxhref, news2BtnTexttext, news2BtnTexthref, news3Imgimagesrc, news3Titletext, news3Bodytext, news3BtnBoxhref, news3BtnTexttext, news3BtnTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newsTitletext, news1Imgimagesrc, news1Titletext, news1Bodytext, news1BtnBoxhref, news1BtnTexttext, news1BtnTexthref, news2Imgimagesrc, news2Titletext, news2Bodytext, news2BtnBoxhref, news2BtnTexttext, news2BtnTexthref, news3Imgimagesrc, news3Titletext, news3Bodytext, news3BtnBoxhref, news3BtnTexttext, news3BtnTexthref });
