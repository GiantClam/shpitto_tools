...
const NAV_ACTIVE_COLOR = "#AEB7C6";
const NAV_INACTIVE_COLOR = "#6B6B70";
...
export default function TemplateExclusiveUnistellarHomeTechnologiesFooterFootpenAlt5({ id, brandtext, contactbtnhref, contacttxttext, col1htext, col1atext, col1ahref, col1btext, col1bhref, col2htext, col2atext, col2ahref, col2btext, col2bhref, copytext, privacytext, legaltext, legalhref, ...rest }) {
