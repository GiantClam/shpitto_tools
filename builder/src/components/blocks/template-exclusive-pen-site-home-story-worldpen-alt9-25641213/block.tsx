...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "worldMapimagesrc"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "world",
  "worldTitletext": "Breton in the world",
  "worldMapimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/map-92fb20e6.jpg"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryWorldpenAlt9({ id, worldTitletext, worldMapimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, worldTitletext, worldMapimagesrc });
