...
const DEFAULT_PROPS = {
  ...
  "t3text": "FAST COMPANY",
  "t4text": "built in",
  "t5text": "Best Companies",
  "t6text": "Newsweek",
  "carttext": "Make history.\nBuild the future of computing.",
  "cardtext": "Join the quantum revolution at IonQ. Meet some of the leaders behind our mission to tackle the world’s toughest problems, and why they chose to work with the brilliant minds at IonQ.",
  "carbtnhref": "/",
  "carbtnttext": "View open positions",
  "carimgimagesrc": "https://images.unsplash.com/photo-1758522965291-36664fbdac9c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxNTI1NDV8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeStoryBlogandawardspenAlt9({ id, tab1text, tab2text, tab3text, headtext, viewbtnhref, viewtxttext, c1ttext, c1mtext, c1rtext, c2ttext, c2mtext, c2rtext, c3ttext, c3mtext, c3rtext, awtitletext, awctltext, t1text, t2text, t3text, t4text, t5text, t6text, carttext, cardtext, carbtnhref, carbtnttext, carimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, tab1text, tab2text, tab3text, headtext, viewbtnhref, viewtxttext, c1ttext, c1mtext, c1rtext, c2ttext, c2mtext, c2rtext, c3ttext, c3mtext, c3rtext, awtitletext, awctltext, t1text, t2text, t3text, t4text, t5text, t6text, carttext, cardtext, carbtnhref, carbtnttext, carimgimagesrc });
