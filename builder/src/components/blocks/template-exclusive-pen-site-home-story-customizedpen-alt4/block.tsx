...
export default function TemplateExclusivePenSiteHomeStoryCustomizedpenAlt4({ id, y4658text, w4sgitext, card1imagesrc, nz2wztext, card2imagesrc, cvugrtext, card3imagesrc, qffxhtext, card4imagesrc, hntlitext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, y4658text, w4sgitext, card1imagesrc, nz2wztext, card2imagesrc, cvugrtext, card3imagesrc, qffxhtext, card4imagesrc, hntlitext });
