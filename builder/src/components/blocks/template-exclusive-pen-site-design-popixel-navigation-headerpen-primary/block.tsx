...
const DEFAULT_PROPS = {
  ...
  "navPageGuideshref": "/guides",
  "navPageDownloadstext": "DOWNLOADS",
  "navPageDownloadshref": "/downloads",
  "navPageDesignstext": "DESIGNS",
  "navPageDesignshref": "/designs",
  "navPageContacttext": "CONTACT",
  "navPageContacthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteDesignPopixelNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageProductstext, navPageProductshref, navPageGuidestext, navPageGuideshref, navPageDownloadstext, navPageDownloadshref, navPageDesignstext, navPageDesignshref, navPageContacttext, navPageContacthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, headerBrandtext, headerBrandhref, navPageProductstext, navPageProductshref, navPageGuidestext, navPageGuideshref, navPageDownloadstext, navPageDownloadshref, navPageDesignstext, navPageDesignshref, navPageContacttext, navPageContacthref });
