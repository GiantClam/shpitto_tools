...
const DEFAULT_PROPS = {
  "id": "footer",
  "footerBrandtext": "Nothing",
  "footerBrandhref": "/",
  "footerTitle0text": "Sections",
  "footerTitle0href": "/",
  "footerBody0text": "Offers Phones",
  "footerBody0href": "/offers",
  "footerTitle1text": "Explore",
  "footerTitle1href": "/",
  "footerBody1text": "Audio Support Centre",
  "footerBody1href": "/audio",
  "footerTitle2text": "Products",
  "footerTitle2href": "/",
  "footerBody2text": "Contact Support Phone (3a) Pro Ear (3)",
  "footerBody2href": "/contact-support",
  "footerCopytext": "Nothing structured clone pen with desktop and mobile page sets.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F4F4F1)";
