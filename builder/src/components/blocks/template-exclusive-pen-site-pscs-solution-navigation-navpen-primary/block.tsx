...
export default function TemplateExclusivePenSitePscsSolutionNavigationNavpenPrimary({ id, jkbzitext, jkbzihref, rpfr2text, rpfr2href, rpepctext, rpepchref, nhthftext, nhthfhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, jkbzitext, jkbzihref, rpfr2text, rpfr2href, rpepctext, rpepchref, nhthftext, nhthfhref });
