...
export default function TemplateExclusiveUnistellarHomeReviewsFooterFootpenAlt4({ id, brandtext, contactbtnhref, contacttxttext, col1htext, col1atext, col1ahref, col1btext, col1bhref, col2htext, col2atext, col2ahref, col2btext, col2bhref, copytext, privacytext, legaltext, legalhref, ...rest }) {
