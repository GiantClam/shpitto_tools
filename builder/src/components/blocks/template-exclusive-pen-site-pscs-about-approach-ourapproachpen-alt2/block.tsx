...
export default function TemplateExclusivePenSitePscsAboutApproachOurapproachpenAlt2({ id, introleadtext, introp1text, introp2text, approachtitletext, approachp1text, approachp2text, flowlabeltext, ggxmctext, rqhctext, emsgrtext, mndsntext, fwftntext, saxjdtext, yddyttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introleadtext, introp1text, introp2text, approachtitletext, approachp1text, approachp2text, flowlabeltext, ggxmctext, rqhctext, emsgrtext, mndsntext, fwftntext, saxjdtext, yddyttext });
