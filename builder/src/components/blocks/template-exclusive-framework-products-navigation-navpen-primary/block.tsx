...
import { renderFrameworkStructuredNav } from "@/components/blocks/_shared/framework-structured-nav";
import {
  ArrowLeft,
  ArrowRight,
  ChevronLeft,
...
export default function TemplateExclusiveFrameworkProductsNavigationNavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
  ...
  return renderFrameworkStructuredNav({
