...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "rightctrlttext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "crurN",
  "newsheadtext": "探索Plexus的其它见解",
  "ni1imagesrc": "https://images.unsplash.com/photo-1704613269725-aabf5a26554c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTU0NzF8&ixlib=rb-4.1.0&q=80&w=1080",
  "nt1text": "World Engineering Day: Engineering with Purpose at Plexus",
  "meta1text": "博客",
  "time1text": "4 分钟阅读",
  "arr1ttext": "→",
  "ni2imagesrc": "https://images.unsplash.com/photo-1583580311636-cf4840c802cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTU0NzJ8&ixlib=rb-4.1.0&q=80&w=1080",
  "nt2text": "Plexus to Present at the Raymond James 47th Annual Institutional Investors Conference",
  "meta2text": "新闻",
  "time2text": "February 23, 2026",
  "arr2ttext": "→",
  "ni3imagesrc": "https://images.unsplash.com/photo-1763739527730-a6a425d17e3a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxOTU0NzN8&ixlib=rb-4.1.0&q=80&w=1080",
  "nt3text": "Product Strategy: The Foundation for Product Success",
  "meta3text": "博客",
  "time3text": "9 分钟阅读",
  "arr3ttext": "→",
  "restagtxttext": "资源",
...
export default function TemplateExclusivePenSiteHomeCtaNewspenAlt5({ id, newsheadtext, ni1imagesrc, nt1text, meta1text, time1text, arr1ttext, ni2imagesrc, nt2text, meta2text, time2text, arr2ttext, ni3imagesrc, nt3text, meta3text, time3text, arr3ttext, restagtxttext, resmoretext, leftctrlttext, rightctrlttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newsheadtext, ni1imagesrc, nt1text, meta1text, time1text, arr1ttext, ni2imagesrc, nt2text, meta2text, time2text, arr2ttext, ni3imagesrc, nt3text, meta3text, time3text, arr3ttext, restagtxttext, resmoretext, leftctrlttext, rightctrlttext });
