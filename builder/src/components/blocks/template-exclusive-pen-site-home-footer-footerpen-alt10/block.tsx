...
export default function TemplateExclusivePenSiteHomeFooterFooterpenAlt10({ id, oiy6ntext, tsjntext, bodyktext, col2ttext, col2thref, nojpwtext, nojpwhref, emdpotext, emdpohref, orh7btext, orh7bhref, tsjzltext, tsjzlhref, kh4ttext, kh4thref, ym8dgtext, ym8dghref, bzr50text, bzr50href, vxyrutext, vxyruhref, a89tctext, a89tchref, dq1qtext, dq1qhref, bpmbgtext, bpmbghref, ipxjftext, ipxjfhref, rcp8vtext, rcp8vhref, dhvhgtext, dhvhghref, ps0z6text, ps0z6href, zqmhktext, zqmhkhref, ehqqtext, ehqqhref, hmvwntext, hmvwnhref, hnrjttext, hnrjthref, rxjytext, rxjyhref, hfjlftext, hfjlfhref, iey8ztext, iey8zhref, gkvjitext, gkvjihref, sgum0text, sgum0href, lgrsntext, lgrsnhref, fetpgtext, fetpghref, tlvdetext, tlvdehref, dfovgtext, dfovghref, socialtext, socialhref, uweqntext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, oiy6ntext, tsjntext, bodyktext, col2ttext, col2thref, nojpwtext, nojpwhref, emdpotext, emdpohref, orh7btext, orh7bhref, tsjzltext, tsjzlhref, kh4ttext, kh4thref, ym8dgtext, ym8dghref, bzr50text, bzr50href, vxyrutext, vxyruhref, a89tctext, a89tchref, dq1qtext, dq1qhref, bpmbgtext, bpmbghref, ipxjftext, ipxjfhref, rcp8vtext, rcp8vhref, dhvhgtext, dhvhghref, ps0z6text, ps0z6href, zqmhktext, zqmhkhref, ehqqtext, ehqqhref, hmvwntext, hmvwnhref, hnrjttext, hnrjthref, rxjytext, rxjyhref, hfjlftext, hfjlfhref, iey8ztext, iey8zhref, gkvjitext, gkvjihref, sgum0text, sgum0href, lgrsntext, lgrsnhref, fetpgtext, fetpghref, tlvdetext, tlvdehref, dfovgtext, dfovghref, socialtext, socialhref, uweqntext });
