...
export default function TemplateExclusivePenSitePscsContactNavigationNavpenPrimary({ id, hwmt6text, hwmt6href, ix2xtext, ix2xhref, ehwrtext, ehwrhref, j2tiptext, j2tiphref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hwmt6text, hwmt6href, ix2xtext, ix2xhref, ehwrtext, ehwrhref, j2tiptext, j2tiphref });
