...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerTitle0text",
      "hrefProp": "footerTitle0href"
    },
    {
      "type": "text",
      "id": "footer-body-0",
      ...
      "children": [],
      "textProp": "footerBody0text",
      "hrefProp": "footerBody0href"
    },
    {
      "type": "text",
      "id": "footer-title-1",
      ...
      "children": [],
      "textProp": "footerTitle1text",
      "hrefProp": "footerTitle1href"
    },
    {
      "type": "text",
      "id": "footer-body-1",
      ...
      "children": [],
      "textProp": "footerBody1text",
      "hrefProp": "footerBody1href"
    },
    {
      "type": "text",
      "id": "footer-title-2",
      ...
      "children": [],
      "textProp": "footerTitle2text",
      "hrefProp": "footerTitle2href"
    },
    {
      "type": "text",
      "id": "footer-body-2",
      ...
      "children": [],
      "textProp": "footerBody2text",
      "hrefProp": "footerBody2href"
    },
    {
      "type": "text",
      "id": "footer-copy",
...
const DEFAULT_PROPS = {
  "id": "footer",
  "footerBrandtext": "Transparent",
  "footerBrandhref": "/",
  "footerTitle0text": "Sections",
  "footerTitle0href": "/",
  "footerBody0text": "All Products Modular System",
  "footerBody0href": "/all-products",
  "footerTitle1text": "Explore",
  "footerTitle1href": "/",
  "footerBody1text": "Sound Room Support",
  "footerBody1href": "/sound-room",
  "footerTitle2text": "Products",
  "footerTitle2href": "/all-products",
  "footerBody2text": "About Transparent Speaker Black Wi‑Fi Transparent Turntable",
  "footerBody2href": "/about",
  "footerCopytext": "Transparent structured clone pen with desktop and mobile page sets.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #D8D5CE)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F4F4EF)";
...
export default function TemplateExclusivePenSiteTransparentSpeakerBlackWiFiFooterFooterpenAlt1({ id, footerBrandtext, footerBrandhref, footerTitle0text, footerTitle0href, footerBody0text, footerBody0href, footerTitle1text, footerTitle1href, footerBody1text, footerBody1href, footerTitle2text, footerTitle2href, footerBody2text, footerBody2href, footerCopytext, footerCopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerBrandtext, footerBrandhref, footerTitle0text, footerTitle0href, footerBody0text, footerBody0href, footerTitle1text, footerTitle1href, footerBody1text, footerBody1href, footerTitle2text, footerTitle2href, footerBody2text, footerBody2href, footerCopytext, footerCopyhref });
