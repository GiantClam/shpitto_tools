...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-footwear-navbar-menu",
      "name": "page-footwear-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageFootwearNavbarMenutext",
      "hrefProp": "pageFootwearNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pageFootwearNavbarMenutext": "☰",
  "pageFootwearNavbarMenuhref": "/",
...
export default function TemplateExclusivePenSiteConsumerFootwearNavigationNavbarpenPrimary({ id, pageFootwearNavbarLogoimagesrc, pageFootwearNavbarMenutext, pageFootwearNavbarMenuhref, pageFootwearNavbarSearchtext, pageFootwearNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageFootwearNavbarLogoimagesrc, pageFootwearNavbarMenutext, pageFootwearNavbarMenuhref, pageFootwearNavbarSearchtext, pageFootwearNavbarSearchhref });
