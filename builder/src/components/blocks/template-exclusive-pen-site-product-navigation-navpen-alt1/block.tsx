...
export default function TemplateExclusivePenSiteProductNavigationNavpenAlt1({ id, vno9vtext, vno9vhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, vno9vtext, vno9vhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref });
