...
export default function TemplateExclusivePenSiteJabilAboutStoryHistorypenAlt4({ id, hbgimagesrc, historyeyebrowtext, historytitletext, historybodytext, historylinktxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hbgimagesrc, historyeyebrowtext, historytitletext, historybodytext, historylinktxttext });
