...
export default function TemplateExclusivePenSiteOerlikonProductsFooterFootercopyppenAlt7({ id, fkd6ttext, cqh9text, vmqhhtext, vmqhhhref, u69t6text, u69t6href, blchntext, blchnhref, htmatext, bluhqtext, c0emtext, c0emhref, zrjwtext, zrjwhref, cu3xbtext, ahhrdtext, ckrbxtext, ckrbxhref, ikct7text, ikct7href, bvxvtext, bvxvhref, bqoltext, qpsztext, owi9ntext, owi9nhref, eey5ttext, eey5thref, kchstext, n6d3qtext, n6d3qhref, h5ditext, k6paftext, z6uxhtext, siowbtext, dz4bbtext, contactbtnhref, contacttexttext, knv5qtext, tqgtdtext, tqgtdhref, kagiotext, kagiohref, gkiv9text, h2f4text, h2f4href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, fkd6ttext, cqh9text, vmqhhtext, vmqhhhref, u69t6text, u69t6href, blchntext, blchnhref, htmatext, bluhqtext, c0emtext, c0emhref, zrjwtext, zrjwhref, cu3xbtext, ahhrdtext, ckrbxtext, ckrbxhref, ikct7text, ikct7href, bvxvtext, bvxvhref, bqoltext, qpsztext, owi9ntext, owi9nhref, eey5ttext, eey5thref, kchstext, n6d3qtext, n6d3qhref, h5ditext, k6paftext, z6uxhtext, siowbtext, dz4bbtext, contactbtnhref, contacttexttext, knv5qtext, tqgtdtext, tqgtdhref, kagiotext, kagiohref, gkiv9text, h2f4text, h2f4href });
