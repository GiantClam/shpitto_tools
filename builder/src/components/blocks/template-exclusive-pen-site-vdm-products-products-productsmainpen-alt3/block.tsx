  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "prodheroimageimagesrc"
    },
    {
      "type": "frame",
      "id": "uPd7J",
...
export default function TemplateExclusivePenSiteVdmProductsProductsProductsmainpenAlt3({ id, prodheroimageimagesrc, biztitletext, bizbodytext, i1imagesrc, t1text, t2text, i3imagesrc, t3text, i4imagesrc, t4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, prodheroimageimagesrc, biztitletext, bizbodytext, i1imagesrc, t1text, t2text, i3imagesrc, t3text, i4imagesrc, t4text });
