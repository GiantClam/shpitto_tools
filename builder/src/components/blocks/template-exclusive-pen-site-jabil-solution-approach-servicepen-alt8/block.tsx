...
export default function TemplateExclusivePenSiteJabilSolutionApproachServicepenAlt8({ id, serviceimgimagesrc, peytext, pl9fytext, psubtext, pbtnhref, pbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, serviceimgimagesrc, peytext, pl9fytext, psubtext, pbtnhref, pbtnttext });
