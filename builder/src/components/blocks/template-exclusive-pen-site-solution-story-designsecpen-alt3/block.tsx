...
const DEFAULT_PROPS = {
  ...
  "dtagtxttext": "解决方案",
  "dtitletext": "设计",
  "ddesctext": "设计是我们产品与客户价值相连的起点。从产品定义到方案验证，Plexus 帮助客户在可制造性的基础上，把创意落地。",
  "cardaimgimagesrc": "https://images.unsplash.com/photo-1577976655502-85300c5ca2cb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDE0MzJ8&ixlib=rb-4.1.0&q=80&w=1080",
  "cardattext": "设计与开发",
  "cardadtext": "提供需求澄清、架构规划、原型验证和可制造性评估。",
  "cardbimgimagesrc": "https://images.unsplash.com/photo-1583199873799-135c4ac1f5cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDE0MzJ8&ixlib=rb-4.1.0&q=80&w=1080",
  "cardbttext": "客户合作",
  "cardbdtext": "将工程能力、交付流程和质量体系与客户目标协同。"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSolutionStoryDesignsecpenAlt3({ id, dtagtxttext, dtitletext, ddesctext, cardaimgimagesrc, cardattext, cardadtext, cardbimgimagesrc, cardbttext, cardbdtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, dtagtxttext, dtitletext, ddesctext, cardaimgimagesrc, cardattext, cardadtext, cardbimgimagesrc, cardbttext, cardbdtext });
