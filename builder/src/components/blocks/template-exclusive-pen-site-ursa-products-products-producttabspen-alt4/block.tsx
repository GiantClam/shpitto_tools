...
export default function TemplateExclusivePenSiteUrsaProductsProductsProducttabspenAlt4({ id, kkcvgtext, pd8zhtext, esxwwtext, czkq5text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, kkcvgtext, pd8zhtext, esxwwtext, czkq5text });
