...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "chat-mobile-label",
      "name": "chat-mobile-label",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "chatMobileLabeltext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "company-profile",
  "profileTitletext": "Breton Company profile",
  "profileCopytext": "Breton is a global industrial group focused on advanced technologies, materials and process innovation, with a strong emphasis on research and long-term partnerships.",
  "profileImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/bio-142e1546.jpg",
  "profileImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/nik-815f020e.jpg",
  "chatMobileLabeltext": "• CHAT WITH US"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryCompanyprofilepenAlt10({ id, profileTitletext, profileCopytext, profileImg0imagesrc, profileImg1imagesrc, chatMobileLabeltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, profileTitletext, profileCopytext, profileImg0imagesrc, profileImg1imagesrc, chatMobileLabeltext });
