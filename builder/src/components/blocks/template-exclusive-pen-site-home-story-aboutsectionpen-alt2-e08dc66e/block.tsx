...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "aboutCtaTexttext",
      "hrefProp": "aboutCtaTexthref"
    },
    {
      "type": "text",
      "id": "about-cta-arrow",
      "name": "about-cta-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "aboutCtaArrowtext",
      "hrefProp": "aboutCtaArrowhref"
    },
    {
      "type": "rectangle",
      "id": "about-image",
      ...
      "children": [],
      "imageProp": "aboutImageimagesrc"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "about-section",
  "aboutKickertext": "OUR STORY",
  "aboutTitletext": "One Italian story, over 90 years of machine-tool expertise.",
  "aboutCopytext": "PAMA is an Italian company that has been present in the machine tool market for over 90 years, known for building large and medium-large units, well appreciated in all sectors where maximum rigidity and high precision are required.",
  "aboutCtaBoxhref": "/",
  "aboutCtaTexttext": "DISCOVER MORE",
  "aboutCtaTexthref": "/",
  "aboutCtaArrowtext": "›",
  "aboutCtaArrowhref": "/",
  "aboutImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/about-77effc9b.jpg"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteHomeStoryAboutsectionpenAlt2({ id, aboutKickertext, aboutTitletext, aboutCopytext, aboutCtaBoxhref, aboutCtaTexttext, aboutCtaTexthref, aboutCtaArrowtext, aboutCtaArrowhref, aboutImageimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, aboutKickertext, aboutTitletext, aboutCopytext, aboutCtaBoxhref, aboutCtaTexttext, aboutCtaTexthref, aboutCtaArrowtext, aboutCtaArrowhref, aboutImageimagesrc });
