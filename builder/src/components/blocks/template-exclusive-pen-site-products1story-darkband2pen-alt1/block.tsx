...
export default function TemplateExclusivePenSiteProducts1StoryDarkband2penAlt1({ id, db2ttext, dbinputtxttext, db2btnhref, dbbtntxttext, dbsubtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, db2ttext, dbinputtxttext, db2btnhref, dbbtntxttext, dbsubtext });
