...
export default function TemplateExclusivePenSiteItalianStyleNavigationNavbarpenPrimary({ id, pageItalianStyleNavbarLogoimagesrc, pageItalianStyleNavbarLangtext, pageItalianStyleNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageItalianStyleNavbarLogoimagesrc, pageItalianStyleNavbarLangtext, pageItalianStyleNavbarLanghref });
