...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-contact-support",
  "name": "Header",
  "style": {
  ...
  "children": [
    ...
    },
    {
      ...
      "hrefProp": "navPageAnnouncementshref"
    },
    {
      "type": "text",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #111111)";
...
export default function TemplateExclusivePenSiteContactSupportNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageProductstext, navPageProductshref, navPageSupporttext, navPageSupporthref, navPageAnnouncementstext, navPageAnnouncementshref, navPageDevelopertext, navPageDeveloperhref, navPageEditionstext, navPageEditionshref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, headerBrandtext, headerBrandhref, navPageProductstext, navPageProductshref, navPageSupporttext, navPageSupporthref, navPageAnnouncementstext, navPageAnnouncementshref, navPageDevelopertext, navPageDeveloperhref, navPageEditionstext, navPageEditionshref });
