...
export default function TemplateExclusivePenSiteResourcesFooterFooterpenAlt1({ id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref, ...rest }) {
