...
export default function TemplateExclusivePenSiteBitNavigationNavbarpenPrimary({ id, pageBitNavbarLogoimagesrc, pageBitNavbarSearchtext, pageBitNavbarSearchhref, pageBitNavbarLangtext, pageBitNavbarLanghref, pageBitNavbarMenutext, pageBitNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageBitNavbarLogoimagesrc, pageBitNavbarSearchtext, pageBitNavbarSearchhref, pageBitNavbarLangtext, pageBitNavbarLanghref, pageBitNavbarMenutext, pageBitNavbarMenuhref });
