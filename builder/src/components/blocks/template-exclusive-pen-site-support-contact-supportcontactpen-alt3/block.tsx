...
export default function TemplateExclusivePenSiteSupportContactSupportcontactpenAlt3({ id, contacttitletext, contactbgimagesrc, contactbtnhref, contactbtnttext, contactbtnthref, qtagtext, qdesctext, ...rest }) {
