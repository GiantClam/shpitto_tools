...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-news-events-navbar-bg",
      "name": "page-news-events-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-news-events-navbar-logo",
      "name": "page-news-events-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 34,
      ...
      "children": [],
      "imageProp": "pageNewsEventsNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-search",
      "name": "page-news-events-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarSearchtext",
      "hrefProp": "pageNewsEventsNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-intl",
      "name": "page-news-events-navbar-intl",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarIntltext",
      "hrefProp": "pageNewsEventsNavbarIntlhref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-design",
      "name": "page-news-events-navbar-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarDesigntext",
      "hrefProp": "pageNewsEventsNavbarDesignhref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-support",
      "name": "page-news-events-navbar-support",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarSupporttext",
      "hrefProp": "pageNewsEventsNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-iso",
      "name": "page-news-events-navbar-iso",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarIsotext",
      "hrefProp": "pageNewsEventsNavbarIsohref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-PLATFORM",
      "name": "page-news-events-navbar-PLATFORM",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarPlatformtext",
      "hrefProp": "pageNewsEventsNavbarPlatformhref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-INDUSTRIES",
      "name": "page-news-events-navbar-INDUSTRIES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarIndustriestext",
      "hrefProp": "pageNewsEventsNavbarIndustrieshref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-PARTNERS",
      "name": "page-news-events-navbar-PARTNERS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarPartnerstext",
      "hrefProp": "pageNewsEventsNavbarPartnershref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-RESOURCES",
      "name": "page-news-events-navbar-RESOURCES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarResourcestext",
      "hrefProp": "pageNewsEventsNavbarResourceshref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-ABOUT",
      "name": "page-news-events-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarAbouttext",
      "hrefProp": "pageNewsEventsNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-news-events-navbar-contact-box",
      "name": "page-news-events-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 40,
    ...
    {
      "type": "text",
      "id": "page-news-events-navbar-contact-text",
      "name": "page-news-events-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarContactTexttext",
      "hrefProp": "pageNewsEventsNavbarContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-news-events-navbar",
  "pageNewsEventsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "pageNewsEventsNavbarSearchtext": "Search...",
  "pageNewsEventsNavbarSearchhref": "/",
  "pageNewsEventsNavbarIntltext": "International",
  "pageNewsEventsNavbarIntlhref": "/",
  "pageNewsEventsNavbarDesigntext": "Design Engine",
  "pageNewsEventsNavbarDesignhref": "/",
  "pageNewsEventsNavbarSupporttext": "Customer Support",
  "pageNewsEventsNavbarSupporthref": "/contact",
  "pageNewsEventsNavbarIsotext": "ISO 9001:2015",
  "pageNewsEventsNavbarIsohref": "/",
  "pageNewsEventsNavbarPlatformtext": "PLATFORM",
  "pageNewsEventsNavbarPlatformhref": "/platform",
  "pageNewsEventsNavbarIndustriestext": "INDUSTRIES",
  "pageNewsEventsNavbarIndustrieshref": "/industries",
  "pageNewsEventsNavbarPartnerstext": "PARTNERS",
  "pageNewsEventsNavbarPartnershref": "/partners",
  "pageNewsEventsNavbarResourcestext": "RESOURCES",
  "pageNewsEventsNavbarResourceshref": "/resources",
  "pageNewsEventsNavbarAbouttext": "ABOUT",
  "pageNewsEventsNavbarAbouthref": "/about",
  "pageNewsEventsNavbarContactTexttext": "CONTACT",
  "pageNewsEventsNavbarContactTexthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteNewsEventsNavigationNavbarpenPrimary({ id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, pageNewsEventsNavbarIntltext, pageNewsEventsNavbarIntlhref, pageNewsEventsNavbarDesigntext, pageNewsEventsNavbarDesignhref, pageNewsEventsNavbarSupporttext, pageNewsEventsNavbarSupporthref, pageNewsEventsNavbarIsotext, pageNewsEventsNavbarIsohref, pageNewsEventsNavbarPlatformtext, pageNewsEventsNavbarPlatformhref, pageNewsEventsNavbarIndustriestext, pageNewsEventsNavbarIndustrieshref, pageNewsEventsNavbarPartnerstext, pageNewsEventsNavbarPartnershref, pageNewsEventsNavbarResourcestext, pageNewsEventsNavbarResourceshref, pageNewsEventsNavbarAbouttext, pageNewsEventsNavbarAbouthref, pageNewsEventsNavbarContactTexttext, pageNewsEventsNavbarContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, pageNewsEventsNavbarIntltext, pageNewsEventsNavbarIntlhref, pageNewsEventsNavbarDesigntext, pageNewsEventsNavbarDesignhref, pageNewsEventsNavbarSupporttext, pageNewsEventsNavbarSupporthref, pageNewsEventsNavbarIsotext, pageNewsEventsNavbarIsohref, pageNewsEventsNavbarPlatformtext, pageNewsEventsNavbarPlatformhref, pageNewsEventsNavbarIndustriestext, pageNewsEventsNavbarIndustrieshref, pageNewsEventsNavbarPartnerstext, pageNewsEventsNavbarPartnershref, pageNewsEventsNavbarResourcestext, pageNewsEventsNavbarResourceshref, pageNewsEventsNavbarAbouttext, pageNewsEventsNavbarAbouthref, pageNewsEventsNavbarContactTexttext, pageNewsEventsNavbarContactTexthref });
