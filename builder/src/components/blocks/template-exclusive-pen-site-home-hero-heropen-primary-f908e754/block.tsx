  ...
  "children": [
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "type": "text",
          "id": "home-navbar-Engineering",
          "name": "home-navbar-Engineering",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "homeNavbarEngineeringtext"
        },
        {
          "type": "text",
          "id": "home-navbar-Products",
          "name": "home-navbar-Products",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "homeNavbarProductstext"
        },
        {
          "type": "text",
          "id": "home-navbar-Services",
          "name": "home-navbar-Services",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "homeNavbarServicestext"
        },
        {
          "type": "text",
          "id": "home-navbar-BIT",
          "name": "home-navbar-BIT",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "homeNavbarBittext"
        },
        {
          "type": "rectangle",
          "id": "home-navbar-lets",
          "name": "home-navbar-lets",
          "style": {
            "boxSizing": "border-box",
            "width": 200,
            "height": 84,
        ...
        {
          "type": "text",
          "id": "home-navbar-lets-t",
          "name": "home-navbar-lets-t",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "chatLabeltext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "hero",
  "heroBgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/breton-real-head.png",
  "homeNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "homeNavbarEngineeringtext": "Engineering",
  "homeNavbarProductstext": "Products",
  "homeNavbarServicestext": "Services",
  "homeNavbarBittext": "BIT",
  "homeNavbarLetsTtext": "Let's talk",
  "homeNavbarSearchtext": "⌕",
  "homeNavbarLangtext": "Language",
  "homeNavbarMenutext": "☰",
  "heroTitletext": "PIONEER IN THE\nDEVELOPMENT OF\nADVANCED\nTECHNOLOGIES\nAND MATERIALS",
  "heroCatArrowtext": "⌄",
  "heroCatLabeltext": "CHOOSE A CATEGORY",
  "chatLabeltext": "• CHAT WITH US"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroBgimagesrc, homeNavbarLogoimagesrc, homeNavbarEngineeringtext, homeNavbarProductstext, homeNavbarServicestext, homeNavbarBittext, homeNavbarLetsTtext, homeNavbarSearchtext, homeNavbarLangtext, homeNavbarMenutext, heroTitletext, heroCatArrowtext, heroCatLabeltext, chatLabeltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroBgimagesrc, homeNavbarLogoimagesrc, homeNavbarEngineeringtext, homeNavbarProductstext, homeNavbarServicestext, homeNavbarBittext, homeNavbarLetsTtext, homeNavbarSearchtext, homeNavbarLangtext, homeNavbarMenutext, heroTitletext, heroCatArrowtext, heroCatLabeltext, chatLabeltext });
