...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-resources-navbar-bg",
      "name": "page-resources-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-resources-navbar-logo",
      "name": "page-resources-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 110,
        "height": 34,
      ...
      "children": [],
      "imageProp": "pageResourcesNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-search",
      "name": "page-resources-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarSearchtext",
      "hrefProp": "pageResourcesNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-intl",
      "name": "page-resources-navbar-intl",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarIntltext",
      "hrefProp": "pageResourcesNavbarIntlhref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-design",
      "name": "page-resources-navbar-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarDesigntext",
      "hrefProp": "pageResourcesNavbarDesignhref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-support",
      "name": "page-resources-navbar-support",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarSupporttext",
      "hrefProp": "pageResourcesNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-iso",
      "name": "page-resources-navbar-iso",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarIsotext",
      "hrefProp": "pageResourcesNavbarIsohref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-PLATFORM",
      "name": "page-resources-navbar-PLATFORM",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarPlatformtext",
      "hrefProp": "pageResourcesNavbarPlatformhref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-INDUSTRIES",
      "name": "page-resources-navbar-INDUSTRIES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarIndustriestext",
      "hrefProp": "pageResourcesNavbarIndustrieshref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-PARTNERS",
      "name": "page-resources-navbar-PARTNERS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarPartnerstext",
      "hrefProp": "pageResourcesNavbarPartnershref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-RESOURCES",
      "name": "page-resources-navbar-RESOURCES",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarResourcestext",
      "hrefProp": "pageResourcesNavbarResourceshref"
    },
    {
      "type": "text",
      "id": "page-resources-navbar-ABOUT",
      "name": "page-resources-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarAbouttext",
      "hrefProp": "pageResourcesNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-resources-navbar-contact-box",
      "name": "page-resources-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 40,
    ...
    {
      "type": "text",
      "id": "page-resources-navbar-contact-text",
      "name": "page-resources-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarContactTexttext",
      "hrefProp": "pageResourcesNavbarContactTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-resources-navbar",
  "pageResourcesNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "pageResourcesNavbarSearchtext": "Search...",
  "pageResourcesNavbarSearchhref": "/",
  "pageResourcesNavbarIntltext": "International",
  "pageResourcesNavbarIntlhref": "/",
  "pageResourcesNavbarDesigntext": "Design Engine",
  "pageResourcesNavbarDesignhref": "/",
  "pageResourcesNavbarSupporttext": "Customer Support",
  "pageResourcesNavbarSupporthref": "/contact",
  "pageResourcesNavbarIsotext": "ISO 9001:2015",
  "pageResourcesNavbarIsohref": "/",
  "pageResourcesNavbarPlatformtext": "PLATFORM",
  "pageResourcesNavbarPlatformhref": "/platform",
  "pageResourcesNavbarIndustriestext": "INDUSTRIES",
  "pageResourcesNavbarIndustrieshref": "/industries",
  "pageResourcesNavbarPartnerstext": "PARTNERS",
  "pageResourcesNavbarPartnershref": "/partners",
  "pageResourcesNavbarResourcestext": "RESOURCES",
  "pageResourcesNavbarResourceshref": "/resources",
  "pageResourcesNavbarAbouttext": "ABOUT",
  "pageResourcesNavbarAbouthref": "/about",
  "pageResourcesNavbarContactTexttext": "CONTACT",
  "pageResourcesNavbarContactTexthref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteResourcesNavigationNavbarpenPrimary({ id, pageResourcesNavbarLogoimagesrc, pageResourcesNavbarSearchtext, pageResourcesNavbarSearchhref, pageResourcesNavbarIntltext, pageResourcesNavbarIntlhref, pageResourcesNavbarDesigntext, pageResourcesNavbarDesignhref, pageResourcesNavbarSupporttext, pageResourcesNavbarSupporthref, pageResourcesNavbarIsotext, pageResourcesNavbarIsohref, pageResourcesNavbarPlatformtext, pageResourcesNavbarPlatformhref, pageResourcesNavbarIndustriestext, pageResourcesNavbarIndustrieshref, pageResourcesNavbarPartnerstext, pageResourcesNavbarPartnershref, pageResourcesNavbarResourcestext, pageResourcesNavbarResourceshref, pageResourcesNavbarAbouttext, pageResourcesNavbarAbouthref, pageResourcesNavbarContactTexttext, pageResourcesNavbarContactTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageResourcesNavbarLogoimagesrc, pageResourcesNavbarSearchtext, pageResourcesNavbarSearchhref, pageResourcesNavbarIntltext, pageResourcesNavbarIntlhref, pageResourcesNavbarDesigntext, pageResourcesNavbarDesignhref, pageResourcesNavbarSupporttext, pageResourcesNavbarSupporthref, pageResourcesNavbarIsotext, pageResourcesNavbarIsohref, pageResourcesNavbarPlatformtext, pageResourcesNavbarPlatformhref, pageResourcesNavbarIndustriestext, pageResourcesNavbarIndustrieshref, pageResourcesNavbarPartnerstext, pageResourcesNavbarPartnershref, pageResourcesNavbarResourcestext, pageResourcesNavbarResourceshref, pageResourcesNavbarAbouttext, pageResourcesNavbarAbouthref, pageResourcesNavbarContactTexttext, pageResourcesNavbarContactTexthref });
