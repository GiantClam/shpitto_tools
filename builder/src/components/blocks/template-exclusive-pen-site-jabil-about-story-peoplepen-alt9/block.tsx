          ...
          "children": [
            {
              ...
              "children": [],
              "textProp": "peoplebtn2ttext"
            }
          ],
          "hrefProp": "peoplebtn2href"
        }
      ]
    },
    {
...
export default function TemplateExclusivePenSiteJabilAboutStoryPeoplepenAlt9({ id, peytext, psubtext, pbodytext, pbtnhref, pbtnttext, peoplebtn2href, peoplebtn2ttext, pimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, peytext, psubtext, pbodytext, pbtnhref, pbtnttext, peoplebtn2href, peoplebtn2ttext, pimgimagesrc });
