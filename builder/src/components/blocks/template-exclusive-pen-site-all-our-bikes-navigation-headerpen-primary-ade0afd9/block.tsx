...
export default function TemplateExclusivePenSiteAllOurBikesNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
