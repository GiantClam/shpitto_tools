...
const DEFAULT_PROPS = {
  "id": "07cxS",
  "sec1titletext": "Land and maritime defense",
  "sec1desctext": "We are driven by a singular mission: to empower those who safeguard our nations and communities. Our resilient technologies are designed with usability in mind, including extreme environments, to integrate seamlessly with military vehicles and vessels, providing reliable tactical connectivity on the move, on land and at sea."
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteApplicationStorySec1penAlt6({ id, sec1titletext, sec1desctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec1titletext, sec1desctext });
