...
export default function TemplateExclusivePenSiteHomeStoryNosingledaypenAlt4({ id, nstitletext, nsheroimagesrc, nstxttext, l1text, l2text, l3text, l4text, l5text, l6text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, nstitletext, nsheroimagesrc, nstxttext, l1text, l2text, l3text, l4text, l5text, l6text });
