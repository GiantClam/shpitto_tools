...
export default function TemplateExclusivePenSiteApplicationContactAppcontactpenAlt1({ id, contacttitletext, contactbgimagesrc, contactbtnhref, contactbtnttext, contactbtnthref, qtagtext, qdesctext, ...rest }) {
