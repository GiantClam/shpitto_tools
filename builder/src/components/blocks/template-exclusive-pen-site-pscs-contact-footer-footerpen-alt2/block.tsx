...
export default function TemplateExclusivePenSitePscsContactFooterFooterpenAlt2({ id, ynjxxtext, zozn6text, zozn6href, zmqvdtext, zmqvdhref, z2ce1text, g2pmtext, g2pmhref, orsltext, v8z7qtext, v8z7qhref, fv5itext, b1dwjtext, b1dwjhref, jccqttext, wvxstext, djftbtext, znvtytext, gq0ytext, eghevtext, h6oxutext, h6oxuhref, is9attext, is9athref, g2mnjtext, g2mnjhref, du1mtext, du1mhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ynjxxtext, zozn6text, zozn6href, zmqvdtext, zmqvdhref, z2ce1text, g2pmtext, g2pmhref, orsltext, v8z7qtext, v8z7qhref, fv5itext, b1dwjtext, b1dwjhref, jccqttext, wvxstext, djftbtext, znvtytext, gq0ytext, eghevtext, h6oxutext, h6oxuhref, is9attext, is9athref, g2mnjtext, g2mnjhref, du1mtext, du1mhref });
