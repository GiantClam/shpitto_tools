...
export default function TemplateExclusivePenSiteSupportCentreNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
