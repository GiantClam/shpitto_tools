...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-huayra-r",
      "name": "header-bg-huayra-r",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-huayra-r",
      "name": "brand-logo-huayra-r",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoHuayraRimagesrc"
    },
    {
      "type": "text",
      "id": "nav-huayra-r-0",
      ...
      "children": [],
      "textProp": "navHuayraR0text",
      "hrefProp": "navHuayraR0href"
    },
    {
      "type": "text",
      "id": "nav-huayra-r-1",
      ...
      "children": [],
      "textProp": "navHuayraR1text",
      "hrefProp": "navHuayraR1href"
    },
    {
      "type": "text",
      "id": "nav-huayra-r-2",
      ...
      "children": [],
      "textProp": "navHuayraR2text",
      "hrefProp": "navHuayraR2href"
    },
    {
      "type": "text",
      "id": "nav-huayra-r-3",
      ...
      "children": [],
      "textProp": "navHuayraR3text",
      "hrefProp": "navHuayraR3href"
    },
    {
      "type": "text",
      "id": "nav-huayra-r-4",
      ...
      "children": [],
      "textProp": "navHuayraR4text",
      "hrefProp": "navHuayraR4href"
    },
    {
      "type": "text",
      "id": "nav-huayra-r-5",
      ...
      "children": [],
      "textProp": "navHuayraR5text",
      "hrefProp": "navHuayraR5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-huayra-r",
      "name": "menu-box-huayra-r",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-huayra-r",
      "name": "menu-line-1-huayra-r",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-huayra-r",
      "name": "menu-line-2-huayra-r",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-huayra-r",
      "name": "menu-line-3-huayra-r",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-huayra-r",
  "brandLogoHuayraRimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navHuayraR0text": "Home",
  "navHuayraR0href": "/",
  "navHuayraR1text": "History",
  "navHuayraR1href": "/history",
  "navHuayraR2text": "Dealers",
  "navHuayraR2href": "/dealers",
  "navHuayraR3text": "Tours",
  "navHuayraR3href": "/guided-tours",
  "navHuayraR4text": "Utopia",
  "navHuayraR4href": "/pagani-utopia",
  "navHuayraR5text": "Contact",
  "navHuayraR5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHuayraRNavigationNavbarpenPrimary({ id, brandLogoHuayraRimagesrc, navHuayraR0text, navHuayraR0href, navHuayraR1text, navHuayraR1href, navHuayraR2text, navHuayraR2href, navHuayraR3text, navHuayraR3href, navHuayraR4text, navHuayraR4href, navHuayraR5text, navHuayraR5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoHuayraRimagesrc, navHuayraR0text, navHuayraR0href, navHuayraR1text, navHuayraR1href, navHuayraR2text, navHuayraR2href, navHuayraR3text, navHuayraR3href, navHuayraR4text, navHuayraR4href, navHuayraR5text, navHuayraR5href });
