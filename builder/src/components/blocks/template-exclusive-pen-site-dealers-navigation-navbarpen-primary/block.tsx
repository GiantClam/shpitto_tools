...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-dealers",
      "name": "header-bg-dealers",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-dealers",
      "name": "brand-logo-dealers",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoDealersimagesrc"
    },
    {
      "type": "text",
      "id": "nav-dealers-0",
      ...
      "children": [],
      "textProp": "navDealers0text",
      "hrefProp": "navDealers0href"
    },
    {
      "type": "text",
      "id": "nav-dealers-1",
      ...
      "children": [],
      "textProp": "navDealers1text",
      "hrefProp": "navDealers1href"
    },
    {
      "type": "text",
      "id": "nav-dealers-2",
      ...
      "children": [],
      "textProp": "navDealers2text",
      "hrefProp": "navDealers2href"
    },
    {
      "type": "text",
      "id": "nav-dealers-3",
      ...
      "children": [],
      "textProp": "navDealers3text",
      "hrefProp": "navDealers3href"
    },
    {
      "type": "text",
      "id": "nav-dealers-4",
      ...
      "children": [],
      "textProp": "navDealers4text",
      "hrefProp": "navDealers4href"
    },
    {
      "type": "text",
      "id": "nav-dealers-5",
      ...
      "children": [],
      "textProp": "navDealers5text",
      "hrefProp": "navDealers5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-dealers",
      "name": "menu-box-dealers",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-dealers",
      "name": "menu-line-1-dealers",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-dealers",
      "name": "menu-line-2-dealers",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-dealers",
      "name": "menu-line-3-dealers",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-dealers",
  "brandLogoDealersimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navDealers0text": "Home",
  "navDealers0href": "/",
  "navDealers1text": "History",
  "navDealers1href": "/history",
  "navDealers2text": "Dealers",
  "navDealers2href": "/dealers",
  "navDealers3text": "Tours",
  "navDealers3href": "/guided-tours",
  "navDealers4text": "Utopia",
  "navDealers4href": "/pagani-utopia",
  "navDealers5text": "Contact",
  "navDealers5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteDealersNavigationNavbarpenPrimary({ id, brandLogoDealersimagesrc, navDealers0text, navDealers0href, navDealers1text, navDealers1href, navDealers2text, navDealers2href, navDealers3text, navDealers3href, navDealers4text, navDealers4href, navDealers5text, navDealers5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoDealersimagesrc, navDealers0text, navDealers0href, navDealers1text, navDealers1href, navDealers2text, navDealers2href, navDealers3text, navDealers3href, navDealers4text, navDealers4href, navDealers5text, navDealers5href });
