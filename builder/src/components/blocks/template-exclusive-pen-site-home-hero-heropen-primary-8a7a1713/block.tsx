    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "children": [],
          "textProp": "navPageOfferstext"
        },
        {
          "type": "text",
          "id": "nav-page-phones",
          "name": "nav-page-phones",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
        ...
        },
        {
          ...
          "children": [],
          "textProp": "navPageAudiotext"
        },
        {
          "type": "text",
          "id": "nav-page-support-centre",
          "name": "nav-page-support-centre",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageSupportCentretext"
        },
        {
          "type": "text",
          "id": "nav-page-contact-support",
          "name": "nav-page-contact-support",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageContactSupporttext"
        }
      ]
    },
    {
...
const DEFAULT_PROPS = {
  "id": "hero",
  "heroImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/nothing-tech/page-home-img-2-3285f3b8.jpg",
  "headerBrandtext": "Nothing",
  "navPageOfferstext": "OFFERS",
  "navPagePhonestext": "PHONES",
  "navPageAudiotext": "AUDIO",
  "navPageSupportCentretext": "SUPPORT CENTRE",
  "navPageContactSupporttext": "CONTACT SUPPORT",
  "heroKickertext": "NOTHING",
  "heroTitletext": "Tech that feels playful again",
  "heroSubtitletext": "phones, audio and support systems shaped by a clear visual identity and stripped-back industrial design.",
  "heroPrimaryTexttext": "Phones",
  "heroSecondaryTexttext": "Support Centre"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroImageimagesrc, headerBrandtext, navPageOfferstext, navPagePhonestext, navPageAudiotext, navPageSupportCentretext, navPageContactSupporttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroImageimagesrc, headerBrandtext, navPageOfferstext, navPagePhonestext, navPageAudiotext, navPageSupportCentretext, navPageContactSupporttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext });
