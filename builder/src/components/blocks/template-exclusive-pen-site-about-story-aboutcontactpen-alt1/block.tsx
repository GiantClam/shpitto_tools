...
const DEFAULT_PROPS = {
  ...
  "contacttitletext": "在Plexus，您的成功就是我们的承诺。",
  "contactbtnhref": "/",
...
export default function TemplateExclusivePenSiteAboutStoryAboutcontactpenAlt1({ id, contactimgimagesrc, contacttagtxttext, contacttitletext, contactbtnhref, contactbtntxttext, ...rest }) {
