  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "mdconnectimageimagesrc"
    },
    {
      "type": "frame",
      "id": "vnJyK",
          ...
          "children": [
            {
              ...
              "children": [],
              "textProp": "mdconnectbtntxttext"
            }
          ],
          "hrefProp": "mdconnectbtnhref"
        }
      ]
    }
  ]
...
const DEFAULT_PROPS = {
  "id": "kLerZ",
  "mdconnectimageimagesrc": "https://images.unsplash.com/photo-1654949003341-428579eb4a1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzIyMDgwNzh8&ixlib=rb-4.1.0&q=80&w=1080",
  "mdconnectktext": "MASTER & DYNAMIC APP",
  "mdconnectttext": "Fine-tune Your Sound With Personalized EQ",
  "mdconnectdtext": "Adjust ANC levels, update firmware, and create custom sound profiles for every listening environment.",
  "mdconnectbtnhref": "/download-app",
  "mdconnectbtntxttext": "Download App"
};
...
export default function TemplateExclusivePenSiteHomeStoryMdconnectpenAlt5({ id, mdconnectimageimagesrc, mdconnectktext, mdconnectttext, mdconnectdtext, mdconnectbtnhref, mdconnectbtntxttext, ...rest }) {
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, mdconnectimageimagesrc, mdconnectktext, mdconnectttext, mdconnectdtext, mdconnectbtnhref, mdconnectbtntxttext });
