...
export default function TemplateExclusivePenSiteSandvikNewsNavigationHeadpenPrimary({ id, logotext, logohref, navtext, navhref, actionstext, actionshref, searchtxttext, searchtxthref, loginbtnhref, logintxttext, logintxthref, ...rest }) {
