...
export default function TemplateExclusivePenSiteSupportNavigationNavbarpenPrimary({ id, pageSupportNavbarLogoimagesrc, pageSupportNavbarContactTexttext, pageSupportNavbarContactTexthref, pageSupportNavbarContactArrowtext, pageSupportNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageSupportNavbarLogoimagesrc, pageSupportNavbarContactTexttext, pageSupportNavbarContactTexthref, pageSupportNavbarContactArrowtext, pageSupportNavbarContactArrowhref });
