...
export default function TemplateExclusivePenSiteHomeStoryWorldwidepenAlt5({ id, wttext, wstext, wdtext, wb1ttext, wb2ttext, wb3ttext, wb4ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, wttext, wstext, wdtext, wb1ttext, wb2ttext, wb3ttext, wb4ttext });
