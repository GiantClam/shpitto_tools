...
export default function TemplateExclusiveUnistellarHomeUseCasesHeroUsecaseheropenAlt1({ id, herotagtxttext, herotitletext, herosubtext, ctaprimarytxttext, ctaprimaryhref, ctasecondarytxttext, ctasecondaryhref, trustchip1txttext, trustchip1href, trustchip2txttext, trustchip2href, trustchip3txttext, trustchip3href, heromediaimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotagtxttext, herotitletext, herosubtext, ctaprimarytxttext, ctaprimaryhref, ctasecondarytxttext, ctasecondaryhref, trustchip1txttext, trustchip1href, trustchip2txttext, trustchip2href, trustchip3txttext, trustchip3href, heromediaimagesrc });
