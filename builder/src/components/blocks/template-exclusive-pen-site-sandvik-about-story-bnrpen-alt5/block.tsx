...
const SECTION_TREE = {
  ...
  "children": [],
  "imageProp": "bnrimagesrc"
};
const DEFAULT_PROPS = {
  "id": "60KHG",
  "bnrimagesrc": "https://images.unsplash.com/photo-1760122534307-8822d17819b0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMzA4MjV8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSandvikAboutStoryBnrpenAlt5({ id, bnrimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, bnrimagesrc });
