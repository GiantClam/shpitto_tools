...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "infotexttext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "ZDTmw",
  "pagetitletext": "Contact IonQ",
  "pagesubtext": "To send us a message, please fill out the form below.",
  "lab1text": "Your name",
  "ph1text": "Enter full name",
  "lab2text": "Your email",
  "ph2text": "Enter email",
  "lab3text": "How can we help?",
  "ph3text": "Your message",
  "remaintext": "256 characters remaining",
  "agreetext": "I agree to receive periodic updates from IonQ about its hardware, services, and other programs.",
  "btnhref": "/contact",
  "btnttext": "Contact us",
  "infotitletext": "Contact info",
  "infotexttext": "For general inquiries, you can also email info@ionq.com\n\nFor media inquiries, visit our newsroom or email media@ionq.com\n\nFor employment inquiries, view currently open positions or contact jobs@ionq.com\n\nOur mailing address:\n\nIonQ, Inc.\n4505 Campus Drive\nCollege Park, MD 20740"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteContactContactContactmainpenAlt2({ id, pagetitletext, pagesubtext, lab1text, ph1text, lab2text, ph2text, lab3text, ph3text, remaintext, agreetext, btnhref, btnttext, infotitletext, infotexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagetitletext, pagesubtext, lab1text, ph1text, lab2text, ph2text, lab3text, ph3text, remaintext, agreetext, btnhref, btnttext, infotitletext, infotexttext });
