...
export default function TemplateExclusivePenSitePscsAboutStoryAwardspenAlt3({ id, ypnlztext, gzme4text, w4kp1text, btklhtext, s6nzvtext, kahnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ypnlztext, gzme4text, w4kp1text, btklhtext, s6nzvtext, kahnttext });
