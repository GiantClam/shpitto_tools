...
export default function TemplateExclusivePenSiteUrsaNewsApproachFeaturednewspenAlt3({ id, nx0wimagesrc, djv3etext, w7yystext, hbsqdtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, nx0wimagesrc, djv3etext, w7yystext, hbsqdtext });
