  ...
  "children": [
    ...
    },
    {
      ...
      "style": {
        ...
        "fontWeight": "600",
        "position": "absolute",
        "left": 683.0044958443526,
        "top": 497
      },
      "children": [],
      "textProp": "sec1btnttext",
      "hrefProp": "sec1btnthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "TS2YU",
  "sec1titletext": "Resilient connectivity for\nmission-critical operations",
  "sec1desctext": "For vital operations in any dynamic environment, connectivity is more than advantageous-it’s a necessity. Our cutting-edge metamaterial-based technology, hybrid multi-network, multi-orbit and software-defined solutions provide military-grade reliability and security, ensuring unparalleled operational mobility, simplicity, and resilience. Experience the freedom of solutions that adapt to your environment and evolve with your needs, keeping you connected anytime, anywhere.",
  "sec1btnhref": "/",
  "sec1btnttext": "Why Kymeta",
  "sec1btnthref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #263B66)";
...
export default function TemplateExclusivePenSiteHomeStorySec1penAlt2({ id, sec1titletext, sec1desctext, sec1btnhref, sec1btnttext, sec1btnthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec1titletext, sec1desctext, sec1btnhref, sec1btnttext, sec1btnthref });
