...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-warcom-news-navbar-bg",
      "name": "page-warcom-news-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 86,
    ...
    {
      "type": "rectangle",
      "id": "page-warcom-news-navbar-logo",
      "name": "page-warcom-news-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 64,
      ...
      "children": [],
      "imageProp": "pageWarcomNewsNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-lang",
      "name": "page-warcom-news-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarLangtext",
      "hrefProp": "pageWarcomNewsNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-企业",
      "name": "page-warcom-news-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarText",
      "hrefProp": "pageWarcomNewsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-产品",
      "name": "page-warcom-news-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarText2",
      "hrefProp": "pageWarcomNewsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-行业",
      "name": "page-warcom-news-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarText3",
      "hrefProp": "pageWarcomNewsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-技术",
      "name": "page-warcom-news-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarText4",
      "hrefProp": "pageWarcomNewsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-通信",
      "name": "page-warcom-news-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarText5",
      "hrefProp": "pageWarcomNewsNavbarHref"
    },
    {
      "type": "text",
      "id": "page-warcom-news-navbar-联系方式",
      "name": "page-warcom-news-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageWarcomNewsNavbarText6",
      "hrefProp": "pageWarcomNewsNavbarHref"
    },
    {
      "type": "rectangle",
      "id": "page-warcom-news-navbar-menu-hit",
      "name": "page-warcom-news-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-warcom-news-navbar-menu-line1",
      "name": "page-warcom-news-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-warcom-news-navbar-menu-line2",
      "name": "page-warcom-news-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-warcom-news-navbar-menu-line3",
      "name": "page-warcom-news-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-warcom-news-navbar",
  "pageWarcomNewsNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageWarcomNewsNavbarLangtext": "ZH",
  "pageWarcomNewsNavbarLanghref": "/",
  "pageWarcomNewsNavbarText": "企业",
  "pageWarcomNewsNavbarHref": "/",
  "pageWarcomNewsNavbarText2": "产品",
  "pageWarcomNewsNavbarText3": "行业",
  "pageWarcomNewsNavbarText4": "技术",
  "pageWarcomNewsNavbarText5": "通信",
  "pageWarcomNewsNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteWarcomNewsNavigationNavbarpenPrimary({ id, pageWarcomNewsNavbarLogoimagesrc, pageWarcomNewsNavbarLangtext, pageWarcomNewsNavbarLanghref, pageWarcomNewsNavbarText, pageWarcomNewsNavbarHref, pageWarcomNewsNavbarText2, pageWarcomNewsNavbarText3, pageWarcomNewsNavbarText4, pageWarcomNewsNavbarText5, pageWarcomNewsNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageWarcomNewsNavbarLogoimagesrc, pageWarcomNewsNavbarLangtext, pageWarcomNewsNavbarLanghref, pageWarcomNewsNavbarText, pageWarcomNewsNavbarHref, pageWarcomNewsNavbarText2, pageWarcomNewsNavbarText3, pageWarcomNewsNavbarText4, pageWarcomNewsNavbarText5, pageWarcomNewsNavbarText6 });
