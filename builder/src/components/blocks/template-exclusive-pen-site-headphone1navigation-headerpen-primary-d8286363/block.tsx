...
export default function TemplateExclusivePenSiteHeadphone1NavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
