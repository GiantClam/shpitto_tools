...
export default function TemplateExclusiveUnistellarHomeUseCasesFooterBottomctapenAlt4({ id, bottomCtahref, ctatitletext, ctasubtext, ctabtntxttext, ctabtntxthref, ctabtnhref, ctachip1txttext, ctachip1href, ctachip2txttext, ctachip2href, ctachip3txttext, ctachip3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, bottomCtahref, ctatitletext, ctasubtext, ctabtntxttext, ctabtntxthref, ctabtnhref, ctachip1txttext, ctachip1href, ctachip2txttext, ctachip2href, ctachip3txttext, ctachip3href });
