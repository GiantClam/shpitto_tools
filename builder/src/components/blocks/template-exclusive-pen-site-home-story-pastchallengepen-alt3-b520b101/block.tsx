...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "timeline-bg-overlay",
      "name": "timeline-bg-overlay",
      "style": {
        "boxSizing": "border-box",
        "width": 390,
        "height": 760,
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "timelineImageimagesrc"
    },
    {
      "type": "rectangle",
      "id": "timeline-line",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "timelineYear0text"
    },
    {
      "type": "text",
      "id": "timeline-year-1",
      "name": "timeline-year-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "timelineYear1text"
    },
    {
      "type": "text",
      "id": "timeline-year-2",
      "name": "timeline-year-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "timelineYear2text"
    },
    {
      "type": "text",
      "id": "timeline-year-3",
      "name": "timeline-year-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "timelineYear3text"
    },
    {
      "type": "text",
      "id": "timeline-year-4",
      "name": "timeline-year-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "timelineYear4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "past-challenge",
  "timelineTitletext": "The boy who wanted to create the most beautiful car in the world.",
  "timelineQuotetext": "\"When you point a visionary bow to a star and let yourself float on the wings of the dream towards an unpredictable destination, thirsty of perfection and rebel to mediocrity, you carry with you the mysterious spring of an ideal.\"\nJosé Ingenieros, Argentinian writer",
  "timelineReadtext": "READ MORE",
  "timelineImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/timeline-boy.jpg",
  "timelineYear0text": "1955",
  "timelineYear1text": "1967",
  "timelineYear2text": "1971",
  "timelineYear3text": "1972",
  "timelineYear4text": "1974-75"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryPastchallengepenAlt3({ id, timelineTitletext, timelineQuotetext, timelineReadtext, timelineImageimagesrc, timelineYear0text, timelineYear1text, timelineYear2text, timelineYear3text, timelineYear4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, timelineTitletext, timelineQuotetext, timelineReadtext, timelineImageimagesrc, timelineYear0text, timelineYear1text, timelineYear2text, timelineYear3text, timelineYear4text });
