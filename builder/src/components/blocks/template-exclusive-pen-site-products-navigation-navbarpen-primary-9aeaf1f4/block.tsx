...
export default function TemplateExclusivePenSiteProductsNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarContactTexttext, pageProductsNavbarContactTexthref, pageProductsNavbarContactArrowtext, pageProductsNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarContactTexttext, pageProductsNavbarContactTexthref, pageProductsNavbarContactArrowtext, pageProductsNavbarContactArrowhref });
