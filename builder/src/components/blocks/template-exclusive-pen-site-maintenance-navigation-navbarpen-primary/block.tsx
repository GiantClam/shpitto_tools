...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-bg",
      "name": "page-maintenance-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-logo",
      "name": "page-maintenance-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pageMaintenanceNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-maintenance-navbar-SECTORS",
      "name": "page-maintenance-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageMaintenanceNavbarSectorstext",
      "hrefProp": "pageMaintenanceNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-maintenance-navbar-PRODUCTS",
      "name": "page-maintenance-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageMaintenanceNavbarProductstext",
      "hrefProp": "pageMaintenanceNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-maintenance-navbar-SUPPORT",
      "name": "page-maintenance-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageMaintenanceNavbarSupporttext",
      "hrefProp": "pageMaintenanceNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-maintenance-navbar-ABOUT",
      "name": "page-maintenance-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageMaintenanceNavbarAbouttext",
      "hrefProp": "pageMaintenanceNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-contact-box",
      "name": "page-maintenance-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-maintenance-navbar-contact-text",
      "name": "page-maintenance-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageMaintenanceNavbarContactTexttext",
      "hrefProp": "pageMaintenanceNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-maintenance-navbar-contact-arrow",
      "name": "page-maintenance-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageMaintenanceNavbarContactArrowtext",
      "hrefProp": "pageMaintenanceNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-menu-hit",
      "name": "page-maintenance-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-menu-line1",
      "name": "page-maintenance-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-menu-line2",
      "name": "page-maintenance-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-maintenance-navbar-menu-line3",
      "name": "page-maintenance-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-maintenance-navbar",
  "pageMaintenanceNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageMaintenanceNavbarSectorstext": "SECTORS",
  "pageMaintenanceNavbarSectorshref": "/",
  "pageMaintenanceNavbarProductstext": "PRODUCTS",
  "pageMaintenanceNavbarProductshref": "/products",
  "pageMaintenanceNavbarSupporttext": "SUPPORT",
  "pageMaintenanceNavbarSupporthref": "/support",
  "pageMaintenanceNavbarAbouttext": "ABOUT",
  "pageMaintenanceNavbarAbouthref": "/about-us",
  "pageMaintenanceNavbarContactTexttext": "CONTACT",
  "pageMaintenanceNavbarContactTexthref": "/contact-us",
  "pageMaintenanceNavbarContactArrowtext": "›",
  "pageMaintenanceNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteMaintenanceNavigationNavbarpenPrimary({ id, pageMaintenanceNavbarLogoimagesrc, pageMaintenanceNavbarSectorstext, pageMaintenanceNavbarSectorshref, pageMaintenanceNavbarProductstext, pageMaintenanceNavbarProductshref, pageMaintenanceNavbarSupporttext, pageMaintenanceNavbarSupporthref, pageMaintenanceNavbarAbouttext, pageMaintenanceNavbarAbouthref, pageMaintenanceNavbarContactTexttext, pageMaintenanceNavbarContactTexthref, pageMaintenanceNavbarContactArrowtext, pageMaintenanceNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageMaintenanceNavbarLogoimagesrc, pageMaintenanceNavbarSectorstext, pageMaintenanceNavbarSectorshref, pageMaintenanceNavbarProductstext, pageMaintenanceNavbarProductshref, pageMaintenanceNavbarSupporttext, pageMaintenanceNavbarSupporthref, pageMaintenanceNavbarAbouttext, pageMaintenanceNavbarAbouthref, pageMaintenanceNavbarContactTexttext, pageMaintenanceNavbarContactTexthref, pageMaintenanceNavbarContactArrowtext, pageMaintenanceNavbarContactArrowhref });
