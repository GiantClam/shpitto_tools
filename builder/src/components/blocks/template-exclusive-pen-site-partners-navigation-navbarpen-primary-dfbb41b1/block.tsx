...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-partners-navbar-menu",
      "name": "page-partners-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pagePartnersNavbarMenutext",
      "hrefProp": "pagePartnersNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pagePartnersNavbarMenutext": "☰",
  "pagePartnersNavbarMenuhref": "/",
  "pagePartnersNavbarSearchtext": "⌕",
...
export default function TemplateExclusivePenSitePartnersNavigationNavbarpenPrimary({ id, pagePartnersNavbarLogoimagesrc, pagePartnersNavbarMenutext, pagePartnersNavbarMenuhref, pagePartnersNavbarSearchtext, pagePartnersNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagePartnersNavbarLogoimagesrc, pagePartnersNavbarMenutext, pagePartnersNavbarMenuhref, pagePartnersNavbarSearchtext, pagePartnersNavbarSearchhref });
