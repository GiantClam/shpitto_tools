...
export default function TemplateExclusivePenSiteAboutFooterFooterpenAlt2({ id, vlbrhtext, imz8dtext, imz8dhref, zr0text, mbhbtext, mbhbhref, wer5jtext, hy3sbtext, hy3sbhref, iuru3text, g0outext, g0ouhref, nzlvptext, qjmimtext, qjmimhref, lsxlstext, xz2obhref, zelqitext, vb8xtext, lwirdtext, ...rest }) {
