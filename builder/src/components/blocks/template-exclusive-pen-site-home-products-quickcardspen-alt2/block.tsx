...
export default function TemplateExclusivePenSiteHomeProductsQuickcardspenAlt2({ id, qc1ktext, qc1ttext, qc4ktext, qc2ktext, qc2ttext, qc4ktext2, qc3ktext, qc3ttext, qc4ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, qc1ktext, qc1ttext, qc4ktext, qc2ktext, qc2ttext, qc4ktext2, qc3ktext, qc3ttext, qc4ttext });
