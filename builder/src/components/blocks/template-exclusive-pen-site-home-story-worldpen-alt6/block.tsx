...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "worldBtnTexttext",
      "hrefProp": "worldBtnTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "world",
  "worldTitletext": "FPT 世界",
  "worldCopytext": "FPT 的国际销售和售后网络覆盖 40 多个国家。每天有 300 多名代理商为集团国际成功做出贡献。",
  "worldStat1text": "56",
  "worldStat1Ltext": "年份",
  "worldStat2text": "76500",
  "worldStat2Ltext": "平方米",
  "worldStat3text": "410",
  "worldStat3Ltext": "人员",
  "worldStat4text": "40",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #3E4248)";
...
export default function TemplateExclusivePenSiteHomeStoryWorldpenAlt6({ id, worldTitletext, worldCopytext, worldStat1text, worldStat1Ltext, worldStat2text, worldStat2Ltext, worldStat3text, worldStat3Ltext, worldStat4text, worldStat4Ltext, worldBtnBoxhref, worldBtnTexttext, worldBtnTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, worldTitletext, worldCopytext, worldStat1text, worldStat1Ltext, worldStat2text, worldStat2Ltext, worldStat3text, worldStat3Ltext, worldStat4text, worldStat4Ltext, worldBtnBoxhref, worldBtnTexttext, worldBtnTexthref });
