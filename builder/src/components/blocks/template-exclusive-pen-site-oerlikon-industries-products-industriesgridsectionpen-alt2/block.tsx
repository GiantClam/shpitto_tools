...
const SECTION_TREE = {
  "type": "frame",
  "id": "zeSeg",
  "name": "Industries Grid Section",
  "style": {
    "boxSizing": "border-box",
    "display": "flex",
    "flexDirection": "column",
    "gap": 8,
    "padding": "20px 86px 24px 86px",
    "width": "100%",
    "background": "#f4f4f4"
  },
  "children": [
...
export default function TemplateExclusivePenSiteOerlikonIndustriesProductsIndustriesgridsectionpenAlt2({ id, t11text, d11text, t12text, d12text, t21text, d21text, t22text, d22text, t31text, d31text, t32text, d32text, t41text, d41text, t42text, d42text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, t11text, d11text, t12text, d12text, t21text, d21text, t22text, d22text, t31text, d31text, t32text, d32text, t41text, d41text, t42text, d42text });
