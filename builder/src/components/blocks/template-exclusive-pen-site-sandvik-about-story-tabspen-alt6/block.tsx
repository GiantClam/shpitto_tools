...
const DEFAULT_PROPS = {
  ...
  "hqgqntext": "可持续发展",
  "txqptext": "我们做什么",
  "mwytptext": "我们的核心业务是向全世界工程应用行业供应刀具解决方案。但这只是我们所做工作的一个方面。凭借我们共享者的积极参与，我们开发出各种先进技术，用以提升生产率、定制能够消除障碍的服务和程序，并设计符合具体需求的刀具。",
  "egqqrtext": "了解更多  ›"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteSandvikAboutStoryTabspenAlt6({ id, t1text, t2text, t3text, t4text, lwtpqtext, fjqutext, hqgqntext, txqptext, mwytptext, egqqrtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, t1text, t2text, t3text, t4text, lwtpqtext, fjqutext, hqgqntext, txqptext, mwytptext, egqqrtext });
