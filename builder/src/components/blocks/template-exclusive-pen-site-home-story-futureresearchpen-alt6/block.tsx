...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "future-research-bg",
      "name": "future-research-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 820,
      ...
      "children": [],
      "imageProp": "futureResearchBgimagesrc"
    },
    {
      "type": "rectangle",
      "id": "future-research-shade",
      "name": "future-research-shade",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 820,
    ...
    {
      "type": "rectangle",
      "id": "future-research-shell",
      "name": "future-research-shell",
      "style": {
        "boxSizing": "border-box",
        "width": 760,
        "height": 300,
    ...
    {
      "type": "text",
      "id": "future-research-chapter",
      "name": "future-research-chapter",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchChaptertext"
    },
    {
      "type": "text",
      "id": "future-research-count",
      "name": "future-research-count",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchCounttext"
    },
    {
      "type": "text",
      "id": "future-research-title",
      "name": "future-research-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchTitletext"
    },
    {
      "type": "text",
      "id": "future-research-body",
      "name": "future-research-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchBodytext"
    },
    {
      "type": "rectangle",
      "id": "future-research-nav-chip-0",
      "name": "future-research-nav-chip-0",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-research-nav-chip-text-0",
      "name": "future-research-nav-chip-text-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchNavChipText0text"
    },
    {
      "type": "rectangle",
      "id": "future-research-nav-chip-1",
      "name": "future-research-nav-chip-1",
      "style": {
        "boxSizing": "border-box",
    ...
    {
      "type": "text",
      "id": "future-research-nav-chip-text-1",
      "name": "future-research-nav-chip-text-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
        ...
        "fontSize": 11,
        "fontWeight": "400",
        "width": 98.39999999999999,
        "position": "absolute",
        "left": 162,
        "top": 457
      },
      "children": [],
      "textProp": "futureResearchNavChipText1text"
    },
    {
      "type": "rectangle",
      "id": "future-research-nav-chip-2",
      "name": "future-research-nav-chip-2",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-research-nav-chip-text-2",
      "name": "future-research-nav-chip-text-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchNavChipText2text"
    },
    {
      "type": "rectangle",
      "id": "future-research-nav-chip-3",
      "name": "future-research-nav-chip-3",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-research-nav-chip-text-3",
      "name": "future-research-nav-chip-text-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchNavChipText3text"
    },
    {
      "type": "rectangle",
      "id": "future-research-nav-chip-4",
      "name": "future-research-nav-chip-4",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-research-nav-chip-text-4",
      "name": "future-research-nav-chip-text-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureResearchNavChipText4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "future-research",
  "futureResearchBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/future-research.jpg",
  "futureResearchChaptertext": "Future",
  "futureResearchCounttext": "2 / 5",
  "futureResearchTitletext": "The Research",
  "futureResearchBodytext": "It is the quest for perfection that drives man to go beyond his limits and exceed, the science to rewrite its rules and the car to evolve constantly, in what can be defined as an ongoing challenge between intellect and creativity.",
  "futureResearchNavChipText0text": "Intro",
  "futureResearchNavChipText1text": "The Research",
  "futureResearchNavChipText2text": "Beauty",
  "futureResearchNavChipText3text": "The Dream",
  "futureResearchNavChipText4text": "Certainty"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryFutureresearchpenAlt6({ id, futureResearchBgimagesrc, futureResearchChaptertext, futureResearchCounttext, futureResearchTitletext, futureResearchBodytext, futureResearchNavChipText0text, futureResearchNavChipText1text, futureResearchNavChipText2text, futureResearchNavChipText3text, futureResearchNavChipText4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, futureResearchBgimagesrc, futureResearchChaptertext, futureResearchCounttext, futureResearchTitletext, futureResearchBodytext, futureResearchNavChipText0text, futureResearchNavChipText1text, futureResearchNavChipText2text, futureResearchNavChipText3text, futureResearchNavChipText4text });
