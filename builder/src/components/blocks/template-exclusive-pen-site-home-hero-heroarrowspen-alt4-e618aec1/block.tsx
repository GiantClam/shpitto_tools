...
export default function TemplateExclusivePenSiteHomeHeroHeroarrowspenAlt4({ id, arrowprevtxttext, arrownexttxttext, ...rest }) {
  const pathname = usePathname();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, arrowprevtxttext, arrownexttxttext });
