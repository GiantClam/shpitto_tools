...
export default function TemplateExclusivePenSiteMaintenanceFooterFooterpenAlt1({ id, footerLogoimagesrc, footerCopytext, footerCopyhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCol3text, footerCol3href, ...rest }) {
