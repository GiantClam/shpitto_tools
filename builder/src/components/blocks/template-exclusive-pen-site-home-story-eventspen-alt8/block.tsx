...
export default function TemplateExclusivePenSiteHomeStoryEventspenAlt8({ id, evtxt1text, e1imgimagesrc, e1ttext, e1dtext, evtxt2text, e2imgimagesrc, e2ttext, e2dtext, evtxt3text, e3imgimagesrc, e3ttext, e3dtext, evheadtext, evbtnhref, evbtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, evtxt1text, e1imgimagesrc, e1ttext, e1dtext, evtxt2text, e2imgimagesrc, e2ttext, e2dtext, evtxt3text, e3imgimagesrc, e3ttext, e3dtext, evheadtext, evbtnhref, evbtntxttext });
