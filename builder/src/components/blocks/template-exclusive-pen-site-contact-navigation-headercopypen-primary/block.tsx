...
export default function TemplateExclusivePenSiteContactNavigationHeadercopypenPrimary({ id, logotext, logohref, navtext, navhref, utilitytext, utilityhref, ...rest }) {
