...
export default function TemplateExclusivePenSiteVdmAboutStoryAboutmainpenAlt2({ id, lab1text, herotitletext, herosubtext, heroimgimagesrc, seckickertext, sectitletext, secbodytext, t1imagesrc, t2imagesrc, t3imagesrc, t4imagesrc, lab2text, lab3text, lab4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, lab1text, herotitletext, herosubtext, heroimgimagesrc, seckickertext, sectitletext, secbodytext, t1imagesrc, t2imagesrc, t3imagesrc, t4imagesrc, lab2text, lab3text, lab4text });
