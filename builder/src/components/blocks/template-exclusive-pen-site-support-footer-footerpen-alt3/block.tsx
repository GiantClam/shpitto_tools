...
export default function TemplateExclusivePenSiteSupportFooterFooterpenAlt3({ id, clzbctext, pcfsktext, pcfskhref, g6yuftext, rdotctext, rdotchref, hu3uvtext, nqugstext, nqugshref, om4ndtext, tn1zntext, tn1znhref, d8wcftext, wwiyjtext, wwiyjhref, zao7qtext, j01f7href, fonnptext, irp3atext, quashtext, ...rest }) {
