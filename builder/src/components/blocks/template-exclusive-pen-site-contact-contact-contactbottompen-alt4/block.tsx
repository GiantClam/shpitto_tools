...
export default function TemplateExclusivePenSiteContactContactContactbottompenAlt4({ id, contacttitletext, contactbgimagesrc, contactbtnhref, contactbtnttext, contactbtnthref, qtagtext, qdesctext, ...rest }) {
