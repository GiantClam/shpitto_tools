...
export default function TemplateExclusivePenSiteServiceNavigationHeaderpenPrimary({ id, xx5uptext, xx5uphref, uo0itext, uo0ihref, yis2ttext, yis2thref, huvntext, huvnhref, b4fgvtext, b4fgvhref, i8gf1text, i8gf1href, jcvwwtext, jcvwwhref, kdcjetext, kdcjehref, abnmutext, abnmuhref, ba7vstext, ba7vshref, krlpetext, krlpehref, dsbgitext, dsbgihref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, xx5uptext, xx5uphref, uo0itext, uo0ihref, yis2ttext, yis2thref, huvntext, huvnhref, b4fgvtext, b4fgvhref, i8gf1text, i8gf1href, jcvwwtext, jcvwwhref, kdcjetext, kdcjehref, abnmutext, abnmuhref, ba7vstext, ba7vshref, krlpetext, krlpehref, dsbgitext, dsbgihref });
