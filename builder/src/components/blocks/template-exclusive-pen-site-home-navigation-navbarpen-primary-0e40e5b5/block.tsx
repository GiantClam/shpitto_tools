...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageIndustriesNavbarLogoimagesrc, pageIndustriesNavbarLangtext, pageIndustriesNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageIndustriesNavbarLogoimagesrc, pageIndustriesNavbarLangtext, pageIndustriesNavbarLanghref });
