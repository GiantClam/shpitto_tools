...
export default function TemplateExclusivePenSiteUrsaProductsNavigationNavpenPrimary({ id, logotext, logohref, menu1text, menu1href, menu2text, menu2href, menu3text, menu3href, menu4text, menu4href, iconstext, iconshref, soc1ttext, soc1thref, soc2ttext, soc2thref, soc3ttext, soc3thref, xittext, xithref, ...rest }) {
