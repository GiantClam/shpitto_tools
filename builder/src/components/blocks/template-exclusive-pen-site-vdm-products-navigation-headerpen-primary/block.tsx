...
export default function TemplateExclusivePenSiteVdmProductsNavigationHeaderpenPrimary({ id, logomaintext, logomainhref, logosubtext, logosubhref, nav1text, nav1href, nav2text, nav2href, nav3text, nav3href, r1text, r1href, r2text, r2href, r3text, r3href, searchtext, searchhref, ...rest }) {
