...
const DEFAULT_PROPS = {
  "id": "focus-on",
  "focusOntext": "FOCUS ON",
  "subtitletext": "WARCOM AND\nFPT: A LEGACY OF\nINNOVATION AND\nSHARED QUALITY",
  "bodytext": "The implementation period required level, and every detail had to be guaranteed\nbefore introducing productivity and market growth in risk-free conditions.",
  "imageimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/focus-warcom.jpg",
  "bodytext2": "Discover more",
  "focuslabeltext": "CUSTOMER STORY"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Heebo",
...
export default function TemplateExclusivePenSiteHomeStoryFocusonpenAlt1({ id, focusOntext, subtitletext, bodytext, imageimagesrc, bodytext2, focuslabeltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, focusOntext, subtitletext, bodytext, imageimagesrc, bodytext2, focuslabeltext });
