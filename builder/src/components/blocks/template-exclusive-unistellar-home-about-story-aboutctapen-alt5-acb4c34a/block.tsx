...
const DEFAULT_PROPS = {
  ...
  "ctabtnprimaryhref": "/explore-products",
  "ctatxtprimarytext": "EXPLORE PRODUCTS",
  "ctabtnsecondaryhref": "/talk-to-an-expert",
...
export default function TemplateExclusiveUnistellarHomeAboutStoryAboutctapenAlt5({ id, ctaeyebrowtext, ctaheadtext, ctabodytext, ctabuttonshref, ctabtnprimaryhref, ctatxtprimarytext, ctabtnsecondaryhref, ctatxtsecondarytext, sub1ttext, sub2ttext, sub3ttext, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctaeyebrowtext, ctaheadtext, ctabodytext, ctabuttonshref, ctabtnprimaryhref, ctatxtprimarytext, ctabtnsecondaryhref, ctatxtsecondarytext, sub1ttext, sub2ttext, sub3ttext });
