...
const DEFAULT_PROPS = {
  "id": "zHHUg",
  "srv1ttext": "Free Shipping",
  "srv1dtext": "Complimentary shipping and easy returns for all online orders.",
  "srv2ttext": "2-Year Warranty",
  "srv2dtext": "Premium coverage for long-term confidence in every product.",
  "srv3ttext": "Support Center",
  "srv3dtext": "Dedicated support, setup guides, and product specialists anytime."
};
...
export default function TemplateExclusivePenSiteHomeApproachServicehighlightspenAlt6({ id, srv1ttext, srv1dtext, srv2ttext, srv2dtext, srv3ttext, srv3dtext, ...rest }) {
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, srv1ttext, srv1dtext, srv2ttext, srv2dtext, srv3ttext, srv3dtext });
