...
export default function TemplateExclusivePenSiteHomeApproachIndustrysolutionspenAlt5({ id, intitletext, cardaeroimagesrc, w5ywbtext, sufsytext, cardautoimagesrc, drmutext, fb7w3text, cardenergyimagesrc, cj6cktext, yl66ntext, cardtoolingimagesrc, nsqz8text, kychftext, cardgeneralimagesrc, s8bxdtext, ad81text, cardmedicalimagesrc, merl6text, xahbutext, cardluxuryimagesrc, dzmvetext, oskxrtext, cardsemiimagesrc, ueycztext, pycb4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, intitletext, cardaeroimagesrc, w5ywbtext, sufsytext, cardautoimagesrc, drmutext, fb7w3text, cardenergyimagesrc, cj6cktext, yl66ntext, cardtoolingimagesrc, nsqz8text, kychftext, cardgeneralimagesrc, s8bxdtext, ad81text, cardmedicalimagesrc, merl6text, xahbutext, cardluxuryimagesrc, dzmvetext, oskxrtext, cardsemiimagesrc, ueycztext, pycb4text });
