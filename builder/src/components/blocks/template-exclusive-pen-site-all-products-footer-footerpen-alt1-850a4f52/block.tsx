...
export default function TemplateExclusivePenSiteAllProductsFooterFooterpenAlt1({ id, footerBrandtext, footerBrandhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCopytext, footerCopyhref, ...rest }) {
