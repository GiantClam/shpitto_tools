...
export default function TemplateExclusiveUnistellarHomeSmartBinocularsCtaCtapenAlt4({ id, ctahref, ctakickertext, ctatitletext, ctabodytext, ctabuttontexttext, ctabuttontexthref, ctabuttonhref, ctas1ttext, ctas1href, ctas2ttext, ctas2href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctahref, ctakickertext, ctatitletext, ctabodytext, ctabuttontexttext, ctabuttontexthref, ctabuttonhref, ctas1ttext, ctas1href, ctas2ttext, ctas2href });
