...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "leadbtn1ttext",
      "hrefProp": "leadbtn1thref"
    },
    {
      "type": "rectangle",
      "id": "5sMvS",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "leadbtn2ttext",
      "hrefProp": "leadbtn2thref"
    },
    {
      "type": "frame",
      "id": "Kk6VV",
    ...
    },
    {
      ...
      "style": {
        ...
        "width": 130,
        "height": 420,
        "background": "linear-gradient(90deg, #ECEDEE 0%, #ECEDEE00 100%)",
        "position": "absolute",
        "left": 560,
        "top": 58
      },
...
const DEFAULT_PROPS = {
  "id": "Ij7M8",
  "leadtagtext": "Leadership",
  "leaddesctext": "Our leadership creates a best-in-class performance culture that is vital to Kymeta's success and the success of our customers. Our leaders share a relentless focus on expanding technology while building long-lasting working relationships.",
  "leadbtn1href": "/",
  "leadbtn1ttext": "Leadership team",
  "leadbtn1thref": "/",
  "leadbtn2href": "/",
  "leadbtn2ttext": "Board of Directors",
  "leadbtn2thref": "/",
  "leadimgimagesrc": "https://images.unsplash.com/photo-1581092160607-ee22621dd758?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHNlYXJjaHwxfHxmYWN0b3J5JTIwdGVhbXxlbnwwfHx8fDE3NzMyNzEyNDF8MA&ixlib=rb-4.1.0&q=80&w=1600"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryLeadershippenAlt8({ id, leadtagtext, leaddesctext, leadbtn1href, leadbtn1ttext, leadbtn1thref, leadbtn2href, leadbtn2ttext, leadbtn2thref, leadimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, leadtagtext, leaddesctext, leadbtn1href, leadbtn1ttext, leadbtn1thref, leadbtn2href, leadbtn2ttext, leadbtn2thref, leadimgimagesrc });
