...
export default function TemplateExclusivePenSiteOerlikonProductsStoryPresscopyppenAlt5({ id, pressttext, pressltext, evttext, evltext, cnmktext, evloctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pressttext, pressltext, evttext, evltext, cnmktext, evloctext });
