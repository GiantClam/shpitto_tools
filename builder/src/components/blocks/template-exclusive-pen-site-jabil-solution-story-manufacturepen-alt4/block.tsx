...
export default function TemplateExclusivePenSiteJabilSolutionStoryManufacturepenAlt4({ id, manimgimagesrc, peytext, abp6jtext, psubtext, pbtnhref, pbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, manimgimagesrc, peytext, abp6jtext, psubtext, pbtnhref, pbtnttext });
