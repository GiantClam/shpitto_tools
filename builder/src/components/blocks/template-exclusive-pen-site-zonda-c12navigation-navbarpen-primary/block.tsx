...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-zonda-c12",
      "name": "header-bg-zonda-c12",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-zonda-c12",
      "name": "brand-logo-zonda-c12",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoZondaC12imagesrc"
    },
    {
      "type": "text",
      "id": "nav-zonda-c12-0",
      "name": "nav-zonda-c12-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navZondaC120text",
      "hrefProp": "navZondaC120href"
    },
    {
      "type": "text",
      "id": "nav-zonda-c12-1",
      "name": "nav-zonda-c12-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navZondaC121text",
      "hrefProp": "navZondaC121href"
    },
    {
      "type": "text",
      "id": "nav-zonda-c12-2",
      "name": "nav-zonda-c12-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navZondaC122text",
      "hrefProp": "navZondaC122href"
    },
    {
      "type": "text",
      "id": "nav-zonda-c12-3",
      "name": "nav-zonda-c12-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navZondaC123text",
      "hrefProp": "navZondaC123href"
    },
    {
      "type": "text",
      "id": "nav-zonda-c12-4",
      "name": "nav-zonda-c12-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navZondaC124text",
      "hrefProp": "navZondaC124href"
    },
    {
      "type": "text",
      "id": "nav-zonda-c12-5",
      "name": "nav-zonda-c12-5",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navZondaC125text",
      "hrefProp": "navZondaC125href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-zonda-c12",
      "name": "menu-box-zonda-c12",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-zonda-c12",
      "name": "menu-line-1-zonda-c12",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-zonda-c12",
      "name": "menu-line-2-zonda-c12",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-zonda-c12",
      "name": "menu-line-3-zonda-c12",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-zonda-c12",
  "brandLogoZondaC12imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navZondaC120text": "Home",
  "navZondaC120href": "/",
  "navZondaC121text": "History",
  "navZondaC121href": "/history",
  "navZondaC122text": "Dealers",
  "navZondaC122href": "/dealers",
  "navZondaC123text": "Tours",
  "navZondaC123href": "/guided-tours",
  "navZondaC124text": "Utopia",
  "navZondaC124href": "/pagani-utopia",
  "navZondaC125text": "Contact",
  "navZondaC125href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteZondaC12NavigationNavbarpenPrimary({ id, brandLogoZondaC12imagesrc, navZondaC120text, navZondaC120href, navZondaC121text, navZondaC121href, navZondaC122text, navZondaC122href, navZondaC123text, navZondaC123href, navZondaC124text, navZondaC124href, navZondaC125text, navZondaC125href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoZondaC12imagesrc, navZondaC120text, navZondaC120href, navZondaC121text, navZondaC121href, navZondaC122text, navZondaC122href, navZondaC123text, navZondaC123href, navZondaC124text, navZondaC124href, navZondaC125text, navZondaC125href });
