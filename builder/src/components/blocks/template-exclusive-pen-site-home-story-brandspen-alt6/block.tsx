...
export default function TemplateExclusivePenSiteHomeStoryBrandspenAlt6({ id, brtitletext, idzotext, nowtxtext, wlspvtext, nlvzftext, rw5c3text, fojphtext, brdesctext, brbtnhref, tvsjrtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brtitletext, idzotext, nowtxtext, wlspvtext, nlvzftext, rw5c3text, fojphtext, brdesctext, brbtnhref, tvsjrtext });
