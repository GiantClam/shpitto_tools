...
const DEFAULT_PROPS = {
  "id": "4t1PL",
  "herotitletext": "资源",
  "herodesctext": "探索专业知识和解决方案、案例研究和行业洞察",
  "herobtnhref": "/",
  "herobtntxttext": "解决方案",
...
export default function TemplateExclusivePenSiteResourcesHeroSolheropenAlt1({ id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herodesctext2, ...rest }) {
