...
export default function TemplateExclusivePenSitePscsProductsStoryExpertintropenAlt2({ id, introtitletext, introleadtext, introbodytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introtitletext, introleadtext, introbodytext });
