...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageTechnologyNavbarLogoimagesrc, pageTechnologyNavbarLangtext, pageTechnologyNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageTechnologyNavbarLogoimagesrc, pageTechnologyNavbarLangtext, pageTechnologyNavbarLanghref });
