...
export default function TemplateExclusivePenSiteOerlikonAboutNavigationNavcopyapenPrimary({ id, topmenutext, topmenuhref, contactbtnhref, contactdottext, contacttexttext, logotext, logohref, navPortfoliotext, navPortfoliohref, navIndustriestext, navIndustrieshref, navInnovationtext, navInnovationhref, navSustainabilitytext, navSustainabilityhref, navInvestorstext, navInvestorshref, navAbouttext, navAbouthref, navCareerstext, navCareershref, ...rest }) {
