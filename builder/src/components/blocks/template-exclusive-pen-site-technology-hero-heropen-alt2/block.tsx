...
const DEFAULT_PROPS = {
  "id": "CoJ3Y",
  "herotitletext": "The atom.",
  "herosubtext": "IonQ’s trapped ion quantum systems are designed to solve challenges no classical computer can touch—from logistics and drug discovery to national defense.",
  "plus1text": "+",
  "plus2text": "+",
  "plus3text": "+",
  "plus4text": "+",
  "pretext": "Quantum built on nature’s most perfect building block:"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteTechnologyHeroHeropenAlt2({ id, herotitletext, herosubtext, plus1text, plus2text, plus3text, plus4text, pretext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herosubtext, plus1text, plus2text, plus3text, plus4text, pretext });
