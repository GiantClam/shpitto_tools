...
export default function TemplateExclusivePenSiteHomeNavigationTopnavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
