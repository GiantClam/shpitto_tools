...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-news-events-navbar-Engineering",
      "name": "page-news-events-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarEngineeringtext",
      "hrefProp": "pageNewsEventsNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-Products",
      "name": "page-news-events-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarProductstext",
      "hrefProp": "pageNewsEventsNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-Services",
      "name": "page-news-events-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarServicestext",
      "hrefProp": "pageNewsEventsNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-BIT",
      "name": "page-news-events-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarBittext",
      "hrefProp": "pageNewsEventsNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-news-events-navbar-lets",
      "name": "page-news-events-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-news-events-navbar-lets-t",
      "name": "page-news-events-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarLetsTtext",
      "hrefProp": "pageNewsEventsNavbarLetsThref"
    },
    {
      "type": "text",
    ...
    {
      "type": "text",
      "id": "page-news-events-navbar-lang",
      "name": "page-news-events-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarLangtext",
      "hrefProp": "pageNewsEventsNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-news-events-navbar-menu",
      "name": "page-news-events-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageNewsEventsNavbarMenutext",
      "hrefProp": "pageNewsEventsNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-news-events-navbar",
  "pageNewsEventsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageNewsEventsNavbarEngineeringtext": "Engineering",
  "pageNewsEventsNavbarEngineeringhref": "/engineering",
  "pageNewsEventsNavbarProductstext": "Products",
  "pageNewsEventsNavbarProductshref": "/products",
  "pageNewsEventsNavbarServicestext": "Services",
  "pageNewsEventsNavbarServiceshref": "/services",
  "pageNewsEventsNavbarBittext": "BIT",
  "pageNewsEventsNavbarBithref": "/bit",
  "pageNewsEventsNavbarLetsTtext": "Let's talk",
  "pageNewsEventsNavbarLetsThref": "/",
  "pageNewsEventsNavbarSearchtext": "⌕",
  "pageNewsEventsNavbarSearchhref": "/",
  "pageNewsEventsNavbarLangtext": "Language",
  "pageNewsEventsNavbarLanghref": "/",
  "pageNewsEventsNavbarMenutext": "☰",
  "pageNewsEventsNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteNewsEventsNavigationNavbarpenPrimary({ id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarEngineeringtext, pageNewsEventsNavbarEngineeringhref, pageNewsEventsNavbarProductstext, pageNewsEventsNavbarProductshref, pageNewsEventsNavbarServicestext, pageNewsEventsNavbarServiceshref, pageNewsEventsNavbarBittext, pageNewsEventsNavbarBithref, pageNewsEventsNavbarLetsTtext, pageNewsEventsNavbarLetsThref, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, pageNewsEventsNavbarLangtext, pageNewsEventsNavbarLanghref, pageNewsEventsNavbarMenutext, pageNewsEventsNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarEngineeringtext, pageNewsEventsNavbarEngineeringhref, pageNewsEventsNavbarProductstext, pageNewsEventsNavbarProductshref, pageNewsEventsNavbarServicestext, pageNewsEventsNavbarServiceshref, pageNewsEventsNavbarBittext, pageNewsEventsNavbarBithref, pageNewsEventsNavbarLetsTtext, pageNewsEventsNavbarLetsThref, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, pageNewsEventsNavbarLangtext, pageNewsEventsNavbarLanghref, pageNewsEventsNavbarMenutext, pageNewsEventsNavbarMenuhref });
