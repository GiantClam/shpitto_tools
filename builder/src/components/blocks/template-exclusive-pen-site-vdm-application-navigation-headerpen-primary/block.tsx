      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "logomaintext",
          "hrefProp": "logomainhref"
        },
        {
          "type": "text",
          "id": "1BTUY",
          ...
          "children": [],
          "textProp": "logosubtext",
          "hrefProp": "logosubhref"
        }
      ]
    },
    {
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #f26922)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #0f3a5d)";
...
export default function TemplateExclusivePenSiteVdmApplicationNavigationHeaderpenPrimary({ id, logomaintext, logomainhref, logosubtext, logosubhref, nav1text, nav1href, nav2text, nav2href, nav3text, nav3href, r1text, r1href, r2text, r2href, r3text, r3href, searchtext, searchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logomaintext, logomainhref, logosubtext, logosubhref, nav1text, nav1href, nav2text, nav2href, nav3text, nav3href, r1text, r1href, r2text, r2href, r3text, r3href, searchtext, searchhref });
