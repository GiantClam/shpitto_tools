...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-service-support",
  "name": "Header",
  "style": {
  ...
  "children": [
    ...
    },
    {
      ...
      "hrefProp": "navPageAllOurBikeshref"
    },
    {
      "type": "text",
      "id": "nav-page-work",
    ...
    },
    {
      ...
      "hrefProp": "navPageServiceSupporthref"
    }
  ]
};
const DEFAULT_PROPS = {
  ...
  "navPageAllOurBikeshref": "/all-our-bikes",
  "navPageWorktext": "WORK",
  "navPageWorkhref": "/work",
  "navPageFriendstext": "FRIENDS",
  "navPageFriendshref": "/friends",
  "navPageContactUstext": "CONTACT US",
  "navPageContactUshref": "/contact-us",
  "navPageServiceSupporttext": "SERVICE & SUPPORT",
  "navPageServiceSupporthref": "/service-support"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #121212)";
...
export default function TemplateExclusivePenSiteServiceSupportNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageAllOurBikestext, navPageAllOurBikeshref, navPageWorktext, navPageWorkhref, navPageFriendstext, navPageFriendshref, navPageContactUstext, navPageContactUshref, navPageServiceSupporttext, navPageServiceSupporthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, headerBrandtext, headerBrandhref, navPageAllOurBikestext, navPageAllOurBikeshref, navPageWorktext, navPageWorkhref, navPageFriendstext, navPageFriendshref, navPageContactUstext, navPageContactUshref, navPageServiceSupporttext, navPageServiceSupporthref });
