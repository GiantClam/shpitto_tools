...
export default function TemplateExclusiveUnistellarHomeSmartBinocularsStoryUsecasespenAlt3({ id, usetitletext, usesubtext, usecard1tagtext, usecard1titletext, usecard1bodytext, usecard1href, usecard2titletext, usecard2bodytext, usecard2href, usecard3titletext, usecard3bodytext, usecard3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, usetitletext, usesubtext, usecard1tagtext, usecard1titletext, usecard1bodytext, usecard1href, usecard2titletext, usecard2bodytext, usecard2href, usecard3titletext, usecard3bodytext, usecard3href });
