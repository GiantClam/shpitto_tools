...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerPlatformtext",
      "hrefProp": "footerPlatformhref"
    },
    {
      "type": "text",
      "id": "footer-Platform-body",
      "name": "footer-Platform-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerPlatformBodytext",
      "hrefProp": "footerPlatformBodyhref"
    },
    {
      "type": "text",
      "id": "footer-Products",
      ...
      "children": [],
      "textProp": "footerProductstext",
      "hrefProp": "footerProductshref"
    },
    {
      "type": "text",
      "id": "footer-Products-body",
      "name": "footer-Products-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerProductsBodytext",
      "hrefProp": "footerProductsBodyhref"
    },
    {
      "type": "text",
      ...
      "children": [],
      "textProp": "footerIndustriestext",
      "hrefProp": "footerIndustrieshref"
    },
    {
      "type": "text",
      "id": "footer-Industries-body",
      "name": "footer-Industries-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerIndustriesBodytext",
      "hrefProp": "footerIndustriesBodyhref"
    },
    {
      "type": "text",
      "id": "footer-Resources",
      ...
      "children": [],
      "textProp": "footerResourcestext",
      "hrefProp": "footerResourceshref"
    },
    {
      "type": "text",
      "id": "footer-Resources-body",
      "name": "footer-Resources-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerResourcesBodytext",
      "hrefProp": "footerResourcesBodyhref"
    },
    {
      "type": "text",
      "id": "footer-About",
      ...
      "children": [],
      "textProp": "footerAbouttext",
      "hrefProp": "footerAbouthref"
    },
    {
      "type": "text",
      "id": "footer-About-body",
      "name": "footer-About-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerAboutBodytext",
      "hrefProp": "footerAboutBodyhref"
    },
    {
      "type": "text",
      "id": "footer-copy",
...
const DEFAULT_PROPS = {
  "id": "footer",
  "footerLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/carbon-logo.png",
  "footerPlatformtext": "PLATFORM",
  "footerPlatformhref": "/platform",
  "footerPlatformBodytext": "How it Works\nMaterials\nSoftware\nHardware",
  "footerPlatformBodyhref": "/",
  "footerProductstext": "PRODUCTS",
  "footerProductshref": "/products",
  "footerProductsBodytext": "M3 3D Printer\nM2 3D Printer\nL1 3D Printer\nAO Suite",
  "footerProductsBodyhref": "/m3-3d-printer",
  "footerIndustriestext": "INDUSTRIES",
  "footerIndustrieshref": "/industries",
  "footerIndustriesBodytext": "Consumer\nDental\nOrthodontics\nIndustrial",
  "footerIndustriesBodyhref": "/consumer-footwear",
  "footerResourcestext": "RESOURCES",
  "footerResourceshref": "/resources",
  "footerResourcesBodytext": "Blog\nCase studies\nCourses\nDatasheets",
  "footerResourcesBodyhref": "/",
  "footerAbouttext": "ABOUT",
  "footerAbouthref": "/about",
  "footerAboutBodytext": "About Carbon\nNewsroom\nContact Us\nPartners",
  "footerAboutBodyhref": "/about",
  "footerCopytext": "Carbon structured clone pen. Desktop and mobile files contain editable text, cards, buttons and image containers.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #B9C0DA)";
...
export default function TemplateExclusivePenSiteConsumerFootwearFooterFooterpenAlt1({ id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerIndustriestext, footerIndustrieshref, footerIndustriesBodytext, footerIndustriesBodyhref, footerResourcestext, footerResourceshref, footerResourcesBodytext, footerResourcesBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerIndustriestext, footerIndustrieshref, footerIndustriesBodytext, footerIndustriesBodyhref, footerResourcestext, footerResourceshref, footerResourcesBodytext, footerResourcesBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref });
