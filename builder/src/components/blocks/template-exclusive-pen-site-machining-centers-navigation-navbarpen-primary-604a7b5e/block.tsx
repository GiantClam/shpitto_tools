...
export default function TemplateExclusivePenSiteMachiningCentersNavigationNavbarpenPrimary({ id, pageMachiningCentersNavbarLogoimagesrc, pageMachiningCentersNavbarContactTexttext, pageMachiningCentersNavbarContactTexthref, pageMachiningCentersNavbarContactArrowtext, pageMachiningCentersNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageMachiningCentersNavbarLogoimagesrc, pageMachiningCentersNavbarContactTexttext, pageMachiningCentersNavbarContactTexthref, pageMachiningCentersNavbarContactArrowtext, pageMachiningCentersNavbarContactArrowhref });
