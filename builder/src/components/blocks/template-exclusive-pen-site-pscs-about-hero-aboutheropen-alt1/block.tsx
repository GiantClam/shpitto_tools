          ...
          "children": [
            ...
            },
            {
              ...
              "style": {
                ...
                "width": 814,
                "height": 220,
                "background": "linear-gradient(90deg, #05375bdd 0%, #05375b55 100%)",
                "position": "absolute",
                "left": 933,
                "top": 0
              },
...
export default function TemplateExclusivePenSitePscsAboutHeroAboutheropenAlt1({ id, herotitletext, herobodytext, heroimgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herobodytext, heroimgimagesrc });
