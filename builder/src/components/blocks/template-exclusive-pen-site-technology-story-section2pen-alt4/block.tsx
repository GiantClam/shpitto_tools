...
const DEFAULT_PROPS = {
  "id": "HyNAl",
  "sec2titletext": "Not just quantum\n—better quantum",
  "journeytext": "[ Quantum Journey ]",
  "introtext": "Most quantum computers rely on superconducting circuits or exotic materials. IonQ takes a simpler, more powerful approach: we use single atoms—identical, stable, and natural—as the building blocks of computation.",
  "idx1text": "001",
  "ptitletext": "The atom: nature’s qubit",
  "pbody1text": "The most important part of any quantum computer are its quantum bits, or qubits. IonQ’s qubits are ionized ytterbium atoms, a silvery rare-earth metal. Each ytterbium atom is perfectly identical to every other ytterbium atom in the universe.",
  "pbody2text": "Moreover, once prepared in a particular stable quantum state, they can remain in that state for very long periods of time — they’re so consistent they’re used in one of the most accurate atomic clocks ever built."
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteTechnologyStorySection2penAlt4({ id, sec2titletext, journeytext, introtext, idx1text, ptitletext, pbody1text, pbody2text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec2titletext, journeytext, introtext, idx1text, ptitletext, pbody1text, pbody2text });
