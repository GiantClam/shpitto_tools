...
export default function TemplateExclusivePenSitePscsProductsStoryWhyjabilpenAlt6({ id, whytitletext, whyleadtext, why1ttext, why1btext, why2ttext, why2btext, why3ttext, why3btext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, whytitletext, whyleadtext, why1ttext, why1btext, why2ttext, why2btext, why3ttext, why3btext });
