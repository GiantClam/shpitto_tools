      ...
      "children": [
        ...
        },
        {
          ...
          "style": {
            ...
            "width": 365,
            "position": "absolute",
            "left": 424.07746478873196,
            "top": 116
          },
          "children": [],
          "textProp": "lnlabeltext"
        },
        {
          "type": "frame",
          "id": "27Bzg",
        ...
        },
        {
          ...
          "style": {
            ...
            "width": 14,
            "position": "absolute",
            "left": 41.30545774647908,
            "top": 282
          },
          "children": [],
          "textProp": "flagtxttext"
        },
        {
          "type": "text",
          "id": "884MP",
...
export default function TemplateExclusivePenSiteJabilContactContactContactpenAlt2({ id, formtitletext, fnlabeltext, lnlabeltext, colabeltext, joblabeltext, indlabeltext, emaillabeltext, phonelabeltext, reasonlabeltext, commentlabeltext, flagtxttext, cctxttext, captxttext, capicontext, submitbtnhref, submittxttext, peytext, psubtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, formtitletext, fnlabeltext, lnlabeltext, colabeltext, joblabeltext, indlabeltext, emaillabeltext, phonelabeltext, reasonlabeltext, commentlabeltext, flagtxttext, cctxttext, captxttext, capicontext, submitbtnhref, submittxttext, peytext, psubtext });
