...
export default function TemplateExclusiveFrameworkBlogNavigationNavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
