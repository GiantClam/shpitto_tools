...
export default function TemplateExclusivePenSiteAboutNavigationTopnavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
