...
export default function TemplateExclusivePenSiteHomeProductsProductrangepenAlt2({ id, pttext, pstext, i1ttext, i2ttext, i3ttext, i4ttext, i5ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pttext, pstext, i1ttext, i2ttext, i3ttext, i4ttext, i5ttext });
