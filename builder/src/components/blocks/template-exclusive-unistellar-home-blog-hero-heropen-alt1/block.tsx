...
export default function TemplateExclusiveUnistellarHomeBlogHeroHeropenAlt1({ id, herotagtext, herotitletext, herodesctext, cat1ttext, cat1href, cat2ttext, cat2href, cat3ttext, cat3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotagtext, herotitletext, herodesctext, cat1ttext, cat1href, cat2ttext, cat2href, cat3ttext, cat3href });
