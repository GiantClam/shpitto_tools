...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarLangtext, pageProductsNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarLangtext, pageProductsNavbarLanghref });
