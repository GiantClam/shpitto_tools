...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "focusCardImgimagesrc"
    },
    {
      "type": "text",
      "id": "focus-card-title",
      "name": "focus-card-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "focusCardTitletext"
    },
    {
      "type": "text",
      "id": "focus-card-body",
      "name": "focus-card-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "focusCardBodytext"
    },
    {
      "type": "rectangle",
      "id": "focus-card-btn-box",
      "name": "focus-card-btn-box",
      "style": {
        "boxSizing": "border-box",
        "width": 120,
        "height": 30,
      ...
      "children": [],
      "hrefProp": "focusCardBtnBoxhref"
    },
    {
      "type": "text",
      "id": "focus-card-btn-text",
      "name": "focus-card-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "focusCardBtnTexttext",
      "hrefProp": "focusCardBtnTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "focus",
  "focusLabeltext": "FOCUS ON",
  "focusCardImgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/focus-warcom.jpg",
  "focusCardTitletext": "WARCOM AND FPT",
  "focusCardBodytext": "共享质量、创新与制造能力的客户案例。",
  "focusCardBtnBoxhref": "/",
  "focusCardBtnTexttext": "了解更多",
  "focusCardBtnTexthref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryFocuspenAlt1({ id, focusLabeltext, focusCardImgimagesrc, focusCardTitletext, focusCardBodytext, focusCardBtnBoxhref, focusCardBtnTexttext, focusCardBtnTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, focusLabeltext, focusCardImgimagesrc, focusCardTitletext, focusCardBodytext, focusCardBtnBoxhref, focusCardBtnTexttext, focusCardBtnTexthref });
