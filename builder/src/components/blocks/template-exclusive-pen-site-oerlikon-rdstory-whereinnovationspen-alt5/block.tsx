...
const SECTION_TREE = {
  "type": "frame",
  "id": "Bbgi5",
  "name": "Where Innovations",
  "style": {
    "boxSizing": "border-box",
    "display": "flex",
    "flexDirection": "column",
    "gap": 14,
    "padding": "14px 90px 24px 90px",
    "width": "100%",
    "background": "#f4f5f7"
  },
  "children": [
...
export default function TemplateExclusivePenSiteOerlikonRDStoryWhereinnovationspenAlt5({ id, j9zzktext, img1aimagesrc, fy6a3text, ubggstext, img2aimagesrc, m7jpstext, uwfpatext, img3aimagesrc, vtuektext, gsaaptext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, j9zzktext, img1aimagesrc, fy6a3text, ubggstext, img2aimagesrc, m7jpstext, uwfpatext, img3aimagesrc, vtuektext, gsaaptext });
