...
export default function TemplateExclusivePenSiteAudioNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOfferstext, navPageOffershref, navPagePhonestext, navPagePhoneshref, navPageAudiotext, navPageAudiohref, navPageSupportCentretext, navPageSupportCentrehref, navPageContactSupporttext, navPageContactSupporthref, ...rest }) {
