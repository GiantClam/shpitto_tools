...
export default function TemplateExclusivePenSiteProductsNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarMenutext, pageProductsNavbarMenuhref, pageProductsNavbarSearchtext, pageProductsNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarMenutext, pageProductsNavbarMenuhref, pageProductsNavbarSearchtext, pageProductsNavbarSearchhref });
