...
export default function TemplateExclusivePenSitePscsBlogFooterHomefooterpenAlt4({ id, tgluqtext, hnjyftext, hnjyfhref, xcdgtext, xcdghref, k5aw9text, d6avitext, d6avihref, qmipftext, c6rhtext, c6rhhref, fcw5text, dmvdttext, dmvdthref, fhlnmtext, xmgwqtext, suck7text, wq76otext, glmtktext, pnzntext, q1cg3text, q1cg3href, ffxaktext, ffxakhref, xremqtext, xremqhref, ifquvtext, ifquvhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, tgluqtext, hnjyftext, hnjyfhref, xcdgtext, xcdghref, k5aw9text, d6avitext, d6avihref, qmipftext, c6rhtext, c6rhhref, fcw5text, dmvdttext, dmvdthref, fhlnmtext, xmgwqtext, suck7text, wq76otext, glmtktext, pnzntext, q1cg3text, q1cg3href, ffxaktext, ffxakhref, xremqtext, xremqhref, ifquvtext, ifquvhref });
