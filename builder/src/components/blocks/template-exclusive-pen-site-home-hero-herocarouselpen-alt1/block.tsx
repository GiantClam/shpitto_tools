  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "heroslideimageimagesrc"
    },
    {
      "type": "frame",
      "id": "CMyTy",
      ...
      "style": {
        ...
        "width": 1296,
        "height": 820,
        "background": "linear-gradient(90deg, #0D0D0DCC 0%, #0D0D0D66 45%, #0D0D0D22 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
          ...
          "children": [
            {
              ...
              "children": [],
              "textProp": "heroctatexttext"
            }
          ],
          "hrefProp": "heroctahref"
        }
      ]
    },
    {
...
const DEFAULT_PROPS = {
  "id": "O74yh",
  "heroslideimageimagesrc": "https://images.unsplash.com/photo-1678025275990-fc029162ec5d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzIyMDgwNzN8&ixlib=rb-4.1.0&q=80&w=1080",
  "herokickertext": "MASTER & DYNAMIC / NEW",
  "heroheadlinetext": "MW75 Active Noise-Cancelling Wireless Headphones",
  "herobodytext": "Crafted from anodized aluminum and premium leather for immersive sound and all-day comfort.",
  "heroctatexttext": "Shop Headphones",
  "heroctahref": "/masterdynamic-product",
  "arrowprevtxttext": "←",
  "arrownexttxttext": "→"
};
...
export default function TemplateExclusivePenSiteHomeHeroHerocarouselpenAlt1({ id, heroslideimageimagesrc, herokickertext, heroheadlinetext, herobodytext, heroctatexttext, heroctahref, arrowprevtxttext, arrownexttxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroslideimageimagesrc, herokickertext, heroheadlinetext, herobodytext, heroctatexttext, heroctahref, arrowprevtxttext, arrownexttxttext });
