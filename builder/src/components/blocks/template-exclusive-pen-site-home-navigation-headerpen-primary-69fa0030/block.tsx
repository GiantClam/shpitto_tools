...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #8fb0c4)";
...
export default function TemplateExclusivePenSiteHomeNavigationHeaderpenPrimary({ id, logotext, logohref, brandtext, brandhref, navtext, navhref, searchtext, searchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, brandtext, brandhref, navtext, navhref, searchtext, searchhref });
