...
const DEFAULT_PROPS = {
  "id": "tqUlb",
  "flogotext": "&",
  "fdesctext": "Contact Center 客服中心\n☎ +86 800-820-2623(座机)/+86 400-820-2623(手机)\n沪ICP备20012694号-1\n京公网安备 11010502044395号",
  "fdeschref": "/sandvik-contact",
  "fcol1text": "产品",
  "fcol1href": "/",
  "fcol2text": "服务",
  "fcol2href": "/",
  "fcol3text": "订购",
  "fcol3href": "/",
  "fcopytext": "法律声明      隐私政策      安全      通用条款和条件",
  "fcopyhref": "/",
  "rbtext": "关于我们",
  "rbhref": "/",
  "ch1text": "⌄",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #E6E6E6)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F0F0F0)";
...
export default function TemplateExclusivePenSiteSandvikCustomerServiceFooterFootpenAlt2({ id, flogotext, fdesctext, fdeschref, fcol1text, fcol1href, fcol2text, fcol2href, fcol3text, fcol3href, fcopytext, fcopyhref, rbtext, rbhref, ch1text, ch1href, ch2text, ch2href, ch3text, ch3href, ch4text, ch4href, soctext, sochref, rt1text, rt1href, rt2text, rt2href, locttext, locthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, flogotext, fdesctext, fdeschref, fcol1text, fcol1href, fcol2text, fcol2href, fcol3text, fcol3href, fcopytext, fcopyhref, rbtext, rbhref, ch1text, ch1href, ch2text, ch2href, ch3text, ch3href, ch4text, ch4href, soctext, sochref, rt1text, rt1href, rt2text, rt2href, locttext, locthref });
