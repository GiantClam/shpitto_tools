...
export default function TemplateExclusiveUnistellarHomeHomeStorySubpagelinkspenAlt9({ id, chip1text, lk1href, chip2text, lk2href, chip3text, lk3href, chip4text, lk4href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, chip1text, lk1href, chip2text, lk2href, chip3text, lk3href, chip4text, lk4href });
