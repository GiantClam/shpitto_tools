      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "ctabtn1txttext"
        }
      ],
      "hrefProp": "ctabtn1href"
    },
    {
      "type": "frame",
      "id": "vg6xr",
      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "ctabtn2txttext"
        }
      ],
      "hrefProp": "ctabtn2href"
    },
    {
      "type": "rectangle",
      "id": "vYgEn",
...
const DEFAULT_PROPS = {
  "id": "L0Rzo",
  "ctatitletext": "我们的业务遍及全球。我们的影响惠及未来。",
  "ctabtn1href": "/",
  "ctabtn1txttext": "查看我们的地点",
  "ctabtn2href": "/",
  "ctabtn2txttext": "查看我们的奖项",
  "soltagtxttext": "地点与奖项",
  "soldesctext": "我们的业务遍布全球四大洲，这使我们能够充分利用全球范围内的专业知识和人才，确保为世界各地的客户提供屡获殊荣的卓越产品。"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutCtaAboutctapenAlt7({ id, ctatitletext, ctabtn1href, ctabtn1txttext, ctabtn2href, ctabtn2txttext, soltagtxttext, soldesctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctatitletext, ctabtn1href, ctabtn1txttext, ctabtn2href, ctabtn2txttext, soltagtxttext, soldesctext });
