...
export default function TemplateExclusivePenSiteHomeStoryCategoriespenAlt1({ id, catTitletext, catCardImg0imagesrc, catCardT0text, catCardB0text, catCardT1text, catCardB1text, catCardT2text, catCardB2text, catCardImg3imagesrc, catCardT3text, catCardB3text, catCardT4text, catCardB4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, catTitletext, catCardImg0imagesrc, catCardT0text, catCardB0text, catCardT1text, catCardB1text, catCardT2text, catCardB2text, catCardImg3imagesrc, catCardT3text, catCardB3text, catCardT4text, catCardB4text });
