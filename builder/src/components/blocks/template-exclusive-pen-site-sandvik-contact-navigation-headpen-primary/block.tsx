...
export default function TemplateExclusivePenSiteSandvikContactNavigationHeadpenPrimary({ id, logotext, logohref, navtext, navhref, actionstext, actionshref, searchtxttext, searchtxthref, loginbtnhref, logintxttext, logintxthref, ...rest }) {
