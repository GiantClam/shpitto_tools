...
export default function TemplateExclusiveFrameworkContactFooterFooterpenAlt3({ id, a8p3ftext, mqbmrtext, mqbmrhref, dthwxtext, howybtext, howybhref, npx2text, t3cx4text, t3cx4href, fhzltext, puz92text, puz92href, xfcygtext, fnrsltext, fnrslhref, wpl5ptext, uwcuhref, uoytatext, dmqitext, thaqitext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, a8p3ftext, mqbmrtext, mqbmrhref, dthwxtext, howybtext, howybhref, npx2text, t3cx4text, t3cx4href, fhzltext, puz92text, puz92href, xfcygtext, fnrsltext, fnrslhref, wpl5ptext, uwcuhref, uoytatext, dmqitext, thaqitext });
  ...
  return renderFrameworkStructuredFooter({
    ...
    columns: [
      buildColumn(a8p3ftext, mqbmrtext, mqbmrhref),
      buildColumn(dthwxtext, howybtext, howybhref),
      buildColumn(npx2text, t3cx4text, t3cx4href),
      buildColumn(fhzltext, puz92text, puz92href),
    ],
    subscribeTitle: xfcygtext,
    subscribeBody: fnrsltext,
    subscribeBodyHref: fnrslhref,
    subscribeInputPlaceholder: wpl5ptext,
    subscribeInputHref: uwcuhref,
    subscribeButtonLabel: uoytatext,
    legal: dmqitext,
    currency: thaqitext,
    theme: merged?.theme,
  });
