...
export default function TemplateExclusivePenSitePscsSolutionProductsCardssectionpenAlt3({ id, cardstitletext, cardsintrotext, img1imagesrc, t1text, b1text, img2imagesrc, t2text, b2text, img3imagesrc, t3text, b3text, img4imagesrc, t4text, b4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, cardstitletext, cardsintrotext, img1imagesrc, t1text, b1text, img2imagesrc, t2text, b2text, img3imagesrc, t3text, b3text, img4imagesrc, t4text, b4text });
