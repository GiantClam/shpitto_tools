...
export default function TemplateExclusivePenSiteUrsaNewsProductsNewsgridpenAlt4({ id, qzfvrtext, kp79uimagesrc, aziptext, uuxggtext, wedoztext, fo7rkimagesrc, y2hf4text, ag9hatext, m27aitext, w5hliimagesrc, j0ig6text, walwutext, pmfxutext, v5uhtext, turkitext, om50zimagesrc, eqhgstext, mwxj9text, aq1lztext, fiuaaimagesrc, y2clmtext, yoqg2text, n97qtext, ggtdrimagesrc, saun5text, dquyutext, hevxptext, ccgqimagesrc, gqnf6text, nfjz6text, y1mmatext, orcxpimagesrc, vkpkbtext, cfl0itext, su6qltext, tixqvimagesrc, chr3vtext, oi4ztext, gdwxntext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, qzfvrtext, kp79uimagesrc, aziptext, uuxggtext, wedoztext, fo7rkimagesrc, y2hf4text, ag9hatext, m27aitext, w5hliimagesrc, j0ig6text, walwutext, pmfxutext, v5uhtext, turkitext, om50zimagesrc, eqhgstext, mwxj9text, aq1lztext, fiuaaimagesrc, y2clmtext, yoqg2text, n97qtext, ggtdrimagesrc, saun5text, dquyutext, hevxptext, ccgqimagesrc, gqnf6text, nfjz6text, y1mmatext, orcxpimagesrc, vkpkbtext, cfl0itext, su6qltext, tixqvimagesrc, chr3vtext, oi4ztext, gdwxntext });
