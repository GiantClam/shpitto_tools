          ...
          "children": [
            {
              ...
              "style": {
                ...
                "width": 438,
                "height": 80,
                "background": "linear-gradient(0deg, #00000000 0%, #000000CC 100%)",
                "position": "absolute",
                "left": 0,
                "top": 280
              },
            ...
            },
            {
              ...
              "children": [],
              "textProp": "valuetagtext"
            }
          ],
          "imageProp": "valuesimgimagesrc"
        },
        {
          "type": "rectangle",
          "id": "Sq0RJ",
...
export default function TemplateExclusivePenSiteUrsaAboutStorySectionmajorvaluepenAlt6({ id, valuesline1text, valuesline2text, valuesline3text, valuesimgimagesrc, valuetagtext, valuessubtitletext, valuestitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, valuesline1text, valuesline2text, valuesline3text, valuesimgimagesrc, valuetagtext, valuessubtitletext, valuestitletext });
