...
const DEFAULT_PROPS = {
  "id": "aAriK",
  "herotitletext": "打造一流产品，\n实现美好未来",
  "herodesctext": "您值得信赖的设计、制造和服务合作伙伴",
  "herobtnhref": "/",
  "herobtntxttext": "了解我们的解决方案"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt1({ id, herotitletext, herodesctext, herobtnhref, herobtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herodesctext, herobtnhref, herobtntxttext });
