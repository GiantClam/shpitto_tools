...
export default function TemplateExclusivePenSiteSolutionApproachQfsspenAlt3({ id, ctabtnhref, ctabtntxttext, ctalinktext, ctalinktext2, ctatitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctabtnhref, ctabtntxttext, ctalinktext, ctalinktext2, ctatitletext });
