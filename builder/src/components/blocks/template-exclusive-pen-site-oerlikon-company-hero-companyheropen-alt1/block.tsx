...
export default function TemplateExclusivePenSiteOerlikonCompanyHeroCompanyheropenAlt1({ id, jd0l5imagesrc, m7lxdtext, cicu0text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, jd0l5imagesrc, m7lxdtext, cicu0text });
