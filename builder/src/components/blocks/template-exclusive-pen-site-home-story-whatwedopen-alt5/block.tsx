      ...
      "children": [
        {
          ...
          "style": {
            ...
            "overflow": "hidden",
            "position": "relative",
            "boxShadow": "0px 8px 18px #08263f22"
          },
          "children": [
            {
              "type": "rectangle",
          ...
          "children": [
            {
              ...
              "style": {
                ...
                "overflow": "hidden",
                "position": "relative",
                "boxShadow": "0px 6px 14px #2447661a"
              },
              "children": [
                {
                  "type": "rectangle",
          ...
          "children": [
            {
              ...
              "hrefProp": "industrybtnhref"
            }
          ],
          "hrefProp": "industrybtnwraphref"
        }
      ]
    }
  ]
...
export default function TemplateExclusivePenSiteHomeStoryWhatwedopenAlt5({ id, fj7ntext, q6krqtext, wd1bgaimagesrc, k9vyttext, wd2bgaimagesrc, us3rvtext, wd3bgaimagesrc, w5mhqtext, zxya9imagesrc, cry5qtext, emy9imagesrc, mnczytext, kxmauimagesrc, dz8ztext, mex4zimagesrc, vlc6xtext, industrybtnwraphref, zgfpbtext, industrybtnhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, fj7ntext, q6krqtext, wd1bgaimagesrc, k9vyttext, wd2bgaimagesrc, us3rvtext, wd3bgaimagesrc, w5mhqtext, zxya9imagesrc, cry5qtext, emy9imagesrc, mnczytext, kxmauimagesrc, dz8ztext, mex4zimagesrc, vlc6xtext, industrybtnwraphref, zgfpbtext, industrybtnhref });
