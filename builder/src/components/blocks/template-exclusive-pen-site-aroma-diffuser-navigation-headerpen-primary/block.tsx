...
export default function TemplateExclusivePenSiteAromaDiffuserNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageAllProductstext, navPageAllProductshref, navPageModularSystemtext, navPageModularSystemhref, navPageSoundRoomtext, navPageSoundRoomhref, navPageSupporttext, navPageSupporthref, navPageAbouttext, navPageAbouthref, ...rest }) {
