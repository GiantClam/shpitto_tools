...
export default function TemplateExclusivePenSiteHomeSocialproofLogostrippenAlt4({ id, rkc4text, tgjnptext, mspsxtext, rn404text, g0ysctext, awardtexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, rkc4text, tgjnptext, mspsxtext, rn404text, g0ysctext, awardtexttext });
