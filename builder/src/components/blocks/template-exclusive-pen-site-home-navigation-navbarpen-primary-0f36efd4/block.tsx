...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-technology-navbar-bg",
      "name": "page-technology-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 86,
    ...
    {
      "type": "rectangle",
      "id": "page-technology-navbar-logo",
      "name": "page-technology-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 64,
      ...
      "children": [],
      "imageProp": "pageTechnologyNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-lang",
      "name": "page-technology-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarLangtext",
      "hrefProp": "pageTechnologyNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-企业",
      "name": "page-technology-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarText",
      "hrefProp": "pageTechnologyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-产品",
      "name": "page-technology-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarText2",
      "hrefProp": "pageTechnologyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-行业",
      "name": "page-technology-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarText3",
      "hrefProp": "pageTechnologyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-技术",
      "name": "page-technology-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarText4",
      "hrefProp": "pageTechnologyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-通信",
      "name": "page-technology-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarText5",
      "hrefProp": "pageTechnologyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-technology-navbar-联系方式",
      "name": "page-technology-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageTechnologyNavbarText6",
      "hrefProp": "pageTechnologyNavbarHref"
    },
    {
      "type": "rectangle",
      "id": "page-technology-navbar-menu-hit",
      "name": "page-technology-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-technology-navbar-menu-line1",
      "name": "page-technology-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-technology-navbar-menu-line2",
      "name": "page-technology-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-technology-navbar-menu-line3",
      "name": "page-technology-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-technology-navbar",
  "pageTechnologyNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageTechnologyNavbarLangtext": "ZH",
  "pageTechnologyNavbarLanghref": "/",
  "pageTechnologyNavbarText": "企业",
  "pageTechnologyNavbarHref": "/",
  "pageTechnologyNavbarText2": "产品",
  "pageTechnologyNavbarText3": "行业",
  "pageTechnologyNavbarText4": "技术",
  "pageTechnologyNavbarText5": "通信",
  "pageTechnologyNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageTechnologyNavbarLogoimagesrc, pageTechnologyNavbarLangtext, pageTechnologyNavbarLanghref, pageTechnologyNavbarText, pageTechnologyNavbarHref, pageTechnologyNavbarText2, pageTechnologyNavbarText3, pageTechnologyNavbarText4, pageTechnologyNavbarText5, pageTechnologyNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageTechnologyNavbarLogoimagesrc, pageTechnologyNavbarLangtext, pageTechnologyNavbarLanghref, pageTechnologyNavbarText, pageTechnologyNavbarHref, pageTechnologyNavbarText2, pageTechnologyNavbarText3, pageTechnologyNavbarText4, pageTechnologyNavbarText5, pageTechnologyNavbarText6 });
