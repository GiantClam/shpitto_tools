...
export default function TemplateExclusivePenSiteHomeCtaRecentnewspenAlt4({ id, recentNewsimagesrc, newstitletext, newsimg1imagesrc, newst1text, pr1ttext, btn1href, btn1ttext, btn1atext, newsimg2imagesrc, newst2text, pr2ttext, btn2href, btn2ttext, btn2atext, newsimg3imagesrc, newst3text, pr3ttext, btn3href, btn3ttext, btn3atext, ...rest }) {
