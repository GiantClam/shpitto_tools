...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageServicesNavbarLogoimagesrc, pageServicesNavbarLangtext, pageServicesNavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageServicesNavbarLogoimagesrc, pageServicesNavbarLangtext, pageServicesNavbarLanghref });
