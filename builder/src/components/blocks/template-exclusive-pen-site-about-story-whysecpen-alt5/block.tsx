...
export default function TemplateExclusivePenSiteAboutStoryWhysecpenAlt5({ id, whytitletext, wt1text, wd1text, wt2text, wd2text, wt3text, wd3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, whytitletext, wt1text, wd1text, wt2text, wd2text, wt3text, wd3text });
