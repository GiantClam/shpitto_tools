...
export default function TemplateExclusivePenSiteVdmContactContactContactmainpenAlt2({ id, zltavtext, jkvyztext, yibfutext, n8cuxtext, i3axxtext, jvlq7text, aqb1ytext, l0hrltext, jm6petext, quanktext, qdhy3text, bsgktext, uly6gtext, lx2kbtext, m5sn7text, rqigstext, crumbtext, evitftext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, zltavtext, jkvyztext, yibfutext, n8cuxtext, i3axxtext, jvlq7text, aqb1ytext, l0hrltext, jm6petext, quanktext, qdhy3text, bsgktext, uly6gtext, lx2kbtext, m5sn7text, rqigstext, crumbtext, evitftext });
