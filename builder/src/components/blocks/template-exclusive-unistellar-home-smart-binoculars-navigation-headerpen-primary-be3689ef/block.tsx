...
const DEFAULT_PROPS = {
  ...
  "headerbtntexthref": "/support-portal"
};
...
export default function TemplateExclusiveUnistellarHomeSmartBinocularsNavigationHeaderpenPrimary({ id, logotext, logohref, navhometext, navhomehref, navscopestext, navscopeshref, navbinocstext, navbinocshref, navtechtext, navtechhref, navcontacttext, navcontacthref, headerbtnhref, headerbtntexttext, headerbtntexthref, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, navhometext, navhomehref, navscopestext, navscopeshref, navbinocstext, navbinocshref, navtechtext, navtechhref, navcontacttext, navcontacthref, headerbtnhref, headerbtntexttext, headerbtntexthref });
