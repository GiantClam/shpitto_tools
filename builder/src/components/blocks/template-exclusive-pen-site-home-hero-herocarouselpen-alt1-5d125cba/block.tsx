...
export default function TemplateExclusivePenSiteHomeHeroHerocarouselpenAlt1({ id, heroslideimageimagesrc, herokickertext, heroheadlinetext, herobodytext, heroctatexttext, arrowprevtxttext, arrownexttxttext, ...rest }) {
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroslideimageimagesrc, herokickertext, heroheadlinetext, herobodytext, heroctatexttext, arrowprevtxttext, arrownexttxttext });
