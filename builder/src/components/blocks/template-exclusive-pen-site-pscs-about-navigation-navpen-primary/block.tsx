...
export default function TemplateExclusivePenSitePscsAboutNavigationNavpenPrimary({ id, nwsojtext, nwsojhref, nqk3ntext, nqk3nhref, seec5text, seec5href, lnxyotext, lnxyohref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, nwsojtext, nwsojhref, nqk3ntext, nqk3nhref, seec5text, seec5href, lnxyotext, lnxyohref });
