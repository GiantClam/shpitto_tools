...
export default function TemplateExclusivePenSiteCmfPhone2ProNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
