...
export default function TemplateExclusivePenSiteSandvikAboutStoryMetricpenAlt7({ id, mltext, m1text, m2text, m3text, m1stext, m2stext, m3stext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, mltext, m1text, m2text, m3text, m1stext, m2stext, m3stext });
