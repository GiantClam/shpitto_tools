...
export default function TemplateExclusivePenSiteContactUsNavigationNavbarpenPrimary({ id, brandLogoContactUsimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoContactUsimagesrc });
