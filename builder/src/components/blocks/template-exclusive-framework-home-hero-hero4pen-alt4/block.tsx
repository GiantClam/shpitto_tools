...
export default function TemplateExclusiveFrameworkHomeHeroHero4penAlt4({ id, h4t1text, h4t2text, h4bttext, dsvsntext, hero4rimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, h4t1text, h4t2text, h4bttext, dsvsntext, hero4rimagesrc });
