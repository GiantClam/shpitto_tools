...
const DEFAULT_PROPS = {
  ...
  "footerBrandhref": "/",
  "footerCol1text": "All Our Bikes Work Friends",
  "footerCol1href": "/all-our-bikes",
  "footerCol2text": "Contact Us Service & Support Bukk Makka",
  "footerCol2href": "/contact-us",
  "footerCopytext": "CAKE structured clone pen. Editable text, cards, buttons and image containers.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteServiceSupportFooterFooterpenAlt1({ id, footerBrandtext, footerBrandhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCopytext, footerCopyhref, ...rest }) {
