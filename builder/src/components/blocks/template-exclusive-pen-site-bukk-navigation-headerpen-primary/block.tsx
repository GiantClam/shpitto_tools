...
export default function TemplateExclusivePenSiteBukkNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageAllOurBikestext, navPageAllOurBikeshref, navPageWorktext, navPageWorkhref, navPageFriendstext, navPageFriendshref, navPageContactUstext, navPageContactUshref, navPageServiceSupporttext, navPageServiceSupporthref, ...rest }) {
