...
const SECTION_TREE = {
  ...
  "imageProp": "sectionSolutionMainimagesrc"
};
const DEFAULT_PROPS = {
  "id": "JNZ8K",
...
export default function TemplateExclusivePenSiteUrsaSolutionApproachSectionsolutionmainpenAlt4({ id, sectionSolutionMainimagesrc, dulxrimagesrc, nyda6text, s2aaytext, zt6cimagesrc, ppievtext, thjkhtext, ybiqdimagesrc, afloktext, ncysotext, frcibimagesrc, nqvzotext, iflzitext, ufluttext, pfnsimagesrc, peitext, co7nmtext, ch4sxtext, mvkutext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sectionSolutionMainimagesrc, dulxrimagesrc, nyda6text, s2aaytext, zt6cimagesrc, ppievtext, thjkhtext, ybiqdimagesrc, afloktext, ncysotext, frcibimagesrc, nqvzotext, iflzitext, ufluttext, pfnsimagesrc, peitext, co7nmtext, ch4sxtext, mvkutext });
