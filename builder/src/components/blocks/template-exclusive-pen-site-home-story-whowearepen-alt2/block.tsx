  ...
  "children": [
    ...
    },
    {
      ...
      "style": {
        ...
        "height": 259,
        "borderRadius": 16,
        "background": "linear-gradient(0deg, #0f507f 0%, #08365b 100%)",
        "position": "absolute",
        "left": 738,
        "top": 34
      },
...
export default function TemplateExclusivePenSiteHomeStoryWhowearepenAlt2({ id, grkmvtext, e8gkntext, gxrgatext, gtc37text, dxsxqtext, v3z1wtext, t1text, label1text, bes0vtext, fxfg1text, t2text, rmsx6text, yamfltext, dv0hktext, t3text, feylntext, fbi9wtext, wqjbctext, t4text, tra4text, yzp0dtext, zipsotext, q85k1text, ctawhobhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, grkmvtext, e8gkntext, gxrgatext, gtc37text, dxsxqtext, v3z1wtext, t1text, label1text, bes0vtext, fxfg1text, t2text, rmsx6text, yamfltext, dv0hktext, t3text, feylntext, fbi9wtext, wqjbctext, t4text, tra4text, yzp0dtext, zipsotext, q85k1text, ctawhobhref });
