      ...
      "children": [
        {
          ...
          "children": [
            ...
            },
            {
              ...
              "hrefProp": "bodytoggleinactivehref"
            }
          ]
        },
        {
...
const DEFAULT_PROPS = {
  ...
  "bodytoggleactivehref": "/",
  "bodytoggleinactivetxttext": "FAQ TAB",
  "bodytoggleinactivehref": "/masterdynamic-support",
  ...
  "faq2href": "/masterdynamic-support",
...
export default function TemplateExclusivePenSiteMasterdynamicSupportContactSupmainpenAlt1({ id, suptitletext, supheroimageimagesrc, supsearchtxttext, focustxttext, focuschiphref, supbtnhref, supbtntxttext, supentrytitletext, quick1imageimagesrc, quick1idxtext, quick1titletext, quick1desctext, hoverctatxttext, hoverctaarrowtext, hoverctahref, quick2imageimagesrc, quick2idxtext, quick2titletext, quick2desctext, quick3imageimagesrc, quick3idxtext, quick3titletext, quick3desctext, bodytoggleactivetxttext, bodytoggleactivehref, bodytoggleinactivetxttext, bodytoggleinactivehref, supticketsheadtext, ticket1toptext, ticket1stattext, ticket1msgtext, ticket2toptext, ticket2stattext, ticket2msgtext, faqtitletext, cwritext, faqmetatext, faqanswertext, faq1href, vykpxtext, faq2href, nw1btext, faq3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, suptitletext, supheroimageimagesrc, supsearchtxttext, focustxttext, focuschiphref, supbtnhref, supbtntxttext, supentrytitletext, quick1imageimagesrc, quick1idxtext, quick1titletext, quick1desctext, hoverctatxttext, hoverctaarrowtext, hoverctahref, quick2imageimagesrc, quick2idxtext, quick2titletext, quick2desctext, quick3imageimagesrc, quick3idxtext, quick3titletext, quick3desctext, bodytoggleactivetxttext, bodytoggleactivehref, bodytoggleinactivetxttext, bodytoggleinactivehref, supticketsheadtext, ticket1toptext, ticket1stattext, ticket1msgtext, ticket2toptext, ticket2stattext, ticket2msgtext, faqtitletext, cwritext, faqmetatext, faqanswertext, faq1href, vykpxtext, faq2href, nw1btext, faq3href });
