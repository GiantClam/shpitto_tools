...
export default function TemplateExclusiveUnistellarHomeAboutNavigationNavaboutpenPrimary({ id, logotext, logohref, oc9eltext, oc9elhref, euio2text, euio2href, lm0tptext, lm0tphref, zyby0text, zyby0href, jhibgtext, jhibghref, ctahref, ctatexttext, ctatexthref, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, oc9eltext, oc9elhref, euio2text, euio2href, lm0tptext, lm0tphref, zyby0text, zyby0href, jhibgtext, jhibghref, ctahref, ctatexttext, ctatexthref });
