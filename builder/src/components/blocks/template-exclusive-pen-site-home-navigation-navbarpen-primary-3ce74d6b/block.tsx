...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-company-navbar-bg",
      "name": "page-company-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 86,
    ...
    {
      "type": "rectangle",
      "id": "page-company-navbar-logo",
      "name": "page-company-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 106,
        "height": 64,
      ...
      "children": [],
      "imageProp": "pageCompanyNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-company-navbar-lang",
      "name": "page-company-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarLangtext",
      "hrefProp": "pageCompanyNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-company-navbar-企业",
      "name": "page-company-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarText",
      "hrefProp": "pageCompanyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-company-navbar-产品",
      "name": "page-company-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarText2",
      "hrefProp": "pageCompanyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-company-navbar-行业",
      "name": "page-company-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarText3",
      "hrefProp": "pageCompanyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-company-navbar-技术",
      "name": "page-company-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarText4",
      "hrefProp": "pageCompanyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-company-navbar-通信",
      "name": "page-company-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarText5",
      "hrefProp": "pageCompanyNavbarHref"
    },
    {
      "type": "text",
      "id": "page-company-navbar-联系方式",
      "name": "page-company-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageCompanyNavbarText6",
      "hrefProp": "pageCompanyNavbarHref"
    },
    {
      "type": "rectangle",
      "id": "page-company-navbar-menu-hit",
      "name": "page-company-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-company-navbar-menu-line1",
      "name": "page-company-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-company-navbar-menu-line2",
      "name": "page-company-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-company-navbar-menu-line3",
      "name": "page-company-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-company-navbar",
  "pageCompanyNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageCompanyNavbarLangtext": "ZH",
  "pageCompanyNavbarLanghref": "/",
  "pageCompanyNavbarText": "企业",
  "pageCompanyNavbarHref": "/",
  "pageCompanyNavbarText2": "产品",
  "pageCompanyNavbarText3": "行业",
  "pageCompanyNavbarText4": "技术",
  "pageCompanyNavbarText5": "通信",
  "pageCompanyNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageCompanyNavbarLogoimagesrc, pageCompanyNavbarLangtext, pageCompanyNavbarLanghref, pageCompanyNavbarText, pageCompanyNavbarHref, pageCompanyNavbarText2, pageCompanyNavbarText3, pageCompanyNavbarText4, pageCompanyNavbarText5, pageCompanyNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageCompanyNavbarLogoimagesrc, pageCompanyNavbarLangtext, pageCompanyNavbarLanghref, pageCompanyNavbarText, pageCompanyNavbarHref, pageCompanyNavbarText2, pageCompanyNavbarText3, pageCompanyNavbarText4, pageCompanyNavbarText5, pageCompanyNavbarText6 });
