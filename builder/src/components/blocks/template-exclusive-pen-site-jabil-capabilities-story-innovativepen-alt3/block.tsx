...
export default function TemplateExclusivePenSiteJabilCapabilitiesStoryInnovativepenAlt3({ id, peytext, psubtext, pbtnhref, pbtnttext, icardimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, peytext, psubtext, pbtnhref, pbtnttext, icardimagesrc });
