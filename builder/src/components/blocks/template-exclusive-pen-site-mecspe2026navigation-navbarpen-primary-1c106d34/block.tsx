...
export default function TemplateExclusivePenSiteMecspe2026NavigationNavbarpenPrimary({ id, pageMecspe2026NavbarLogoimagesrc, pageMecspe2026NavbarLangtext, pageMecspe2026NavbarLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageMecspe2026NavbarLogoimagesrc, pageMecspe2026NavbarLangtext, pageMecspe2026NavbarLanghref });
