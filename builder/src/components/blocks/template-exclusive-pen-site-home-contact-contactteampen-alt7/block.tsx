...
export default function TemplateExclusivePenSiteHomeContactContactteampenAlt7({ id, contactimgimagesrc, contacttagtxttext, contacttitletext, contactbtnhref, contactbtntxttext, ...rest }) {
