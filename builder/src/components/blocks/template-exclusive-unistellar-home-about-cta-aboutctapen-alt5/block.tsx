...
export default function TemplateExclusiveUnistellarHomeAboutCtaAboutctapenAlt5({ id, ctaeyebrowtext, ctaheadtext, ctabodytext, ctabuttonshref, ctatxtprimarytext, ctabtnprimaryhref, ctatxtsecondarytext, ctabtnsecondaryhref, sub1ttext, sub2ttext, sub3ttext, ...rest }) {
