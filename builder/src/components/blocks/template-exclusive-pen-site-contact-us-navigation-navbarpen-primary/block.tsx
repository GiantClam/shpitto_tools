...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-contact-us",
      "name": "header-bg-contact-us",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-contact-us",
      "name": "brand-logo-contact-us",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoContactUsimagesrc"
    },
    {
      "type": "text",
      "id": "nav-contact-us-0",
      "name": "nav-contact-us-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navContactUs0text",
      "hrefProp": "navContactUs0href"
    },
    {
      "type": "text",
      "id": "nav-contact-us-1",
      "name": "nav-contact-us-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navContactUs1text",
      "hrefProp": "navContactUs1href"
    },
    {
      "type": "text",
      "id": "nav-contact-us-2",
      "name": "nav-contact-us-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navContactUs2text",
      "hrefProp": "navContactUs2href"
    },
    {
      "type": "text",
      "id": "nav-contact-us-3",
      "name": "nav-contact-us-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navContactUs3text",
      "hrefProp": "navContactUs3href"
    },
    {
      "type": "text",
      "id": "nav-contact-us-4",
      "name": "nav-contact-us-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navContactUs4text",
      "hrefProp": "navContactUs4href"
    },
    {
      "type": "text",
      "id": "nav-contact-us-5",
      "name": "nav-contact-us-5",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navContactUs5text",
      "hrefProp": "navContactUs5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-contact-us",
      "name": "menu-box-contact-us",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-contact-us",
      "name": "menu-line-1-contact-us",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-contact-us",
      "name": "menu-line-2-contact-us",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-contact-us",
      "name": "menu-line-3-contact-us",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-contact-us",
  "brandLogoContactUsimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navContactUs0text": "Home",
  "navContactUs0href": "/",
  "navContactUs1text": "History",
  "navContactUs1href": "/history",
  "navContactUs2text": "Dealers",
  "navContactUs2href": "/dealers",
  "navContactUs3text": "Tours",
  "navContactUs3href": "/guided-tours",
  "navContactUs4text": "Utopia",
  "navContactUs4href": "/pagani-utopia",
  "navContactUs5text": "Contact",
  "navContactUs5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteContactUsNavigationNavbarpenPrimary({ id, brandLogoContactUsimagesrc, navContactUs0text, navContactUs0href, navContactUs1text, navContactUs1href, navContactUs2text, navContactUs2href, navContactUs3text, navContactUs3href, navContactUs4text, navContactUs4href, navContactUs5text, navContactUs5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoContactUsimagesrc, navContactUs0text, navContactUs0href, navContactUs1text, navContactUs1href, navContactUs2text, navContactUs2href, navContactUs3text, navContactUs3href, navContactUs4text, navContactUs4href, navContactUs5text, navContactUs5href });
