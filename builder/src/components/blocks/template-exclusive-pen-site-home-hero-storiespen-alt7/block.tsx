...
export default function TemplateExclusivePenSiteHomeHeroStoriespenAlt7({ id, sttitletext, story1imagesrc, p6f2otext, story2imagesrc, yd0zjtext, story3imagesrc, y1hegtext, stlinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sttitletext, story1imagesrc, p6f2otext, story2imagesrc, yd0zjtext, story3imagesrc, y1hegtext, stlinktext });
