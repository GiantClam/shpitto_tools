...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "rectangle",
      "id": "present-left-marker-line1",
      "name": "present-left-marker-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 1,
        "height": 124,
    ...
    {
      "type": "rectangle",
      "id": "present-left-marker-line2",
      "name": "present-left-marker-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 236,
        "height": 1,
    ...
    {
      "type": "text",
      "id": "present-left-marker-num",
      "name": "present-left-marker-num",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "presentLeftMarkerNumtext"
    },
    {
      "type": "text",
      "id": "present-left-marker-label",
      "name": "present-left-marker-label",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "presentLeftMarkerLabeltext"
    },
    {
      "type": "text",
      "id": "present-title",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "presentLinktext"
    },
    {
      "type": "text",
      "id": "present-right-rail",
      "name": "present-right-rail",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "presentRightRailtext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "present",
  "presentBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/present.jpg",
  "presentLeftMarkerNumtext": "01",
  "presentLeftMarkerLabeltext": "PRESENT",
  "presentTitletext": "WE'VE GONE THIS FAR, DRIVEN BY THE WINDS OF ALL TIMES.",
  "presentBodytext": "Designed to celebrate the harmony between art and science, these cars can catch the moment. Past and future meet at the perfect time, at the exact instant when the wind of creativity starts to blow. And that’s how Huayra Roadster was born: a car of unique beauty, like a work of art made from a block of Carrara marble.",
  "presentLinktext": "HUAYRA ROADSTER",
  "presentRightRailtext": "BACK TO HISTORY OF A DREAM"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryPresentpenAlt4({ id, presentBgimagesrc, presentLeftMarkerNumtext, presentLeftMarkerLabeltext, presentTitletext, presentBodytext, presentLinktext, presentRightRailtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, presentBgimagesrc, presentLeftMarkerNumtext, presentLeftMarkerLabeltext, presentTitletext, presentBodytext, presentLinktext, presentRightRailtext });
