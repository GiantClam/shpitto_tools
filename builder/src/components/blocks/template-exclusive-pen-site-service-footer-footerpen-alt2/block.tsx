...
export default function TemplateExclusivePenSiteServiceFooterFooterpenAlt2({ id, qhsydtext, zwsytext, cgdojtext, col2ttext, col2thref, hafjjtext, hafjjhref, ikvvztext, ikvvzhref, sc0text, sc0href, lyvoutext, lyvouhref, zpxzstext, zpxzshref, podltext, podlhref, gtduetext, gtduehref, o8fibtext, o8fibhref, iyov7text, iyov7href, eueovtext, eueovhref, gwtwvtext, gwtwvhref, n0pjptext, n0pjphref, d9yxutext, d9yxuhref, xbswdtext, xbswdhref, rxgrhtext, rxgrhhref, hkbixtext, hkbixhref, tynoatext, tynoahref, fmb2text, fmb2href, got79text, got79href, liqtext, liqhref, lpltext, lplhref, jzrqptext, jzrqphref, zwbsitext, zwbsihref, fh6vntext, fh6vnhref, blpz6text, blpz6href, xrhaetext, xrhaehref, xmjp0text, xmjp0href, b5dtext, b5dhref, socialtext, socialhref, r9bmctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, qhsydtext, zwsytext, cgdojtext, col2ttext, col2thref, hafjjtext, hafjjhref, ikvvztext, ikvvzhref, sc0text, sc0href, lyvoutext, lyvouhref, zpxzstext, zpxzshref, podltext, podlhref, gtduetext, gtduehref, o8fibtext, o8fibhref, iyov7text, iyov7href, eueovtext, eueovhref, gwtwvtext, gwtwvhref, n0pjptext, n0pjphref, d9yxutext, d9yxuhref, xbswdtext, xbswdhref, rxgrhtext, rxgrhhref, hkbixtext, hkbixhref, tynoatext, tynoahref, fmb2text, fmb2href, got79text, got79href, liqtext, liqhref, lpltext, lplhref, jzrqptext, jzrqphref, zwbsitext, zwbsihref, fh6vntext, fh6vnhref, blpz6text, blpz6href, xrhaetext, xrhaehref, xmjp0text, xmjp0href, b5dtext, b5dhref, socialtext, socialhref, r9bmctext });
