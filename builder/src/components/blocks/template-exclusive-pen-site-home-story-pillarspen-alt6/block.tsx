...
const DEFAULT_PROPS = {
  "id": "XJ6lL",
  "m29mltext": "Industry use case highlights",
  "h1imagesrc": "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxMjIwMjd8&ixlib=rb-4.1.0&q=80&w=1080",
  "b17text": "Quantum-accelerated drug development",
  "c5text": "In collaboration with AstraZeneca, AWS, and NVIDIA, this stack accelerates chemistry simulation by at least 60x times.",
  "c6text": "Read more  →",
  "h2imagesrc": "https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxMjIwMjh8&ixlib=rb-4.1.0&q=80&w=1080",
  "b18text": "Enterprise-grade LLMs with quantum fine tuning",
  "c7text": "IonQ quantum fine-tuning is a hybrid approach that adds a quantum layer to classical AI models.",
  "c8text": "Read more  →",
  "h3imagesrc": "https://images.unsplash.com/photo-1569910260389-a948497cfcfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxMjIwMjh8&ixlib=rb-4.1.0&q=80&w=1080",
  "b19text": "Advancing automotive materials with quantum AI",
  "c9text": "IonQ partnered with a leading global automotive manufacturer for advanced steel microstructures.",
  "c10text": "Read more  →",
  "h4imagesrc": "https://images.unsplash.com/photo-1518770660439-4636190af475?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
  "b20text": "Unlocking financial quantum potential",
  "c11text": "IonQ is pioneering quantum finance workflows with simulation and portfolio optimization.",
  "c12text": "Read more  →",
  "leftbtnhref": "/",
  "lefttxttext": "←",
  "rightbtnhref": "/",
...
export default function TemplateExclusivePenSiteHomeStoryPillarspenAlt6({ id, m29mltext, h1imagesrc, b17text, c5text, c6text, h2imagesrc, b18text, c7text, c8text, h3imagesrc, b19text, c9text, c10text, h4imagesrc, b20text, c11text, c12text, leftbtnhref, lefttxttext, rightbtnhref, righttxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, m29mltext, h1imagesrc, b17text, c5text, c6text, h2imagesrc, b18text, c7text, c8text, h3imagesrc, b19text, c9text, c10text, h4imagesrc, b20text, c11text, c12text, leftbtnhref, lefttxttext, rightbtnhref, righttxttext });
