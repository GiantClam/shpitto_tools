      ...
      "children": [
        {
          ...
          "style": {
            ...
            "width": 720,
            "height": 640,
            "background": "linear-gradient(90deg, #00132690 0%, #00132618 100%)",
            "position": "absolute",
            "left": 0,
            "top": 0
          },
...
export default function TemplateExclusivePenSiteHomeStorySec2penAlt2({ id, sec2lefttitle1text, sec2lefttitle2text, sec2lefttitle3text, sec2bodytext, sec2rightimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec2lefttitle1text, sec2lefttitle2text, sec2lefttitle3text, sec2bodytext, sec2rightimagesrc });
