...
export default function TemplateExclusivePenSiteAromaDiffuserNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
