...
export default function TemplateExclusivePenSiteAboutFooterFooterpenAlt1({ id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerIndustriestext, footerIndustrieshref, footerIndustriesBodytext, footerIndustriesBodyhref, footerResourcestext, footerResourceshref, footerResourcesBodytext, footerResourcesBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref, ...rest }) {
