...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "text",
      "id": "companycards-title",
      "name": "companycards-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "companycardsTitletext"
    },
    {
      "type": "rectangle",
      "id": "cc-1-box",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "cc1BtnTexttext",
      "hrefProp": "cc1BtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "cc-2-box",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "cc2BtnTexttext",
      "hrefProp": "cc2BtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "cc-3-box",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "cc3BtnTexttext",
      "hrefProp": "cc3BtnTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "companycards",
  "companycardsTitletext": "FPT 世界",
  "cc1Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/card-italian.jpg",
  "cc1Titletext": "意式风格",
  "cc1Bodytext": "作为意大利生产商的自豪。",
  "cc1BtnBoxhref": "/",
  "cc1BtnTexttext": "了解更多",
  "cc1BtnTexthref": "/",
  "cc2Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/card-dna.jpg",
  "cc2Titletext": "创新是我们的 DNA",
  "cc2Bodytext": "FPT 已注册 30 多项国际专利。",
  "cc2BtnBoxhref": "/",
  "cc2BtnTexttext": "了解更多",
  "cc2BtnTexthref": "/",
  "cc3Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/card-engineers.jpg",
  "cc3Titletext": "超过 50 名工程师",
  "cc3Bodytext": "持续研发新产品、机头和生产解决方案。",
  "cc3BtnBoxhref": "/",
  "cc3BtnTexttext": "了解更多",
  "cc3BtnTexthref": "/"
};
...
export default function TemplateExclusivePenSiteHomeProductsCompanycardspenAlt4({ id, companycardsTitletext, cc1Imgimagesrc, cc1Titletext, cc1Bodytext, cc1BtnBoxhref, cc1BtnTexttext, cc1BtnTexthref, cc2Imgimagesrc, cc2Titletext, cc2Bodytext, cc2BtnBoxhref, cc2BtnTexttext, cc2BtnTexthref, cc3Imgimagesrc, cc3Titletext, cc3Bodytext, cc3BtnBoxhref, cc3BtnTexttext, cc3BtnTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, companycardsTitletext, cc1Imgimagesrc, cc1Titletext, cc1Bodytext, cc1BtnBoxhref, cc1BtnTexttext, cc1BtnTexthref, cc2Imgimagesrc, cc2Titletext, cc2Bodytext, cc2BtnBoxhref, cc2BtnTexttext, cc2BtnTexthref, cc3Imgimagesrc, cc3Titletext, cc3Bodytext, cc3BtnBoxhref, cc3BtnTexttext, cc3BtnTexthref });
