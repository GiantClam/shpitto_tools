              ...
              "children": [
                {
                  ...
                  "children": [],
                  "textProp": "missionbtntxttext"
                }
              ],
              "hrefProp": "missionbtnhref"
            }
          ]
        }
      ]
...
const DEFAULT_PROPS = {
  "id": "YcB38",
  "missiontagtext": "[ Our mission ]",
  "missiontitletext": "To develop the world's best quantum technology to solve the world's most complex problems",
  "missiondesctext": "Building on over 30 years of research, we've brought quantum computing out of the lab and into the real world.",
  "missionbtnhref": "/contact",
  "missionbtntxttext": "View all partners and customers",
  "partlabeltext": "Our partners",
  "plogo1text": "Google Cloud",
  "plogo2text": "AIST",
  "plogo3text": "NVIDIA",
  "plogo4text": "DELL",
  "plogo5text": "LOCKHEED MARTIN",
  "partlabeltext2": "Our customers"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeStoryIntropenAlt3({ id, missiontagtext, missiontitletext, missiondesctext, missionbtnhref, missionbtntxttext, partlabeltext, plogo1text, plogo2text, plogo3text, plogo4text, plogo5text, partlabeltext2, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, missiontagtext, missiontitletext, missiondesctext, missionbtnhref, missionbtntxttext, partlabeltext, plogo1text, plogo2text, plogo3text, plogo4text, plogo5text, partlabeltext2 });
