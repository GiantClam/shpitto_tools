...
export default function TemplateExclusivePenSiteAboutStoryLearnsecpenAlt7({ id, learntitletext, lt1text, imgaimagesrc, desc1text, lt2text, imgbimagesrc, desc2text, lt3text, imgcimagesrc, desc3text, lt4text, imgdimagesrc, desc4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, learntitletext, lt1text, imgaimagesrc, desc1text, lt2text, imgbimagesrc, desc2text, lt3text, imgcimagesrc, desc3text, lt4text, imgdimagesrc, desc4text });
