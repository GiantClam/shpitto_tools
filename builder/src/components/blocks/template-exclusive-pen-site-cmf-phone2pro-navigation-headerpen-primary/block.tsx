...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-cmf-phone-2-pro",
  "name": "Header",
  "style": {
...
export default function TemplateExclusivePenSiteCmfPhone2ProNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOfferstext, navPageOffershref, navPagePhonestext, navPagePhoneshref, navPageAudiotext, navPageAudiohref, navPageSupportCentretext, navPageSupportCentrehref, navPageContactSupporttext, navPageContactSupporthref, ...rest }) {
