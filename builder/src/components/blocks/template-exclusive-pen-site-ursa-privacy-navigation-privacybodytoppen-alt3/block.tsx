...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #F15A24)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F3F7FC)";
...
export default function TemplateExclusivePenSiteUrsaPrivacyNavigationPrivacybodytoppenAlt3({ id, scdmutext, scdmuhref, beqcctext, beqcchref, hqgqvtext, hqgqvhref, lhcgxtext, lhcgxhref, ecejtext, ecejhref, w4diltext, w4dilhref, qvlivtext, qvlivhref, k67bhtext, k67bhhref, mkdentext, mkdenhref, ol7rptext, ol7rphref, p9cwgtext, p9cwghref, df7u9text, df7u9href, ffwcvtext, ffwcvhref, z1ddmtext, z1ddmhref, q4ia1text, q4ia1href, p5nbntext, p5nbnhref, xwuwetext, xwuwehref, wjitjtext, wjitjhref, ps9ytext, ps9yhref, owfsetext, owfsehref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, scdmutext, scdmuhref, beqcctext, beqcchref, hqgqvtext, hqgqvhref, lhcgxtext, lhcgxhref, ecejtext, ecejhref, w4diltext, w4dilhref, qvlivtext, qvlivhref, k67bhtext, k67bhhref, mkdentext, mkdenhref, ol7rptext, ol7rphref, p9cwgtext, p9cwghref, df7u9text, df7u9href, ffwcvtext, ffwcvhref, z1ddmtext, z1ddmhref, q4ia1text, q4ia1href, p5nbntext, p5nbnhref, xwuwetext, xwuwehref, wjitjtext, wjitjhref, ps9ytext, ps9yhref, owfsetext, owfsehref });
