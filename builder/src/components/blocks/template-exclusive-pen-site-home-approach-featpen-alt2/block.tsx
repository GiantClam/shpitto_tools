...
const DEFAULT_PROPS = {
  "id": "35a3s",
  "f1ttext": "Premium Materials",
  "f1dtext": "Machined aluminum, tempered glass, and soft lambskin leather.",
  "f2ttext": "Wireless Freedom",
  "f2dtext": "Bluetooth 5.2 with stable multipoint connection and long battery life.",
  "f3ttext": "Studio Sound",
  "f3dtext": "Acoustic tuning by in-house engineers for rich, balanced listening."
};
...
export default function TemplateExclusivePenSiteHomeApproachFeatpenAlt2({ id, f1ttext, f1dtext, f2ttext, f2dtext, f3ttext, f3dtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, f1ttext, f1dtext, f2ttext, f2dtext, f3ttext, f3dtext });
