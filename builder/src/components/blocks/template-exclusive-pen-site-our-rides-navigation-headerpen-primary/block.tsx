...
export default function TemplateExclusivePenSiteOurRidesNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOurRidestext, navPageOurRideshref, navPageAccessoriestext, navPageAccessorieshref, navPageOurStorytext, navPageOurStoryhref, navPagePeakDesigntext, navPagePeakDesignhref, navPageShippingDeliverytext, navPageShippingDeliveryhref, ...rest }) {
