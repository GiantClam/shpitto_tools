...
export default function TemplateExclusivePenSitePscsProductsContactContactpenAlt7({ id, ckpfltext, aaomutext, gzw6ktext, qoafvtext, eozcwtext, wiu5text, zl3vktext, g23jbtext, wwmtdtext, ynfotext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ckpfltext, aaomutext, gzw6ktext, qoafvtext, eozcwtext, wiu5text, zl3vktext, g23jbtext, wwmtdtext, ynfotext });
