...
const DEFAULT_PROPS = {
  "id": "0ELCp",
  "apptitletext": "应用行业",
  "appdesctext": "得益于其机器的多功能性，FPT 可在各个工业领域开展业务。每台机器都根据行业需求与客户生产特性制造。",
  "appicon1imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-rail.jpg",
  "applabel1text": "铁路",
  "appicon2imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-energy.jpg",
  "applabel2text": "能源",
  "appicon3imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-earth.jpg",
  "applabel3text": "土方工程",
  "appicon4imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-ship.jpg",
  "applabel4text": "船舶",
  "appicon5imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-defense.jpg",
  "applabel5text": "防务",
  "appicon6imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-general.jpg",
  "applabel6text": "通用机械"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryApplicationspenAlt4({ id, apptitletext, appdesctext, appicon1imagesrc, applabel1text, appicon2imagesrc, applabel2text, appicon3imagesrc, applabel3text, appicon4imagesrc, applabel4text, appicon5imagesrc, applabel5text, appicon6imagesrc, applabel6text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, apptitletext, appdesctext, appicon1imagesrc, applabel1text, appicon2imagesrc, applabel2text, appicon3imagesrc, applabel3text, appicon4imagesrc, applabel4text, appicon5imagesrc, applabel5text, appicon6imagesrc, applabel6text });
