...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "introlinktext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "8zR9k",
  "introtexttext": "Looking to connect with our sales team? Fill out the contact form below, and we'll ensure your inquiry reaches the right person. For service and support related matters, please email",
  "introlinktext": "support@kymetacorp.com directly"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteContactContactContactintropenAlt2({ id, introtexttext, introlinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introtexttext, introlinktext });
