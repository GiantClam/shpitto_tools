...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "trustedImg0imagesrc"
    },
    {
      "type": "text",
      "id": "trusted-label-0",
      "name": "trusted-label-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "trustedImg1imagesrc"
    },
    {
      "type": "text",
      "id": "trusted-label-1",
      "name": "trusted-label-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "trustedImg2imagesrc"
    },
    {
      "type": "text",
      "id": "trusted-label-2",
      "name": "trusted-label-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "trustedImg3imagesrc"
    },
    {
      "type": "text",
      "id": "trusted-label-3",
      "name": "trusted-label-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "trustedLabel3text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "trusted",
  "trustedTitletext": "Trusted",
  "trustedSubtext": "and Proven in Your Industry",
  "trustedImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-trusted1-3ebe5f85.jpg",
  "trustedLabel0text": "Sports",
  "trustedImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-trusted2-c4d52ba1.jpg",
  "trustedLabel1text": "Backpacks",
  "trustedImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-trusted3-d85f2352.jpg",
  "trustedLabel2text": "Protection",
  "trustedImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-trusted4-bfb7840a.jpg",
  "trustedLabel3text": "Custom Fit"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeSocialproofTrustedpenAlt3({ id, trustedTitletext, trustedSubtext, trustedImg0imagesrc, trustedLabel0text, trustedImg1imagesrc, trustedLabel1text, trustedImg2imagesrc, trustedLabel2text, trustedImg3imagesrc, trustedLabel3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, trustedTitletext, trustedSubtext, trustedImg0imagesrc, trustedLabel0text, trustedImg1imagesrc, trustedLabel1text, trustedImg2imagesrc, trustedLabel2text, trustedImg3imagesrc, trustedLabel3text });
