...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-engineering-navbar-bg",
      "name": "page-engineering-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-engineering-navbar-logo",
      "name": "page-engineering-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 140,
        "height": 44,
      ...
      "children": [],
      "imageProp": "pageEngineeringNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-Engineering",
      "name": "page-engineering-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarEngineeringtext",
      "hrefProp": "pageEngineeringNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-Products",
      "name": "page-engineering-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarProductstext",
      "hrefProp": "pageEngineeringNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-Services",
      "name": "page-engineering-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarServicestext",
      "hrefProp": "pageEngineeringNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-BIT",
      "name": "page-engineering-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarBittext",
      "hrefProp": "pageEngineeringNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-engineering-navbar-lets",
      "name": "page-engineering-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-engineering-navbar-lets-t",
      "name": "page-engineering-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarLetsTtext",
      "hrefProp": "pageEngineeringNavbarLetsThref"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-search",
      "name": "page-engineering-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarSearchtext",
      "hrefProp": "pageEngineeringNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-lang",
      "name": "page-engineering-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarLangtext",
      "hrefProp": "pageEngineeringNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-engineering-navbar-menu",
      "name": "page-engineering-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageEngineeringNavbarMenutext",
      "hrefProp": "pageEngineeringNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-engineering-navbar",
  "pageEngineeringNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageEngineeringNavbarEngineeringtext": "Engineering",
  "pageEngineeringNavbarEngineeringhref": "/engineering",
  "pageEngineeringNavbarProductstext": "Products",
  "pageEngineeringNavbarProductshref": "/products",
  "pageEngineeringNavbarServicestext": "Services",
  "pageEngineeringNavbarServiceshref": "/services",
  "pageEngineeringNavbarBittext": "BIT",
  "pageEngineeringNavbarBithref": "/bit",
  "pageEngineeringNavbarLetsTtext": "Let's talk",
  "pageEngineeringNavbarLetsThref": "/",
  "pageEngineeringNavbarSearchtext": "⌕",
  "pageEngineeringNavbarSearchhref": "/",
  "pageEngineeringNavbarLangtext": "Language",
  "pageEngineeringNavbarLanghref": "/",
  "pageEngineeringNavbarMenutext": "☰",
  "pageEngineeringNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteEngineeringNavigationNavbarpenPrimary({ id, pageEngineeringNavbarLogoimagesrc, pageEngineeringNavbarEngineeringtext, pageEngineeringNavbarEngineeringhref, pageEngineeringNavbarProductstext, pageEngineeringNavbarProductshref, pageEngineeringNavbarServicestext, pageEngineeringNavbarServiceshref, pageEngineeringNavbarBittext, pageEngineeringNavbarBithref, pageEngineeringNavbarLetsTtext, pageEngineeringNavbarLetsThref, pageEngineeringNavbarSearchtext, pageEngineeringNavbarSearchhref, pageEngineeringNavbarLangtext, pageEngineeringNavbarLanghref, pageEngineeringNavbarMenutext, pageEngineeringNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageEngineeringNavbarLogoimagesrc, pageEngineeringNavbarEngineeringtext, pageEngineeringNavbarEngineeringhref, pageEngineeringNavbarProductstext, pageEngineeringNavbarProductshref, pageEngineeringNavbarServicestext, pageEngineeringNavbarServiceshref, pageEngineeringNavbarBittext, pageEngineeringNavbarBithref, pageEngineeringNavbarLetsTtext, pageEngineeringNavbarLetsThref, pageEngineeringNavbarSearchtext, pageEngineeringNavbarSearchhref, pageEngineeringNavbarLangtext, pageEngineeringNavbarLanghref, pageEngineeringNavbarMenutext, pageEngineeringNavbarMenuhref });
