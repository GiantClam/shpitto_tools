...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-bg",
      "name": "page-about-us-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 74,
    ...
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-logo",
      "name": "page-about-us-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 118,
        "height": 36,
      ...
      "children": [],
      "imageProp": "pageAboutUsNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-about-us-navbar-SECTORS",
      "name": "page-about-us-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutUsNavbarSectorstext",
      "hrefProp": "pageAboutUsNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-about-us-navbar-PRODUCTS",
      "name": "page-about-us-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutUsNavbarProductstext",
      "hrefProp": "pageAboutUsNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-about-us-navbar-SUPPORT",
      "name": "page-about-us-navbar-SUPPORT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutUsNavbarSupporttext",
      "hrefProp": "pageAboutUsNavbarSupporthref"
    },
    {
      "type": "text",
      "id": "page-about-us-navbar-ABOUT",
      "name": "page-about-us-navbar-ABOUT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutUsNavbarAbouttext",
      "hrefProp": "pageAboutUsNavbarAbouthref"
    },
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-contact-box",
      "name": "page-about-us-navbar-contact-box",
      "style": {
        "boxSizing": "border-box",
        "width": 96,
        "height": 36,
    ...
    {
      "type": "text",
      "id": "page-about-us-navbar-contact-text",
      "name": "page-about-us-navbar-contact-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutUsNavbarContactTexttext",
      "hrefProp": "pageAboutUsNavbarContactTexthref"
    },
    {
      "type": "text",
      "id": "page-about-us-navbar-contact-arrow",
      "name": "page-about-us-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAboutUsNavbarContactArrowtext",
      "hrefProp": "pageAboutUsNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-menu-hit",
      "name": "page-about-us-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-menu-line1",
      "name": "page-about-us-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-menu-line2",
      "name": "page-about-us-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-about-us-navbar-menu-line3",
      "name": "page-about-us-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-about-us-navbar",
  "pageAboutUsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageAboutUsNavbarSectorstext": "SECTORS",
  "pageAboutUsNavbarSectorshref": "/",
  "pageAboutUsNavbarProductstext": "PRODUCTS",
  "pageAboutUsNavbarProductshref": "/products",
  "pageAboutUsNavbarSupporttext": "SUPPORT",
  "pageAboutUsNavbarSupporthref": "/support",
  "pageAboutUsNavbarAbouttext": "ABOUT",
  "pageAboutUsNavbarAbouthref": "/about-us",
  "pageAboutUsNavbarContactTexttext": "CONTACT",
  "pageAboutUsNavbarContactTexthref": "/contact-us",
  "pageAboutUsNavbarContactArrowtext": "›",
  "pageAboutUsNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteAboutUsNavigationNavbarpenPrimary({ id, pageAboutUsNavbarLogoimagesrc, pageAboutUsNavbarSectorstext, pageAboutUsNavbarSectorshref, pageAboutUsNavbarProductstext, pageAboutUsNavbarProductshref, pageAboutUsNavbarSupporttext, pageAboutUsNavbarSupporthref, pageAboutUsNavbarAbouttext, pageAboutUsNavbarAbouthref, pageAboutUsNavbarContactTexttext, pageAboutUsNavbarContactTexthref, pageAboutUsNavbarContactArrowtext, pageAboutUsNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAboutUsNavbarLogoimagesrc, pageAboutUsNavbarSectorstext, pageAboutUsNavbarSectorshref, pageAboutUsNavbarProductstext, pageAboutUsNavbarProductshref, pageAboutUsNavbarSupporttext, pageAboutUsNavbarSupporthref, pageAboutUsNavbarAbouttext, pageAboutUsNavbarAbouthref, pageAboutUsNavbarContactTexttext, pageAboutUsNavbarContactTexthref, pageAboutUsNavbarContactArrowtext, pageAboutUsNavbarContactArrowhref });
