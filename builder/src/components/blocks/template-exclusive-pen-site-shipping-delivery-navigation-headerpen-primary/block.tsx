...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-shipping-delivery",
  "name": "Header",
  "style": {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "nav-page-our-rides",
      "name": "nav-page-our-rides",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPageOurRidestext",
      "hrefProp": "navPageOurRideshref"
    },
    {
      "type": "text",
      "id": "nav-page-accessories",
      "name": "nav-page-accessories",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPageAccessoriestext",
      "hrefProp": "navPageAccessorieshref"
    },
    {
      "type": "text",
      "id": "nav-page-our-story",
      "name": "nav-page-our-story",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPageOurStorytext",
      "hrefProp": "navPageOurStoryhref"
    },
    {
      "type": "text",
      "id": "nav-page-peak-design",
      "name": "nav-page-peak-design",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPagePeakDesigntext",
      "hrefProp": "navPagePeakDesignhref"
    },
    {
      "type": "text",
      "id": "nav-page-shipping-delivery",
      "name": "nav-page-shipping-delivery",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPageShippingDeliverytext",
      "hrefProp": "navPageShippingDeliveryhref"
    }
  ]
};
const DEFAULT_PROPS = {
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #151515)";
...
export default function TemplateExclusivePenSiteShippingDeliveryNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageOurRidestext, navPageOurRideshref, navPageAccessoriestext, navPageAccessorieshref, navPageOurStorytext, navPageOurStoryhref, navPagePeakDesigntext, navPagePeakDesignhref, navPageShippingDeliverytext, navPageShippingDeliveryhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, headerBrandtext, headerBrandhref, navPageOurRidestext, navPageOurRideshref, navPageAccessoriestext, navPageAccessorieshref, navPageOurStorytext, navPageOurStoryhref, navPagePeakDesigntext, navPagePeakDesignhref, navPageShippingDeliverytext, navPageShippingDeliveryhref });
