...
const DEFAULT_PROPS = {
  "id": "G8wJR",
  "offhtext": "Our offices",
  "maptitletext": "IonQ’s Expanding",
  "mapsubtext": "🇺🇸  🇨🇦  🇬🇧  🇨🇭  🇸🇪  🇮🇹  🇰🇷",
  "gftext": "Global Footprint",
  "leftcitiestext": "Boston, MA, USA\n\nChattanooga, TN, USA\n\nWashington DC, USA\n\nCollege Park, MD, USA\n\nSeattle, WA, USA\n\nSan Francisco, CA, USA",
  "rightcitiestext": "Toronto, Canada\n\nGothenburg, Sweden\n\nOxford, United Kingdom\n\nSeoul, South Korea\n\nRome, Italy\n\nBasel, Switzerland\n\nGeneva, Switzerland",
  "copytext": "Copyright © 2025 IonQ, Inc. All Rights Reserved."
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryOfficespenAlt7({ id, offhtext, maptitletext, mapsubtext, gftext, leftcitiestext, rightcitiestext, copytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, offhtext, maptitletext, mapsubtext, gftext, leftcitiestext, rightcitiestext, copytext });
