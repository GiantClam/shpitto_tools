...
export default function TemplateExclusiveUnistellarHomeHomeStorySwitchsecpenAlt5({ id, switchtagtext, switchtitletext, switchsupporttext, steptitle1text, stepdesc1text, stepcard1href, steptitle2text, stepdesc2text, stepcard2href, steptitle3text, stepdesc3text, stepcard3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, switchtagtext, switchtitletext, switchsupporttext, steptitle1text, stepdesc1text, stepcard1href, steptitle2text, stepdesc2text, stepcard2href, steptitle3text, stepdesc3text, stepcard3href });
