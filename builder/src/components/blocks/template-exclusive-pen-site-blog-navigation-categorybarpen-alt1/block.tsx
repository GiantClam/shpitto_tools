...
const DEFAULT_PROPS = {
  "id": "bSTRz",
  "fmwkqtext": "All",
  "fmwkqhref": "/blog?category=all",
  "shvcttext": "News",
  "shvcthref": "/blog?category=news",
  "fmg0utext": "Releases",
  "fmg0uhref": "/blog?category=release",
  "usnltext": "Reviews",
  "usnlhref": "/blog?category=reviews",
  "krcrjtext": "Environment",
  "krcrjhref": "/blog?category=environment"
};
...
export default function TemplateExclusivePenSiteBlogNavigationCategorybarpenAlt1({ id, fmwkqtext, fmwkqhref, shvcttext, shvcthref, fmg0utext, fmg0uhref, usnltext, usnlhref, krcrjtext, krcrjhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, fmwkqtext, fmwkqhref, shvcttext, shvcthref, fmg0utext, fmg0uhref, usnltext, usnlhref, krcrjtext, krcrjhref });
