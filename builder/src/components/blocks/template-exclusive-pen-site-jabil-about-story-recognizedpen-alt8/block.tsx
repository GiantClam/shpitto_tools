...
export default function TemplateExclusivePenSiteJabilAboutStoryRecognizedpenAlt8({ id, reytext, rsubtext, r1text, r2text, r3text, recbtnhref, recbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, reytext, rsubtext, r1text, r2text, r3text, recbtnhref, recbtnttext });
