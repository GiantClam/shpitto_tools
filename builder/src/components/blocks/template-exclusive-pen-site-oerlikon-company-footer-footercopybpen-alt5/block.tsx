...
export default function TemplateExclusivePenSiteOerlikonCompanyFooterFootercopybpenAlt5({ id, jikbztext, ctfi7text, qn27vtext, qn27vhref, j3yzttext, j3yzthref, ngxzwtext, ngxzwhref, jxlzitext, urwpetext, pjqntext, pjqnhref, eehrwtext, eehrwhref, kddc1text, q88text, fssaitext, fssaihref, dpyjftext, dpyjfhref, gotjatext, gotjahref, fbmjqtext, ooas5text, b90dtext, b90dhref, inpxotext, inpxohref, jeshtext, bmxhwtext, bmxhwhref, xofrotext, rliuytext, lvibztext, k5rnctext, cubdetext, contactbtnhref, contacttexttext, ybqhtext, upwjwtext, upwjwhref, bmjertext, bmjerhref, klk0atext, lmbztext, lmbzhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, jikbztext, ctfi7text, qn27vtext, qn27vhref, j3yzttext, j3yzthref, ngxzwtext, ngxzwhref, jxlzitext, urwpetext, pjqntext, pjqnhref, eehrwtext, eehrwhref, kddc1text, q88text, fssaitext, fssaihref, dpyjftext, dpyjfhref, gotjatext, gotjahref, fbmjqtext, ooas5text, b90dtext, b90dhref, inpxotext, inpxohref, jeshtext, bmxhwtext, bmxhwhref, xofrotext, rliuytext, lvibztext, k5rnctext, cubdetext, contactbtnhref, contacttexttext, ybqhtext, upwjwtext, upwjwhref, bmjertext, bmjerhref, klk0atext, lmbztext, lmbzhref });
