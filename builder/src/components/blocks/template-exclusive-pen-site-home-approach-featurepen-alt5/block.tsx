...
const DEFAULT_PROPS = {
  "id": "ouSKb",
  "featimgimagesrc": "https://images.unsplash.com/photo-1551607895-9712a0c9260f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxMjIwMjV8&ixlib=rb-4.1.0&q=80&w=1080",
  "paaqptext": "Commercial advantage pillars",
  "qmsktext": "Learn how quantum can drive enterprise value.",
  "featbtnhref": "/",
  "f6text": "Learn more",
  "a8text": "Performance",
  "a9text": "Driving efficiency and unparalleled flexibility",
  "a10text": "Read more  →",
  "a12text": "Scale",
  "a13text": "Architecture that enables expansive growth",
  "a14text": "Read more  →",
  "a16text": "Enterprise-grade",
  "a17text": "Meeting real-world needs",
  "a18text": "Read more  →"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeApproachFeaturepenAlt5({ id, featimgimagesrc, paaqptext, qmsktext, featbtnhref, f6text, a8text, a9text, a10text, a12text, a13text, a14text, a16text, a17text, a18text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, featimgimagesrc, paaqptext, qmsktext, featbtnhref, f6text, a8text, a9text, a10text, a12text, a13text, a14text, a16text, a17text, a18text });
