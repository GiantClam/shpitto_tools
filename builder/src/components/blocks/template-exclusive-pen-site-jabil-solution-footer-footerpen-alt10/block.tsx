...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "socialrowtext",
      "hrefProp": "socialrowhref"
    },
    {
      "type": "frame",
      "id": "dxgpj",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerlinkstext",
      "hrefProp": "footerlinkshref"
    },
    {
      "type": "text",
      "id": "3QpNR",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #c4d0d8)";
...
export default function TemplateExclusivePenSiteJabilSolutionFooterFooterpenAlt10({ id, seqbptext, qeoiwtext, qeoiwhref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, seqbptext, qeoiwtext, qeoiwhref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref });
