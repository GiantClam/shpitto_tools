...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "herovisualimagesrc"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "i3WWF",
  "herotitletext": "我们的解决方案",
  "herodesctext": "在整个产品生命周期中为客户创造价值",
  "herobtnhref": "/",
  "herobtntxttext": "解决方案",
  "herovisualimagesrc": "https://images.unsplash.com/photo-1636368085784-ceb7909dba73?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDEzNDJ8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSolutionHeroSolheropenAlt1({ id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herovisualimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herovisualimagesrc });
