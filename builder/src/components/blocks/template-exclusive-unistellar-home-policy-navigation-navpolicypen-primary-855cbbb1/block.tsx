...
export default function TemplateExclusiveUnistellarHomePolicyNavigationNavpolicypenPrimary({ id, logotext, logohref, g7iitext, g7iihref, ahwkftext, ahwkfhref, seg1mtext, seg1mhref, zoypptext, zoypphref, hatqitext, hatqihref, ctahref, ctatexttext, ...rest }) {
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, g7iitext, g7iihref, ahwkftext, ahwkfhref, seg1mtext, seg1mhref, zoypptext, zoypphref, hatqitext, hatqihref, ctahref, ctatexttext });
