...
export default function TemplateExclusivePenSiteHomeStoryGlobalpenAlt3({ id, globaleyebrowtext, globaltitletext, ctqqtext, zjk9htext, xyof9text, fdjojtext, psyvitext, w5ccptext, icmntext, ey99gtext, yh67otext, etsdotext, xghbgtext, ugnmtext, linktxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, globaleyebrowtext, globaltitletext, ctqqtext, zjk9htext, xyof9text, fdjojtext, psyvitext, w5ccptext, icmntext, ey99gtext, yh67otext, etsdotext, xghbgtext, ugnmtext, linktxttext });
