...
export default function TemplateExclusivePenSiteSolutionNavigationSolheaderpenPrimary({ id, logotexttext, logotexthref, navtext, navhref, langtxttext, langtxthref, ctahtxttext, ctahtxthref, toplinkstext, toplinkshref, flagtxttext, flagtxthref, langarrowtext, langarrowhref, ...rest }) {
