...
export default function TemplateExclusivePenSiteHomeStoryCompanyprofilepenAlt10({ id, profileTitletext, profileCopytext, profileImg0imagesrc, profileImg1imagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, profileTitletext, profileCopytext, profileImg0imagesrc, profileImg1imagesrc });
