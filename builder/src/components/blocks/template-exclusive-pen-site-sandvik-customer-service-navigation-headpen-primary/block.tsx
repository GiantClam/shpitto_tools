...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "actionstext",
      "hrefProp": "actionshref"
    },
    {
      "type": "rectangle",
      "id": "Iv74B",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "searchtxttext",
      "hrefProp": "searchtxthref"
    },
    {
      "type": "rectangle",
      "id": "ni24Q",
    ...
    },
    {
      ...
      "children": [],
      "textProp": "logintxttext",
      "hrefProp": "logintxthref"
    },
    {
      "type": "rectangle",
      "id": "2xLyD",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #575246)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #222222)";
...
export default function TemplateExclusivePenSiteSandvikCustomerServiceNavigationHeadpenPrimary({ id, logotext, logohref, navtext, navhref, actionstext, actionshref, searchtxttext, searchtxthref, loginbtnhref, logintxttext, logintxthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, navtext, navhref, actionstext, actionshref, searchtxttext, searchtxthref, loginbtnhref, logintxttext, logintxthref });
