...
const DEFAULT_PROPS = {
  ...
  "pageBretonKappaGNavbarLangtext": "🌐",
...
export default function TemplateExclusivePenSiteBretonKappaGNavigationNavbarpenPrimary({ id, pageBretonKappaGNavbarLogoimagesrc, pageBretonKappaGNavbarSearchtext, pageBretonKappaGNavbarSearchhref, pageBretonKappaGNavbarLangtext, pageBretonKappaGNavbarLanghref, pageBretonKappaGNavbarMenutext, pageBretonKappaGNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageBretonKappaGNavbarLogoimagesrc, pageBretonKappaGNavbarSearchtext, pageBretonKappaGNavbarSearchhref, pageBretonKappaGNavbarLangtext, pageBretonKappaGNavbarLanghref, pageBretonKappaGNavbarMenutext, pageBretonKappaGNavbarMenuhref });
