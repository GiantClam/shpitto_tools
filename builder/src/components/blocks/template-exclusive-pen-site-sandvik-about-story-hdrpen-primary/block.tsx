...
export default function TemplateExclusivePenSiteSandvikAboutStoryHdrpenPrimary({ id, logotext, navtext, actionstext, searchtxttext, loginbtnhref, logintxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, navtext, actionstext, searchtxttext, loginbtnhref, logintxttext });
