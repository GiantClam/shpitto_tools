...
export default function TemplateExclusivePenSiteAerospaceSectorNavigationNavbarpenPrimary({ id, pageAerospaceSectorNavbarLogoimagesrc, pageAerospaceSectorNavbarContactTexttext, pageAerospaceSectorNavbarContactTexthref, pageAerospaceSectorNavbarContactArrowtext, pageAerospaceSectorNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAerospaceSectorNavbarLogoimagesrc, pageAerospaceSectorNavbarContactTexttext, pageAerospaceSectorNavbarContactTexthref, pageAerospaceSectorNavbarContactArrowtext, pageAerospaceSectorNavbarContactArrowhref });
