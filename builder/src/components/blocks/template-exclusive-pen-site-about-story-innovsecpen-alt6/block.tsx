...
export default function TemplateExclusivePenSiteAboutStoryInnovsecpenAlt6({ id, invtitletext, stat1text, stat2text, stat3text, videoimagesrc, sd1text, sd2text, sd3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, invtitletext, stat1text, stat2text, stat3text, videoimagesrc, sd1text, sd2text, sd3text });
