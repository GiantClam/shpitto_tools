...
export default function TemplateExclusivePenSiteOerlikonIndustriesStoryStoriescopybpenAlt4({ id, sttitletext, story1imagesrc, mvqegtext, story2imagesrc, yng28text, story3imagesrc, tst9ntext, stlinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sttitletext, story1imagesrc, mvqegtext, story2imagesrc, yng28text, story3imagesrc, tst9ntext, stlinktext });
