...
export default function TemplateExclusivePenSiteProducts1NavigationHeaderpenPrimary({ id, mcpprtext, mcpprhref, et5ybtext, et5ybhref, ozyp5text, ozyp5href, ky86ttext, ky86thref, ysmhctext, ysmhchref, ri5eftext, ri5efhref, idnvltext, idnvlhref, ej20xtext, ej20xhref, qdc7text, qdc7href, szugttext, szugthref, dp3z6text, dp3z6href, iveudtext, iveudhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, mcpprtext, mcpprhref, et5ybtext, et5ybhref, ozyp5text, ozyp5href, ky86ttext, ky86thref, ysmhctext, ysmhchref, ri5eftext, ri5efhref, idnvltext, idnvlhref, ej20xtext, ej20xhref, qdc7text, qdc7href, szugttext, szugthref, dp3z6text, dp3z6href, iveudtext, iveudhref });
