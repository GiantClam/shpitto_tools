...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "bitBtnTexttext",
      "hrefProp": "bitBtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "bit-img",
      ...
      "children": [],
      "imageProp": "bitImgimagesrc"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "bit",
  "bitKickertext": "WHERE TECHNOLOGICAL INNOVATION IS BORN",
  "bitTitletext": "BIT - Breton Institute\nof Technology",
  "bitCopytext": "Pioneer in the development of innovative processes, materials, machines and plants, Breton has always been committed to research.",
  "bitBtnBoxhref": "/",
  "bitBtnTexttext": "Discover more",
  "bitBtnTexthref": "/",
  "bitImgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/bit-559da0ba.jpg"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #232529)";
...
export default function TemplateExclusivePenSiteHomeStoryBitpenAlt6({ id, bitKickertext, bitTitletext, bitCopytext, bitBtnBoxhref, bitBtnTexttext, bitBtnTexthref, bitImgimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, bitKickertext, bitTitletext, bitCopytext, bitBtnBoxhref, bitBtnTexttext, bitBtnTexthref, bitImgimagesrc });
