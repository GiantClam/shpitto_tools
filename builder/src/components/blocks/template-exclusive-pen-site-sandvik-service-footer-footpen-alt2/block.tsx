...
export default function TemplateExclusivePenSiteSandvikServiceFooterFootpenAlt2({ id, flogotext, fdesctext, fdeschref, fcol1text, fcol1href, fcol2text, fcol2href, fcol3text, fcol3href, fcopytext, fcopyhref, rbtext, rbhref, ch1text, ch1href, ch2text, ch2href, ch3text, ch3href, ch4text, ch4href, soctext, sochref, rt1text, rt1href, rt2text, rt2href, locttext, locthref, ...rest }) {
