...
export default function TemplateExclusivePenSiteBlogFooterFooterpenAlt3({ id, y1pjgtext, boahrtext, boahrhref, hqbpktext, uj2cktext, uj2ckhref, iiv5dtext, tfjhstext, tfjhshref, iaikqtext, gzytext, gzyhref, hftivtext, brd7etext, brd7ehref, dmhketext, xjtjihref, vt300text, xsatptext, b7gutext, ...rest }) {
