...
export default function TemplateExclusivePenSiteTechnologyStoryAnnpenPrimary({ id, anntexttext, annbtnhref, annbtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, anntexttext, annbtnhref, annbtntxttext });
