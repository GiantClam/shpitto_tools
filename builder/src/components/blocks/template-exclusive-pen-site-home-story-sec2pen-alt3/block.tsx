...
const DEFAULT_PROPS = {
  "id": "D5Gkl",
  "sec2titletext": "Versatile solutions for every deployment",
  "s2c1iimagesrc": "https://images.unsplash.com/photo-1706625669737-7235e82eee30?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDYzODh8&ixlib=rb-4.1.0&q=80&w=1080",
  "s2c1ttext": "Military & Government",
  "s2c1dtext": "Global reach with seamless multi-orbit relays, ensuring constant and secure broadband connections in remote and challenging environments.",
  "btn21href": "/",
  "btn21ttext": "Learn more",
  "btn21thref": "/",
  "s2c2iimagesrc": "https://images.unsplash.com/photo-1747554451404-e4ff2fc467a4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDYzODh8&ixlib=rb-4.1.0&q=80&w=1080",
  "s2c2ttext": "Maritime",
  "s2c2dtext": "Uninterrupted communication at sea, from inland waterways to deep oceans, with excellent tracking in rough conditions.",
  "btn22href": "/",
  "btn22ttext": "Learn more",
  "btn22thref": "/",
  "s2c3iimagesrc": "https://images.unsplash.com/photo-1674068974343-83d577b56ceb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDYzODl8&ixlib=rb-4.1.0&q=80&w=1080",
  "s2c3ttext": "Land",
  "s2c3dtext": "High-speed, low-latency broadband for seamless operations in isolated areas, for workforce connectivity and between autonomous vehicles.",
  "btn23href": "/",
  "btn23ttext": "Learn more",
  "btn23thref": "/",
  "apptagtext": "APPLICATIONS"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #2b313a)";
...
export default function TemplateExclusivePenSiteHomeStorySec2penAlt3({ id, sec2titletext, s2c1iimagesrc, s2c1ttext, s2c1dtext, btn21href, btn21ttext, btn21thref, s2c2iimagesrc, s2c2ttext, s2c2dtext, btn22href, btn22ttext, btn22thref, s2c3iimagesrc, s2c3ttext, s2c3dtext, btn23href, btn23ttext, btn23thref, apptagtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec2titletext, s2c1iimagesrc, s2c1ttext, s2c1dtext, btn21href, btn21ttext, btn21thref, s2c2iimagesrc, s2c2ttext, s2c2dtext, btn22href, btn22ttext, btn22thref, s2c3iimagesrc, s2c3ttext, s2c3dtext, btn23href, btn23ttext, btn23thref, apptagtext });
