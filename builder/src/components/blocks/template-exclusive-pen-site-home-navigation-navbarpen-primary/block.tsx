...
const DEFAULT_PROPS = {
  ...
  "text6": "联系方式",
  "text7": "ZH",
  "logomarkimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Heebo",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, text, href, text2, text3, text4, fptText, fptHref, text5, text6, text7, logomarkimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, text, href, text2, text3, text4, fptText, fptHref, text5, text6, text7, logomarkimagesrc });
