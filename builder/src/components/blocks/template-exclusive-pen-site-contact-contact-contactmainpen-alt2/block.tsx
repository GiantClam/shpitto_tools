...
const ICONS = { ArrowLeft, ArrowRight, ChevronLeft, ChevronRight, Globe, HeartHandshake, Menu, MessageSquare, Minus, Newspaper, Play, Plus, Search, ShoppingBag, Sparkles, Wifi, X };
