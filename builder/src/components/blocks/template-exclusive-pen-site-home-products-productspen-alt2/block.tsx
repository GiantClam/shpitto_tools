...
export default function TemplateExclusivePenSiteHomeProductsProductspenAlt2({ id, text, text2, text3, text4, text5, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, text, text2, text3, text4, text5 });
