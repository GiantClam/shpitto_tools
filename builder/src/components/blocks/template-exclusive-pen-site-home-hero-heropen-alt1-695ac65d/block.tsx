...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "herobtntexttext",
      "hrefProp": "herobtntexthref"
    },
    {
      "type": "frame",
      "id": "iZixY",
...
const DEFAULT_PROPS = {
  "id": "oidUt",
  "herotagtext": "新产品",
  "herotitletext": "最新切削刀具和解决方案",
  "herobtnhref": "/",
  "herobtntexttext": "点击此处查看新产品",
  "herobtntexthref": "/",
  "heroimgimagesrc": "https://images.unsplash.com/photo-1763100351670-756f71d57c9f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjU2NjJ8&ixlib=rb-4.1.0&q=80&w=1080",
  "playtritext": "▶"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt1({ id, herotagtext, herotitletext, herobtnhref, herobtntexttext, herobtntexthref, heroimgimagesrc, playtritext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotagtext, herotitletext, herobtnhref, herobtntexttext, herobtntexthref, heroimgimagesrc, playtritext });
