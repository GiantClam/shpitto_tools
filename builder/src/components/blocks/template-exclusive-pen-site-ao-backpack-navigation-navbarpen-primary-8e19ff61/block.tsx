...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-ao-backpack-navbar-menu",
      "name": "page-ao-backpack-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageAoBackpackNavbarMenutext",
      "hrefProp": "pageAoBackpackNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pageAoBackpackNavbarMenutext": "☰",
  "pageAoBackpackNavbarMenuhref": "/",
  "pageAoBackpackNavbarSearchtext": "⌕",
...
export default function TemplateExclusivePenSiteAoBackpackNavigationNavbarpenPrimary({ id, pageAoBackpackNavbarLogoimagesrc, pageAoBackpackNavbarMenutext, pageAoBackpackNavbarMenuhref, pageAoBackpackNavbarSearchtext, pageAoBackpackNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageAoBackpackNavbarLogoimagesrc, pageAoBackpackNavbarMenutext, pageAoBackpackNavbarMenuhref, pageAoBackpackNavbarSearchtext, pageAoBackpackNavbarSearchhref });
