      ...
      "children": [
        {
          ...
          "style": {
            ...
            "width": 760,
            "height": 160,
            "background": "linear-gradient(0deg, #0A0D1000 0%, #0A0D10F2 100%)",
            "position": "absolute",
            "left": 0,
            "top": 360
          },
          ...
          "children": [
            {
              ...
              "children": [],
              "textProp": "textcardbodytext"
            }
          ]
        }
      ],
      "imageProp": "historycenterimagesrc"
    },
    {
      "type": "frame",
      "id": "E9Njd",
      ...
      "imageProp": "historyrightimagesrc"
    },
    {
      "type": "frame",
      "id": "TVHcZ",
...
export default function TemplateExclusivePenSiteUrsaAboutStorySectionhistorypenAlt5({ id, historyleftimagesrc, historycenterimagesrc, textcardbodytext, historyrightimagesrc, historytitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, historyleftimagesrc, historycenterimagesrc, textcardbodytext, historyrightimagesrc, historytitletext });
