...
export default function TemplateExclusivePenSiteContactFooterFooterpenAlt3({ id, flogottext, flogothref, fnavtext, fnavhref, copytext, copyhref, footeraddrtext, footeraddrhref, fbtext, fbhref, intext, inhref, ...rest }) {
