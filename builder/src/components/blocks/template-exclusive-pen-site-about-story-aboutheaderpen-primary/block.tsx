...
export default function TemplateExclusivePenSiteAboutStoryAboutheaderpenPrimary({ id, logotext, navtext, utilitytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, navtext, utilitytext });
