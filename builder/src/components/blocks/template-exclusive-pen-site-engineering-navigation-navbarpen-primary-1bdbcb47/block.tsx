...
export default function TemplateExclusivePenSiteEngineeringNavigationNavbarpenPrimary({ id, pageEngineeringNavbarLogoimagesrc, pageEngineeringNavbarSearchtext, pageEngineeringNavbarSearchhref, pageEngineeringNavbarLangtext, pageEngineeringNavbarLanghref, pageEngineeringNavbarMenutext, pageEngineeringNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageEngineeringNavbarLogoimagesrc, pageEngineeringNavbarSearchtext, pageEngineeringNavbarSearchhref, pageEngineeringNavbarLangtext, pageEngineeringNavbarLanghref, pageEngineeringNavbarMenutext, pageEngineeringNavbarMenuhref });
