...
export default function TemplateExclusivePenSitePscsBlogNavigationNavpenPrimary({ id, gtg0jtext, gtg0jhref, u1i5xtext, u1i5xhref, rkeetext, rkeehref, g2fu3text, g2fu3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, gtg0jtext, gtg0jhref, u1i5xtext, u1i5xhref, rkeetext, rkeehref, g2fu3text, g2fu3href });
