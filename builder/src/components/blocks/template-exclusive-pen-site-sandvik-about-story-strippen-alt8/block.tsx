...
const DEFAULT_PROPS = {
  "id": "TYJSF",
  "yttext": "“若要实现职业成功，你需要找到一家可供你实现发展的企业，一家开放、透明、基于正确价值观的企业。对我而言，这样的企业就是山特维克可乐满。”",
  "authtext": "海伦·布洛姆奎斯特 (Helen Blomqvist)\n山特维克可乐满总裁",
  "i1imagesrc": "https://images.unsplash.com/photo-1562877773-a37120131ec4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjk4MTF8&ixlib=rb-4.1.0&q=80&w=1080",
  "i2imagesrc": "https://images.unsplash.com/photo-1761410200102-b61792b4b76c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjk4MTF8&ixlib=rb-4.1.0&q=80&w=1080",
  "i4imagesrc": "https://images.unsplash.com/photo-1762854372010-f8a649ec0b91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMzE3NDJ8&ixlib=rb-4.1.0&q=80&w=1080"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSandvikAboutStoryStrippenAlt8({ id, yttext, authtext, i1imagesrc, i2imagesrc, i4imagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, yttext, authtext, i1imagesrc, i2imagesrc, i4imagesrc });
