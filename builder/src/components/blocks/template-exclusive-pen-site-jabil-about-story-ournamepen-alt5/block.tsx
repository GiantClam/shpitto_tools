...
export default function TemplateExclusivePenSiteJabilAboutStoryOurnamepenAlt5({ id, onimgimagesrc, onbadgetext, onplayicontext, onlogotext, oneytext, onsubtext, onbodytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, onimgimagesrc, onbadgetext, onplayicontext, onlogotext, oneytext, onsubtext, onbodytext });
