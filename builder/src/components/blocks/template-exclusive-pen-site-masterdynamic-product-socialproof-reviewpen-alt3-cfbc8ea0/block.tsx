...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "reviewdtext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "eygxt",
  "reviewttext": "Customer Reviews",
  "revealtxttext": "reveal / 180ms",
  "reviewstext": "4.8 / 5.0",
  "reviewdtext": "\"The best balance of comfort, clarity, and materials I've used in years.\" — Verified Buyer"
};
...
export default function TemplateExclusivePenSiteMasterdynamicProductSocialproofReviewpenAlt3({ id, reviewttext, revealtxttext, reviewstext, reviewdtext, ...rest }) {
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, reviewttext, revealtxttext, reviewstext, reviewdtext });
