...
const DEFAULT_PROPS = {
  "id": "numbers",
  "numTitletext": "A story told in numbers",
  "numCopytext": "The numbers outline the philosophy, history and growth of Breton, starting from the vision of the founder and proceeding in the aim of anticipating future trends.",
  "numV0text": "+100",
  "numL0text": "Countries in which Breton is present",
  "numV1text": "+1700",
  "numL1text": "Registered Patents",
  "numV2text": "+50",
  "numL2text": "Scientific partnerships with top universities",
  "numV3text": "+40",
  "numL3text": "Authorized Technical Services Worldwide"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryNumberspenAlt8({ id, numTitletext, numCopytext, numV0text, numL0text, numV1text, numL1text, numV2text, numL2text, numV3text, numL3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, numTitletext, numCopytext, numV0text, numL0text, numV1text, numL1text, numV2text, numL2text, numV3text, numL3text });
