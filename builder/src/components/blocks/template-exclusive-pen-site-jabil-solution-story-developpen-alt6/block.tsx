...
export default function TemplateExclusivePenSiteJabilSolutionStoryDeveloppenAlt6({ id, developimgimagesrc, peytext, i1bamtext, psubtext, pbtnhref, pbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, developimgimagesrc, peytext, i1bamtext, psubtext, pbtnhref, pbtnttext });
