...
export default function TemplateExclusivePenSiteHomeNavigationHeaderpenPrimary({ id, elhutext, elhuhref, xg0zjtext, xg0zjhref, vvetext, vvehref, nizdctext, nizdchref, yjeptext, yjephref, f57oqtext, f57oqhref, uj4aftext, uj4afhref, vlkr7text, vlkr7href, ybebrtext, ybebrhref, wzietext, wziehref, nilptext, nilphref, hvhywtext, hvhywhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, elhutext, elhuhref, xg0zjtext, xg0zjhref, vvetext, vvehref, nizdctext, nizdchref, yjeptext, yjephref, f57oqtext, f57oqhref, uj4aftext, uj4afhref, vlkr7text, vlkr7href, ybebrtext, ybebrhref, wzietext, wziehref, nilptext, nilphref, hvhywtext, hvhywhref });
