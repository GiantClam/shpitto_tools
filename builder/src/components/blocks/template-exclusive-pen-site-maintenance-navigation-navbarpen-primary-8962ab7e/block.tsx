...
export default function TemplateExclusivePenSiteMaintenanceNavigationNavbarpenPrimary({ id, pageMaintenanceNavbarLogoimagesrc, pageMaintenanceNavbarContactTexttext, pageMaintenanceNavbarContactTexthref, pageMaintenanceNavbarContactArrowtext, pageMaintenanceNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageMaintenanceNavbarLogoimagesrc, pageMaintenanceNavbarContactTexttext, pageMaintenanceNavbarContactTexthref, pageMaintenanceNavbarContactArrowtext, pageMaintenanceNavbarContactArrowhref });
