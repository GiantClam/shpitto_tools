...
export default function TemplateExclusivePenSiteResourcesStoryResourcefilterspenAlt8({ id, f1ttext, f2ttext, f3ttext, f4ttext, f5ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, f1ttext, f2ttext, f3ttext, f4ttext, f5ttext });
