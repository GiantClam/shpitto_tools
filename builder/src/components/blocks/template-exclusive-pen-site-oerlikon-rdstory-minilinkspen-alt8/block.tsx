...
export default function TemplateExclusivePenSiteOerlikonRDStoryMinilinkspenAlt8({ id, mini1imgimagesrc, cq6wgtext, mini2imgimagesrc, j8wjqtext, mini3imgimagesrc, upcfptext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, mini1imgimagesrc, cq6wgtext, mini2imgimagesrc, j8wjqtext, mini3imgimagesrc, upcfptext });
