...
export default function TemplateExclusivePenSiteHomeApproachFeaturedpenAlt2({ id, featuredTitletext, featCardImg0imagesrc, featCardK0text, featCardT0text, featCardImg1imagesrc, featCardK1text, featCardT1text, featCardK2text, featCardT2text, featCardK3text, featCardT3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, featuredTitletext, featCardImg0imagesrc, featCardK0text, featCardT0text, featCardImg1imagesrc, featCardK1text, featCardT1text, featCardK2text, featCardT2text, featCardK3text, featCardT3text });
