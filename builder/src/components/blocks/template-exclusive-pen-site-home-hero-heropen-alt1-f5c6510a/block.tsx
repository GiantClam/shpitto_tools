...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt1({ id, heroimagesrc, h1text, h2text, hdesctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroimagesrc, h1text, h2text, hdesctext });
