...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "rectangle",
      "id": "story-card-0-image",
      "name": "story-card-0-image",
      "style": {
        "boxSizing": "border-box",
        "width": 326,
        "height": 92,
      ...
      "children": [],
      "imageProp": "storyCard0Imageimagesrc"
    },
    {
      "type": "text",
      "id": "story-card-0-eyebrow",
      "name": "story-card-0-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard0Eyebrowtext"
    },
    {
      "type": "text",
      "id": "story-card-0-title",
      "name": "story-card-0-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard0Titletext"
    },
    {
      "type": "text",
      "id": "story-card-0-body",
      "name": "story-card-0-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "storyCard0Bodytext"
    },
    {
      "type": "text",
      "id": "story-card-0-arrow",
      "name": "story-card-0-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
...
const DEFAULT_PROPS = {
  ...
  "storyCard0Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/sector-aerospace-1c409b17.jpg",
  "storyCard0Eyebrowtext": "SECTOR",
  "storyCard0Titletext": "AEROSPACE SECTOR",
  "storyCard0Bodytext": "Processing of hard materials for the aerospace sector.",
  "storyCard0Arrowtext": "›",
  "storyCard1Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/sector-energy-40ca7931.jpg",
  "storyCard1Eyebrowtext": "SECTOR",
  "storyCard1Titletext": "ENERGY SECTOR",
  "storyCard1Bodytext": "Precision and repeatability for energy applications.",
  "storyCard1Arrowtext": "›",
  "storyCard2Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/sector-transport-18e8f590.jpg",
  "storyCard2Eyebrowtext": "SECTOR",
  "storyCard2Titletext": "TRANSPORT SECTOR",
  "storyCard2Bodytext": "Flexible, reliable solutions for transport components.",
  "storyCard2Arrowtext": "›"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryMoveinstylepenAlt1({ id, storyTitletext, storyCopytext, storyCard0Imageimagesrc, storyCard0Eyebrowtext, storyCard0Titletext, storyCard0Bodytext, storyCard0Arrowtext, storyCard1Imageimagesrc, storyCard1Eyebrowtext, storyCard1Titletext, storyCard1Bodytext, storyCard1Arrowtext, storyCard2Imageimagesrc, storyCard2Eyebrowtext, storyCard2Titletext, storyCard2Bodytext, storyCard2Arrowtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, storyTitletext, storyCopytext, storyCard0Imageimagesrc, storyCard0Eyebrowtext, storyCard0Titletext, storyCard0Bodytext, storyCard0Arrowtext, storyCard1Imageimagesrc, storyCard1Eyebrowtext, storyCard1Titletext, storyCard1Bodytext, storyCard1Arrowtext, storyCard2Imageimagesrc, storyCard2Eyebrowtext, storyCard2Titletext, storyCard2Bodytext, storyCard2Arrowtext });
