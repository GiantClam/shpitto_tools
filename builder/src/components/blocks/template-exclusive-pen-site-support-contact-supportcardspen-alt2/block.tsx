...
const DEFAULT_PROPS = {
  "id": "aZTSN",
  "c1imgimagesrc": "https://images.unsplash.com/photo-1762271232351-30d1dde5d53b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjM1MDB8&ixlib=rb-4.1.0&q=80&w=1080",
  "c1ttext": "Resources",
  "c1dtext": "Visit our resources page for everything from how-to videos to product documentation, data sheets, technical documentation and much more.",
  "c1bttext": "Access resources",
  "c2imgimagesrc": "https://images.unsplash.com/photo-1753596726279-fcd814647a2c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjM1MDF8&ixlib=rb-4.1.0&q=80&w=1080",
  "c2ttext": "Kymeta Access App Portal",
  "c2dtext": "Kymeta Access is available as an Android tablet and iOS mobile application or a web portal. Designed to support directly with your service, subscriptions + data management, and support ticket and service dispatch requests, subscription management, and support ticketing.",
  "c2bttext": "Discover Kymeta Access",
  "c3imgimagesrc": "https://images.unsplash.com/photo-1671104695363-fc7feefbb682?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjM1MDJ8&ixlib=rb-4.1.0&q=80&w=1080",
  "c3ttext": "Training (online or instructor-led)",
  "c3dtext": "Kymeta offers several virtual and in-person classes to enable a successful deployment and continued uptime of terminal operations. Our online training portal provides video and self-directed and instructor-led virtual classes.",
  "c3bttext": "Training",
  "c4imgimagesrc": "https://images.unsplash.com/photo-1590239683804-b9f5725fe77c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjM1MDN8&ixlib=rb-4.1.0&q=80&w=1080",
  "c4ttext": "Policies & warranties",
  "c4dtext": "Our products are backed by an included 12-month warranty with the option to extend up to an additional 24 years. Learn about terms and other policies, including downloadable warranty documentation.",
  "c4bttext": "Policies & warranties"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSupportContactSupportcardspenAlt2({ id, c1imgimagesrc, c1ttext, c1dtext, c1bttext, c2imgimagesrc, c2ttext, c2dtext, c2bttext, c3imgimagesrc, c3ttext, c3dtext, c3bttext, c4imgimagesrc, c4ttext, c4dtext, c4bttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, c1imgimagesrc, c1ttext, c1dtext, c1bttext, c2imgimagesrc, c2ttext, c2dtext, c2bttext, c3imgimagesrc, c3ttext, c3dtext, c3bttext, c4imgimagesrc, c4ttext, c4dtext, c4bttext });
