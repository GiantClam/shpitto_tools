  ...
  "children": [
    {
      ...
      "style": {
        ...
        "width": 1440,
        "height": 528,
        "background": "linear-gradient(90deg, #04142d 0%, #001024 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
    ...
    },
    {
      ...
      "style": {
        ...
        "height": 92,
        "borderRadius": 44,
        "background": "linear-gradient(90deg, #23d2ff 0%, #158fe7 100%)",
        "position": "absolute",
        "left": 431,
        "top": 102
      },
    ...
    },
    {
      ...
      "style": {
        ...
        "height": 90,
        "borderRadius": 43,
        "background": "linear-gradient(90deg, #138de6 0%, #23d2ff 100%)",
        "position": "absolute",
        "left": 445,
        "top": 250
      },
...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt1({ id, yqclhtext, h9bqktext, sjib8text, btnrowbhref, agwxutext, s32z6text, q7j1ftext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, yqclhtext, h9bqktext, sjib8text, btnrowbhref, agwxutext, s32z6text, q7j1ftext });
