...
export default function TemplateExclusivePenSiteUrsaContactStoryCareersintropenAlt3({ id, xupg8text, g7ww8imagesrc, p13uuimagesrc, yur38imagesrc, rcfsyimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, xupg8text, g7ww8imagesrc, p13uuimagesrc, yur38imagesrc, rcfsyimagesrc });
