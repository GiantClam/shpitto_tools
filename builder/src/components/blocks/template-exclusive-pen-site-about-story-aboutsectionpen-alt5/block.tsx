...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "foundedlabel2text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "ffQEc",
  "abouthtext": "About IonQ",
  "aboutp1text": "Founded in 2015 by Dr. Chris Monroe and Dr. Jungsang Kim, IonQ emerged from more than 30 years of academic research and foundational breakthroughs licensed from the University of Maryland and Duke University. With early support from global venture capital firm New Enterprise Associates and the goal of bringing trapped ion quantum computing out of the lab and into real-world use, IonQ has since grown into a global leader in quantum computing, networking, and sensing.",
  "aboutp2text": "IonQ has established partnerships with leading academic institutions, industry innovators, and federal agencies, and continues to advance one of the most aggressive technology roadmaps in the field. Our mission is to solve problems that are beyond the reach of classical systems.",
  "locttext": "College Park, MD",
  "yearttext": "2015",
  "para32text": "We are accelerating our technology and commercial roadmap toward world’s most powerful quantum systems for practical innovation in chemistry, logistics, financial modeling, cybersecurity, and defense.",
  "hqlabel2text": "[ Headquartered ]",
  "foundedlabel2text": "[ Founded ]"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryAboutsectionpenAlt5({ id, abouthtext, aboutp1text, aboutp2text, locttext, yearttext, para32text, hqlabel2text, foundedlabel2text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, abouthtext, aboutp1text, aboutp2text, locttext, yearttext, para32text, hqlabel2text, foundedlabel2text });
