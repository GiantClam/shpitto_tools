...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "dealsBtnTexttext",
      "hrefProp": "dealsBtnTexthref"
    },
    {
      "type": "text",
      "id": "deals-copy",
...
const DEFAULT_PROPS = {
  "id": "deals",
  "dealsTitletext": "Breton Deals",
  "dealsBtnBoxhref": "/",
  "dealsBtnTexttext": "Discover more",
  "dealsBtnTexthref": "/",
  "dealsCopytext": "Explore Breton second-hand machinery for compound stone and natural stone at attractive prices."
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryBretondealspenAlt4({ id, dealsTitletext, dealsBtnBoxhref, dealsBtnTexttext, dealsBtnTexthref, dealsCopytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, dealsTitletext, dealsBtnBoxhref, dealsBtnTexttext, dealsBtnTexthref, dealsCopytext });
