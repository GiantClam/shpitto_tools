...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "utilitytext",
      "hrefProp": "utilityhref"
    }
  ]
};
const DEFAULT_PROPS = {
  ...
  "logotext": "KYMETA",
  "logohref": "/",
  "navtext": "Why Kymeta     Applications     Products & Services     Support     About",
  "navhref": "/products",
  "utilitytext": "Contact     Sign in ↗",
  "utilityhref": "/contact"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #D8E2F1)";
...
export default function TemplateExclusivePenSiteApplicationNavigationAppheaderpenPrimary({ id, logotext, logohref, navtext, navhref, utilitytext, utilityhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, navtext, navhref, utilitytext, utilityhref });
