...
export default function TemplateExclusivePenSiteOerlikonCompanyStoryValuespenAlt3({ id, evg0timagesrc, eelmttext, uip9vtext, gagduimagesrc, fvb0text, iszj7text, thgceimagesrc, dtlk3text, lkaqitext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, evg0timagesrc, eelmttext, uip9vtext, gagduimagesrc, fvb0text, iszj7text, thgceimagesrc, dtlk3text, lkaqitext });
