...
export default function TemplateExclusivePenSiteProductsNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarSearchtext, pageProductsNavbarSearchhref, pageProductsNavbarLangtext, pageProductsNavbarLanghref, pageProductsNavbarMenutext, pageProductsNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarSearchtext, pageProductsNavbarSearchhref, pageProductsNavbarLangtext, pageProductsNavbarLanghref, pageProductsNavbarMenutext, pageProductsNavbarMenuhref });
