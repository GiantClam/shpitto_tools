...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-products-navbar-Engineering",
      "name": "page-products-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarEngineeringtext",
      "hrefProp": "pageProductsNavbarEngineeringhref"
    },
    {
      "type": "text",
    ...
    {
      "type": "text",
      "id": "page-products-navbar-Services",
      "name": "page-products-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarServicestext",
      "hrefProp": "pageProductsNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-BIT",
      "name": "page-products-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarBittext",
      "hrefProp": "pageProductsNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-products-navbar-lets",
      "name": "page-products-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-products-navbar-lets-t",
      "name": "page-products-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarLetsTtext",
      "hrefProp": "pageProductsNavbarLetsThref"
    },
    {
      "type": "text",
    ...
    {
      "type": "text",
      "id": "page-products-navbar-lang",
      "name": "page-products-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarLangtext",
      "hrefProp": "pageProductsNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-menu",
      "name": "page-products-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarMenutext",
      "hrefProp": "pageProductsNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-products-navbar",
  "pageProductsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageProductsNavbarEngineeringtext": "Engineering",
  "pageProductsNavbarEngineeringhref": "/engineering",
  "pageProductsNavbarProductstext": "Products",
  "pageProductsNavbarProductshref": "/products",
  "pageProductsNavbarServicestext": "Services",
  "pageProductsNavbarServiceshref": "/services",
  "pageProductsNavbarBittext": "BIT",
  "pageProductsNavbarBithref": "/bit",
  "pageProductsNavbarLetsTtext": "Let's talk",
  "pageProductsNavbarLetsThref": "/",
  "pageProductsNavbarSearchtext": "⌕",
  "pageProductsNavbarSearchhref": "/",
  "pageProductsNavbarLangtext": "Language",
  "pageProductsNavbarLanghref": "/",
  "pageProductsNavbarMenutext": "☰",
  "pageProductsNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteProductsNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarEngineeringtext, pageProductsNavbarEngineeringhref, pageProductsNavbarProductstext, pageProductsNavbarProductshref, pageProductsNavbarServicestext, pageProductsNavbarServiceshref, pageProductsNavbarBittext, pageProductsNavbarBithref, pageProductsNavbarLetsTtext, pageProductsNavbarLetsThref, pageProductsNavbarSearchtext, pageProductsNavbarSearchhref, pageProductsNavbarLangtext, pageProductsNavbarLanghref, pageProductsNavbarMenutext, pageProductsNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarEngineeringtext, pageProductsNavbarEngineeringhref, pageProductsNavbarProductstext, pageProductsNavbarProductshref, pageProductsNavbarServicestext, pageProductsNavbarServiceshref, pageProductsNavbarBittext, pageProductsNavbarBithref, pageProductsNavbarLetsTtext, pageProductsNavbarLetsThref, pageProductsNavbarSearchtext, pageProductsNavbarSearchhref, pageProductsNavbarLangtext, pageProductsNavbarLanghref, pageProductsNavbarMenutext, pageProductsNavbarMenuhref });
