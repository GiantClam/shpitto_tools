...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt1({ id, x8zgjimagesrc, fxfprtext, z6x5atext, yeubitext, gf0irtext, z5epbtext, cg3jctext, rszngtext, gat6ntext, fldaxtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, x8zgjimagesrc, fxfprtext, z6x5atext, yeubitext, gf0irtext, z5epbtext, cg3jctext, rszngtext, gat6ntext, fldaxtext });
