  ...
  "children": [
    ...
    },
    {
      ...
      "style": {
        ...
        "width": 1440,
        "height": 620,
        "background": "linear-gradient(0deg, #00000000 0%, #00000030 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
...
const DEFAULT_PROPS = {
  "id": "CY3FA",
  "timelineimgimagesrc": "https://images.unsplash.com/photo-1461360370896-922624d12aa1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHNlYXJjaHwxfHxvbGQlMjBwcm9mZXNzb3IlMjBibGFja2JvYXJkfGVufDB8fHx8MTc3MzI3MTAwOXww&ixlib=rb-4.1.0&q=80&w=1600",
  "yeartitletext": "1967",
  "yeardesctext": "Physicist Victor Veselago, Ph.D., publishes an analysis stating that materials could be created to have both negative permittivity and permeability. This theoretical material does not exist in nature, but Veselago's research shows the remarkable properties such a material would possess.",
  "yearcredittext": "Image source: Wikimedia Commons, modified to fit format"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStorySec3penAlt3({ id, timelineimgimagesrc, yeartitletext, yeardesctext, yearcredittext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, timelineimgimagesrc, yeartitletext, yeardesctext, yearcredittext });
