...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #d3e4ef)";
...
export default function TemplateExclusivePenSiteJabilCapabilitiesNavigationHeaderpenPrimary({ id, logotext, logohref, navtext, navhref, searchtext, searchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, navtext, navhref, searchtext, searchhref });
