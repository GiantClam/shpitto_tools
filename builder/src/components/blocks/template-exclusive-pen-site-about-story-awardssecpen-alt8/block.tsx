...
export default function TemplateExclusivePenSiteAboutStoryAwardssecpenAlt8({ id, awhtext, awctltext, t1text, t2text, t3text, t4text, t5text, t6text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, awhtext, awctltext, t1text, t2text, t3text, t4text, t5text, t6text });
