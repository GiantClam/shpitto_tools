...
export default function TemplateExclusivePenSiteHandlebarRisersNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
