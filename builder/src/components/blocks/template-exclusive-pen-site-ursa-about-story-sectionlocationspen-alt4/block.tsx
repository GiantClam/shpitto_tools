    ...
    },
    {
      ...
      "children": [
          ...
          "children": [
            {
              ...
              "children": [
                {
                  ...
                  "style": {
                    ...
                    "width": 680,
                    "height": 230,
                    "background": "linear-gradient(0deg, #FF6D4AB3 0%, #D34A30CC 100%)",
                    "position": "absolute",
                    "left": 0,
                    "top": 0
                  },
              ...
              "imageProp": "leftMountainimagesrc"
            },
            {
              "type": "rectangle",
              "id": "Iu0Ld",
        ...
        },
        {
          ...
          "children": [],
          "imageProp": "locationsRightimagesrc"
        }
      ]
    }
  ]
...
export default function TemplateExclusivePenSiteUrsaAboutStorySectionlocationspenAlt4({ id, loctitletext, leftMountainimagesrc, loclefttexttext, locationsRightimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, loctitletext, leftMountainimagesrc, loclefttexttext, locationsRightimagesrc });
