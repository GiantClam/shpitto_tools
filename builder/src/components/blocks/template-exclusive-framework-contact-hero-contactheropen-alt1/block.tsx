...
export default function TemplateExclusiveFrameworkContactHeroContactheropenAlt1({ id, herotitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext });
