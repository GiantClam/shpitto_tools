...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "fusionPlaytext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "fusion",
  "fusionTitletext": "A Fusion of Innovative Tools and Your Imagination",
  "fusionVideoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-video-619161bb.jpg",
  "fusionPlaytext": "▶"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryFusionpenAlt2({ id, fusionTitletext, fusionVideoimagesrc, fusionPlaytext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, fusionTitletext, fusionVideoimagesrc, fusionPlaytext });
