...
export default function TemplateExclusivePenSiteOerlikonRDStoryAwardpenAlt4({ id, rj9setext, dof4text, lvk28text, p7ibutext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, rj9setext, dof4text, lvk28text, p7ibutext });
