...
export default function TemplateExclusivePenSiteJabilSolutionNavigationHeaderpenPrimary({ id, logotext, logohref, navtext, navhref, searchtext, searchhref, ...rest }) {
