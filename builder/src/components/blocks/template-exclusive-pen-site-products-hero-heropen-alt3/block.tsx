  ...
  "children": [
    {
      ...
      "style": {
        ...
        "width": 1440,
        "height": 560,
        "background": "linear-gradient(90deg, #03070ECC 0%, #03070E66 45%, #03070E20 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
...
const DEFAULT_PROPS = {
  "id": "AQUKO",
  "heroimagesrc": "https://images.unsplash.com/photo-1493238792000-8113da705763?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHNlYXJjaHwxfHxtaWxpdGFyeSUyMHZlaGljbGUlMjBkZXNlcnR8ZW58MHx8fHwxNzczMjcxOTQ2fDA&ixlib=rb-4.1.0&q=80&w=1600",
  "herotitletext": "Durable user terminals for mission-critical operations",
  "herotagtext": "Products"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteProductsHeroHeropenAlt3({ id, heroimagesrc, herotitletext, herotagtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroimagesrc, herotitletext, herotagtext });
