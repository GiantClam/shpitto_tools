  ...
  "children": [
    ...
    },
    {
      ...
      "style": {
        ...
        "width": 1440,
        "height": 260,
        "background": "linear-gradient(90deg, #03070ECC 0%, #03070E55 50%, #03070EDD 100%)",
        "position": "absolute",
        "left": 0,
        "top": 0
      },
...
const DEFAULT_PROPS = {
  "id": "mzw9R",
  "heroimgimagesrc": "https://images.unsplash.com/photo-1652523229217-02b0cf805f1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMjEzMDJ8&ixlib=rb-4.1.0&q=80&w=1080",
...
export default function TemplateExclusivePenSiteContactHeroContactheropenAlt1({ id, heroimgimagesrc, herotitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroimgimagesrc, herotitletext });
