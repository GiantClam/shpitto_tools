...
export default function TemplateExclusivePenSiteHomeContactContactpenAlt6({ id, contacttitletext, contactbgimagesrc, contactbtnhref, contactbtnttext, contactbtnthref, qtagtext, qdesctext, ...rest }) {
