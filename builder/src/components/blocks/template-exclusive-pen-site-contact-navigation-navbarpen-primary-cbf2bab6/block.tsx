...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-contact-navbar-menu",
      "name": "page-contact-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactNavbarMenutext",
      "hrefProp": "pageContactNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pageContactNavbarMenutext": "☰",
  "pageContactNavbarMenuhref": "/",
  "pageContactNavbarSearchtext": "⌕",
...
export default function TemplateExclusivePenSiteContactNavigationNavbarpenPrimary({ id, pageContactNavbarLogoimagesrc, pageContactNavbarMenutext, pageContactNavbarMenuhref, pageContactNavbarSearchtext, pageContactNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactNavbarLogoimagesrc, pageContactNavbarMenutext, pageContactNavbarMenuhref, pageContactNavbarSearchtext, pageContactNavbarSearchhref });
