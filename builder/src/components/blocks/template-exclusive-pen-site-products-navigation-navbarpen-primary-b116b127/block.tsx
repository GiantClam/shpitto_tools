...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-products-navbar-SECTORS",
      "name": "page-products-navbar-SECTORS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarSectorstext",
      "hrefProp": "pageProductsNavbarSectorshref"
    },
    {
      "type": "text",
      "id": "page-products-navbar-PRODUCTS",
      "name": "page-products-navbar-PRODUCTS",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarProductstext",
      "hrefProp": "pageProductsNavbarProductshref"
    },
    {
      "type": "text",
    ...
    {
      "type": "text",
      "id": "page-products-navbar-contact-arrow",
      "name": "page-products-navbar-contact-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageProductsNavbarContactArrowtext",
      "hrefProp": "pageProductsNavbarContactArrowhref"
    },
    {
      "type": "rectangle",
      "id": "page-products-navbar-menu-hit",
      "name": "page-products-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-products-navbar-menu-line1",
      "name": "page-products-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-products-navbar-menu-line2",
      "name": "page-products-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-products-navbar-menu-line3",
      "name": "page-products-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 12,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-products-navbar",
  "pageProductsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/pama-logo.png",
  "pageProductsNavbarSectorstext": "SECTORS",
  "pageProductsNavbarSectorshref": "/",
  "pageProductsNavbarProductstext": "PRODUCTS",
  "pageProductsNavbarProductshref": "/products",
  "pageProductsNavbarSupporttext": "SUPPORT",
  "pageProductsNavbarSupporthref": "/support",
  "pageProductsNavbarAbouttext": "ABOUT",
  "pageProductsNavbarAbouthref": "/about-us",
  "pageProductsNavbarContactTexttext": "CONTACT",
  "pageProductsNavbarContactTexthref": "/contact-us",
  "pageProductsNavbarContactArrowtext": "›",
  "pageProductsNavbarContactArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteProductsNavigationNavbarpenPrimary({ id, pageProductsNavbarLogoimagesrc, pageProductsNavbarSectorstext, pageProductsNavbarSectorshref, pageProductsNavbarProductstext, pageProductsNavbarProductshref, pageProductsNavbarSupporttext, pageProductsNavbarSupporthref, pageProductsNavbarAbouttext, pageProductsNavbarAbouthref, pageProductsNavbarContactTexttext, pageProductsNavbarContactTexthref, pageProductsNavbarContactArrowtext, pageProductsNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageProductsNavbarLogoimagesrc, pageProductsNavbarSectorstext, pageProductsNavbarSectorshref, pageProductsNavbarProductstext, pageProductsNavbarProductshref, pageProductsNavbarSupporttext, pageProductsNavbarSupporthref, pageProductsNavbarAbouttext, pageProductsNavbarAbouthref, pageProductsNavbarContactTexttext, pageProductsNavbarContactTexthref, pageProductsNavbarContactArrowtext, pageProductsNavbarContactArrowhref });
