...
export default function TemplateExclusiveFrameworkHomeHeroHero2penAlt2({ id, hero2limagesrc, h2t1text, h2t2text, h2bttext, dxtv6text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hero2limagesrc, h2t1text, h2t2text, h2bttext, dxtv6text });
