...
export default function TemplateExclusivePenSitePrivacyStoryPrivacymainpenAlt3({ id, crumbtext, titletext, headtext, p1text, ct1text, cd1text, b1ttext, ct2text, cd2text, b2ttext, ct3text, cd3text, b3ttext, ct4text, cd4text, b4ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, crumbtext, titletext, headtext, p1text, ct1text, cd1text, b1ttext, ct2text, cd2text, b2ttext, ct3text, cd3text, b3ttext, ct4text, cd4text, b4ttext });
