      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "herorighttxttext"
        }
      ]
    }
  ],
  "imageProp": "heroimagesrc"
};
const DEFAULT_PROPS = {
  "id": "zDKcC",
  "heroimagesrc": "https://images.unsplash.com/photo-1643685807520-602b232ef3ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMxNDQ3OTl8&ixlib=rb-4.1.0&q=80&w=1080",
  "badgetexttext": "IonQ Earns ISO 14001 Certification, Advancing Enterprise-Ready Quantum Innovation",
  "herotitletext": "Quantum is now.",
  "herodesctext": "Quantum computing is changing the world, and IonQ is leading the way across quantum computing, networking, sensing, and security.",
  "herobtnhref": "/",
  "herobtntxttext": "Start your quantum journey",
  "herorighttxttext": "Learn more about our roadmap"
};
const DEFAULT_THEME = {
  "mode": "dark",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenAlt2({ id, heroimagesrc, badgetexttext, herotitletext, herodesctext, herobtnhref, herobtntxttext, herorighttxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroimagesrc, badgetexttext, herotitletext, herodesctext, herobtnhref, herobtntxttext, herorighttxttext });
