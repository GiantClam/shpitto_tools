...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "history-parent-bg",
      "name": "history-parent-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 390,
        "height": 640,
      ...
      "children": [],
      "imageProp": "historyParentBgimagesrc"
    },
    {
      "type": "rectangle",
      "id": "history-parent-shade",
      "name": "history-parent-shade",
      "style": {
        "boxSizing": "border-box",
        "width": 390,
        "height": 640,
    ...
    },
    {
      ...
      "children": [],
      "textProp": "historyQuotetext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "history-parent",
  "historyParentBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/history.jpg",
  "historyTitletext": "History of a dream",
  "historyItem1text": "Past",
  "historyItem2text": "Present",
  "historyItem3text": "Future",
  "historyQuotetext": "Inspired, at the highest level, by beauty and scientific research."
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryHistoryparentpenAlt1({ id, historyParentBgimagesrc, historyTitletext, historyItem1text, historyItem2text, historyItem3text, historyQuotetext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, historyParentBgimagesrc, historyTitletext, historyItem1text, historyItem2text, historyItem3text, historyQuotetext });
