...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroBannerimagesrc, heroBannerBadgeimagesrc, homeNavbarLogoimagesrc, homeNavbarMenutext, homeNavbarSearchtext, heroBannerTexttext, heroKickertext, heroTitletext, heroCardLeftImageimagesrc, heroCardRightImageimagesrc, heroCardLeftLabeltext, heroCardRightLabeltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroBannerimagesrc, heroBannerBadgeimagesrc, homeNavbarLogoimagesrc, homeNavbarMenutext, homeNavbarSearchtext, heroBannerTexttext, heroKickertext, heroTitletext, heroCardLeftImageimagesrc, heroCardRightImageimagesrc, heroCardLeftLabeltext, heroCardRightLabeltext });
