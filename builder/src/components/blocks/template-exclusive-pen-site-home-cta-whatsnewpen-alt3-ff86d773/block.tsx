...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "newCardImg0imagesrc"
    },
    {
      "type": "text",
      "id": "new-card-label-0",
      "name": "new-card-label-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "newCardImg1imagesrc"
    },
    {
      "type": "text",
      "id": "new-card-label-1",
      "name": "new-card-label-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "newCardImg2imagesrc"
    },
    {
      "type": "text",
      "id": "new-card-label-2",
      "name": "new-card-label-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "newCardImg3imagesrc"
    },
    {
      "type": "text",
      "id": "new-card-label-3",
      "name": "new-card-label-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "newCardLabel3text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "whats-new",
  "newTitletext": "What's New",
  "newCopytext": "Discover Breton's new technological solutions",
  "newCardImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/microwire-0ff9c364.jpg",
  "newCardLabel0text": "Microwire",
  "newCardImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/nexa-8a60fc23.png",
  "newCardLabel1text": "Breton Nexa",
  "newCardImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/hydra-b461b69c.png",
  "newCardLabel2text": "Breton Hydra",
  "newCardImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/kappa-9e8748c4.png",
  "newCardLabel3text": "Breton Kappa G"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeCtaWhatsnewpenAlt3({ id, newTitletext, newCopytext, newCardImg0imagesrc, newCardLabel0text, newCardImg1imagesrc, newCardLabel1text, newCardImg2imagesrc, newCardLabel2text, newCardImg3imagesrc, newCardLabel3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newTitletext, newCopytext, newCardImg0imagesrc, newCardLabel0text, newCardImg1imagesrc, newCardLabel1text, newCardImg2imagesrc, newCardLabel2text, newCardImg3imagesrc, newCardLabel3text });
