...
export default function TemplateExclusivePenSiteAboutNavigationNavpenAlt1({ id, hpv6ttext, hpv6thref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hpv6ttext, hpv6thref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref });
