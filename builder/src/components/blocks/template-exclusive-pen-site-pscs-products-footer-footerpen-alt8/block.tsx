...
export default function TemplateExclusivePenSitePscsProductsFooterFooterpenAlt8({ id, gw6v0text, vhbctext, vhbchref, egxdrtext, egxdrhref, dk8zitext, rodlftext, rodlfhref, ul4qqtext, ntn3ltext, ntn3lhref, tnezmtext, w3nestext, w3neshref, pvr8text, yhgp9text, ggg0atext, rpwz4text, imlxtext, ziinjtext, aypgstext, aypgshref, ckxtext, ckxhref, vylhtext, vylhhref, pdfmntext, pdfmnhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, gw6v0text, vhbctext, vhbchref, egxdrtext, egxdrhref, dk8zitext, rodlftext, rodlfhref, ul4qqtext, ntn3ltext, ntn3lhref, tnezmtext, w3nestext, w3neshref, pvr8text, yhgp9text, ggg0atext, rpwz4text, imlxtext, ziinjtext, aypgstext, aypgshref, ckxtext, ckxhref, vylhtext, vylhhref, pdfmntext, pdfmnhref });
