...
const SECTION_TREE = {
  "type": "frame",
  "id": "header-page-transparent-speaker-black-wifi",
  "name": "Header",
  "style": {
  ...
  "children": [
    ...
    },
    {
      ...
      "hrefProp": "navPageAllProductshref"
    },
    {
      "type": "text",
      ...
      "hrefProp": "navPageModularSystemhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "navPageAllProductshref": "/all-products",
  "navPageModularSystemtext": "MODULAR SYSTEM",
  "navPageModularSystemhref": "/modular-system",
  "navPageSoundRoomtext": "SOUND ROOM",
  "navPageSoundRoomhref": "/sound-room",
  "navPageSupporttext": "SUPPORT",
  "navPageSupporthref": "/support",
  "navPageAbouttext": "ABOUT",
  "navPageAbouthref": "/about"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #141414)";
...
export default function TemplateExclusivePenSiteTransparentSpeakerBlackWiFiNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, navPageAllProductstext, navPageAllProductshref, navPageModularSystemtext, navPageModularSystemhref, navPageSoundRoomtext, navPageSoundRoomhref, navPageSupporttext, navPageSupporthref, navPageAbouttext, navPageAbouthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, headerBrandtext, headerBrandhref, navPageAllProductstext, navPageAllProductshref, navPageModularSystemtext, navPageModularSystemhref, navPageSoundRoomtext, navPageSoundRoomhref, navPageSupporttext, navPageSupporthref, navPageAbouttext, navPageAbouthref });
