...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #3f668f)";
...
export default function TemplateExclusivePenSiteHomeCtaNewsbtnspenAlt7({ id, newsbtnshref, news1text, newsbtntxttext, newsbtntxthref, n1ttext, n1dtext, n2ttext, n2dtext, n3ttext, n3dtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newsbtnshref, news1text, newsbtntxttext, newsbtntxthref, n1ttext, n1dtext, n2ttext, n2dtext, n3ttext, n3dtext });
