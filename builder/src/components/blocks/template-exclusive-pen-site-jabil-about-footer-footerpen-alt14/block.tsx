...
export default function TemplateExclusivePenSiteJabilAboutFooterFooterpenAlt14({ id, mgzntext, opjqqtext, opjqqhref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, mgzntext, opjqqtext, opjqqhref, socialrowtext, socialrowhref, supplierbtnhref, suptxttext, customerbtnhref, cuttxttext, footerlinkstext, footerlinkshref, footercopytext, footercopyhref });
