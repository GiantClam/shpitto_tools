...
export default function TemplateExclusivePenSiteSolutionNavigationHeaderpenPrimary({ id, vlcf8text, vlcf8href, s5mxtext, s5mxhref, o2jbstext, o2jbshref, nwcdgtext, nwcdghref, yjiodtext, yjiodhref, u6qe9text, u6qe9href, anbl6text, anbl6href, yn04atext, yn04ahref, asf4ltext, asf4lhref, v4lmktext, v4lmkhref, ico5stext, ico5shref, fnecdtext, fnecdhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, vlcf8text, vlcf8href, s5mxtext, s5mxhref, o2jbstext, o2jbshref, nwcdgtext, nwcdghref, yjiodtext, yjiodhref, u6qe9text, u6qe9href, anbl6text, anbl6href, yn04atext, yn04ahref, asf4ltext, asf4lhref, v4lmktext, v4lmkhref, ico5stext, ico5shref, fnecdtext, fnecdhref });
