...
export default function TemplateExclusivePenSiteHomeProductsCatsectionpenAlt2({ id, npew7text, u8z9ytext, izhuqimagesrc, er64ytext, bcel2imagesrc, u2ddtext, dkkwlimagesrc, sodrtext, bmfzeimagesrc, bs4xytext, dmybzimagesrc, yukvutext, oycnimagesrc, lf08btext, moqugimagesrc, owbi2text, iqjisimagesrc, hjfudtext, intoqimagesrc, vusxutext, pzijximagesrc, akyrstext, tnuy2imagesrc, yts1gtext, dnsnkimagesrc, yw8fktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, npew7text, u8z9ytext, izhuqimagesrc, er64ytext, bcel2imagesrc, u2ddtext, dkkwlimagesrc, sodrtext, bmfzeimagesrc, bs4xytext, dmybzimagesrc, yukvutext, oycnimagesrc, lf08btext, moqugimagesrc, owbi2text, iqjisimagesrc, hjfudtext, intoqimagesrc, vusxutext, pzijximagesrc, akyrstext, tnuy2imagesrc, yts1gtext, dnsnkimagesrc, yw8fktext });
