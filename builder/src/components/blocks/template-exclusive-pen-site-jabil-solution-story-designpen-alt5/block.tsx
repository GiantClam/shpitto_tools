...
export default function TemplateExclusivePenSiteJabilSolutionStoryDesignpenAlt5({ id, designimgimagesrc, peytext, sn0dztext, psubtext, pbtnhref, pbtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, designimgimagesrc, peytext, sn0dztext, psubtext, pbtnhref, pbtnttext });
