...
const DEFAULT_PROPS = {
  "id": "c0WNc",
  "hertitletext": "我们的传承",
  "herbodytext": "自1942年在瑞典桑德维肯创立以来，我们一直与客户共同发展，在多个行业都建立了长期合作关系。以强健生命力与开拓的传承不断演进，经历了可持续发展、技能提升与人才发展。两点对长期未来和创造平衡至关重要，未来还需要更多值得期待。",
  "herlinktext": "我们的传承  ›"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteSandvikAboutStoryHeritagesecpenAlt12({ id, hertitletext, herbodytext, herlinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hertitletext, herbodytext, herlinktext });
