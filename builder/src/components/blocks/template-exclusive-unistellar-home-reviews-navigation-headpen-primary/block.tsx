...
export default function TemplateExclusiveUnistellarHomeReviewsNavigationHeadpenPrimary({ id, logotext, logohref, nhtext, nhhref, nstext, nshref, nbtext, nbhref, nttext, nthref, nrtext, nrhref, btnhref, btnttext, ...rest }) {
