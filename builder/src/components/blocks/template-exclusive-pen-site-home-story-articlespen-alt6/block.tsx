      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "newsbtntxttext"
        }
      ],
      "hrefProp": "newsbtn1href"
    }
  ]
};
const DEFAULT_PROPS = {
...
export default function TemplateExclusivePenSiteHomeStoryArticlespenAlt6({ id, arttitletext, a1imgimagesrc, a1txttext, a2imgimagesrc, a2txttext, a3imgimagesrc, a3txttext, newsbtn1href, newsbtntxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, arttitletext, a1imgimagesrc, a1txttext, a2imgimagesrc, a2txttext, a3imgimagesrc, a3txttext, newsbtn1href, newsbtntxttext });
