  ...
  "children": [
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "type": "text",
          "id": "nav-page-all-products",
          "name": "nav-page-all-products",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageAllProductstext"
        },
        {
          "type": "text",
          "id": "nav-page-modular-system",
          "name": "nav-page-modular-system",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageModularSystemtext"
        },
        {
          "type": "text",
          "id": "nav-page-sound-room",
          "name": "nav-page-sound-room",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
...
const DEFAULT_PROPS = {
  "id": "hero",
  "heroImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "headerBrandtext": "Transparent",
  "navPageAllProductstext": "ALL PRODUCTS",
  "navPageModularSystemtext": "MODULAR SYSTEM",
  "navPageSoundRoomtext": "SOUND ROOM",
  "navPageSupporttext": "SUPPORT",
  "navPageAbouttext": "ABOUT",
  "heroKickertext": "TRANSPARENT",
  "heroTitletext": "Timeless speakers and design tech",
  "heroSubtitletext": "scandinavian industrial design, modular systems and audio objects shaped to last and evolve over time.",
  "heroPrimaryTexttext": "All Products",
  "heroSecondaryTexttext": "Modular System"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroImageimagesrc, headerBrandtext, navPageAllProductstext, navPageModularSystemtext, navPageSoundRoomtext, navPageSupporttext, navPageAbouttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroImageimagesrc, headerBrandtext, navPageAllProductstext, navPageModularSystemtext, navPageSoundRoomtext, navPageSupporttext, navPageAbouttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext });
