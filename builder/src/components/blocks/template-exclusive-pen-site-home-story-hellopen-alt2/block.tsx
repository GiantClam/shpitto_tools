...
export default function TemplateExclusivePenSiteHomeStoryHellopenAlt2({ id, helloeyebrowtext, hellotitletext, hellobodytext, hellolinktxttext, helloimageimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, helloeyebrowtext, hellotitletext, hellobodytext, hellolinktxttext, helloimageimagesrc });
