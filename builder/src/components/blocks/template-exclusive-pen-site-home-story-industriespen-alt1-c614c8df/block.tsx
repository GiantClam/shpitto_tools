...
const DEFAULT_PROPS = {
  "id": "industries",
  "indTitletext": "Industries",
  "indImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/viper-dc97c26f.jpg",
  "indT0text": "Stone",
  "indImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/hawx-09d10c43.jpg",
  "indT1text": "Metals",
  "indImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/tetrix-c8316cf5.jpg",
  "indT2text": "Composites",
  "indImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/3d-service-b0b7aef3.jpg",
  "indT3text": "Additive"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryIndustriespenAlt1({ id, indTitletext, indImg0imagesrc, indT0text, indImg1imagesrc, indT1text, indImg2imagesrc, indT2text, indImg3imagesrc, indT3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, indTitletext, indImg0imagesrc, indT0text, indImg1imagesrc, indT1text, indImg2imagesrc, indT2text, indImg3imagesrc, indT3text });
