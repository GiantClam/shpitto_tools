...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-bg",
      "name": "page-contacts-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-logo",
      "name": "page-contacts-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 140,
        "height": 44,
      ...
      "children": [],
      "imageProp": "pageContactsNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-Engineering",
      "name": "page-contacts-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarEngineeringtext",
      "hrefProp": "pageContactsNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-Products",
      "name": "page-contacts-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarProductstext",
      "hrefProp": "pageContactsNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-Services",
      "name": "page-contacts-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarServicestext",
      "hrefProp": "pageContactsNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-BIT",
      "name": "page-contacts-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarBittext",
      "hrefProp": "pageContactsNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-contacts-navbar-lets",
      "name": "page-contacts-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-contacts-navbar-lets-t",
      "name": "page-contacts-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarLetsTtext",
      "hrefProp": "pageContactsNavbarLetsThref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-search",
      "name": "page-contacts-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarSearchtext",
      "hrefProp": "pageContactsNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-lang",
      "name": "page-contacts-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarLangtext",
      "hrefProp": "pageContactsNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-contacts-navbar-menu",
      "name": "page-contacts-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageContactsNavbarMenutext",
      "hrefProp": "pageContactsNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-contacts-navbar",
  "pageContactsNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageContactsNavbarEngineeringtext": "Engineering",
  "pageContactsNavbarEngineeringhref": "/engineering",
  "pageContactsNavbarProductstext": "Products",
  "pageContactsNavbarProductshref": "/products",
  "pageContactsNavbarServicestext": "Services",
  "pageContactsNavbarServiceshref": "/services",
  "pageContactsNavbarBittext": "BIT",
  "pageContactsNavbarBithref": "/bit",
  "pageContactsNavbarLetsTtext": "Let's talk",
  "pageContactsNavbarLetsThref": "/",
  "pageContactsNavbarSearchtext": "⌕",
  "pageContactsNavbarSearchhref": "/",
  "pageContactsNavbarLangtext": "Language",
  "pageContactsNavbarLanghref": "/",
  "pageContactsNavbarMenutext": "☰",
  "pageContactsNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteContactsNavigationNavbarpenPrimary({ id, pageContactsNavbarLogoimagesrc, pageContactsNavbarEngineeringtext, pageContactsNavbarEngineeringhref, pageContactsNavbarProductstext, pageContactsNavbarProductshref, pageContactsNavbarServicestext, pageContactsNavbarServiceshref, pageContactsNavbarBittext, pageContactsNavbarBithref, pageContactsNavbarLetsTtext, pageContactsNavbarLetsThref, pageContactsNavbarSearchtext, pageContactsNavbarSearchhref, pageContactsNavbarLangtext, pageContactsNavbarLanghref, pageContactsNavbarMenutext, pageContactsNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactsNavbarLogoimagesrc, pageContactsNavbarEngineeringtext, pageContactsNavbarEngineeringhref, pageContactsNavbarProductstext, pageContactsNavbarProductshref, pageContactsNavbarServicestext, pageContactsNavbarServiceshref, pageContactsNavbarBittext, pageContactsNavbarBithref, pageContactsNavbarLetsTtext, pageContactsNavbarLetsThref, pageContactsNavbarSearchtext, pageContactsNavbarSearchhref, pageContactsNavbarLangtext, pageContactsNavbarLanghref, pageContactsNavbarMenutext, pageContactsNavbarMenuhref });
