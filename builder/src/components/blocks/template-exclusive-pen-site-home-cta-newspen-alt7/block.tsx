...
export default function TemplateExclusivePenSiteHomeCtaNewspenAlt7({ id, nttext, c1dtext, c1ttext, c1ptext, c1atext, c2dtext, c2ttext, c2ptext, c2atext, c3dtext, c3ttext, c3atext, sharettext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, nttext, c1dtext, c1ttext, c1ptext, c1atext, c2dtext, c2ttext, c2ptext, c2atext, c3dtext, c3ttext, c3atext, sharettext });
