...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footerCol1text",
      "hrefProp": "footerCol1href"
    },
    {
      "type": "text",
      "id": "footer-col-2",
      ...
      "children": [],
      "textProp": "footerCol2text",
      "hrefProp": "footerCol2href"
    },
    {
      "type": "text",
      "id": "footer-copy",
...
const DEFAULT_PROPS = {
  ...
  "footerBrandhref": "/",
  "footerCol1text": "All Products Modular System Sound Room",
  "footerCol1href": "/all-products",
  "footerCol2text": "Support About Transparent Speaker Black Wi‑Fi Transparent Turntable",
  "footerCol2href": "/support",
  "footerCopytext": "Transparent structured clone pen. Editable text, cards, buttons and image containers.",
  "footerCopyhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteTransparentSpeakerBlackWiFiFooterFooterpenAlt1({ id, footerBrandtext, footerBrandhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCopytext, footerCopyhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, footerBrandtext, footerBrandhref, footerCol1text, footerCol1href, footerCol2text, footerCol2href, footerCopytext, footerCopyhref });
