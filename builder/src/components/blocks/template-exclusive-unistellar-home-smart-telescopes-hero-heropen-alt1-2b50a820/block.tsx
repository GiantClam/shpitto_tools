...
const DEFAULT_PROPS = {
  ...
  "cta1thref": "/view-all-smart-telescopes",
  "cta2href": "/compare-models",
  "cta2ttext": "Compare Models",
  "cta2thref": "/compare-models",
...
export default function TemplateExclusiveUnistellarHomeSmartTelescopesHeroHeropenAlt1({ id, eyetext, hedtext, subtext, cta1href, cta1ttext, cta1thref, cta2href, cta2ttext, cta2thref, credtext, visualimagesrc, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, eyetext, hedtext, subtext, cta1href, cta1ttext, cta1thref, cta2href, cta2ttext, cta2thref, credtext, visualimagesrc });
