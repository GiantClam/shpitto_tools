...
export default function TemplateExclusivePenSiteJabilSolutionStoryAboutintropenAlt2({ id, introtexttext, videocardimagesrc, peytext, introtexttext2, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introtexttext, videocardimagesrc, peytext, introtexttext2 });
