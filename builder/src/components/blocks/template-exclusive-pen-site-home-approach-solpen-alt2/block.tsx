...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "sollinktext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "0UgRu",
  "soltitletext": "产品生命周期各阶段的解决方案",
  "c1ttext": "设计",
  "c1dtext": "利用我们的专业知识和方案推动创新。加快产品上市速度，在 Plexus，我们有能力应对产品开发中的复杂挑战。",
  "c2ttext": "制造",
  "c2dtext": "作为制造商的延伸，Plexus 将提供先进的全球生产资源，帮助您实现高质量复杂的产品。",
  "c3ttext": "服务",
  "c3dtext": "从供应链管理到持续服务，Plexus 提供全生命周期支持，确保产品的持久价值和运营韧性。",
  "soltagtxttext": "解决方案",
  "soldesctext": "从产品概念到销售后服务，最大限度地提升产品价值，为客户创造成功。",
  "sollinktext": "探索所有解决方案 →"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeApproachSolpenAlt2({ id, soltitletext, c1ttext, c1dtext, c2ttext, c2dtext, c3ttext, c3dtext, soltagtxttext, soldesctext, sollinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, soltitletext, c1ttext, c1dtext, c2ttext, c2dtext, c3ttext, c3dtext, soltagtxttext, soldesctext, sollinktext });
