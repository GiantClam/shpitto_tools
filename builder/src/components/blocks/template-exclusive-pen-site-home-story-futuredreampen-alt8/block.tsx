  ...
  "children": [
    {
      ...
      "children": [],
      "imageProp": "futureDreamBgimagesrc"
    },
    {
      "type": "rectangle",
      "id": "future-dream-shade",
      "name": "future-dream-shade",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 820,
    ...
    {
      "type": "rectangle",
      "id": "future-dream-shell",
      "name": "future-dream-shell",
      "style": {
        "boxSizing": "border-box",
        "width": 760,
        "height": 300,
    ...
    {
      "type": "text",
      "id": "future-dream-chapter",
      "name": "future-dream-chapter",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamChaptertext"
    },
    {
      "type": "text",
      "id": "future-dream-count",
      "name": "future-dream-count",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamCounttext"
    },
    {
      "type": "text",
      "id": "future-dream-title",
      "name": "future-dream-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamTitletext"
    },
    {
      "type": "text",
      "id": "future-dream-body",
      "name": "future-dream-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamBodytext"
    },
    {
      "type": "rectangle",
      "id": "future-dream-nav-chip-0",
      "name": "future-dream-nav-chip-0",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-dream-nav-chip-text-0",
      "name": "future-dream-nav-chip-text-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamNavChipText0text"
    },
    {
      "type": "rectangle",
      "id": "future-dream-nav-chip-1",
      "name": "future-dream-nav-chip-1",
      "style": {
        "boxSizing": "border-box",
    ...
    {
      "type": "text",
      "id": "future-dream-nav-chip-text-1",
      "name": "future-dream-nav-chip-text-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamNavChipText1text"
    },
    {
      "type": "rectangle",
      "id": "future-dream-nav-chip-2",
      "name": "future-dream-nav-chip-2",
      "style": {
        "boxSizing": "border-box",
        "width": 74,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-dream-nav-chip-text-2",
      "name": "future-dream-nav-chip-text-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamNavChipText2text"
    },
    {
      "type": "rectangle",
      "id": "future-dream-nav-chip-3",
      "name": "future-dream-nav-chip-3",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-dream-nav-chip-text-3",
      "name": "future-dream-nav-chip-text-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamNavChipText3text"
    },
    {
      "type": "rectangle",
      "id": "future-dream-nav-chip-4",
      "name": "future-dream-nav-chip-4",
      "style": {
        "boxSizing": "border-box",
        "width": 97.8,
        "height": 32,
    ...
    {
      "type": "text",
      "id": "future-dream-nav-chip-text-4",
      "name": "future-dream-nav-chip-text-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "futureDreamNavChipText4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "future-dream",
  "futureDreamBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/future-dream.jpg",
  "futureDreamChaptertext": "Future",
  "futureDreamCounttext": "4 / 5",
  "futureDreamTitletext": "The Dream",
  "futureDreamBodytext": "Past and present melt into one: the experience of Horacio, the energy and passion of his team, and the knowledge that turns every Pagani project into an impossible dream that feels close to reality.",
  "futureDreamNavChipText0text": "Intro",
  "futureDreamNavChipText1text": "The Research",
  "futureDreamNavChipText2text": "Beauty",
  "futureDreamNavChipText3text": "The Dream",
  "futureDreamNavChipText4text": "Certainty"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHomeStoryFuturedreampenAlt8({ id, futureDreamBgimagesrc, futureDreamChaptertext, futureDreamCounttext, futureDreamTitletext, futureDreamBodytext, futureDreamNavChipText0text, futureDreamNavChipText1text, futureDreamNavChipText2text, futureDreamNavChipText3text, futureDreamNavChipText4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, futureDreamBgimagesrc, futureDreamChaptertext, futureDreamCounttext, futureDreamTitletext, futureDreamBodytext, futureDreamNavChipText0text, futureDreamNavChipText1text, futureDreamNavChipText2text, futureDreamNavChipText3text, futureDreamNavChipText4text });
