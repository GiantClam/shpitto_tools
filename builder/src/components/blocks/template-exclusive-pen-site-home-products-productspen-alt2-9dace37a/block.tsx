...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "prodCard1Imgimagesrc"
    },
    {
      "type": "text",
      "id": "prod-card-1-title",
      "name": "prod-card-1-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "prodCard1Titletext"
    },
    {
      "type": "text",
      "id": "prod-card-1-body",
      "name": "prod-card-1-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "prodCard1Bodytext"
    },
    {
      "type": "rectangle",
      "id": "prod-card-1-btn-box",
      "name": "prod-card-1-btn-box",
      "style": {
        "boxSizing": "border-box",
        "width": 120,
        "height": 30,
      ...
      "children": [],
      "hrefProp": "prodCard1BtnBoxhref"
    },
    {
      "type": "text",
      "id": "prod-card-1-btn-text",
      "name": "prod-card-1-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "prodCard1BtnTexttext",
      "hrefProp": "prodCard1BtnTexthref"
    },
    {
      "type": "rectangle",
      "id": "prod-card-2-box",
      "name": "prod-card-2-box",
      "style": {
        "boxSizing": "border-box",
        "width": 354,
        "height": 148,
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "prodCard2Imgimagesrc"
    },
    {
      "type": "text",
      "id": "prod-card-2-title",
      "name": "prod-card-2-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "prodCard2Titletext"
    },
    {
      "type": "text",
      "id": "prod-card-2-body",
      "name": "prod-card-2-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "prodCard2Bodytext"
    },
    {
      "type": "rectangle",
      "id": "prod-card-2-btn-box",
      "name": "prod-card-2-btn-box",
      "style": {
        "boxSizing": "border-box",
        "width": 120,
        "height": 30,
      ...
      "children": [],
      "hrefProp": "prodCard2BtnBoxhref"
    },
    {
      "type": "text",
      "id": "prod-card-2-btn-text",
      "name": "prod-card-2-btn-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "prodCard2BtnTexttext",
      "hrefProp": "prodCard2BtnTexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "products",
  "productsTitletext": "产品",
  "prodCard1Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-general.jpg",
  "prodCard1Titletext": "镗床",
  "prodCard1Bodytext": "面向大型结构件与通用加工。",
  "prodCard1BtnBoxhref": "/",
  "prodCard1BtnTexttext": "了解更多",
  "prodCard1BtnTexthref": "/",
  "prodCard2Imgimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/app-energy.jpg",
  "prodCard2Titletext": "卧式铣床",
  "prodCard2Bodytext": "高刚性、高动态的精密加工。",
  "prodCard2BtnBoxhref": "/",
  "prodCard2BtnTexttext": "了解更多",
  "prodCard2BtnTexthref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #565D66)";
...
export default function TemplateExclusivePenSiteHomeProductsProductspenAlt2({ id, productsTitletext, prodCard1Imgimagesrc, prodCard1Titletext, prodCard1Bodytext, prodCard1BtnBoxhref, prodCard1BtnTexttext, prodCard1BtnTexthref, prodCard2Imgimagesrc, prodCard2Titletext, prodCard2Bodytext, prodCard2BtnBoxhref, prodCard2BtnTexttext, prodCard2BtnTexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, productsTitletext, prodCard1Imgimagesrc, prodCard1Titletext, prodCard1Bodytext, prodCard1BtnBoxhref, prodCard1BtnTexttext, prodCard1BtnTexthref, prodCard2Imgimagesrc, prodCard2Titletext, prodCard2Bodytext, prodCard2BtnBoxhref, prodCard2BtnTexttext, prodCard2BtnTexthref });
