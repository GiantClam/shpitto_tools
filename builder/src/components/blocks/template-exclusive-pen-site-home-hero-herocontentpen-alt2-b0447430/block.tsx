...
export default function TemplateExclusivePenSiteHomeHeroHerocontentpenAlt2({ id, herokickertext, heroheadlinetext, herobodytext, heroctatexttext, heroctahref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herokickertext, heroheadlinetext, herobodytext, heroctatexttext, heroctahref });
