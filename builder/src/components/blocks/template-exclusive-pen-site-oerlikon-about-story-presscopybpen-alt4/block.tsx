...
export default function TemplateExclusivePenSiteOerlikonAboutStoryPresscopybpenAlt4({ id, pressttext, pressltext, evttext, evltext, hhxf6text, evloctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pressttext, pressltext, evttext, evltext, hhxf6text, evloctext });
