...
export default function TemplateExclusivePenSiteContactContactContactheaderpenPrimary({ id, logotexttext, navtext, langtxttext, ctahtxttext, toplinkstext, flagtxttext, langarrowtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotexttext, navtext, langtxttext, ctahtxttext, toplinkstext, flagtxttext, langarrowtext });
