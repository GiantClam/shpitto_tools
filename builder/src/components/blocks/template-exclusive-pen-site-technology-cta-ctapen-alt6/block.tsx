      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "ctabtnttext",
          "hrefProp": "ctabtnthref"
        }
      ]
    }
  ],
...
const DEFAULT_PROPS = {
  "id": "Fd4Qb",
  "ctahref": "/",
  "ctattext": "Harness the world-changing\npower of quantum computing",
  "ctadtext": "Access our quantum systems on the cloud in as little as ten minutes, or contact our experts to discuss a custom partnership for your business.",
  "ctabtnttext": "Get started",
  "ctabtnthref": "/"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteTechnologyCtaCtapenAlt6({ id, ctahref, ctattext, ctadtext, ctabtnttext, ctabtnthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctahref, ctattext, ctadtext, ctabtnttext, ctabtnthref });
