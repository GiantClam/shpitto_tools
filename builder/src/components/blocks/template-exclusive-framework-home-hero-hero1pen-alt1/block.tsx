...
export default function TemplateExclusiveFrameworkHomeHeroHero1penAlt1({ id, h1t1text, h1t2text, h1bttext, akwvvtext, hero1rimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, h1t1text, h1t2text, h1bttext, akwvvtext, hero1rimagesrc });
