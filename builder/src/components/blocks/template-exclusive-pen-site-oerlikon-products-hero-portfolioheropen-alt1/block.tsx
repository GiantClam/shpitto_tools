...
export default function TemplateExclusivePenSiteOerlikonProductsHeroPortfolioheropenAlt1({ id, herobgpimagesrc, herotitleptext, herodescptext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herobgpimagesrc, herotitleptext, herodescptext });
