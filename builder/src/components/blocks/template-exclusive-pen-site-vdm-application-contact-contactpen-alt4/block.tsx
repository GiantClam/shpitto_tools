...
export default function TemplateExclusivePenSiteVdmApplicationContactContactpenAlt4({ id, ct1text, ct2text, cbtnhref, cbtnttext, ctitletext, rinfotext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ct1text, ct2text, cbtnhref, cbtnttext, ctitletext, rinfotext });
