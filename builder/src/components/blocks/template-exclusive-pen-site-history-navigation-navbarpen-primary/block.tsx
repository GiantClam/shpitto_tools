...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-history",
      "name": "header-bg-history",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-history",
      "name": "brand-logo-history",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoHistoryimagesrc"
    },
    {
      "type": "text",
      "id": "nav-history-0",
      ...
      "children": [],
      "textProp": "navHistory0text",
      "hrefProp": "navHistory0href"
    },
    {
      "type": "text",
      "id": "nav-history-1",
      ...
      "children": [],
      "textProp": "navHistory1text",
      "hrefProp": "navHistory1href"
    },
    {
      "type": "text",
      "id": "nav-history-2",
      ...
      "children": [],
      "textProp": "navHistory2text",
      "hrefProp": "navHistory2href"
    },
    {
      "type": "text",
      "id": "nav-history-3",
      ...
      "children": [],
      "textProp": "navHistory3text",
      "hrefProp": "navHistory3href"
    },
    {
      "type": "text",
      "id": "nav-history-4",
      ...
      "children": [],
      "textProp": "navHistory4text",
      "hrefProp": "navHistory4href"
    },
    {
      "type": "text",
      "id": "nav-history-5",
      ...
      "children": [],
      "textProp": "navHistory5text",
      "hrefProp": "navHistory5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-history",
      "name": "menu-box-history",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-history",
      "name": "menu-line-1-history",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-history",
      "name": "menu-line-2-history",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-history",
      "name": "menu-line-3-history",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-history",
  "brandLogoHistoryimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navHistory0text": "Home",
  "navHistory0href": "/",
  "navHistory1text": "History",
  "navHistory1href": "/history",
  "navHistory2text": "Dealers",
  "navHistory2href": "/dealers",
  "navHistory3text": "Tours",
  "navHistory3href": "/guided-tours",
  "navHistory4text": "Utopia",
  "navHistory4href": "/pagani-utopia",
  "navHistory5text": "Contact",
  "navHistory5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSiteHistoryNavigationNavbarpenPrimary({ id, brandLogoHistoryimagesrc, navHistory0text, navHistory0href, navHistory1text, navHistory1href, navHistory2text, navHistory2href, navHistory3text, navHistory3href, navHistory4text, navHistory4href, navHistory5text, navHistory5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoHistoryimagesrc, navHistory0text, navHistory0href, navHistory1text, navHistory1href, navHistory2text, navHistory2href, navHistory3text, navHistory3href, navHistory4text, navHistory4href, navHistory5text, navHistory5href });
