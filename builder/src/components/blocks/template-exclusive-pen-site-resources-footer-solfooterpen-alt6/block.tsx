...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "footeraddrtext",
      "hrefProp": "footeraddrhref"
    },
    {
      "type": "text",
      "id": "9fIM5",
...
const DEFAULT_PROPS = {
  ...
  "flogottext": "PLEXUS",
  "flogothref": "/",
  "fnavtext": "解决方案        市场领域        关于我们        资源        职业发展        订阅",
  "fnavhref": "/",
  "copytext": "©2026Plexus，Inc. 保留所有权利。法律声明|政策与报告|隐私声明|请勿出售/共享我的个人信息",
  "copyhref": "/",
  "footeraddrtext": "Plexus Corp. OnePlexus Way, P.O. Box 156, Neenah, WI 54956 | +1 888 208 9005",
  "footeraddrhref": "/",
  "fbtext": "f",
  "fbhref": "/",
  "intext": "in",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #D7E6EA)";
...
export default function TemplateExclusivePenSiteResourcesFooterSolfooterpenAlt6({ id, flogottext, flogothref, fnavtext, fnavhref, copytext, copyhref, footeraddrtext, footeraddrhref, fbtext, fbhref, intext, inhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, flogottext, flogothref, fnavtext, fnavhref, copytext, copyhref, footeraddrtext, footeraddrhref, fbtext, fbhref, intext, inhref });
