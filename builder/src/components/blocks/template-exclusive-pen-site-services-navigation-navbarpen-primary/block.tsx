...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "page-services-navbar-bg",
      "name": "page-services-navbar-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "page-services-navbar-logo",
      "name": "page-services-navbar-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 140,
        "height": 44,
      ...
      "children": [],
      "imageProp": "pageServicesNavbarLogoimagesrc"
    },
    {
      "type": "text",
      "id": "page-services-navbar-Engineering",
      "name": "page-services-navbar-Engineering",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarEngineeringtext",
      "hrefProp": "pageServicesNavbarEngineeringhref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-Products",
      "name": "page-services-navbar-Products",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarProductstext",
      "hrefProp": "pageServicesNavbarProductshref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-Services",
      "name": "page-services-navbar-Services",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarServicestext",
      "hrefProp": "pageServicesNavbarServiceshref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-BIT",
      "name": "page-services-navbar-BIT",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarBittext",
      "hrefProp": "pageServicesNavbarBithref"
    },
    {
      "type": "rectangle",
      "id": "page-services-navbar-lets",
      "name": "page-services-navbar-lets",
      "style": {
        "boxSizing": "border-box",
        "width": 200,
        "height": 84,
    ...
    {
      "type": "text",
      "id": "page-services-navbar-lets-t",
      "name": "page-services-navbar-lets-t",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarLetsTtext",
      "hrefProp": "pageServicesNavbarLetsThref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-search",
      "name": "page-services-navbar-search",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarSearchtext",
      "hrefProp": "pageServicesNavbarSearchhref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-lang",
      "name": "page-services-navbar-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarLangtext",
      "hrefProp": "pageServicesNavbarLanghref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-menu",
      "name": "page-services-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarMenutext",
      "hrefProp": "pageServicesNavbarMenuhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "page-services-navbar",
  "pageServicesNavbarLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/breton/breton-logo.png",
  "pageServicesNavbarEngineeringtext": "Engineering",
  "pageServicesNavbarEngineeringhref": "/engineering",
  "pageServicesNavbarProductstext": "Products",
  "pageServicesNavbarProductshref": "/products",
  "pageServicesNavbarServicestext": "Services",
  "pageServicesNavbarServiceshref": "/services",
  "pageServicesNavbarBittext": "BIT",
  "pageServicesNavbarBithref": "/bit",
  "pageServicesNavbarLetsTtext": "Let's talk",
  "pageServicesNavbarLetsThref": "/",
  "pageServicesNavbarSearchtext": "⌕",
  "pageServicesNavbarSearchhref": "/",
  "pageServicesNavbarLangtext": "Language",
  "pageServicesNavbarLanghref": "/",
  "pageServicesNavbarMenutext": "☰",
  "pageServicesNavbarMenuhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteServicesNavigationNavbarpenPrimary({ id, pageServicesNavbarLogoimagesrc, pageServicesNavbarEngineeringtext, pageServicesNavbarEngineeringhref, pageServicesNavbarProductstext, pageServicesNavbarProductshref, pageServicesNavbarServicestext, pageServicesNavbarServiceshref, pageServicesNavbarBittext, pageServicesNavbarBithref, pageServicesNavbarLetsTtext, pageServicesNavbarLetsThref, pageServicesNavbarSearchtext, pageServicesNavbarSearchhref, pageServicesNavbarLangtext, pageServicesNavbarLanghref, pageServicesNavbarMenutext, pageServicesNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageServicesNavbarLogoimagesrc, pageServicesNavbarEngineeringtext, pageServicesNavbarEngineeringhref, pageServicesNavbarProductstext, pageServicesNavbarProductshref, pageServicesNavbarServicestext, pageServicesNavbarServiceshref, pageServicesNavbarBittext, pageServicesNavbarBithref, pageServicesNavbarLetsTtext, pageServicesNavbarLetsThref, pageServicesNavbarSearchtext, pageServicesNavbarSearchhref, pageServicesNavbarLangtext, pageServicesNavbarLanghref, pageServicesNavbarMenutext, pageServicesNavbarMenuhref });
