...
export default function TemplateExclusivePenSiteOerlikonIndustriesHeroIndustriesheropenAlt1({ id, herobgaimagesrc, herotitleatext, herosubitext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herobgaimagesrc, herotitleatext, herosubitext });
