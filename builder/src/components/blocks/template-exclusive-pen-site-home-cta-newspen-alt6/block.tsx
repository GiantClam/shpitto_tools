...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "newsbtntexttext",
      "hrefProp": "newsbtntexthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "l2pf5",
  "newstitletext": "活动与新闻",
  "featdarktitletext": "MECSPE\n2026 MARCH 4-6\nHall 19 -\nStand D26",
  "featdarkmetatext": "BolognaFiere\nBologna, Italy",
  "featimageimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-mecspe.jpg",
  "feattagtext": "EXHIBITIONS",
  "featpaneltitletext": "FPT AT\nMECSPE\n2026",
  "featpanellinktext": "了解更多  >",
  "newsimg1imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-onder.jpg",
  "newstitle1text": "DUAL ORIGIN CONFIGURATION\nTRANSFORMS ÖNDER METAL'S\nPRODUCTION",
  "newsmeta1text": "NEWS · 26 November 2025",
  "newsimg2imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-steelfab.jpg",
  "newstitle2text": "FPT AT STEELFAB 2026",
  "newsmeta2text": "EXHIBITIONS · 25 November 2025",
  "newsimg3imagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/news-warcom.jpg",
  "newstitle3text": "WARCOM AND FPT: A LEGACY\nOF INNOVATION AND SHARED\nQUALITY",
  "newsmeta3text": "NEWS · 20 November 2025",
  "newsbtnhref": "/",
  "newsbtntexttext": "查看所有活动和新闻",
  "newsbtntexthref": "/"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #5E676F)";
...
export default function TemplateExclusivePenSiteHomeCtaNewspenAlt6({ id, newstitletext, featdarktitletext, featdarkmetatext, featimageimagesrc, feattagtext, featpaneltitletext, featpanellinktext, newsimg1imagesrc, newstitle1text, newsmeta1text, newsimg2imagesrc, newstitle2text, newsmeta2text, newsimg3imagesrc, newstitle3text, newsmeta3text, newsbtnhref, newsbtntexttext, newsbtntexthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, newstitletext, featdarktitletext, featdarkmetatext, featimageimagesrc, feattagtext, featpaneltitletext, featpanellinktext, newsimg1imagesrc, newstitle1text, newsmeta1text, newsimg2imagesrc, newstitle2text, newsmeta2text, newsimg3imagesrc, newstitle3text, newsmeta3text, newsbtnhref, newsbtntexttext, newsbtntexthref });
