...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroImageimagesrc, headerBrandtext, navPageOurRidestext, navPageAccessoriestext, navPageOurStorytext, navPagePeakDesigntext, navPageShippingDeliverytext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroImageimagesrc, headerBrandtext, navPageOurRidestext, navPageAccessoriestext, navPageOurStorytext, navPagePeakDesigntext, navPageShippingDeliverytext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext });
