...
export default function TemplateExclusivePenSiteJabilAboutHeroHeropenAlt1({ id, herobodytext, herotitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herobodytext, herotitletext });
