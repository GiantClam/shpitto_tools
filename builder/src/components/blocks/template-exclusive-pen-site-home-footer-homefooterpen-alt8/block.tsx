...
export default function TemplateExclusivePenSiteHomeFooterHomefooterpenAlt8({ id, zonbrtext, ad9rmtext, ad9rmhref, x7fnvtext, x7fnvhref, r8k6text, snqtext, snqhref, umnaetext, hfa4ztext, hfa4zhref, rtuitext, q4qnttext, q4qnthref, km2tqtext, ey8kztext, l8t2ftext, pzc3dtext, pwpndtext, rud9text, s531btext, s531bhref, db204text, db204href, donsxtext, donsxhref, hymbatext, hymbahref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, zonbrtext, ad9rmtext, ad9rmhref, x7fnvtext, x7fnvhref, r8k6text, snqtext, snqhref, umnaetext, hfa4ztext, hfa4zhref, rtuitext, q4qnttext, q4qnthref, km2tqtext, ey8kztext, l8t2ftext, pzc3dtext, pwpndtext, rud9text, s531btext, s531bhref, db204text, db204href, donsxtext, donsxhref, hymbatext, hymbahref });
