...
export default function TemplateExclusivePenSiteJabilCapabilitiesHeroHeropenAlt1({ id, hbgimagesrc, herobodytext, herotitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, hbgimagesrc, herobodytext, herotitletext });
