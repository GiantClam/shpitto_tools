...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "featCardImg0imagesrc"
    },
    {
      "type": "text",
      "id": "feat-card-k-0",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "featCardImg1imagesrc"
    },
    {
      "type": "text",
      "id": "feat-card-k-1",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "featCardImg2imagesrc"
    },
    {
      "type": "text",
      "id": "feat-card-k-2",
    ...
    },
    {
      ...
      "children": [],
      "imageProp": "featCardImg3imagesrc"
    },
    {
      "type": "text",
      "id": "feat-card-k-3",
...
const DEFAULT_PROPS = {
  ...
  "featCardImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "featCardK0text": "THIRD LEVEL",
  "featCardT0text": "Transparent Speaker Black Wi‑Fi",
  "featCardImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "featCardK1text": "THIRD LEVEL",
  "featCardT1text": "Transparent Turntable",
  "featCardImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "featCardK2text": "THIRD LEVEL",
  "featCardT2text": "Light Speaker White",
  "featCardImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "featCardK3text": "THIRD LEVEL",
  "featCardT3text": "Aroma Diffuser"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeApproachFeaturedpenAlt2({ id, featuredTitletext, featCardImg0imagesrc, featCardK0text, featCardT0text, featCardImg1imagesrc, featCardK1text, featCardT1text, featCardImg2imagesrc, featCardK2text, featCardT2text, featCardImg3imagesrc, featCardK3text, featCardT3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, featuredTitletext, featCardImg0imagesrc, featCardK0text, featCardT0text, featCardImg1imagesrc, featCardK1text, featCardT1text, featCardImg2imagesrc, featCardK2text, featCardT2text, featCardImg3imagesrc, featCardK3text, featCardT3text });
