...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #F95D26)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #F3F5F7)";
...
export default function TemplateExclusivePenSiteUrsaAboutNavigationNavcopypenPrimary({ id, logotext, logohref, menu1text, menu1href, menu2text, menu2href, menu3text, menu3href, menu4text, menu4href, iconstext, iconshref, soc1ttext, soc1thref, soc2ttext, soc2thref, soc3ttext, soc3thref, xittext, xithref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, menu1text, menu1href, menu2text, menu2href, menu3text, menu3href, menu4text, menu4href, iconstext, iconshref, soc1ttext, soc1thref, soc2ttext, soc2thref, soc3ttext, soc3thref, xittext, xithref });
