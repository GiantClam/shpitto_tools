...
export default function TemplateExclusivePenSiteHomeStoryResourcespenAlt3({ id, vptvytext, logomarktext, banbgaimagesrc, b2tuptext, odt1ztext, r1iaimagesrc, xhi1text, learn1text, r2iaimagesrc, uszhctext, learn2text, r3iaimagesrc, zlsextext, learn3text, r4iaimagesrc, zot34text, learn4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, vptvytext, logomarktext, banbgaimagesrc, b2tuptext, odt1ztext, r1iaimagesrc, xhi1text, learn1text, r2iaimagesrc, uszhctext, learn2text, r3iaimagesrc, zlsextext, learn3text, r4iaimagesrc, zot34text, learn4text });
