...
export default function TemplateExclusivePenSitePscsAboutFooterFooterpenAlt6({ id, jleyktext, dm2rtext, dm2rhref, turjgtext, turjghref, uyzatext, vleqitext, vleqihref, fliatext, lnuvltext, lnuvlhref, u2qdztext, fk7ztext, fk7zhref, bkzmvtext, zms4atext, fuzxtext, hdueotext, ecydtext, ym1xotext, hlicntext, hlicnhref, vqp31text, vqp31href, t7wvutext, t7wvuhref, mrjt3text, mrjt3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, jleyktext, dm2rtext, dm2rhref, turjgtext, turjghref, uyzatext, vleqitext, vleqihref, fliatext, lnuvltext, lnuvlhref, u2qdztext, fk7ztext, fk7zhref, bkzmvtext, zms4atext, fuzxtext, hdueotext, ecydtext, ym1xotext, hlicntext, hlicnhref, vqp31text, vqp31href, t7wvutext, t7wvuhref, mrjt3text, mrjt3href });
