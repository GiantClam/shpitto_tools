...
export default function TemplateExclusiveUnistellarHomeHomeNavigationNavpenPrimary({ id, logotext, logohref, navl1text, navl1href, navl2text, navl2href, navl3text, navl3href, navl4text, navl4href, navl5text, navl5href, ctahref, ctatexttext, ctatexthref, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotext, logohref, navl1text, navl1href, navl2text, navl2href, navl3text, navl3href, navl4text, navl4href, navl5text, navl5href, ctahref, ctatexttext, ctatexthref });
