...
export default function TemplateExclusiveUnistellarHomeTechnologiesStoryPillarspenAlt2({ id, pltext, pttext, p1ttext, p1dtext, p1href, p2ttext, p2dtext, p2href, p3ttext, p3dtext, p3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pltext, pttext, p1ttext, p1dtext, p1href, p2ttext, p2dtext, p2href, p3ttext, p3dtext, p3href });
