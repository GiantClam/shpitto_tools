...
export default function TemplateExclusivePenSitePscsBlogStoryTabspenAlt2({ id, tab1texttext, tab2texttext, tab3texttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, tab1texttext, tab2texttext, tab3texttext });
