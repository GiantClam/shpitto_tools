...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-resources-navbar-menu",
      "name": "page-resources-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageResourcesNavbarMenutext",
      "hrefProp": "pageResourcesNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pageResourcesNavbarMenutext": "☰",
  "pageResourcesNavbarMenuhref": "/",
  "pageResourcesNavbarSearchtext": "⌕",
...
export default function TemplateExclusivePenSiteResourcesNavigationNavbarpenPrimary({ id, pageResourcesNavbarLogoimagesrc, pageResourcesNavbarMenutext, pageResourcesNavbarMenuhref, pageResourcesNavbarSearchtext, pageResourcesNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageResourcesNavbarLogoimagesrc, pageResourcesNavbarMenutext, pageResourcesNavbarMenuhref, pageResourcesNavbarSearchtext, pageResourcesNavbarSearchhref });
