...
export default function TemplateExclusivePenSiteAboutFooterAboutfooterpenAlt7({ id, footerlogotext, footcol1text, footcol1href, footcol2text, footcol2href, footcol3text, footcol3href, copyrighttext, copyrighthref, addrtext, addrhref, ...rest }) {
