...
const DEFAULT_PROPS = {
  "id": "suvnG",
  "herotagtext": "About Kymeta",
  "herotitletext": "Born from\nmetamaterials\ninnovation"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutHeroHeropenAlt1({ id, herotagtext, herotitletext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotagtext, herotitletext });
