  ...
  "children": [
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "type": "text",
          "id": "nav-page-all-our-bikes",
          "name": "nav-page-all-our-bikes",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageAllOurBikestext"
        },
        {
          "type": "text",
          "id": "nav-page-work",
          ...
          "children": [],
          "textProp": "navPageWorktext"
        },
        {
          "type": "text",
          "id": "nav-page-friends",
          "name": "nav-page-friends",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageFriendstext"
        },
        {
          "type": "text",
          "id": "nav-page-contact-us",
          "name": "nav-page-contact-us",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageContactUstext"
        },
        {
          "type": "text",
          "id": "nav-page-service-support",
          "name": "nav-page-service-support",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageServiceSupporttext"
        }
      ]
    },
    {
...
const DEFAULT_PROPS = {
  "id": "hero",
  "heroImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/ridecake/page-home-img-1-a6e7f822.jpg",
  "headerBrandtext": "CAKE",
  "navPageAllOurBikestext": "ALL OUR BIKES",
  "navPageWorktext": "WORK",
  "navPageFriendstext": "FRIENDS",
  "navPageContactUstext": "CONTACT US",
  "navPageServiceSupporttext": "SERVICE & SUPPORT",
  "heroKickertext": "CAKE",
  "heroTitletext": "High performance electric motorbikes",
  "heroSubtitletext": "light, quiet and clean machines designed for commuting, work and off-road riding.",
  "heroPrimaryTexttext": "All Our Bikes",
  "heroSecondaryTexttext": "Service & Support"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroImageimagesrc, headerBrandtext, navPageAllOurBikestext, navPageWorktext, navPageFriendstext, navPageContactUstext, navPageServiceSupporttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroImageimagesrc, headerBrandtext, navPageAllOurBikestext, navPageWorktext, navPageFriendstext, navPageContactUstext, navPageServiceSupporttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext });
