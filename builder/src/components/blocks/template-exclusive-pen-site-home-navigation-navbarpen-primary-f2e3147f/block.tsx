...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "home-navbar-mobile-bg",
      "name": "home-navbar-mobile-bg",
      "style": {
        "boxSizing": "border-box",
        "width": 390,
        "height": 72,
    ...
    {
      "type": "rectangle",
      "id": "home-navbar-mobile-logo",
      "name": "home-navbar-mobile-logo",
      "style": {
        "boxSizing": "border-box",
        "width": 72,
        "height": 40,
      ...
      "children": [],
      "imageProp": "homeNavbarMobileLogoimagesrc"
    },
    {
      "type": "text",
      "id": "home-navbar-mobile-lang",
      "name": "home-navbar-mobile-lang",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "homeNavbarMobileLangtext",
      "hrefProp": "homeNavbarMobileLanghref"
    },
    {
      "type": "rectangle",
      "id": "home-navbar-mobile-menu-hit",
      "name": "home-navbar-mobile-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "home-navbar-mobile-menu-line1",
      "name": "home-navbar-mobile-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "home-navbar-mobile-menu-line2",
      "name": "home-navbar-mobile-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "home-navbar-mobile-menu-line3",
      "name": "home-navbar-mobile-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "home-navbar-mobile",
  "homeNavbarMobileLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "homeNavbarMobileLangtext": "ZH",
  "homeNavbarMobileLanghref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, homeNavbarMobileLogoimagesrc, homeNavbarMobileLangtext, homeNavbarMobileLanghref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, homeNavbarMobileLogoimagesrc, homeNavbarMobileLangtext, homeNavbarMobileLanghref });
