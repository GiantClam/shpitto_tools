...
export default function TemplateExclusivePenSiteGuidedToursNavigationNavbarpenPrimary({ id, brandLogoGuidedToursimagesrc, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoGuidedToursimagesrc });
