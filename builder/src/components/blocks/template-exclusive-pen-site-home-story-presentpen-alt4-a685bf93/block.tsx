...
const DEFAULT_PROPS = {
  ...
  "presentMarkertext": "01   PRESENT",
  "presentTitletext": "We've gone this far, driven by the winds of all times.",
  "presentBodytext": "Designed to celebrate the harmony between art and science, these cars can catch the moment. Past and future meet at the perfect time, at the exact instant when the wind of creativity starts to blow.",
...
export default function TemplateExclusivePenSiteHomeStoryPresentpenAlt4({ id, presentBgimagesrc, presentMarkertext, presentTitletext, presentBodytext, presentLinktext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, presentBgimagesrc, presentMarkertext, presentTitletext, presentBodytext, presentLinktext });
