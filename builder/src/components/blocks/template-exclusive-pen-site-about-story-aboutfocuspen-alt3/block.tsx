...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "soltagtxttext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "uRne6",
  "focustitletext": "在Plexus，我们的愿景\n以我们的价值观为指导。",
  "pt1text": "发展人才",
  "txt1text": "我们培养一种信任、勇气和成长的文化，让每个团队成员都能充分发挥自己的潜能。",
  "pt2text": "凝聚归属",
  "txt2text": "我们营造包容的环境，珍视每一位团队成员，拥抱多样性，促进团队合作，共同取得非凡成果。",
  "pt3text": "创新尽责",
  "txt3text": "我们以明确的战略为指导，创新并利用技术，大胆推动积极变革，促进可持续发展的未来。",
  "pt4text": "卓越交付",
  "txt4text": "我们致力于通过标准化、规模化和持续改进来实现卓越的品质和完美的交付。",
  "pt5text": "客户共赢",
  "txt5text": "我们超越客户期望，在信任、坦诚和共享成功的基础上建立合作关系。",
  "soltagtxttext": "我们的价值观"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutStoryAboutfocuspenAlt3({ id, focustitletext, pt1text, txt1text, pt2text, txt2text, pt3text, txt3text, pt4text, txt4text, pt5text, txt5text, soltagtxttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, focustitletext, pt1text, txt1text, pt2text, txt2text, pt3text, txt3text, pt4text, txt4text, pt5text, txt5text, soltagtxttext });
