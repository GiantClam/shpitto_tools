...
const SECTION_TREE = {
  ...
  "children": [],
  "imageProp": "privacybannerimagesrc"
};
const DEFAULT_PROPS = {
  "id": "KcOu3",
  "privacybannerimagesrc": "https://images.unsplash.com/photo-1685514511894-642100f536e9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzIyMDgwMzB8&ixlib=rb-4.1.0&q=80&w=1080"
};
...
export default function TemplateExclusivePenSiteMasterdynamicPrivacyHeroPrivacybannerpenAlt1({ id, privacybannerimagesrc, ...rest }) {
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, privacybannerimagesrc });
