...
export default function TemplateExclusiveUnistellarHomeSmartTelescopesProductsProducthighlightspenAlt2({ id, httext, c1ntext, c1dtext, c1href, c2ntext, c2dtext, c2href, c3ntext, c3dtext, c3href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, httext, c1ntext, c1dtext, c1href, c2ntext, c2dtext, c2href, c3ntext, c3dtext, c3href });
