...
const DEFAULT_PROPS = {
  ...
  "herotitletext": "Serving\nthe front",
  "herotagtext": "Military & Government"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteApplicationHeroHeropenAlt4({ id, heroimagesrc, herotitletext, herotagtext, ...rest }) {
