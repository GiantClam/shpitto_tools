  ...
  "children": [
    ...
    },
    {
      ...
      "style": {
        ...
        "width": 220,
        "height": 440,
        "background": "linear-gradient(90deg, #00000000 0%, #000000C8 62%, #000000F0 100%)",
        "position": "absolute",
        "left": 520,
        "top": 88
      },
    ...
    },
    {
      ...
      "children": [],
      "textProp": "prodbtnttext",
      "hrefProp": "prodbtnthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "B1dqa",
  "sec3titletext": "The intelligent \ncommunications platform",
  "sec3desctext": "Kymeta’s Intelligent Communications Platform leverages advanced processing at the edge, software-defined solutions, and hybrid multi-network capabilities. Our metamaterial-based innovations assure continuous connectivity and spatial intelligence, providing you with the resilient, high-performance communication needed to stay ahead in any situation.",
  "sec3imgimagesrc": "https://images.unsplash.com/photo-1604773794174-0107c62f0968?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDM0ODN8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzMyMDYzOTB8&ixlib=rb-4.1.0&q=80&w=1080",
  "prodbtnhref": "/",
  "prodbtnttext": "Our products",
  "prodbtnthref": "/products"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteHomeStorySec3penAlt4({ id, sec3titletext, sec3desctext, sec3imgimagesrc, prodbtnhref, prodbtnttext, prodbtnthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, sec3titletext, sec3desctext, sec3imgimagesrc, prodbtnhref, prodbtnttext, prodbtnthref });
