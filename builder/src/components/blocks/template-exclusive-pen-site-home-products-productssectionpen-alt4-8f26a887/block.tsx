...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "rectangle",
      "id": "product-card-0-box",
      "name": "product-card-0-box",
      "style": {
        "boxSizing": "border-box",
        "width": 350,
        "height": 152,
    ...
    {
      "type": "rectangle",
      "id": "product-card-0-image",
      "name": "product-card-0-image",
      "style": {
        "boxSizing": "border-box",
        "width": 326,
        "height": 92,
      ...
      "children": [],
      "imageProp": "productCard0Imageimagesrc"
    },
    {
      "type": "text",
      "id": "product-card-0-eyebrow",
      "name": "product-card-0-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard0Eyebrowtext"
    },
    {
      "type": "text",
      "id": "product-card-0-title",
      "name": "product-card-0-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard0Titletext"
    },
    {
      "type": "text",
      "id": "product-card-0-body",
      "name": "product-card-0-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard0Bodytext"
    },
    {
      "type": "text",
      "id": "product-card-0-arrow",
      "name": "product-card-0-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard0Arrowtext"
    },
    {
      "type": "rectangle",
...
const DEFAULT_PROPS = {
  ...
  "prodTab2Texttext": "PURO",
  "prodTab3Texttext": "AUTOMATION",
  "productCard0Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/product-machining-267e98a6.jpg",
  "productCard0Eyebrowtext": "PRODUCT",
  "productCard0Titletext": "MACHINING CENTERS",
  "productCard0Bodytext": "A single machine for multiple processes",
  "productCard0Arrowtext": "›",
  "productCard1Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/product-milling-4bd99504.jpg",
  "productCard1Eyebrowtext": "PRODUCT",
  "productCard1Titletext": "HORIZONTAL MILLING",
  "productCard1Bodytext": "High precision milling machines",
  "productCard1Arrowtext": "›",
  "productCard2Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/product-boring-8e0a2947.jpg",
  "productCard2Eyebrowtext": "PRODUCT",
  "productCard2Titletext": "BORING-MILLING",
  "productCard2Bodytext": "Rigidity, damping and precision",
...
export default function TemplateExclusivePenSiteHomeProductsProductssectionpenAlt4({ id, productsTitletext, productsCopytext, prodTab1Texttext, prodTab2Texttext, prodTab3Texttext, productCard0Imageimagesrc, productCard0Eyebrowtext, productCard0Titletext, productCard0Bodytext, productCard0Arrowtext, productCard1Imageimagesrc, productCard1Eyebrowtext, productCard1Titletext, productCard1Bodytext, productCard1Arrowtext, productCard2Imageimagesrc, productCard2Eyebrowtext, productCard2Titletext, productCard2Bodytext, productCard2Arrowtext, productsCtaBoxhref, productsCtaTexttext, productsCtaTexthref, productsCtaArrowtext, productsCtaArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, productsTitletext, productsCopytext, prodTab1Texttext, prodTab2Texttext, prodTab3Texttext, productCard0Imageimagesrc, productCard0Eyebrowtext, productCard0Titletext, productCard0Bodytext, productCard0Arrowtext, productCard1Imageimagesrc, productCard1Eyebrowtext, productCard1Titletext, productCard1Bodytext, productCard1Arrowtext, productCard2Imageimagesrc, productCard2Eyebrowtext, productCard2Titletext, productCard2Bodytext, productCard2Arrowtext, productsCtaBoxhref, productsCtaTexttext, productsCtaTexthref, productsCtaArrowtext, productsCtaArrowhref });
