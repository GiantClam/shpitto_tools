...
export default function TemplateExclusivePenSiteOerlikonRDStoryExtremeingenuitypenAlt6({ id, extimgaimagesrc, muzdntext, u3a4otext, extbtnahref, j2ehqtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, extimgaimagesrc, muzdntext, u3a4otext, extbtnahref, j2ehqtext });
