...
export default function TemplateExclusivePenSitePscsAboutStoryAboutstatspenAlt5({ id, al5text, sasxstext, gs0sztext, yhh20text, m9fi2text, dcjbtext, rgrxvtext, bos9atext, vyxjmtext, sy1ntext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, al5text, sasxstext, gs0sztext, yhh20text, m9fi2text, dcjbtext, rgrxvtext, bos9atext, vyxjmtext, sy1ntext });
