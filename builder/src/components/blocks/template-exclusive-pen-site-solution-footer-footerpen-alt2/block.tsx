...
export default function TemplateExclusivePenSiteSolutionFooterFooterpenAlt2({ id, cu7kctext, gtmsntext, fqregtext, col2ttext, col2thref, d8zctext, d8zchref, aus4ytext, aus4yhref, slpfqtext, slpfqhref, nivfhtext, nivfhhref, pvr1ttext, pvr1thref, luh0atext, luh0ahref, unx7ytext, unx7yhref, gk8vvtext, gk8vvhref, jf8pwtext, jf8pwhref, dvskitext, dvskihref, enud2text, enud2href, obwtntext, obwtnhref, yty6htext, yty6hhref, o2ut7text, o2ut7href, fsrk1text, fsrk1href, y7tcltext, y7tclhref, gvfemtext, gvfemhref, hfmcltext, hfmclhref, mbahtext, mbahhref, d6f2jtext, d6f2jhref, nfk98text, nfk98href, spfxjtext, spfxjhref, jir9ltext, jir9lhref, hhmcqtext, hhmcqhref, p40rxtext, p40rxhref, sbmnktext, sbmnkhref, vbfwtext, vbfwhref, matamtext, matamhref, socialtext, socialhref, kyo5qtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, cu7kctext, gtmsntext, fqregtext, col2ttext, col2thref, d8zctext, d8zchref, aus4ytext, aus4yhref, slpfqtext, slpfqhref, nivfhtext, nivfhhref, pvr1ttext, pvr1thref, luh0atext, luh0ahref, unx7ytext, unx7yhref, gk8vvtext, gk8vvhref, jf8pwtext, jf8pwhref, dvskitext, dvskihref, enud2text, enud2href, obwtntext, obwtnhref, yty6htext, yty6hhref, o2ut7text, o2ut7href, fsrk1text, fsrk1href, y7tcltext, y7tclhref, gvfemtext, gvfemhref, hfmcltext, hfmclhref, mbahtext, mbahhref, d6f2jtext, d6f2jhref, nfk98text, nfk98href, spfxjtext, spfxjhref, jir9ltext, jir9lhref, hhmcqtext, hhmcqhref, p40rxtext, p40rxhref, sbmnktext, sbmnkhref, vbfwtext, vbfwhref, matamtext, matamhref, socialtext, socialhref, kyo5qtext });
