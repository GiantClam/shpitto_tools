...
export default function TemplateExclusivePenSiteHomeFooterFooterpenAlt4({ id, footerLogoimagesrc, footerPlatformtext, footerPlatformhref, footerPlatformBodytext, footerPlatformBodyhref, footerProductstext, footerProductshref, footerProductsBodytext, footerProductsBodyhref, footerAbouttext, footerAbouthref, footerAboutBodytext, footerAboutBodyhref, footerCopytext, footerCopyhref, ...rest }) {
