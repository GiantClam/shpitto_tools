...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "hrefProp": "heroCta1Boxhref"
    },
    {
      "type": "text",
      "id": "hero-cta-1-text",
      "name": "hero-cta-1-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "heroCta1Texttext",
      "hrefProp": "heroCta1Texthref"
    },
    {
      "type": "rectangle",
      "id": "hero-cta-2-box",
      ...
      "children": [],
      "hrefProp": "heroCta2Boxhref"
    },
    {
      "type": "text",
      "id": "hero-cta-2-text",
      "name": "hero-cta-2-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "heroCta2Texttext",
      "hrefProp": "heroCta2Texthref"
    },
    {
      "type": "rectangle",
      "id": "scroll-indicator-pill",
      "name": "scroll-indicator-pill",
      "style": {
        "boxSizing": "border-box",
        "width": 26,
        "height": 42,
    ...
    {
      "type": "text",
      "id": "scroll-indicator-label",
      "name": "scroll-indicator-label",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "scrollIndicatorLabeltext"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "hero",
  "heroBgimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/hero.jpg",
  "heroEyebrowtext": "Act Three, Scene Two",
  "heroLogoimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/hero-logo.png",
  "heroTitletext": "Pagani Utopia Roadster.",
  "heroSubtext": "The open-top interpretation of Utopia keeps mechanical purity, lightness and timeless proportion at the center of the stage, with a calmer and more precise visual language.",
  "heroCta1Boxhref": "/",
  "heroCta1Texttext": "Discover More",
  "heroCta1Texthref": "/",
  "heroCta2Boxhref": "/",
  "heroCta2Texttext": "History",
  "heroCta2Texthref": "/history",
  "scrollIndicatorLabeltext": "SCROLL DOWN"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroBgimagesrc, heroEyebrowtext, heroLogoimagesrc, heroTitletext, heroSubtext, heroCta1Boxhref, heroCta1Texttext, heroCta1Texthref, heroCta2Boxhref, heroCta2Texttext, heroCta2Texthref, scrollIndicatorLabeltext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroBgimagesrc, heroEyebrowtext, heroLogoimagesrc, heroTitletext, heroSubtext, heroCta1Boxhref, heroCta1Texttext, heroCta1Texthref, heroCta2Boxhref, heroCta2Texttext, heroCta2Texthref, scrollIndicatorLabeltext });
