...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "poweredTitleAtext"
    },
    {
      "type": "text",
      "id": "powered-title-b",
      "name": "powered-title-b",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "poweredTitleBtext"
    },
    {
      "type": "text",
      "id": "powered-title-c",
      "name": "powered-title-c",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
    ...
    {
      "type": "rectangle",
      "id": "powered-card-img-0",
      "name": "powered-card-img-0",
      "style": {
        "boxSizing": "border-box",
        "width": 148,
        "height": 76,
      ...
      "children": [],
      "imageProp": "poweredCardImg0imagesrc"
    },
    {
      "type": "rectangle",
      "id": "powered-card-caption-0",
      "name": "powered-card-caption-0",
      "style": {
        "boxSizing": "border-box",
        "width": 164,
        "height": 26,
    ...
    {
      "type": "text",
      "id": "powered-card-label-0",
      "name": "powered-card-label-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "poweredCardLabel0text"
    },
    {
      "type": "rectangle",
      "id": "powered-card-1",
    ...
    {
      "type": "rectangle",
      "id": "powered-card-img-1",
      "name": "powered-card-img-1",
      "style": {
        "boxSizing": "border-box",
        "width": 148,
        "height": 76,
      ...
      "children": [],
      "imageProp": "poweredCardImg1imagesrc"
    },
    {
      "type": "rectangle",
      "id": "powered-card-caption-1",
      "name": "powered-card-caption-1",
      "style": {
        "boxSizing": "border-box",
        "width": 164,
        "height": 26,
    ...
    {
      "type": "text",
      "id": "powered-card-label-1",
      "name": "powered-card-label-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "poweredCardLabel1text"
    },
    {
      "type": "rectangle",
      "id": "powered-card-2",
    ...
    {
      "type": "rectangle",
      "id": "powered-card-img-2",
      "name": "powered-card-img-2",
      "style": {
        "boxSizing": "border-box",
        "width": 148,
        "height": 76,
      ...
      "children": [],
      "imageProp": "poweredCardImg2imagesrc"
    },
    {
      "type": "rectangle",
      "id": "powered-card-caption-2",
      "name": "powered-card-caption-2",
      "style": {
        "boxSizing": "border-box",
        "width": 164,
        "height": 26,
    ...
    {
      "type": "text",
      "id": "powered-card-label-2",
      "name": "powered-card-label-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "poweredCardLabel2text"
    },
    {
      "type": "rectangle",
      "id": "powered-card-3",
    ...
    {
      "type": "rectangle",
      "id": "powered-card-img-3",
      "name": "powered-card-img-3",
      "style": {
        "boxSizing": "border-box",
        "width": 148,
        "height": 76,
      ...
      "children": [],
      "imageProp": "poweredCardImg3imagesrc"
    },
    {
      "type": "rectangle",
      "id": "powered-card-caption-3",
      "name": "powered-card-caption-3",
      "style": {
        "boxSizing": "border-box",
        "width": 164,
        "height": 26,
    ...
    {
      "type": "text",
      "id": "powered-card-label-3",
      "name": "powered-card-label-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "poweredCardLabel3text"
    },
    {
      "type": "rectangle",
      "id": "powered-card-4",
    ...
    {
      "type": "rectangle",
      "id": "powered-card-img-4",
      "name": "powered-card-img-4",
      "style": {
        "boxSizing": "border-box",
        "width": 148,
        "height": 76,
      ...
      "children": [],
      "imageProp": "poweredCardImg4imagesrc"
    },
    {
      "type": "rectangle",
      "id": "powered-card-caption-4",
      "name": "powered-card-caption-4",
      "style": {
        "boxSizing": "border-box",
        "width": 164,
        "height": 26,
    ...
    {
      "type": "text",
      "id": "powered-card-label-4",
      "name": "powered-card-label-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "poweredCardLabel4text"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "powered",
  "poweredTitleAtext": "Powered",
  "poweredTitleBtext": "By",
  "poweredTitleCtext": "Carbon",
  "poweredCopytext": "Our customers create products with exceptional mechanical properties using our advanced photopolymer resins, computational design tools, and 3D printing hardware.",
  "poweredCardImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-send-56390b29.jpg",
  "poweredCardLabel0text": "SEND Impact Airpads",
  "poweredCardImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-saddle-96b03382.jpg",
  "poweredCardLabel1text": "Specialized Mirror",
  "poweredCardImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-adidas-00a4f7b3.jpg",
  "poweredCardLabel2text": "Adidas 4D",
  "poweredCardImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-helmet-b170d235.jpg",
  "poweredCardLabel3text": "Riddell Helmet",
  "poweredCardImg4imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/carbon/home-bike-63f07d54.jpg",
  "poweredCardLabel4text": "KU Cycle"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryPoweredpenAlt1({ id, poweredTitleAtext, poweredTitleBtext, poweredTitleCtext, poweredCopytext, poweredCardImg0imagesrc, poweredCardLabel0text, poweredCardImg1imagesrc, poweredCardLabel1text, poweredCardImg2imagesrc, poweredCardLabel2text, poweredCardImg3imagesrc, poweredCardLabel3text, poweredCardImg4imagesrc, poweredCardLabel4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, poweredTitleAtext, poweredTitleBtext, poweredTitleCtext, poweredCopytext, poweredCardImg0imagesrc, poweredCardLabel0text, poweredCardImg1imagesrc, poweredCardLabel1text, poweredCardImg2imagesrc, poweredCardLabel2text, poweredCardImg3imagesrc, poweredCardLabel3text, poweredCardImg4imagesrc, poweredCardLabel4text });
