      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "navmenutext",
          "hrefProp": "navmenuhref"
        },
        {
          "type": "frame",
          "id": "nqWmo",
              ...
              "children": [
                {
                  ...
                  "children": [],
                  "textProp": "getstartedtxttext",
                  "hrefProp": "getstartedtxthref"
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [],
                  "textProp": "signintxttext",
                  "hrefProp": "signintxthref"
                }
              ]
            }
          ],
          "hrefProp": "navactionshref"
        }
      ]
    }
  ]
...
const DEFAULT_PROPS = {
  ...
  "e3mtxtext": "IONQ",
  "e3mtxhref": "/",
  "navmenutext": "Products   Company   Resources   Careers   Roadmap   Blog",
  "navmenuhref": "/blog",
  "navactionshref": "/",
  "getstartedtxttext": "Get started",
  "getstartedtxthref": "/",
  "signintxttext": "Sign in",
  "signintxthref": "/"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #E7EDF4)";
...
export default function TemplateExclusivePenSiteTechnologyNavigationNavpenAlt1({ id, e3mtxtext, e3mtxhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, e3mtxtext, e3mtxhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref });
