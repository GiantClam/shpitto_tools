      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "corebtnttext"
        }
      ],
      "hrefProp": "corebtnhref"
    }
  ]
};
const DEFAULT_PROPS = {
...
export default function TemplateExclusivePenSiteOerlikonProductsStoryCorecompetenciespenAlt3({ id, coretitletext, coretext1text, coretext2text, coretitletext2, corebtnhref, corebtnttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, coretitletext, coretext1text, coretext2text, coretitletext2, corebtnhref, corebtnttext });
