...
const DEFAULT_PROPS = {
  ...
  "catCardImg0imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "catCardT0text": "All Products",
  "catCardB0text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection.",
  "catCardImg1imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "catCardT1text": "Modular System",
  "catCardB1text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection.",
  "catCardImg2imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "catCardT2text": "Sound Room",
  "catCardB2text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection.",
  "catCardImg3imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "catCardT3text": "Support",
  "catCardB3text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection.",
  "catCardImg4imagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/transpa-rent/page-all-products-img-1-1d7086e9.jpg",
  "catCardT4text": "About",
  "catCardB4text": "Transparent creates timeless speakers and design tech blending Scandinavian aesthetics, sustainability and crystal-clear sound. Explore the collection."
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeStoryCategoriespenAlt1({ id, catTitletext, catCardImg0imagesrc, catCardT0text, catCardB0text, catCardImg1imagesrc, catCardT1text, catCardB1text, catCardImg2imagesrc, catCardT2text, catCardB2text, catCardImg3imagesrc, catCardT3text, catCardB3text, catCardImg4imagesrc, catCardT4text, catCardB4text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, catTitletext, catCardImg0imagesrc, catCardT0text, catCardB0text, catCardImg1imagesrc, catCardT1text, catCardB1text, catCardImg2imagesrc, catCardT2text, catCardB2text, catCardImg3imagesrc, catCardT3text, catCardB3text, catCardImg4imagesrc, catCardT4text, catCardB4text });
