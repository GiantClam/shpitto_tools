...
export default function TemplateExclusiveUnistellarHomeAboutStoryAboutctapenAlt5({ id, ctaeyebrowtext, ctaheadtext, ctabodytext, ctabuttonshref, ctatxtprimarytext, ctabtnprimaryhref, ctatxtsecondarytext, ctabtnsecondaryhref, sub1ttext, sub2ttext, sub3ttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctaeyebrowtext, ctaheadtext, ctabodytext, ctabuttonshref, ctatxtprimarytext, ctabtnprimaryhref, ctatxtsecondarytext, ctabtnsecondaryhref, sub1ttext, sub2ttext, sub3ttext });
