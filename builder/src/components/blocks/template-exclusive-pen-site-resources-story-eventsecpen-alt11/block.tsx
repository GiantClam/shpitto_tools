...
export default function TemplateExclusivePenSiteResourcesStoryEventsecpenAlt11({ id, restagtxttext, resheadtext, resmoretext, r1iimagesrc, r1ttext, r2iimagesrc, r2ttext, r3iimagesrc, r3ttext, leftctrlttext, rightctrlttext, ...rest }) {
