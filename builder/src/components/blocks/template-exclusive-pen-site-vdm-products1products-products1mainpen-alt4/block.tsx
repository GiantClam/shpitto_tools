...
export default function TemplateExclusivePenSiteVdmProducts1ProductsProducts1mainpenAlt4({ id, introtitletext, introbodytext, secatext, secabodytext, btnhref, btnttext, secbtext, secbbodytext, li1text, li2text, li3text, li4text, i1imagesrc, t1text, t2text, i3imagesrc, t3text, i4imagesrc, t4text, ...rest }) {
