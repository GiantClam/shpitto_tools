...
export default function TemplateExclusiveUnistellarHomeContactContactContactbodypenAlt2({ id, methodstitletext, methodsdesctext, emailtitletext, emailvaluetext, emailrowhref, phonetitletext, phonevaluetext, phonerowhref, presstitletext, pressvaluetext, pressrowhref, officetitletext, officedesctext, addresslabeltext, addresstexttext, hourslabeltext, hourstexttext, visitbtnhref, visitbtntexttext, formCtahref, formtitletext, formdesctext, nametexttext, namefieldhref, emailtexttext, emailfieldhref, messagetexttext, messagefieldhref, submittexttext, formhelptext, quicktitletext, quickdesctext, region1text, region2text, region3text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, methodstitletext, methodsdesctext, emailtitletext, emailvaluetext, emailrowhref, phonetitletext, phonevaluetext, phonerowhref, presstitletext, pressvaluetext, pressrowhref, officetitletext, officedesctext, addresslabeltext, addresstexttext, hourslabeltext, hourstexttext, visitbtnhref, visitbtntexttext, formCtahref, formtitletext, formdesctext, nametexttext, namefieldhref, emailtexttext, emailfieldhref, messagetexttext, messagefieldhref, submittexttext, formhelptext, quicktitletext, quickdesctext, region1text, region2text, region3text });
