...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #CBD6E6)";
...
export default function TemplateExclusivePenSiteUrsaPrivacyFooterPrivacybodybottompenAlt4({ id, l1rq2text, qhhkctext, qhhkchref, y0eatext, y0eahref, jcr2ytext, jcr2yhref, qwemdtext, qwemdhref, sg2iztext, sg2izhref, ningotext, ningohref, eilwtext, eilwhref, v6i29text, v6i29href, xl48stext, xl48shref, llklotext, llklohref, vwrptext, vwrphref, gsanytext, gsanyhref, hqeztext, hqezhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, l1rq2text, qhhkctext, qhhkchref, y0eatext, y0eahref, jcr2ytext, jcr2yhref, qwemdtext, qwemdhref, sg2iztext, sg2izhref, ningotext, ningohref, eilwtext, eilwhref, v6i29text, v6i29href, xl48stext, xl48shref, llklotext, llklohref, vwrptext, vwrphref, gsanytext, gsanyhref, hqeztext, hqezhref });
