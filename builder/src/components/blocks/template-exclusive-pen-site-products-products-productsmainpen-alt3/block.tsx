...
export default function TemplateExclusivePenSiteProductsProductsProductsmainpenAlt3({ id, tagtext, titletext, subtext, i1imagesrc, t1text, d1text, l1text, i2imagesrc, t2text, d2text, l2text, i3imagesrc, t3text, d3text, l3text, i4imagesrc, t4text, d4text, l4text, i5imagesrc, t5text, d5text, l5text, i6imagesrc, t6text, d6text, l6text, i7imagesrc, t7text, d7text, l7text, i8imagesrc, t8text, d8text, l8text, i9imagesrc, t9text, d9text, l9text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, tagtext, titletext, subtext, i1imagesrc, t1text, d1text, l1text, i2imagesrc, t2text, d2text, l2text, i3imagesrc, t3text, d3text, l3text, i4imagesrc, t4text, d4text, l4text, i5imagesrc, t5text, d5text, l5text, i6imagesrc, t6text, d6text, l6text, i7imagesrc, t7text, d7text, l7text, i8imagesrc, t8text, d8text, l8text, i9imagesrc, t9text, d9text, l9text });
