...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "logotexttext",
      "hrefProp": "logotexthref"
    },
    {
      "type": "text",
      "id": "lgo4Z",
      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "langtxttext",
          "hrefProp": "langtxthref"
        }
      ]
    },
    {
      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "ctahtxttext",
          "hrefProp": "ctahtxthref"
        }
      ]
    },
    {
      ...
      "children": [
        {
          ...
          "children": [],
          "textProp": "toplinkstext",
          "hrefProp": "toplinkshref"
        },
        {
          "type": "frame",
          "id": "EUddt",
          ...
          "children": [
            ...
            },
            {
              ...
              "children": [],
              "textProp": "langarrowtext",
              "hrefProp": "langarrowhref"
            }
          ]
        }
      ]
...
const DEFAULT_PROPS = {
  ...
  "logotexttext": "PLEXUS",
  "logotexthref": "/",
  "navtext": "解决方案 ▾    市场领域 ▾    关于我们 ▾    资源 ▾",
  "navhref": "/",
  "langtxttext": "ZH",
  "langtxthref": "/",
  "ctahtxttext": "联系我们的团队",
  "ctahtxthref": "/",
  "toplinkstext": "投资者网站    客户门户网站    供应商门户网站    职业发展",
  "toplinkshref": "/",
  "flagtxttext": "ZH",
  "flagtxthref": "/",
  "langarrowtext": "▾",
...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #22303D)";
...
export default function TemplateExclusivePenSiteResourcesNavigationSolheaderpenPrimary({ id, logotexttext, logotexthref, navtext, navhref, langtxttext, langtxthref, ctahtxttext, ctahtxthref, toplinkstext, toplinkshref, flagtxttext, flagtxthref, langarrowtext, langarrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, logotexttext, logotexthref, navtext, navhref, langtxttext, langtxthref, ctahtxttext, ctahtxthref, toplinkstext, toplinkshref, flagtxttext, flagtxthref, langarrowtext, langarrowhref });
