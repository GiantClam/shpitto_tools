...
export default function TemplateExclusiveUnistellarHomeTechnologiesCtaCtapenAlt4({ id, ctahref, ctahtext, ctadtext, ctabttext, ctabhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, ctahref, ctahtext, ctadtext, ctabttext, ctabhref });
