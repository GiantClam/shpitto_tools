...
const DEFAULT_PROPS = {
  ...
  "ctabtntexthref": "/contact-support",
...
export default function TemplateExclusiveUnistellarHomeSupportCtaContactctapenAlt4({ id, contactCtahref, ctalabeltext, ctatitletext, ctasubtext, ctabtnhref, ctabtntexttext, ctabtntexthref, ctametatext, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, contactCtahref, ctalabeltext, ctatitletext, ctasubtext, ctabtnhref, ctabtntexttext, ctabtntexthref, ctametatext });
