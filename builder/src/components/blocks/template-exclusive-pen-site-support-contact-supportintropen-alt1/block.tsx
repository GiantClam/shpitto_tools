...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "introbtnttext",
      "hrefProp": "introbtnthref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "gjgjM",
  "introttext": "We're committed to timely delivery of world-class products and services, amplifying our customers, and prioritizing support resources.",
  "introbtnhref": "/",
  "introbtnttext": "Email support",
  "introbtnthref": "/support"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteSupportContactSupportintropenAlt1({ id, introttext, introbtnhref, introbtnttext, introbtnthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, introttext, introbtnhref, introbtnttext, introbtnthref });
