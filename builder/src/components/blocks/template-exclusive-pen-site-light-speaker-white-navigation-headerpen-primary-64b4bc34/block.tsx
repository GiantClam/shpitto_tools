...
export default function TemplateExclusivePenSiteLightSpeakerWhiteNavigationHeaderpenPrimary({ id, headerBrandtext, headerBrandhref, headerMenutext, headerMenuhref, ...rest }) {
