...
export default function TemplateExclusivePenSiteHomeApproachFeaturedpenAlt5({ id, fttitletext, fp1imgimagesrc, fp1tagtext, fp1titletext, fp1desctext, fp2imgimagesrc, fp2tagtext, fp2titletext, fp2desctext, fp3imgimagesrc, fp3tagtext, fp3titletext, fp3desctext, fp4imgimagesrc, fp4tagtext, fp4titletext, fp4desctext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, fttitletext, fp1imgimagesrc, fp1tagtext, fp1titletext, fp1desctext, fp2imgimagesrc, fp2tagtext, fp2titletext, fp2desctext, fp3imgimagesrc, fp3tagtext, fp3titletext, fp3desctext, fp4imgimagesrc, fp4tagtext, fp4titletext, fp4desctext });
