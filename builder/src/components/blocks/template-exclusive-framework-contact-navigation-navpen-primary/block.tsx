...
export default function TemplateExclusiveFrameworkContactNavigationNavpenPrimary({ id, logotext, logohref, centernavtext, centernavhref, rightnavtext, rightnavhref, ...rest }) {
