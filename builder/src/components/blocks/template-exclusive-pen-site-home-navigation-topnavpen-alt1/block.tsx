...
export default function TemplateExclusivePenSiteHomeNavigationTopnavpenAlt1({ id, kuftytext, kuftyhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, kuftytext, kuftyhref, navmenutext, navmenuhref, navactionshref, getstartedtxttext, getstartedtxthref, signintxttext, signintxthref });
