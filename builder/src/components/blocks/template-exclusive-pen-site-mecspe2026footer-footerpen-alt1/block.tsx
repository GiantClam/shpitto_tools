...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "footer-col-title-1",
      "name": "footer-col-title-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColTitle1text",
      "hrefProp": "footerColTitle1href"
    },
    {
      "type": "text",
      "id": "footer-col-links-1",
      "name": "footer-col-links-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColLinks1text",
      "hrefProp": "footerColLinks1href"
    },
    {
      "type": "text",
      "id": "footer-col-title-2",
      "name": "footer-col-title-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColTitle2text",
      "hrefProp": "footerColTitle2href"
    },
    {
      "type": "text",
      "id": "footer-col-links-2",
      "name": "footer-col-links-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColLinks2text",
      "hrefProp": "footerColLinks2href"
    },
    {
      "type": "text",
      "id": "footer-col-title-3",
      "name": "footer-col-title-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColTitle3text",
      "hrefProp": "footerColTitle3href"
    },
    {
      "type": "text",
      "id": "footer-col-links-3",
      "name": "footer-col-links-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColLinks3text",
      "hrefProp": "footerColLinks3href"
    },
    {
      "type": "text",
      "id": "footer-col-title-4",
      "name": "footer-col-title-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColTitle4text",
      "hrefProp": "footerColTitle4href"
    },
    {
      "type": "text",
      "id": "footer-col-links-4",
      "name": "footer-col-links-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "footerColLinks4text",
      "hrefProp": "footerColLinks4href"
    },
    {
      "type": "text",
      "id": "footer-lang",
      ...
      "children": [],
      "textProp": "footerLangtext",
      "hrefProp": "footerLanghref"
    },
    {
      "type": "text",
      "id": "footer-copy",
...
const DEFAULT_PROPS = {
  ...
  "footerContacthref": "/",
  "footerColTitle1text": "企业",
  "footerColTitle1href": "/",
  "footerColLinks1text": "企业\n历史\n企业系统\nItalian Style\n我们的认证\nGovernance",
  "footerColLinks1href": "/",
  "footerColTitle2text": "产品",
  "footerColTitle2href": "/",
  "footerColLinks2text": "镗床\n卧式铣床\n立式铣床\n车削中心\nT 型铣床\nFriction Stir Welding\nAccessories",
  "footerColLinks2href": "/",
  "footerColTitle3text": "行业",
  "footerColTitle3href": "/",
  "footerColLinks3text": "能源\n通用机械\n航空航天\n模板&模具\n汽车\n铁路\n石油&天然气\n土方工程\n船舶\n防务",
  "footerColLinks3href": "/",
  "footerColTitle4text": "技术",
  "footerColTitle4href": "/",
  "footerColLinks4text": "FPT 世界\n通信\n联系方式\n加入我们",
  "footerColLinks4href": "/",
  "footerLangtext": "IT   EN   DE   FR   ES   PT   SV   RU   KO   ZH   AR",
  "footerLanghref": "/",
...
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #E7E7E7)";
...
export default function TemplateExclusivePenSiteMecspe2026FooterFooterpenAlt1({ id, footerLogoimagesrc, footerCompanytext, footerCompanyhref, footerAddresstext, footerAddresshref, footerContacttext, footerContacthref, footerColTitle1text, footerColTitle1href, footerColLinks1text, footerColLinks1href, footerColTitle2text, footerColTitle2href, footerColLinks2text, footerColLinks2href, footerColTitle3text, footerColTitle3href, footerColLinks3text, footerColLinks3href, footerColTitle4text, footerColTitle4href, footerColLinks4text, footerColLinks4href, footerLangtext, footerLanghref, footerCopytext, footerCopyhref, ...rest }) {
