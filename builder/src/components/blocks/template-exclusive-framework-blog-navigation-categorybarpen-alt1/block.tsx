...
export default function TemplateExclusiveFrameworkBlogNavigationCategorybarpenAlt1({ id, fmwkqtext, fmwkqhref, shvcttext, shvcthref, fmg0utext, fmg0uhref, usnltext, usnlhref, krcrjtext, krcrjhref, ...rest }) {
