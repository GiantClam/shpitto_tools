...
export default function TemplateExclusivePenSiteSolutionProviderNavigationNavbarpenPrimary({ id, pageSolutionProviderNavbarLogoimagesrc, pageSolutionProviderNavbarContactTexttext, pageSolutionProviderNavbarContactTexthref, pageSolutionProviderNavbarContactArrowtext, pageSolutionProviderNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageSolutionProviderNavbarLogoimagesrc, pageSolutionProviderNavbarContactTexttext, pageSolutionProviderNavbarContactTexthref, pageSolutionProviderNavbarContactArrowtext, pageSolutionProviderNavbarContactArrowhref });
