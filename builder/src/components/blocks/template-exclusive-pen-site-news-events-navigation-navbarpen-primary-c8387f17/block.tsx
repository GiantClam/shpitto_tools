...
export default function TemplateExclusivePenSiteNewsEventsNavigationNavbarpenPrimary({ id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarMenutext, pageNewsEventsNavbarMenuhref, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageNewsEventsNavbarLogoimagesrc, pageNewsEventsNavbarMenutext, pageNewsEventsNavbarMenuhref, pageNewsEventsNavbarSearchtext, pageNewsEventsNavbarSearchhref });
