...
const DEFAULT_PROPS = {
  ...
  "cta1thref": "/explore-the-stack",
  "cta2href": "/compare-outcomes",
  "cta2ttext": "Compare outcomes",
  "cta2thref": "/compare-outcomes",
...
export default function TemplateExclusiveUnistellarHomeTechnologiesHeroHeropenAlt1({ id, badgetext, httext, hstext, cta1href, cta1ttext, cta1thref, cta2href, cta2ttext, cta2thref, visualimagesrc, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, badgetext, httext, hstext, cta1href, cta1ttext, cta1thref, cta2href, cta2ttext, cta2thref, visualimagesrc });
