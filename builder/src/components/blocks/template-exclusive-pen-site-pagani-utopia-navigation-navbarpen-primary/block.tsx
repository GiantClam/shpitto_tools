...
const SECTION_TREE = {
  ...
  "children": [
    {
      "type": "rectangle",
      "id": "header-bg-pagani-utopia",
      "name": "header-bg-pagani-utopia",
      "style": {
        "boxSizing": "border-box",
        "width": 1440,
        "height": 84,
    ...
    {
      "type": "rectangle",
      "id": "brand-logo-pagani-utopia",
      "name": "brand-logo-pagani-utopia",
      "style": {
        "boxSizing": "border-box",
        "width": 152,
        "height": 46,
      ...
      "children": [],
      "imageProp": "brandLogoPaganiUtopiaimagesrc"
    },
    {
      "type": "text",
      "id": "nav-pagani-utopia-0",
      "name": "nav-pagani-utopia-0",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPaganiUtopia0text",
      "hrefProp": "navPaganiUtopia0href"
    },
    {
      "type": "text",
      "id": "nav-pagani-utopia-1",
      "name": "nav-pagani-utopia-1",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPaganiUtopia1text",
      "hrefProp": "navPaganiUtopia1href"
    },
    {
      "type": "text",
      "id": "nav-pagani-utopia-2",
      "name": "nav-pagani-utopia-2",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPaganiUtopia2text",
      "hrefProp": "navPaganiUtopia2href"
    },
    {
      "type": "text",
      "id": "nav-pagani-utopia-3",
      "name": "nav-pagani-utopia-3",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPaganiUtopia3text",
      "hrefProp": "navPaganiUtopia3href"
    },
    {
      "type": "text",
      "id": "nav-pagani-utopia-4",
      "name": "nav-pagani-utopia-4",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPaganiUtopia4text",
      "hrefProp": "navPaganiUtopia4href"
    },
    {
      "type": "text",
      "id": "nav-pagani-utopia-5",
      "name": "nav-pagani-utopia-5",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "navPaganiUtopia5text",
      "hrefProp": "navPaganiUtopia5href"
    },
    {
      "type": "rectangle",
      "id": "menu-box-pagani-utopia",
      "name": "menu-box-pagani-utopia",
      "style": {
        "boxSizing": "border-box",
        "width": 56,
        "height": 56,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-1-pagani-utopia",
      "name": "menu-line-1-pagani-utopia",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-2-pagani-utopia",
      "name": "menu-line-2-pagani-utopia",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "menu-line-3-pagani-utopia",
      "name": "menu-line-3-pagani-utopia",
      "style": {
        "boxSizing": "border-box",
        "width": 18,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "navbar-pagani-utopia",
  "brandLogoPaganiUtopiaimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pagani/pagani-logo.png",
  "navPaganiUtopia0text": "Home",
  "navPaganiUtopia0href": "/",
  "navPaganiUtopia1text": "History",
  "navPaganiUtopia1href": "/history",
  "navPaganiUtopia2text": "Dealers",
  "navPaganiUtopia2href": "/dealers",
  "navPaganiUtopia3text": "Tours",
  "navPaganiUtopia3href": "/guided-tours",
  "navPaganiUtopia4text": "Utopia",
  "navPaganiUtopia4href": "/pagani-utopia",
  "navPaganiUtopia5text": "Contact",
  "navPaganiUtopia5href": "/contact-us"
};
const DEFAULT_THEME = {
  "mode": "dark",
...
export default function TemplateExclusivePenSitePaganiUtopiaNavigationNavbarpenPrimary({ id, brandLogoPaganiUtopiaimagesrc, navPaganiUtopia0text, navPaganiUtopia0href, navPaganiUtopia1text, navPaganiUtopia1href, navPaganiUtopia2text, navPaganiUtopia2href, navPaganiUtopia3text, navPaganiUtopia3href, navPaganiUtopia4text, navPaganiUtopia4href, navPaganiUtopia5text, navPaganiUtopia5href, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, brandLogoPaganiUtopiaimagesrc, navPaganiUtopia0text, navPaganiUtopia0href, navPaganiUtopia1text, navPaganiUtopia1href, navPaganiUtopia2text, navPaganiUtopia2href, navPaganiUtopia3text, navPaganiUtopia3href, navPaganiUtopia4text, navPaganiUtopia4href, navPaganiUtopia5text, navPaganiUtopia5href });
