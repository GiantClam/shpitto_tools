...
export default function TemplateExclusivePenSitePscsBlogProductsBloggridpenAlt3({ id, img1imagesrc, t1text, img2imagesrc, t2text, img3imagesrc, t3text, img4imagesrc, t4text, img5imagesrc, t5text, img6imagesrc, t6text, img7imagesrc, t7text, img8imagesrc, t8text, img9imagesrc, t9text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, img1imagesrc, t1text, img2imagesrc, t2text, img3imagesrc, t3text, img4imagesrc, t4text, img5imagesrc, t5text, img6imagesrc, t6text, img7imagesrc, t7text, img8imagesrc, t8text, img9imagesrc, t9text });
