...
export default function TemplateExclusivePenSiteServicesNavigationNavbarpenPrimary({ id, pageServicesNavbarLogoimagesrc, pageServicesNavbarSearchtext, pageServicesNavbarSearchhref, pageServicesNavbarLangtext, pageServicesNavbarLanghref, pageServicesNavbarMenutext, pageServicesNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageServicesNavbarLogoimagesrc, pageServicesNavbarSearchtext, pageServicesNavbarSearchhref, pageServicesNavbarLangtext, pageServicesNavbarLanghref, pageServicesNavbarMenutext, pageServicesNavbarMenuhref });
