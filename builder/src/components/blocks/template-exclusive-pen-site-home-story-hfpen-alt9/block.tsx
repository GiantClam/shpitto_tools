...
export default function TemplateExclusivePenSiteHomeStoryHfpenAlt9({ id, k1dhitext, ovze9text, rwrx5text, xgczptext, hi5gtext, ggtmktext, sxn6ltext, gcbuvtext, xjrrqtext, c47vstext, fugfktext, kqqdxhref, ln0k2text, ks1jbtext, meabitext, ...rest }) {
