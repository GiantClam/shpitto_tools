...
export default function TemplateExclusivePenSiteOerlikonRDHeroRdheropenAlt1({ id, herobgaimagesrc, fstext, jjd0ntext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herobgaimagesrc, fstext, jjd0ntext });
