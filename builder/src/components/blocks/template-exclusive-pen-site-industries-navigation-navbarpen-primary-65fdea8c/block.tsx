...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-industries-navbar-menu",
      "name": "page-industries-navbar-menu",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageIndustriesNavbarMenutext",
      "hrefProp": "pageIndustriesNavbarMenuhref"
    },
    {
      "type": "text",
...
const DEFAULT_PROPS = {
  ...
  "pageIndustriesNavbarMenutext": "☰",
  "pageIndustriesNavbarMenuhref": "/",
  "pageIndustriesNavbarSearchtext": "⌕",
...
export default function TemplateExclusivePenSiteIndustriesNavigationNavbarpenPrimary({ id, pageIndustriesNavbarLogoimagesrc, pageIndustriesNavbarMenutext, pageIndustriesNavbarMenuhref, pageIndustriesNavbarSearchtext, pageIndustriesNavbarSearchhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageIndustriesNavbarLogoimagesrc, pageIndustriesNavbarMenutext, pageIndustriesNavbarMenuhref, pageIndustriesNavbarSearchtext, pageIndustriesNavbarSearchhref });
