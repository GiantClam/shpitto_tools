...
const DEFAULT_PROPS = {
  "id": "cLZ2O",
  "herotitletext": "About Plexus",
  "herodesctext": "打造一流产品，实现美好未来",
  "herobtnhref": "/",
  "herobtntxttext": "联系我们的团队",
  "herotagtext": "首页  >  关于PLEXUS"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Inter",
...
export default function TemplateExclusivePenSiteAboutHeroAboutheropenAlt5({ id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herotagtext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, herotitletext, herodesctext, herobtnhref, herobtntxttext, herotagtext });
