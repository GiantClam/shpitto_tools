...
export default function TemplateExclusivePenSiteOerlikonAboutStoryMinilinkspenAlt7({ id, m1ttext, card1dtext, m2ttext, m3ttext, m3ttext2, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, m1ttext, card1dtext, m2ttext, m3ttext, m3ttext2 });
