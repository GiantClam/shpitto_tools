    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "children": [],
          "textProp": "navPageGuidestext"
        },
        {
          "type": "text",
          "id": "nav-page-downloads",
          "name": "nav-page-downloads",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageDownloadstext"
        },
        {
          "type": "text",
          "id": "nav-page-designs",
          "name": "nav-page-designs",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
          ...
          "children": [],
          "textProp": "navPageDesignstext"
        },
        {
          "type": "text",
          "id": "nav-page-contact",
          "name": "nav-page-contact",
          "style": {
            "boxSizing": "border-box",
            "margin": 0,
            "whiteSpace": "pre-line",
...
const DEFAULT_PROPS = {
  "id": "hero",
  "heroImageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/teenage-engineering/page-home-img-1-ccece3a3.webp",
  "headerBrandtext": "teenage engineering",
  "navPageProductstext": "PRODUCTS",
  "navPageGuidestext": "GUIDES",
  "navPageDownloadstext": "DOWNLOADS",
  "navPageDesignstext": "DESIGNS",
  "navPageContacttext": "CONTACT",
  "heroKickertext": "TEENAGE ENGINEERING",
  "heroTitletext": "high quality ideas for sound, image and play",
  "heroSubtitletext": "tools, instruments and objects from stockholm designed to make technology feel intentional, tactile and human.",
  "heroPrimaryTexttext": "Products",
  "heroSecondaryTexttext": "Guides"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeHeroHeropenPrimary({ id, heroImageimagesrc, headerBrandtext, navPageProductstext, navPageGuidestext, navPageDownloadstext, navPageDesignstext, navPageContacttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, heroImageimagesrc, headerBrandtext, navPageProductstext, navPageGuidestext, navPageDownloadstext, navPageDesignstext, navPageContacttext, heroKickertext, heroTitletext, heroSubtitletext, heroPrimaryTexttext, heroSecondaryTexttext });
