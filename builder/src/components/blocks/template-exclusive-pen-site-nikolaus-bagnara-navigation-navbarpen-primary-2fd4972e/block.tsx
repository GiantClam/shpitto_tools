...
const DEFAULT_PROPS = {
  ...
  "pageNikolausBagnaraNavbarLangtext": "🌐",
...
export default function TemplateExclusivePenSiteNikolausBagnaraNavigationNavbarpenPrimary({ id, pageNikolausBagnaraNavbarLogoimagesrc, pageNikolausBagnaraNavbarSearchtext, pageNikolausBagnaraNavbarSearchhref, pageNikolausBagnaraNavbarLangtext, pageNikolausBagnaraNavbarLanghref, pageNikolausBagnaraNavbarMenutext, pageNikolausBagnaraNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageNikolausBagnaraNavbarLogoimagesrc, pageNikolausBagnaraNavbarSearchtext, pageNikolausBagnaraNavbarSearchhref, pageNikolausBagnaraNavbarLangtext, pageNikolausBagnaraNavbarLanghref, pageNikolausBagnaraNavbarMenutext, pageNikolausBagnaraNavbarMenuhref });
