...
const NAV_ACTIVE_COLOR = "var(--pen-theme-text, #dd2d2f)";
const NAV_INACTIVE_COLOR = "var(--pen-theme-text-secondary, #32373d)";
...
export default function TemplateExclusivePenSiteOerlikonCompanyNavigationCorecompetenciespenAlt4({ id, iov6qtext, iov6qhref, x2idetext, x2idehref, axjooimagesrc, wsamttext, wsamthref, ehkjetext, ehkjehref, p88adimagesrc, e85ektext, e85ekhref, noioitext, noioihref, kqpgimagesrc, uuslotext, uuslohref, t6natext, t6nahref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, iov6qtext, iov6qhref, x2idetext, x2idehref, axjooimagesrc, wsamttext, wsamthref, ehkjetext, ehkjehref, p88adimagesrc, e85ektext, e85ekhref, noioitext, noioihref, kqpgimagesrc, uuslotext, uuslohref, t6natext, t6nahref });
