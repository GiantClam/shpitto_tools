...
const SECTION_TREE = {
  ...
  "children": [
    ...
    {
      "type": "text",
      "id": "page-services-navbar-企业",
      "name": "page-services-navbar-企业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarText",
      "hrefProp": "pageServicesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-产品",
      "name": "page-services-navbar-产品",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarText2",
      "hrefProp": "pageServicesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-行业",
      "name": "page-services-navbar-行业",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarText3",
      "hrefProp": "pageServicesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-技术",
      "name": "page-services-navbar-技术",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarText4",
      "hrefProp": "pageServicesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-通信",
      "name": "page-services-navbar-通信",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarText5",
      "hrefProp": "pageServicesNavbarHref"
    },
    {
      "type": "text",
      "id": "page-services-navbar-联系方式",
      "name": "page-services-navbar-联系方式",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "pageServicesNavbarText6",
      "hrefProp": "pageServicesNavbarHref"
    },
    {
      "type": "rectangle",
      "id": "page-services-navbar-menu-hit",
      "name": "page-services-navbar-menu-hit",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 16,
    ...
    {
      "type": "rectangle",
      "id": "page-services-navbar-menu-line1",
      "name": "page-services-navbar-menu-line1",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-services-navbar-menu-line2",
      "name": "page-services-navbar-menu-line2",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
    ...
    {
      "type": "rectangle",
      "id": "page-services-navbar-menu-line3",
      "name": "page-services-navbar-menu-line3",
      "style": {
        "boxSizing": "border-box",
        "width": 16,
        "height": 2,
...
const DEFAULT_PROPS = {
  "id": "page-services-navbar",
  "pageServicesNavbarLogoimagesrc": "/Users/andai007/Desktop/shpitto_tools-main/assets/fpt218/logo-fpt.png",
  "pageServicesNavbarLangtext": "ZH",
  "pageServicesNavbarLanghref": "/",
  "pageServicesNavbarText": "企业",
  "pageServicesNavbarHref": "/",
  "pageServicesNavbarText2": "产品",
  "pageServicesNavbarText3": "行业",
  "pageServicesNavbarText4": "技术",
  "pageServicesNavbarText5": "通信",
  "pageServicesNavbarText6": "联系方式"
};
const DEFAULT_THEME = {
  "mode": "light",
...
export default function TemplateExclusivePenSiteHomeNavigationNavbarpenPrimary({ id, pageServicesNavbarLogoimagesrc, pageServicesNavbarLangtext, pageServicesNavbarLanghref, pageServicesNavbarText, pageServicesNavbarHref, pageServicesNavbarText2, pageServicesNavbarText3, pageServicesNavbarText4, pageServicesNavbarText5, pageServicesNavbarText6, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageServicesNavbarLogoimagesrc, pageServicesNavbarLangtext, pageServicesNavbarLanghref, pageServicesNavbarText, pageServicesNavbarHref, pageServicesNavbarText2, pageServicesNavbarText3, pageServicesNavbarText4, pageServicesNavbarText5, pageServicesNavbarText6 });
