...
export default function TemplateExclusivePenSiteContactsNavigationNavbarpenPrimary({ id, pageContactsNavbarLogoimagesrc, pageContactsNavbarSearchtext, pageContactsNavbarSearchhref, pageContactsNavbarLangtext, pageContactsNavbarLanghref, pageContactsNavbarMenutext, pageContactsNavbarMenuhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pageContactsNavbarLogoimagesrc, pageContactsNavbarSearchtext, pageContactsNavbarSearchhref, pageContactsNavbarLangtext, pageContactsNavbarLanghref, pageContactsNavbarMenutext, pageContactsNavbarMenuhref });
