...
const SECTION_TREE = {
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "textProp": "prodTab3Texttext"
    },
    {
      "type": "rectangle",
      "id": "product-card-1-box",
      "name": "product-card-1-box",
      "style": {
        "boxSizing": "border-box",
        "width": 430,
        "height": 260,
    ...
    {
      "type": "rectangle",
      "id": "product-card-1-image",
      "name": "product-card-1-image",
      "style": {
        "boxSizing": "border-box",
        "width": 406,
        "height": 96,
      ...
      "children": [],
      "imageProp": "productCard1Imageimagesrc"
    },
    {
      "type": "text",
      "id": "product-card-1-eyebrow",
      "name": "product-card-1-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard1Eyebrowtext"
    },
    {
      "type": "text",
      "id": "product-card-1-title",
      "name": "product-card-1-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard1Titletext"
    },
    {
      "type": "text",
      "id": "product-card-1-body",
      "name": "product-card-1-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard1Bodytext"
    },
    {
      "type": "text",
      "id": "product-card-1-arrow",
      "name": "product-card-1-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard1Arrowtext"
    },
    {
      "type": "rectangle",
      "id": "product-card-2-box",
      "name": "product-card-2-box",
      "style": {
        "boxSizing": "border-box",
        "width": 430,
        "height": 260,
    ...
    {
      "type": "rectangle",
      "id": "product-card-2-image",
      "name": "product-card-2-image",
      "style": {
        "boxSizing": "border-box",
        "width": 406,
        "height": 96,
      ...
      "children": [],
      "imageProp": "productCard2Imageimagesrc"
    },
    {
      "type": "text",
      "id": "product-card-2-eyebrow",
      "name": "product-card-2-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard2Eyebrowtext"
    },
    {
      "type": "text",
      "id": "product-card-2-title",
      "name": "product-card-2-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard2Titletext"
    },
    {
      "type": "text",
      "id": "product-card-2-body",
      "name": "product-card-2-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard2Bodytext"
    },
    {
      "type": "text",
      "id": "product-card-2-arrow",
      "name": "product-card-2-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard2Arrowtext"
    },
    {
      "type": "rectangle",
      "id": "product-card-3-box",
      "name": "product-card-3-box",
      "style": {
        "boxSizing": "border-box",
        "width": 430,
        "height": 260,
    ...
    {
      "type": "rectangle",
      "id": "product-card-3-image",
      "name": "product-card-3-image",
      "style": {
        "boxSizing": "border-box",
        "width": 406,
        "height": 96,
      ...
      "children": [],
      "imageProp": "productCard3Imageimagesrc"
    },
    {
      "type": "text",
      "id": "product-card-3-eyebrow",
      "name": "product-card-3-eyebrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard3Eyebrowtext"
    },
    {
      "type": "text",
      "id": "product-card-3-title",
      "name": "product-card-3-title",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard3Titletext"
    },
    {
      "type": "text",
      "id": "product-card-3-body",
      "name": "product-card-3-body",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard3Bodytext"
    },
    {
      "type": "text",
      "id": "product-card-3-arrow",
      "name": "product-card-3-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productCard3Arrowtext"
    },
    {
      "type": "ellipse",
      "id": "products-dots-0",
      "name": "products-dots-0",
      "style": {
        "boxSizing": "border-box"
      },
      "children": []
    ...
    },
    {
      ...
      "children": [],
      "hrefProp": "productsCtaBoxhref"
    },
    {
      "type": "text",
      "id": "products-cta-text",
      "name": "products-cta-text",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productsCtaTexttext",
      "hrefProp": "productsCtaTexthref"
    },
    {
      "type": "text",
      "id": "products-cta-arrow",
      "name": "products-cta-arrow",
      "style": {
        "boxSizing": "border-box",
        "margin": 0,
        "whiteSpace": "pre-line",
      ...
      "children": [],
      "textProp": "productsCtaArrowtext",
      "hrefProp": "productsCtaArrowhref"
    }
  ]
};
const DEFAULT_PROPS = {
  "id": "products-section",
  "productsTitletext": "OUR PRODUCTS",
  "productsCopytext": "PAMA’s machine tools provide optimal precision and precisely perform boring, drilling, milling and turning operations, satisfying customer requirements in the most demanding industries.",
  "prodTab1Texttext": "SECTORS",
  "prodTab2Texttext": "HIGH LIFETIME COSTS",
  "prodTab3Texttext": "AUTOMATION",
  "productCard1Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/product-machining-267e98a6.jpg",
  "productCard1Eyebrowtext": "PRODUCT",
  "productCard1Titletext": "MACHINING CENTERS",
  "productCard1Bodytext": "Portal and T-type structures designed for maximum versatility and high precision.",
  "productCard1Arrowtext": "›",
  "productCard2Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/product-milling-4bd99504.jpg",
  "productCard2Eyebrowtext": "PRODUCT",
  "productCard2Titletext": "HORIZONTAL MILLING MACHINES",
  "productCard2Bodytext": "Central headstock milling machines built for dynamics, reliability and precision.",
  "productCard2Arrowtext": "›",
  "productCard3Imageimagesrc": "/Users/andai007/Desktop/website-clone-pen-pack-20260309/assets-structured/pama/product-boring-8e0a2947.jpg",
  "productCard3Eyebrowtext": "PRODUCT",
  "productCard3Titletext": "HORIZONTAL BORING – MILLING MACHINES",
  "productCard3Bodytext": "High metal-removal boring and milling machines for demanding industrial work.",
  "productCard3Arrowtext": "›",
  "productsCtaBoxhref": "/",
  "productsCtaTexttext": "DISCOVER MORE",
  "productsCtaTexthref": "/",
  "productsCtaArrowtext": "›",
  "productsCtaArrowhref": "/"
};
const DEFAULT_THEME = {
  "mode": "light",
  "fontHeading": "Raleway",
...
export default function TemplateExclusivePenSiteHomeProductsProductssectionpenAlt4({ id, productsTitletext, productsCopytext, prodTab1Texttext, prodTab2Texttext, prodTab3Texttext, productCard1Imageimagesrc, productCard1Eyebrowtext, productCard1Titletext, productCard1Bodytext, productCard1Arrowtext, productCard2Imageimagesrc, productCard2Eyebrowtext, productCard2Titletext, productCard2Bodytext, productCard2Arrowtext, productCard3Imageimagesrc, productCard3Eyebrowtext, productCard3Titletext, productCard3Bodytext, productCard3Arrowtext, productsCtaBoxhref, productsCtaTexttext, productsCtaTexthref, productsCtaArrowtext, productsCtaArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, productsTitletext, productsCopytext, prodTab1Texttext, prodTab2Texttext, prodTab3Texttext, productCard1Imageimagesrc, productCard1Eyebrowtext, productCard1Titletext, productCard1Bodytext, productCard1Arrowtext, productCard2Imageimagesrc, productCard2Eyebrowtext, productCard2Titletext, productCard2Bodytext, productCard2Arrowtext, productCard3Imageimagesrc, productCard3Eyebrowtext, productCard3Titletext, productCard3Bodytext, productCard3Arrowtext, productsCtaBoxhref, productsCtaTexttext, productsCtaTexthref, productsCtaArrowtext, productsCtaArrowhref });
