...
export default function TemplateExclusivePenSitePamaWorldwideNavigationNavbarpenPrimary({ id, pagePamaWorldwideNavbarLogoimagesrc, pagePamaWorldwideNavbarContactTexttext, pagePamaWorldwideNavbarContactTexthref, pagePamaWorldwideNavbarContactArrowtext, pagePamaWorldwideNavbarContactArrowhref, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, pagePamaWorldwideNavbarLogoimagesrc, pagePamaWorldwideNavbarContactTexttext, pagePamaWorldwideNavbarContactTexthref, pagePamaWorldwideNavbarContactArrowtext, pagePamaWorldwideNavbarContactArrowhref });
