...
export default function TemplateExclusivePenSitePscsSolutionStoryOverviewpenAlt2({ id, overviewp1text, overviewp2text, ...rest }) {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const providerMotionMode = useMotionMode();
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, overviewp1text, overviewp2text });
