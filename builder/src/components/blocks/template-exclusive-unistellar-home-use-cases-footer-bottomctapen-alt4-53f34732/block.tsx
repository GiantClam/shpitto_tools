...
const DEFAULT_PROPS = {
  ...
  "ctasubhref": "/choose-the-setup-that-matches-your-skill-level-get-guided-quickly-and-build-mome",
  "ctabtnhref": "/book-a-personal-demo",
...
export default function TemplateExclusiveUnistellarHomeUseCasesFooterBottomctapenAlt4({ id, bottomCtahref, ctatitletext, ctasubtext, ctasubhref, ctabtnhref, ctabtntxttext, ctabtntxthref, ctachip1txttext, ctachip2txttext, ctachip3txttext, ...rest }) {
  const merged = assignDefined({ ...DEFAULT_PROPS }, { id, bottomCtahref, ctatitletext, ctasubtext, ctasubhref, ctabtnhref, ctabtntxttext, ctabtntxthref, ctachip1txttext, ctachip2txttext, ctachip3txttext });
