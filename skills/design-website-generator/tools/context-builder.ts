 ...
 * 
 * This is a CONTEXT BUILDER only - workflow logic is in SKILL.md/prompts/
 */
 ...
 * Used by all page generation prompts
 */
 ...
 * Used to maintain coherence across pages
 */
 ...
 * Used when generating Page N to include all previous page contexts
 */
