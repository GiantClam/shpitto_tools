/**
 * Resource Loader - Load rules, prompts, references
 * 
 * This is a LOADER only - content is defined in SKILL.md and related files
 */
...
const PROMPTS_DIR = path.join(SKILL_ROOT, 'prompts');
